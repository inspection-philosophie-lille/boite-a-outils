...
const philosophyData = {
		...
		source: "DESCARTES, Méditations métaphysiques, 4e éd. (1647), Adam et Tannery, Paris, Vrin, t. IX-1, pp. 43-45."
};
...
const questions = [
		// Question n°1
		{
				...
				answers: [
						"Réponse : qu'elle est infinie et parfaite",
						"Réponse : qu'elle est très petite et limitée",
						"Réponse : qu'elle est égale à celle de Dieu"
				],
				correct: 2,
		...
		// Question n°2
		{
				...
				answers: [
						"Réponse : une faculté beaucoup plus ample et même infinie",
						"Réponse : une faculté semblable à la sienne",
						"Réponse : une faculté uniquement humaine"
				],
				correct: 1,
		...
		// Question n°3
		{
				...
				answers: [
						"Réponse : à la nature humaine",
						"Réponse : à la nature de Dieu",
						"Réponse : à la nature des anges"
				],
				correct: 2,
		...
		// Question n°4
		{
				...
				answers: [
						"Réponse : qu'elles sont infinies en lui",
						"Réponse : qu'elles sont très petites et bornées en lui, mais infinies en Dieu",
						"Réponse : qu'elles n'existent pas en Dieu"
				],
				correct: 2,
		...
		// Question n°5
		{
				...
				answers: [
						"Réponse : l'entendement",
						"Réponse : la volonté",
						"Réponse : l'imagination"
				],
				correct: 2,
		...
		// Question n°6
		{
				...
				answers: [
						"Réponse : sa capacité de raisonner",
						"Réponse : sa volonté",
						"Réponse : sa mémoire"
				],
				correct: 2,
		...
		// Question n°7
		{
				...
				answers: [
						"Réponse : dans le fait d'être contraint par des forces extérieures",
						"Réponse : dans le fait de pouvoir faire ou ne pas faire une chose sans contrainte extérieure",
						"Réponse : dans l'indifférence complète"
				],
				correct: 2,
		...
		// Question n°8
		{
				...
				answers: [
						"Réponse : être indifférent entre deux options",
						"Réponse : ne pas être indifférent, mais pencher vers un choix avec connaissance",
						"Réponse : être déterminé par des causes extérieures"
				],
				correct: 2,
		...
		// Question n°9
		{
				...
				answers: [
						"Réponse : elles la diminuent",
						"Réponse : elles l'augmentent et la fortifient",
						"Réponse : elles la rendent indifférente"
				],
				correct: 2,
		...
		// Question n°10
		{
				...
				answers: [
						"Réponse : comme le plus haut degré de la liberté",
						"Réponse : comme le plus bas degré de la liberté",
						"Réponse : comme l'essence même de la liberté"
				],
				correct: 2,
		...
		// Question n°11
		{
				...
				answers: [
						"Réponse : une perfection de la volonté",
						"Réponse : un défaut dans la connaissance",
						"Réponse : la présence de la grâce divine"
				],
				correct: 2,
		...
		// Question n°12
		{
				...
				answers: [
						"Réponse : quand nous serions toujours indifférents",
						"Réponse : quand nous connaîtrions toujours clairement le vrai et le bien",
						"Réponse : quand nous serions déterminés par nos passions"
				],
				correct: 2,
		...
		// Question n°13
		{
				...
				answers: [
						"Réponse : formellement, dans son essence même",
						"Réponse : par la connaissance et la puissance qui s'y joignent",
						"Réponse : parce qu'elle est moins libre"
				],
				correct: 2,
		...
		// Question n°14
		{
				...
				answers: [
						"Réponse : oui, beaucoup plus petite",
						"Réponse : non, elle ne semble pas plus grande",
						"Réponse : elle est identique"
				],
				correct: 2,
		...
		// Question n°15
		{
				...
				answers: [
						"Réponse : il est plus restreint",
						"Réponse : il s'étend infiniment à plus de choses",
						"Réponse : il est identique"
				],
				correct: 2,
		...
		// Question n°16
		{
				...
				answers: [
						"Réponse : les actions de l'entendement",
						"Réponse : les opérations fondamentales de la volonté",
						"Réponse : les passions du corps"
				],
				correct: 2,
		...
		// Question n°17
		{
				...
				answers: [
						"Réponse : quand on est indifférent",
						"Réponse : quand on suit son penchant avec connaissance évidente",
						"Réponse : quand on est contraint"
				],
				correct: 2,
		...
		// Question n°18
		{
				...
				answers: [
						"Réponse : la connaissance diminue la liberté",
						"Réponse : la connaissance augmente la liberté",
						"Réponse : elles sont sans rapport"
				],
				correct: 2,
		...
		// Question n°19
		{
				...
				answers: [
						"Réponse : parce qu'il est Dieu",
						"Réponse : parce que sa volonté est déjà infinie",
						"Réponse : parce qu'il l'expérimente comme très grande et étendue"
				],
				correct: 3,
		...
		// Question n°20
		{
				...
				answers: [
						"Réponse : au déterminisme absolu",
						"Réponse : au libertarisme indifférentiste",
						"Réponse : au rationalisme de la liberté éclairée"
				],
				correct: 3,
		...
		// Question n°21
		{
				...
				answers: [
						"Réponse : il est infini en l'homme comme en Dieu",
						"Réponse : il est limité en l'homme mais infini en Dieu",
						"Réponse : il est identique dans les deux cas"
				],
				correct: 2,
		...
		// Question n°22
		{
				...
				answers: [
						"Réponse : selon son apparence extérieure",
						"Réponse : selon son essence même, abstraction faite de ses circonstances",
						"Réponse : selon ses effets pratiques"
				],
				correct: 2,
		...
		// Question n°23
		{
				...
				answers: [
						"Réponse : la volonté précède et détermine l'entendement",
						"Réponse : la volonté agit sur les choses que l'entendement lui propose",
						"Réponse : l'entendement et la volonté sont totalement indépendants"
				],
				correct: 2,
		...
		// Question n°24
		{
				...
				answers: [
						"Réponse : Dieu n'intervient pas dans la pensée humaine",
						"Réponse : Dieu peut disposer l'intérieur de la pensée",
						"Réponse : Dieu empêche la liberté humaine"
				],
				correct: 2,
		...
		// Question n°25
		{
				...
				answers: [
						"Réponse : la délibération est le signe de la liberté parfaite",
						"Réponse : la délibération indique un manque de connaissance",
						"Réponse : la délibération est toujours inutile"
				],
				correct: 2,
		...
		// Question n°26
		{
				...
				answers: [
						"Réponse : elle sert uniquement d'idée régulatrice",
						"Réponse : elle prouve l'existence de Dieu",
						"Réponse : elle montre les limites de la raison humaine"
				],
				correct: 2,
		...
		// Question n°27
		{
				...
				answers: [
						"Réponse : l'absence totale de raison",
						"Réponse : la présence de raisons trop nombreuses",
						"Réponse : la force des raisons qui déterminent le choix"
				],
				correct: 1,
		...
		// Question n°28
		{
				...
				answers: [
						"Réponse : par sa perfection absolue",
						"Réponse : par son infinité formelle dans son essence",
						"Réponse : par sa capacité à créer ex nihilo"
				],
				correct: 2,
		...
		// Question n°29
		{
				...
				answers: [
						"Réponse : la première paire concerne la connaissance, la seconde l'action",
						"Réponse : la première est passive, la seconde active",
						"Réponse : la première relève du corps, la seconde de l'âme"
				],
				correct: 1,
		...
		// Question n°30
		{
				...
				answers: [
						"Réponse : parce qu'elle est plus indifférente",
						"Réponse : parce qu'elle est jointe à la connaissance et à la puissance infinies",
						"Réponse : parce qu'elle est moins libre"
				],
				correct: 2,
		...
		// Question n°31
		{
				...
				answers: [
						"Réponse : il fait une expérience scientifique",
						"Réponse : il a une connaissance empirique sensible",
						"Réponse : il a une conscience immédiate par introspection"
				],
				correct: 3,
		...
		// Question n°32
		{
				...
				answers: [
						"Réponse : la connaissance intuitive immédiate",
						"Réponse : la connaissance acquise par les sens",
						"Réponse : la connaissance rationnelle développée par la raison humaine"
				],
				correct: 3,
		...
		// Question n°33
		{
				...
				answers: [
						"Réponse : comme une gradation dans l'intensité de la liberté",
						"Réponse : comme une contradiction dans les termes",
						"Réponse : comme une métaphore sans portée conceptuelle"
				],
				correct: 1,
		...
		// Question n°34
		{
				...
				answers: [
						"Réponse : elle est la faculté la plus limitée",
						"Réponse : elle est la faculté la plus étendue et semblable à celle de Dieu",
						"Réponse : elle est équivalente aux autres facultés"
				],
				correct: 2,
		...
		// Question n°35
		{
				...
				answers: [
						"Réponse : en niant la réalité du mal",
						"Réponse : en attribuant le mal à la liberté humaine",
						"Réponse : en faisant de Dieu l'auteur du mal"
				],
				correct: 2,
		...
		// Question n°36
		{
				...
				answers: [
						"Réponse : elle supprime la liberté humaine",
						"Réponse : elle coopère avec la liberté sans la détruire",
						"Réponse : elle est incompatible avec la raison"
				],
				correct: 2,
		...
		// Question n°37
		{
				...
				answers: [
						"Réponse : le détachement affectif",
						"Réponse : l'équilibre parfait entre deux options possibles",
						"Réponse : l'impartialité du jugement"
				],
				correct: 2,
		...
		// Question n°38
		{
				...
				answers: [
						"Réponse : parce qu'elle est mauvaise par nature",
						"Réponse : parce qu'elle dépasse les limites de l'entendement",
						"Réponse : parce qu'elle est déterminée par le corps"
				],
				correct: 2,
		...
		// Question n°39
		{
				...
				answers: [
						"Réponse : elle désigne la connaissance sensorielle",
						"Réponse : elle représente la raison humaine capable de connaître l'évidence",
						"Réponse : elle symbolise la révélation divine"
				],
				correct: 2,
		...
		// Question n°40
		{
				...
				answers: [
						...
						"Réponse : elle est le fondement de toute la démarche cartésienne",
						"Réponse : elle ne sert qu'à constater des limites"
				],
				correct: 2,
		...
		// Question n°41
		{
				...
				answers: [
						"Réponse : comme toute influence venant de l'extérieur",
						"Réponse : comme une force physique qui empêche l'action",
						"Réponse : comme une pression psychologique"
				],
				correct: 1,
		...
		// Question n°42
		{
				...
				answers: [
						"Réponse : la capacité de rester indifférente",
						"Réponse : le pouvoir de choisir sans raison",
						"Réponse : l'aptitude à suivre l'évidence rationnelle"
				],
				correct: 3,
		...
		// Question n°43
		{
				...
				answers: [
						"Réponse : par son exercice concret",
						"Réponse : par son essence formelle",
						"Réponse : par ses effets dans le monde"
				],
				correct: 2,
		...
		// Question n°44
		{
				...
				answers: [
						"Réponse : la volonté est un type de jugement",
						"Réponse : le jugement est l'acte par lequel la volonté affirme ou nie",
						"Réponse : ils sont totalement séparés"
				],
				correct: 2,
		...
		// Question n°45
		{
				...
				answers: [
						"Réponse : par la doctrine de la grâce divine",
						"Réponse : en distinguant détermination interne et contrainte externe",
						"Réponse : en faisant de la liberté un mystère"
				],
				correct: 2,
		...
		// Question n°46
		{
				...
				answers: [
						"Réponse : elle nie la toute-puissance divine",
						"Réponse : elle concilie liberté humaine et souveraineté divine",
						"Réponse : elle rend Dieu responsable du mal"
				],
				correct: 2,
		...
		// Question n°47
		{
				...
				answers: [
						"Réponse : elle fonde une morale du devoir absolu",
						"Réponse : elle conduit à une éthique intellectualiste",
						"Réponse : elle justifie l'immoralisme"
				],
				correct: 2,
		...
		// Question n°48
		{
				...
				answers: [
						"Réponse : les passions déterminent nécessairement la volonté",
						"Réponse : la volonté peut maîtriser les passions",
						"Réponse : volonté et passions sont indépendantes"
				],
				correct: 2,
		...
		// Question n°49
		{
				...
				answers: [
						"Réponse : par la révélation divine",
						"Réponse : par la méthode et la progression des connaissances",
						"Réponse : en renonçant à la certitude"
				],
				correct: 2,
		...
		// Question n°50
		{
				...
				answers: [
						...
						"Réponse : elle a inspiré le déterminisme spinoziste",
						"Réponse : elle a influencé Leibniz, Kant et la philosophie moderne"
				],
				correct: 3,
