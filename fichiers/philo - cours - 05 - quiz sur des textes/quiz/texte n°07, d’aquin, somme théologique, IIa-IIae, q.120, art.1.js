...
const questions = [
    ...
    { 
        ...
        answers: [
            "sur des situations universelles et immuables", 
            "sur des situations singulières qui peuvent varier à l'infini", 
    ...
    { 
        ...
        answers: [
            "qu'elle est possible et souhaitable", 
            "qu'elle est impossible à instituer", 
            "qu'elle existe dans la loi divine"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "tous les cas particuliers possibles", 
            "les conditions générales", 
            "uniquement les situations exceptionnelles"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "toujours bénéfique", 
            "contraire à la justice et au bien commun", 
            "plus stricte encore"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "la loi sur le paiement des impôts", 
            "la loi sur le rendement des dépôts", 
    ...
    { 
        ...
        answers: [
            "quand le déposant est pauvre", 
            "quand un fou réclame son épée ou quand on trahit sa patrie", 
            "quand le dépôt est de peu de valeur"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "pour rester fidèle à l'esprit de justice et au bien commun", 
    ...
    { 
        ...
        answers: [
            "entre loi écrite et loi orale", 
            "entre lettre et esprit de la loi", 
            "entre loi humaine et loi animale"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "parce qu'ils manquent de sagesse", 
            "parce que les situations singulières sont infiniment variables", 
    ...
    { 
        ...
        answers: [
            "être mal écrite", 
            "ne pas atteindre son but dans certains cas", 
            "être trop ancienne"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "être appliquée littéralement", 
            "sauvegarder la justice et le bien commun", 
    ...
    { 
        ...
        answers: [
            "qu'il faut toujours respecter la propriété", 
            "que certaines applications littérales de la loi peuvent être nuisibles", 
            "que les fous ne devraient pas posséder d'épées"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            ...
            "une conception téléologique et flexible", 
            "une conception purement punitive"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "la généralité concerne la majorité des situations, les particuliers sont exceptionnels", 
            "il n'y a pas de différence", 
            "la généralité concerne les riches, les particuliers les pauvres"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "l'anarchie", 
            "une meilleure réalisation de la justice", 
            "l'arbitraire"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "il faut toujours obéir aux lois sans réfléchir", 
            "il faut parfois adapter l'application des lois aux circonstances", 
            "il faut abolir toutes les lois"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "à des situations abstraites et universelles", 
            "à des situations singulières et concrètes", 
            "uniquement à des situations idéales"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "le pouvoir des législateurs", 
            "la justice et le bien commun", 
            "la stabilité sociale à tout prix"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            ...
            "dans la généralité des cas particuliers", 
            "seulement dans les cas prévus par le législateur"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "entre loi ancienne et loi nouvelle", 
            "entre lettre et esprit de la loi", 
    ...
    { 
        ...
        answers: [
            ...
            "de trahir la justice dans certains cas", 
            "de simplifier la justice"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "rigidité dans l'application des lois", 
            "capacité d'adaptation aux circonstances", 
            "obéissance aveugle au législateur"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "un cas ordinaire", 
            "un contre-exemple montrant les limites de la loi", 
            "un exemple de désobéissance justifiée"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "créer des lois parfaites", 
            "prévoir tous les cas particuliers", 
            "établir des règles pour le bien commun"
        ], 
        correct: 3,
    ...
    { 
        ...
        answers: [
            "par paresse des législateurs", 
            "parce qu'elle doit couvrir de nombreux cas", 
    ...
    { 
        ...
        answers: [
            "abolir la loi", 
            "ne pas appliquer le texte strictement", 
    ...
    { 
        ...
        answers: [
            "qu'il faut toujours rendre un dépôt", 
            "que certains principes peuvent entrer en conflit", 
            "que la patrie est plus importante que la justice"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "il faut toujours leur obéir", 
            "il faut parfois y désobéir", 
            "il faut les réformer d'abord"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "toujours la forme", 
            "toujours le fond", 
            "le fond quand la forme y fait obstacle"
        ], 
        correct: 3,
    ...
    { 
        ...
        answers: [
            ...
            "son incapacité à prévoir tous les cas", 
            "sa complexité"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            ...
            "la vertu qui adapte la loi aux cas particuliers", 
    ...
    { 
        ...
        answers: [
            ...
            "par un principe supérieur de justice", 
            "par la nécessité politique"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "aucune différence", 
            "la légalité est formelle, la légitimité est morale", 
            "la légalité est morale, la légitimité est formelle"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "suivre toujours le devoir légal", 
            "choisir le devoir moral supérieur", 
            "ne rien faire"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "elle refuse toute exception", 
            "elle admet des exceptions justifiées", 
            "elle nie la valeur des lois"
        ], 
        correct: 2,
