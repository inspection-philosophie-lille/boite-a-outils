...
const questions = [
    ...
    { 
        ...
        answers: [
            "pourquoi les hommes mentent-ils souvent ?", 
            "pourquoi les hommes disent-ils la vérité la plupart du temps ?", 
            "quel est l'origine du sens moral ?"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            ...
            "parce que Nietzsche cherche des explications naturelles et non transcendantes", 
            "parce que la religion encourage le mensonge"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "parce que dire la vérité est plus facile", 
            "parce que le mensonge est moralement supérieur", 
            "parce que la société punit le mensonge"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "invention, dissimulation et mémoire", 
    ...
    { 
        ...
        answers: [
            "celui qui ment doit inventer vingt autres mensonges", 
            "le mensonge est toujours bénéfique", 
    ...
    { 
        ...
        answers: [
            "parce que la ruse est toujours préférable", 
            "parce qu'en des circonstances simples, il est avantageux de parler franc", 
            "parce que le mensonge est socialement valorisé"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "parce qu'elle nécessite moins d'efforts et évite les complications de la ruse", 
    ...
    { 
        ...
        answers: [
            ...
            "il se sert naturellement du mensonge", 
            "il rejette toute forme de communication"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "il a un sens inné de la vérité", 
            "un sens de la vérité lui est étranger et inaccessible", 
            "il hait le mensonge"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "une conception utilitaire et pragmatique", 
            "une conception métaphysique absolue", 
            "une conception divine et révélée"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "moralisateur et normatif", 
            "psychologique et désillusionné", 
            "religieux et pieux"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "les explications morales ou religieuses transcendantes", 
            "les explications psychologiques", 
            "les explications utilitaires"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "elle détermine nos rapports à la vérité et au mensonge", 
            "elle n'a aucune importance", 
            "elle est toujours bénéfique"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "mentir sans conscience morale du mensonge", 
            "mentir pour une bonne cause", 
            "mentir par ignorance"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "la généalogie (recherche des origines psychologiques et sociales)", 
    ...
    { 
        ...
        answers: [
            "l'homme est naturellement bon et véridique", 
            "l'homme adapte son rapport à la vérité selon ses intérêts et circonstances", 
            "l'homme est naturellement menteur"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "la conception morale traditionnelle de la vérité", 
            "l'utilitarisme", 
            "la psychologie"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "au rationalisme classique", 
            "à la philosophie critique et généalogique", 
    ...
    { 
        ...
        answers: [
            "il défend l'absolu de la vérité", 
            "il relativise et naturalise notre pratique de la vérité", 
            "il affirme l'impossibilité de toute vérité"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "une réfutation suivie de deux explications positives et d'un contre-exemple", 
            "une affirmation dogmatique sans justification", 
            "un développement purement théorique sans exemples"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "comme une faculté innée universelle", 
            "comme une construction sociale et psychologique variable", 
    ...
    { 
        ...
        answers: [
            "elle sert d'ornement littéraire sans fonction argumentative", 
            "elle illustre et renforce l'argument sur la complexité du mensonge", 
            "elle contredit la thèse principale de Nietzsche"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "des conditions familiales simples et harmonieuses", 
            "des situations familiales conflictuelles, ambiguës ou manipulateuses", 
            "un manque de discipline dans l'éducation"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "la vérité est toujours complexe et difficile", 
            "dans des circonstances simples, la vérité est avantageuse", 
            "la simplicité empêche toute forme de vérité"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "il sert de simple anecdote sans portée théorique", 
            "il montre la plasticité du comportement humain face à la vérité", 
            "il prouve que tous les enfants sont naturelmente menteurs"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "l'enfant est conscient de manipuler la vérité", 
            "l'enfant adapte spontanément son discours à ses besoins sans réflexion morale", 
            "l'enfant est contraint par ses parents à mentir"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "comme une donnée universelle et immuable", 
            "comme un produit variable de l'éducation et des circonstances", 
    ...
    { 
        ...
        answers: [
            "la vérité dépend toujours d'un choix conscient et volontaire", 
            "le rapport à la vérité est souvent involontaire et automatique", 
            "seule la volonté divine détermine notre rapport à la vérité"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "par leur degré de complexité cognitive requise", 
            "par leur valeur morale intrinsèque", 
            "par leur origine divine ou diabolique"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "des situations idéales qui justifient moralement la vérité", 
            "des conditions pratiques où la vérité est stratégiquement avantageuse", 
    ...
    { 
        ...
        answers: [
            "comme un calcul égoïste conscient", 
            "comme une orientation fondamentale et souvent inconsciente de l'action", 
            "comme une illusion à dépasser"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "une société harmonieuse et transparente", 
            "une société diverse où coexistent différentes formes de rapport à la vérité", 
            "une société fondamentalement mensongère"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "comme une force secondaire sans importance", 
            "comme un mécanisme fondamental qui explique nos comportements moraux", 
    ...
    { 
        ...
        answers: [
            "la vérité est toujours du côté des opprimés", 
            "la vérité peut être une stratégie de ceux qui détiennent l'autorité", 
            "la vérité est indépendante des rapports de pouvoir"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "comme une essence fixe et immuable", 
            "comme une plasticité qui s'adapte aux circonstances", 
            "comme une perfection divine à retrouver"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "une digression sans rapport avec l'argument principal", 
            "une illustration concrète qui renforce l'argument sur la complexité du mensonge", 
            "une contradiction délibérée de la thèse de Nietzsche"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "comme une faculté sans importance", 
            "comme une exigence qui rend le mensonge difficile et coûteux", 
            "comme un don divin qui permet de distinguer le vrai du faux"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "un dégoût moral inné pour le mensonge", 
            "une réaction affective négative indépendante des conséquences", 
            "une construction éducative et sociale"
        ], 
        correct: 3,
    ...
    { 
        ...
        answers: [
            "l'individu est totalement déterminé par la société", 
            "l'individu et la société s'influencent mutuellement", 
            "l'individu est indépendant de la société"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "elle est totalement absente de l'analyse", 
            "elle joue un rôle central à travers les notions de facilité et de répugnance", 
            "elle est considérée comme un obstacle à la vérité"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "comme une caractéristique objective des situations", 
            "comme une perception subjective liée à la position sociale", 
            "comme une illusion métaphysique"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "ils sont évités au profit de la pure théorie", 
            "ils jouent un rôle essentiel pour ancrer l'analyse dans le réel", 
            "ils servent seulement d'illustrations décoratives"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "il ne l'envisage pas, considérant l'éducation actuelle comme naturelle", 
            "il la suggère implicitement en montrant comment l'éducation actuelle produit certains effets", 
            "il propose un programme éducatif détaillé"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "la vérité est toujours liée à la transparence des relations", 
            "la vérité est indépendante de la transparence", 
            "la vérité détruit la transparence"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "comme un état originel à retrouver", 
            "comme un mythe chrétien sans réalité", 
            "comme une absence de conscience morale acquise"
        ], 
        correct: 3,
    ...
    { 
        ...
        answers: [
            "limiter l'analyse aux situations triviales sans portée philosophique", 
            "ancrer la réflexion philosophique dans l'expérience ordinaire", 
            "éviter les questions métaphysiques importantes"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "il la valorise comme expression de l'authenticité", 
            "il la décrit comme le résultat d'habitudes incorporées", 
            "il la rejette comme irrationnelle"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "elle est évitée comme un défaut logique", 
            "elle est recherchée comme moteur de la pensée", 
            "elle est résolue par la synthèse hégélienne"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "elle substitue aux justifications morales des explications psychologiques et utilitaires", 
            "elle réaffirme les fondements métaphysiques de la vérité", 
            "elle nie toute possibilité de distinction entre vérité et mensonge"
        ], 
        correct: 1,
