...
const questions = [
    ...
    { 
        ...
        answers: [
            "Augmenter constamment sa force physique",
            "Transformer sa force en droit et l'obéissance en devoir", 
            "Éliminer tous ceux qui pourraient le menacer"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Un droit sérieux et légitime", 
            "Un droit pris ironiquement en apparence mais réellement établi", 
            "Un droit naturel évident pour tous"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Une puissance morale et spirituelle", 
            "Une puissance physique purement matérielle", 
            "Une manifestation de la volonté divine"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Une moralité supérieure et noble", 
            "Aucune moralité ne peut en résulter", 
            "Une moralité relative selon les circonstances"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Un acte de volonté libre et réfléchie", 
            "Un acte de nécessité ou tout au plus de prudence", 
            "Un devoir moral fondamental"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Le droit devient stable et permanent", 
            "Toute force qui surmonte la première succède à son droit", 
            "La société trouve enfin un fondement solide"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "On doit quand même obéir par devoir", 
            "On le peut légitimement", 
    ...
    { 
        ...
        answers: [
            "Il devient trop rigide", 
            "Ce n'est pas un vrai droit selon Rousseau", 
            "Il acquiert une valeur divine"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Cédez toujours à toutes les autorités sans réfléchir", 
            "Cédez à la force, mais c'est un précepte superflu", 
            "Obéissez seulement aux lois divines"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Il l'accepte sans réserve comme vérité absolue", 
            "Il le rejette complètement comme superstition", 
            "Il l'accepte mais montre son absurdité par analogie"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Un brigand au coin d'un bois", 
            "Un roi dans son palais", 
            "Un juge rendant la justice"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "Une puissance illégitime qu'on peut ignorer", 
            "Aussi une puissance au même titre que les autres", 
            "Un simple objet sans signification politique"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "La force fait toujours droit dans la pratique", 
            "Force ne fait pas droit", 
            "Le droit dépend uniquement de la volonté divine"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "À toutes les puissances sans distinction", 
            "Seulement aux puissances légitimes", 
    ...
    { 
        ...
        answers: [
            "Une théorie claire et évidente", 
            "Un discours confus et incohérent", 
            "Une vérité philosophique profonde"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Parce que la force est déjà suffisante par elle-même", 
            "Parce que dans cette théorie, droit et force sont confondus", 
            "Parce que le droit vient toujours après la force"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Entre force physique et obligation morale", 
    ...
    { 
        ...
        answers: [
            "L'idée que la force physique puisse fonder un droit légitime", 
            "L'existence de toute forme de pouvoir politique", 
            "La nécessité d'obéir à quelque autorité que ce soit"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "Un pouvoir fondé uniquement sur la force", 
            "Un pouvoir fondé sur le consentement ou un pacte", 
            "Un pouvoir fondé sur l'hérédité divine"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            ...
            "XVIIIe siècle - Lumières/Contractualisme", 
    ...
    { 
        ...
        answers: [
            "Justifier l'absolutisme royal", 
            "Démontrer l'invalidité du droit du plus fort", 
    ...
    { 
        ...
        answers: [
            "Il l'accepte sans discussion", 
            "Il le rejette avec mépris", 
            "Il l'accepte formellement mais en neutralise la portée"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Il est identique à la nécessité physique", 
            "Il suppose une adhésion volontaire de la volonté", 
    ...
    { 
        ...
        answers: [
            "Que le vol est parfois justifié", 
            "Que la force ne crée aucune obligation morale", 
            "Que les brigands ont des droits"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Montrer que personne ne prend ce droit au sérieux", 
            "Indiquer que ce droit est présenté comme sérieux mais est en fait absurde", 
            "Faire une plaisanterie sur le pouvoir"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Une vertu morale élevée", 
            "Un simple calcul d'intérêt face au danger", 
            "Une qualité des gouvernants"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "La stabilité du pouvoir est assurée", 
            "Dès qu'une force est vaincue, son droit disparaît", 
            "La cause produit toujours le même effet"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "La liberté comme absence de toute contrainte", 
            "La liberté comme obéissance à la loi qu'on s'est prescrite", 
            "La liberté comme pouvoir de nuire aux autres"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Il justifie la domination des plus forts", 
            "Rép : Il élimine la force comme fondement pour chercher un autre principe", 
            "Il appelle à la révolution violente"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Justifier les régimes autoritaires", 
            "Critiquer toute forme d'autorité", 
            "Fonder la distinction entre pouvoir légitime et pouvoir de fait"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Il recommande l'obéissance absolue", 
            "Il distingue obéissance forcée et obéissance par devoir", 
            "Il rejette toute forme d'obéissance"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            ...
            "Le sentiment d'une obligation morale intérieure", 
    ...
    { 
        ...
        answers: [
            ...
            "L'analyse conceptuelle et logique", 
            "L'invocation de l'autorité"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Par son rejet de la tradition comme justification", 
            "Par son appel à l'autorité religieuse", 
            "Par son mépris de la raison"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "Justifier la résignation face au malheur", 
            "Montrer l'absurdité de l'argument théologique", 
            "Défendre la médecine traditionnelle"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            ...
            "La puissance fondée sur un principe autre que la force", 
            "La puissance héréditaire"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Il accepte le droit du plus fort que Hobbes rejette", 
            "Il rejette la force comme fondement alors que Hobbes l'accepte", 
            "Ils ont exactement la même théorie"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            ...
            "Guider le lecteur dans la réflexion et souligner les absurdités", 
    ...
    { 
        ...
        answers: [
            ...
            "L'absolutisme monarchique en France", 
    ...
    { 
        ...
        answers: [
            "Mettre de côté", 
            "Poser comme fondement indiscutable", 
    ...
    { 
        ...
        answers: [
            "Il remet en cause le fondement traditionnel du pouvoir", 
            "Il appelle à la violence", 
            "Il rejette toute religion"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "Comme des relations de pur rapport de force", 
            "Comme des relations devant être fondées sur le droit", 
            "Comme des relations purement affectives"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Sans être vu", 
            "Sans subir de conséquence physique", 
    ...
    { 
        ...
        answers: [
            "La justification de toutes les révolutions", 
            "L'idée que tout pouvoir doit prouver sa légitimité", 
            "Le rejet de tout gouvernement"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Il justifie la dictature", 
            "Il fonde l'autorité sur le consentement plutôt que sur la force", 
            "Il rejette toute forme de représentation"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Un ton lyrique et poétique", 
            "Un ton polémique et ironique", 
            "Un ton scientifique et neutre"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Parce qu'il justifie la tyrannie", 
            "Parce qu'il pose avec force la question de la légitimité du pouvoir", 
            "Parce qu'il décrit des événements historiques"
        ], 
        correct: 2,
