...
const questions = [
    {
        ...
        answers: [
            "Réponse : l'acquisition de connaissances scientifiques",
            "Réponse : la sortie de l'homme de sa minorité dont il est lui-même responsable",
            "Réponse : l'obéissance à l'autorité éclairée"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : être jeune d'âge",
            "Réponse : incapacité de se servir de son entendement sans la direction d'autrui",
            "Réponse : avoir un statut social inférieur"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : parce qu'il naît naturellement ignorant",
            "Réponse : parce que la cause réside dans un défaut de l'entendement",
            "Réponse : parce que la cause réside dans un manque de décision et de courage"
        ],
        correct: 3,
    ...
    },
    {
        ...
        answers: [
            "Réponse : pense par toi-même",
            "Réponse : aie le courage de te servir de ton propre entendement",
            "Réponse : connais-toi toi-même"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : le principe fondamental de la métaphysique",
            "Réponse : la devise des Lumières",
            "Réponse : une maxime morale universelle"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : l'ignorance et la pauvreté",
            "Réponse : la paresse et la lâcheté",
            "Réponse : l'oppression politique et religieuse"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : parce que l'État y encourage",
            "Réponse : parce qu'on n'a pas besoin de penser par soi-même",
            "Réponse : parce que c'est notre condition naturelle"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : avoir un livre qui tient lieu d'entendement",
            "Réponse : suivre les coutumes traditionnelles",
            "Réponse : obéir aux lois sans les questionner"
        ],
        correct: 1,
    ...
    },
    {
        ...
        answers: [
            "Réponse : d'acheter la liberté",
            "Réponse : de payer d'autres pour penser à notre place",
            "Réponse : d'accéder à l'éducation"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : parce que la société l'interdit",
            "Réponse : parce que c'est presque devenu un état naturel",
            "Réponse : parce que cela nécessite une intelligence exceptionnelle"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : La majorité est majeure, la minorité est mineure",
            "Réponse : La majorité est mineure, la minorité est majeure",
            "Réponse : Tous les hommes naissent majeurs"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : Illumination",
            "Réponse : Éclaircissement/Explication",
            "Réponse : Révolution"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : Elle ajoute quelque chose à la réalité",
            "Réponse : Elle retire ce qui obscurcit l'intelligence",
            "Réponse : Elle crée une nouvelle réalité"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : devenir indépendant politiquement",
            "Réponse : se libérer de la tutelle intellectuelle d'autrui",
            "Réponse : échapper à l'autorité parentale"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : les parents et éducateurs",
            "Réponse : ceux qui se posent en guides intellectuels pour les mineurs",
    ...
    },
    {
        ...
        answers: [
            "Réponse : l'éducation formelle",
            "Réponse : le courage d'utiliser sa propre raison",
    ...
    },
    {
        ...
        answers: [
            ...
            "Réponse : un défaut de l'entendement",
            "Réponse : l'oppression sociale"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : comme une joie naturelle",
            "Réponse : comme un travail ennuyeux",
            "Réponse : comme un devoir moral"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : c'est un choix courageux et responsable",
            "Réponse : c'est un devoir envers la société",
            "Réponse : c'est une exigence religieuse"
        ],
        correct: 1,
    ...
    },
    {
        ...
        answers: [
            "Réponse : l'ordre et la stabilité sociale",
            "Réponse : de ne pas se donner de peine soi-même",
            "Réponse : une vie plus heureuse et paisible"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : un processus collectif et historique",
            "Réponse : une conversion religieuse",
            "Réponse : une libération principalement individuelle et courageuse"
        ],
        correct: 3,
    ...
    },
    {
        ...
        answers: [
            "Réponse : devenir majeur légalement",
            "Réponse : opérer une transformation intellectuelle et morale",
            "Réponse : quitter la maison familiale"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : Être puni pour ce qu'on ne contrôle pas",
            "Réponse : Le comble de l'irresponsabilité",
            "Réponse : Une contradiction logique"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : On naît mineur",
            "Réponse : On devient mineur par habitude",
            "Réponse : La société nous rend mineurs"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : Un état inné et biologique",
            "Réponse : Une habitude devenue spontanée",
            "Réponse : Un déterminisme génétique"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : Parce que l'État doit l'imposer",
            "Réponse : Parce qu'on ne peut s'émanciper tout seul",
            "Réponse : Parce que la pensée est forcément sociale"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : À la science",
            "Réponse : À l'opinion commune",
            "Réponse : À ses propres idées"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : La certitude absolue",
            "Réponse : Le savoir objectif",
            "Réponse : L'intuition immédiate"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : À son rejet des certitudes",
            "Réponse : À son goût de la certitude et son sens de l'ambiguïté",
            "Réponse : À sa capacité à simplifier les problèmes"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : Un livre qu'on comprend mal",
            "Réponse : Un livre qui pense à notre place",
            "Réponse : Un livre trop complexe"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : Des péchés capitaux",
            "Réponse : Des causes psychologiques de la minorité",
            "Réponse : Des défauts naturels"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : La biologie les a libérés",
            "Réponse : Ils ont atteint l'âge adulte biologiquement",
            "Réponse : Ils sont indépendants économiquement"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : Par altruisme",
            "Réponse : Parce que c'est facile face à des mineurs",
            "Réponse : Par devoir professionnel"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : L'incompétence des médecins",
            "Réponse : La démission de sa propre réflexion",
            "Réponse : Le coût des soins médicaux"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : Incapacité à prendre des décisions pratiques",
            "Réponse : Refus de décider d'utiliser son entendement",
            "Réponse : Indécision pathologique"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : Ce sont des synonymes",
            "Réponse : L'entendement est inférieur à la raison",
            "Réponse : La raison guide l'entendement"
        ],
        correct: 1,
    ...
    },
    {
        ...
        answers: [
            "Réponse : À un moutonnement",
            "Réponse : À une démoutonnisation de la tête",
            "Réponse : À un élevage ovin"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : Savoir théorique",
            "Réponse : Avoir du goût, être soi-même",
            "Réponse : Être sage"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : Un état purement biologique",
            "Réponse : Une habitude tellement ancrée qu'elle semble innée",
            "Réponse : Un retour à l'état de nature"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : De devenir trop critique",
            "Réponse : D'être flattée et manipulée (démagogie)",
            "Réponse : De disparaître"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : L'opinion scientifique",
            "Réponse : L'opinion commune",
            "Réponse : L'opinion philosophique"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : De l'orthodoxie (mainstream)",
            "Réponse : De l'innovation",
            "Réponse : De la solitude"
        ],
        correct: 1,
    ...
    },
    {
        ...
        answers: [
            "Réponse : Je deviens libre",
            "Réponse : Je n'ai pas besoin de penser",
            "Réponse : Je peux acheter des livres"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : Comme une relation conflictuelle",
            "Réponse : Comme une relation consentie et commode",
            "Réponse : Comme une relation éducative"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : Sans conseils extérieurs",
            "Réponse : En autonomie intellectuelle",
            "Réponse : Sans éducation"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : Elle est trop récente",
            "Réponse : Elle brouille la frontière enfant/adulte",
            "Réponse : Elle n'existe pas chez Kant"
        ],
        correct: 2,
    ...
    },
    {
        ...
        answers: [
            "Réponse : La liberté sans contrôle",
            "Réponse : Un pouvoir de contrôle par l'opinion publique",
            "Réponse : L'absence de débat"
        ],
        correct: 2,
