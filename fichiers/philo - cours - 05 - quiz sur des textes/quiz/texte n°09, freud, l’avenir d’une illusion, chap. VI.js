...
const questions = [
    ...
    { 
        ...
        answers: [
            "le résidu de l'expérience", 
            "le résultat final de la réflexion", 
            "des illusions réalisant des désirs humains"
        ], 
        correct: 3,
    ...
    { 
        ...
        answers: [
            "leur vérité rationnelle", 
            "la force des désirs humains", 
    ...
    { 
        ...
        answers: [
            "le besoin de savoir", 
            "le besoin d'être protégé et aimé", 
    ...
    { 
        ...
        answers: [
            "parce que la détresse dure toute la vie", 
            "parce que le père biologique meurt", 
    ...
    { 
        ...
        answers: [
            "par la pensée d'un règne bienveillant", 
            "par des punitions", 
            "par l'indifférence"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "le chaos", 
            "la réalisation des exigences de la justice", 
            "l'arbitraire"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "une limitation du temps", 
            "les cadres du temps et le lieu où les désirs se réaliseront", 
            "l'oubli des désirs"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "seulement des questions pratiques", 
            "la genèse de l'univers, le rapport corps/esprit", 
    ...
    { 
        ...
        answers: [
            "elle complique les conflits", 
            "elle enlève les conflits de l'enfance en leur donnant une solution acceptée de tous", 
            "elle crée de nouveaux conflits"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "d'être dérivée de la raison", 
            "d'être dérivée des désirs humains", 
            "d'être confirmée par la réalité"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "à l'idée scientifique", 
            "à l'idée délirante en psychiatrie", 
    ...
    { 
        ...
        answers: [
            "quand elle est vérifiée par l'expérience", 
            "quand la réalisation d'un désir est prévalente dans sa motivation", 
            "quand elle est partagée par peu de gens"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "on tient compte de ses rapports à la réalité", 
            "on ne tient pas compte de ses rapports à la réalité", 
            "on la compare à la science"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "elle cherche à être confirmée par le réel", 
            "elle renonce à être confirmée par le réel", 
            "elle est indifférente à la réalité"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "compenser les frustrations et angoisses humaines", 
            "développer la pensée rationnelle", 
    ...
    { 
        ...
        answers: [
            "la projection des désirs infantiles sur la figure divine", 
            "la sublimation artistique", 
            "le refoulement des désirs"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "l'illusion vient des désirs, l'erreur de la raison", 
            "il n'y a pas de différence", 
            "l'illusion est collective, l'erreur individuelle"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "une défense de la religion", 
            "une explication naturaliste et critique de la religion", 
            "une apologie du désir"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            ...
            "comme des conclusions rationnelles", 
            "comme des constructions psychiques issues du désir"
        ], 
        correct: 3,
    ...
    { 
        ...
        answers: [
            ...
            "une sublimation de la figure paternelle", 
    ...
    { 
        ...
        answers: [
            "aucune relation", 
            "la détresse infantile est la source du besoin de protection que la religion satisfait", 
            "la religion supprime la détresse infantile"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "l'accomplissement pratique des souhaits", 
            "la satisfaction symbolique de besoins psychiques par l'imagination", 
            "la suppression des désirs"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "comme des désirs superficiels et changeants", 
            "comme les désirs les plus anciens, forts et pressants de l'humanité", 
            "comme des désirs individuels et idiosyncrasiques"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            ...
            "la validation sociale des mécanismes de défense psychiques", 
            "la création de conflits interpersonnels"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "l'illusion est sociale, le délire individuel", 
            "il n'y a pas de différence substantielle", 
            "l'illusion est rationnelle, le délire irrationnel"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "il l'accepte comme révélation", 
            "il la suspend pour étudier les fonctions psychologiques", 
            "il la démontre par des arguments philosophiques"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "l'illusion cherche constamment des preuves empiriques", 
            "l'illusion crée son propre système de validation autonome", 
            "l'illusion s'adapte toujours aux faits"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "une étape nécessaire du développement humain", 
            "une névrose collective de l'humanité", 
            "une forme supérieure de connaissance"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "par leur vérité transcendante", 
            "par leur capacité à répondre à des besoins psychiques constants", 
    ...
    { 
        ...
        answers: [
            "la religion décrit exactement la réalité", 
            "la religion crée une réalité alternative en opposition au réel", 
            "la religion ignore complètement la réalité"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "une figure accessoire", 
            "le prototype de la figure divine", 
    ...
    { 
        ...
        answers: [
            ...
            "comme une opposition radicale de méthodes et d'objectifs", 
            "comme deux formes équivalentes de connaissance"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "créer l'injustice", 
            "compenser les échecs de la justice humaine", 
            "justifier l'arbitraire"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "l'allongement de la vie par la médecine", 
    ...
    { 
        ...
        answers: [
            "comme des réponses définitives et vraies", 
            "comme des constructions imaginaires dérivées du système religieux", 
    ...
    { 
        ...
        answers: [
            "un besoin culturel acquis", 
            "un besoin psychique fondamental né de la détresse infantile", 
            "un besoin purement biologique"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            ...
            "les mécanismes psychiques communs aux deux phénomènes", 
            "la supériorité de la religion"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            ...
            "par la prévalence de la réalisation d'un désir", 
            "par la conformité sociale"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "une négligence méthodologique", 
            "une position épistémologique délibérée", 
            "un aveu d'échec"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "l'angoisse est un obstacle à la religion", 
            "l'angoisse face aux dangers de la vie appelle la consolation religieuse", 
            "la religion supprime toute angoisse"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "comme une libération authentique", 
            "comme un soulagement illusoire mais psychiquement réel", 
            "comme une aggravation des conflits"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "des disputes familiales sans importance", 
            "des dilemmes psychiques fondamentaux qui structurent la personnalité", 
            "des inventions des adultes"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "l'illusion est involontaire, le mensonge volontaire", 
            "il n'y a pas de différence", 
            "l'illusion est individuelle, le mensonge collectif"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "comme une réalité métaphysique", 
            "comme une projection du désir d'ordre et de protection", 
            "comme un concept philosophique abstrait"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "les limites spatio-temporelles de la vie terrestre", 
            "l'au-delà comme espace-temps infini où se réalisent les désirs", 
            "les institutions religieuses concrètes"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "comme une défense de la foi", 
            "comme une explication scientifique qui se substitue à l'explication religieuse", 
            "comme une forme de spiritualité nouvelle"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            ...
            "compréhension empathique de leurs besoins psychiques", 
            "indifférence totale"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            ...
            "préparer l'humanité à vivre sans religion grâce à la science", 
            "réformer les institutions religieuses"
        ], 
        correct: 2,
