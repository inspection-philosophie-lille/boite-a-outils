...
const philosophyData = {
    ...
    source: "HEGEL, Esthétique, introduction : chap.1, section 2, §1, trad. S. Jankélévitch, Flammarion, pp.35-37"
};
...
const questions = [
    ...
    { 
        ...
        answers: [
            ...
            "un artiste accompli", 
            "on se livre à un artifice sans valeur"
        ], 
        correct: 3,
    ...
    { 
        ...
        answers: [
            "un homme qui savait lancer des lentilles à travers un petit orifice", 
            "un homme qui pouvait soulever des montagnes", 
            "un homme qui imitait le chant des oiseaux"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "pour le récompenser", 
            "pour lui montrer l'inutilité de son adresse", 
            "pour l'encourager"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "un ver faisant des efforts pour égaler un éléphant", 
            "un géant surpassant un nain", 
            "un fleuve se jetant dans la mer"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "qu'elle est supérieure au chant naturel", 
            "qu'elle devient insipide quand on sait que c'est un homme", 
    ...
    { 
        ...
        answers: [
            "une libre production de la nature", 
            "un simple artifice", 
            "une œuvre d'art accomplie"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "parce qu'il est parfaitement imité", 
            "parce qu'un animal inconscient émet des sons ressemblant à des sentiments humains", 
    ...
    { 
        ...
        answers: [
            "l'imitation de la nature par l'art", 
            "l'imitation de l'humain par la nature", 
    ...
    { 
        ...
        answers: [
            ...
            "qu'il est inférieur à la nature et sans signification spirituelle", 
            "qu'il est immoral"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            ...
            "une habileté vide de sens spirituel", 
            "une création divine"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "la première est consciente, la seconde inconsciente", 
    ...
    { 
        ...
        answers: [
            "tromper les sens", 
            "exprimer l'Esprit et la liberté humaine", 
            "copier parfaitement la réalité"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "la dimension spirituelle et idéelle", 
            "la technique", 
            "la beauté physique"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "comme des preuves du génie artistique", 
            "comme des anecdotes sans importance réelle", 
    ...
    { 
        ...
        answers: [
            "l'art doit surpasser la nature par l'imitation", 
            "l'art doit exprimer ce que la nature ne peut exprimer", 
            "l'art doit disparaître au profit de la nature"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "la beauté comme imitation parfaite", 
            "la beauté comme expression de l'Idée", 
            "la beauté comme utilité"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "il définit les règles de l'imitation parfaite", 
            "il critique la conception mimétique de l'art", 
            "il célèbre le trompe-l'œil"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "la technique est l'essence de l'art", 
            "la technique est nécessaire mais insuffisante pour faire une œuvre d'art", 
            "la technique n'a aucun rapport avec l'art"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "l'histoire est sans importance pour l'art", 
            "l'art évolue historiquement selon la conscience que l'Esprit prend de lui-même", 
            "l'art est éternel et immuable"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "comme un plaisir purement sensoriel", 
            "comme une jouissance spirituelle de la liberté se contemplant elle-même", 
            "comme une réaction biologique"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "décorer les lieux de vie", 
            "exprimer et former la conscience collective d'une époque", 
            "divertir les masses"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "comme le sommet de l'art", 
            "comme un jeu vain qui confond art et illusion", 
            "comme une preuve de l'habileté divine de l'artiste"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "la subjectivité doit être totalement absente", 
            "la subjectivité de l'artiste est essentielle mais doit exprimer l'Esprit objectif", 
            "seule la subjectivité individuelle compte"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            ...
            "la forme doit être adéquate au contenu spirituel", 
    ...
    { 
        ...
        answers: [
            "la religion n'a aucun rapport avec l'art", 
            "l'art est une forme inférieure de la religion", 
            "l'art, la religion et la philosophie sont trois formes de l'Esprit absolu"
        ], 
        correct: 3,
    ...
    { 
        ...
        answers: [
            "le génie est une inspiration divine inexplicable", 
            "le génie est la capacité à exprimer l'Esprit de son temps", 
    ...
    { 
        ...
        answers: [
            ...
            "la liberté comme expression consciente de la nécessité spirituelle", 
            "la liberté n'a pas sa place dans l'art"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "l'art doit viser l'universel abstrait", 
            "l'art doit incarner l'universel dans le particulier sensible", 
            "l'art doit se limiter au particulier concret"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "les sens doivent être totalement négligés", 
            "les sens sont le médium nécessaire mais non suffisant de l'expérience esthétique", 
            "seul le plaisir des sens compte"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "comme un progrès linéaire vers toujours plus de réalisme", 
            "comme un développement dialectique où chaque forme répond à des besoins spirituels spécifiques", 
            "comme un déclin constant depuis l'Antiquité"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "l'art n'a aucun rapport avec la vérité", 
            "l'art est un mode d'accès à la vérité par la sensibilité", 
            "l'art cache la vérité"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "le style est une affaire purement individuelle", 
            "le style exprime la vision du monde d'une époque", 
            "le style n'a aucune importance"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "la nature est divine et parfaite", 
            "la nature est le règne de la nécessité inconsciente, inférieur à l'Esprit", 
    ...
    { 
        ...
        answers: [
            "les anciens sont toujours supérieurs", 
            "les modernes sont toujours supérieurs", 
            "chaque époque a sa propre forme d'excellence correspondant à son stade de développement spirituel"
        ], 
        correct: 3,
    ...
    { 
        ...
        answers: [
            "une inspiration divine mystérieuse", 
            "un travail technique méticuleux", 
            "une activité spirituelle consciente qui transforme le donné sensible"
        ], 
        correct: 3,
    ...
    { 
        ...
        answers: [
            "le goût est purement subjectif et relatif", 
            "le goût est l'expression de l'éducation et de la culture d'une époque", 
            "le goût n'a aucune importance philosophique"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "l'architecture est l'art le plus élevé", 
            "l'architecture est l'art le plus bas car le plus matériel", 
            "l'architecture est le premier art dans l'évolution historique"
        ], 
        correct: 3,
    ...
    { 
        ...
        answers: [
            "la peinture est l'art suprême", 
            "la peinture est un art intermédiaire qui spiritualise la matière", 
            "la peinture est inférieure à la sculpture"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "la musique est l'art le plus matériel", 
            "la musique est un art intérieur qui exprime directement les sentiments", 
            "la musique n'est pas un vrai art"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "parce qu'elle imite le mieux la nature", 
            "parce qu'elle est la plus spirituelle, utilisant le langage qui est la matière la plus immatérielle", 
    ...
    { 
        ...
        answers: [
            "un divertissement sans importance", 
            "la forme artistique la plus haute car elle expose le conflit des valeurs éthiques", 
            "une imitation des actions humaines"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "comme la copie parfaite de la nature", 
            "comme l'incarnation parfaite de l'Idée dans une forme sensible", 
    ...
    { 
        ...
        answers: [
            "l'humour n'a aucune place dans l'art sérieux", 
            "l'humour est une forme de conscience de la contradiction entre l'idéal et le réel", 
            "le comique est l'essence de l'art"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "l'art doit être totalement indépendant de la politique", 
            "l'art exprime et forme la conscience politique d'un peuple", 
            "l'art doit servir la propagande politique"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "elle a été totalement oubliée", 
            "elle a influencé profondément l'histoire de l'art et la philosophie de l'art moderne", 
    ...
    { 
        ...
        answers: [
            "elle justifie l'abandon du réalisme au profit de l'abstraction", 
            "elle légitime le retour à l'artisanat", 
            "elle défend la supériorité de la photographie"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "une déduction purement abstraite", 
            "une analyse dialectique qui part d'exemples concrets pour en tirer des principes généraux", 
            "une description phénoménologique sans interprétation"
        ], 
        correct: 2,
