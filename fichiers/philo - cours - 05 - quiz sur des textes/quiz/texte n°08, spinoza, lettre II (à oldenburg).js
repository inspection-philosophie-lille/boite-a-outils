...
const questions = [
		...
		question: "Question n°1 : À quelle cause unique Spinoza ramène-t-il les causes d'erreur de Bacon ?",
				answers: [
						"à la limitation de l'entendement humain", 
						"à la thèse cartésienne de la volonté libre et plus ample que l'entendement", 
						"à l'ignorance des lois de la nature"
				], 
				correct: 2,
		...
		{ 
				...
				answers: [
						"la distinction entre entendement et volonté", 
						"l'existence de Dieu", 
						"la liberté de la volonté comme cause des erreurs"
				], 
				correct: 3,
		...
		{ 
				...
				answers: [
						...
						"le même rapport qu'entre la blancheur et tel ou tel blanc", 
						"le rapport de partie à tout"
				], 
				correct: 2,
		...
		{ 
				...
				answers: [
						"entre l'animal et le lion", 
						"entre l'humanité et tel ou tel homme", 
						"entre la substance et ses modes"
				], 
				correct: 2,
		...
		{ 
				...
				answers: [
						"concevoir la volonté comme cause d'une volition déterminée", 
						"concevoir l'humanité comme cause d'un homme", 
						"concevoir la blancheur comme cause d'un objet blanc"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"des actes libres", 
						"des actes nécessités par des causes", 
						"des illusions"
				], 
				correct: 2,
		...
		{ 
				...
				answers: [
						...
						"une abstraction mentale sans existence réelle", 
						"une faculté divine"
				], 
				correct: 2,
		...
		{ 
				...
				answers: [
						"des actes libres de la volonté", 
						"des volitions déterminées par des causes extérieures", 
						"des illusions sans cause"
				], 
				correct: 2,
		...
		{ 
				...
				answers: [
						"parce qu'elles sont indéterminées", 
						"parce qu'elles ont besoin d'une cause pour exister", 
						"parce qu'elles sont divines"
				], 
				correct: 2,
		...
		{ 
				...
				answers: [
						"un compatibilisme (liberté comme conscience de la nécessité)", 
						"un libertarisme radical", 
		...
		{ 
				...
				answers: [
						"la volonté n'est pas la cause des volitions particulières", 
						"la volonté est plus limitée que l'entendement", 
						"les erreurs viennent de l'entendement seul"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"la volonté est une qualité générale qui se manifeste dans des cas particuliers", 
						"la volonté est une couleur", 
						"la volonté est perceptible par les sens"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"elles sont des modes de la substance", 
						"elles sont des substances indépendantes", 
		...
		{ 
				...
				answers: [
						"elles sont des fautes morales", 
						"elles sont nécessaires et déterminées", 
						"elles sont évitables par un effort de volonté"
				], 
				correct: 2,
		...
		{ 
				...
				answers: [
						"l'erreur comme défaut de volonté", 
						"l'erreur comme défaut de connaissance", 
						"l'erreur comme mal métaphysique"
				], 
				correct: 2,
		...
		{ 
				...
				answers: [
						...
						"un rapport d'inclusion logique", 
						"un rapport de supériorité ontologique"
				], 
				correct: 2,
				correct: 2,
		...
		{ 
				...
				answers: [
						"un acte particulier de volonté", 
						"la faculté de vouloir en général", 
		...
		{ 
				...
				answers: [
						"il les étudie en détail", 
						"il les considère comme sans importance", 
						"il les approuve toutes"
				], 
				correct: 2,
		...
		{ 
				...
				answers: [
						"réfuter le libre arbitre", 
						"défendre l'empirisme", 
		...
		{ 
				...
				answers: [
						"la responsabilité morale disparaît", 
						"la volonté devient toute-puissante", 
						"l'erreur devient un choix moral"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"déductive et conceptuelle", 
						"inductive et empirique", 
						"rhétorique et persuasive"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"les erreurs sont des volitions particulières", 
						"les erreurs sont des défauts d'entendement", 
						"les erreurs sont des illusions sensibles"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"elles déterminent nécessairement nos volitions", 
						"elles influencent mais ne déterminent pas", 
		...
		{ 
				...
				answers: [
						"en acceptant que les erreurs sont des volitions pour en tirer une conclusion contraire", 
						"en niant toute la philosophie cartésienne", 
						"en attribuant à Descartes des thèses qu'il ne défend pas"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"illustrer une relation logique", 
						"apporter une preuve empirique", 
						"séduire le lecteur par des images"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"la volonté peut affirmer ou nier au-delà de ce que l'entendement perçoit clairement", 
						"la volonté a plus de puissance que l'entendement", 
						"la volonté comprend plus de choses que l'entendement"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"par son refus de toute transcendance et son immanentisme", 
						"par son empirisme radical", 
						"par son scepticisme méthodologique"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"la vraie liberté est la conscience de la nécessité", 
						"le déterminisme exclut toute forme de liberté", 
						"la liberté précède le déterminisme"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						...
						"comme une influence possible", 
						"comme une relation mystérieuse"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"il souligne le caractère inéluctable de l'enchaînement logique", 
						"il indique une simple probabilité", 
		...
		{ 
				...
				answers: [
						"elle annonce le refus du libre arbitre et le déterminisme de l'Éthique", 
						"elle développe déjà la théorie des attributs", 
						"elle présente la méthode géométrique"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"elle n'est pas mentionnée, l'accent est sur la causalité", 
						"elle est la source de la liberté", 
						"elle crée l'illusion de la volonté"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"Descartes attribue à la volonté un rôle causal qu'elle ne peut avoir", 
						"Descartes se trompe sur l'existence de la volonté", 
						"Descartes ment sciemment"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"l'humanité ne produit pas les individus comme une cause", 
						"Pierre et Paul sont libres de choisir", 
						"les individus sont supérieurs à l'espèce"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"la vérité comme adéquation de l'entendement à la réalité", 
						"la vérité comme création de la volonté", 
						"la vérité comme croyance utile"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"par sa clarté, sa rigueur et son refus des métaphores obscures", 
						"par son lyrisme et son enthousiasme", 
						"par son obscurité volontaire"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"il est mentionné comme ayant des vices similaires à Descartes", 
						"il est le véritable adversaire de Spinoza", 
						"il est un allié contre Descartes"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"avec rigueur et respect, en les citant précisément", 
						"avec mépris et ironie", 
						"en les déformant pour mieux les réfuter"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"elle fonde une conception strictement causale de l'activité mentale", 
						"elle ouvre la voie au scepticisme", 
						"elle justifie l'empirisme lockéen"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"le déterminisme spinoziste est rationnel et intelligible, non un destin aveugle", 
						"elle ne diffère pas, c'est un fatalisme", 
						"elle laisse une place au hasard"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"marquer les étapes de l'argumentation", 
						"indiquer des passages supprimés", 
						"signaler des ajouts de l'éditeur"
				], 
				correct: 1,
		...
		{ 
				...
				answers: [
						"elle applique dès 1661 les principes déterministes qu'on retrouvera dans l'Éthique", 
						"elle marque une rupture avec ses œuvres ultérieures", 
						"elle est un simple brouillon sans lien avec le système"
				], 
				correct: 1,
