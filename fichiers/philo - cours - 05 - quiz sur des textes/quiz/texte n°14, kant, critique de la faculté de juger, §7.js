...
const questions = [
    ...
    { 
        ...
        answers: [
            "comme un jugement universel", 
            "comme un jugement restreint à sa seule personne", 
            "comme un jugement scientifique"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "cela est agréable", 
            "cela m'est agréable", 
            "cela est universellement agréable"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "tous la voient de la même façon", 
            "douce et aimable pour l'un, morte et éteinte pour l'autre", 
    ...
    { 
        ...
        answers: [
            ...
            "l'agréable est subjectif, le beau prétend à l'universalité", 
            "le beau est subjectif, l'agréable est universel"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "on exprime une préférence personnelle", 
            "on attribue aux autres la même satisfaction", 
            "on décrit une propriété physique"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "comme d'une propriété des choses", 
            "comme d'une illusion", 
            "comme d'une simple sensation"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "on exige l'adhésion des autres", 
            "on accepte toutes les opinions", 
    ...
    { 
        ...
        answers: [
            "on les blâme et on leur dénie le goût", 
            "on accepte leur différence", 
            "on change d'avis"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "une vérité esthétique", 
            "la négation du goût et du jugement esthétique", 
            "un principe moral"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "un jugement subjectif mais prétendant à l'universalité", 
            "un jugement objectif et scientifique", 
            "un jugement purement arbitraire"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            ...
            "l'intolérance des gens", 
            "l'objectivité des propriétés esthétiques"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "entre agréable (subjectif) et beau (subjectif mais universel)", 
    ...
    { 
        ...
        answers: [
            "parce que le goût n'existerait pas comme faculté de juger universellement", 
            "parce que tout le monde a le même goût", 
            "parce que la beauté est une illusion"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "le beau prétend à l'accord universel, le charmant est personnel", 
            "le beau est toujours utile, le charmant inutile", 
            "le beau est rare, le charmant commun"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "XVIIIe siècle, philosophie critique (idéalisme transcendantal)", 
    ...
    { 
        ...
        answers: [
            "elle fonde l'autonomie du jugement esthétique", 
            "elle nie toute valeur à l'art", 
            "elle réduit la beauté à l'utilité"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "le plaisir esthétique est désintéressé, le plaisir sensoriel est intéressé", 
            "le plaisir esthétique est plus intense", 
            "le plaisir sensoriel est plus durable"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "une faculté qui permet de percevoir les couleurs", 
            "le principe subjectif qui fonde la prétention à l'universalité du jugement de goût", 
    ...
    { 
        ...
        answers: [
            "la beauté est le symbole de la moralité", 
            "la beauté et la moralité n'ont aucun rapport", 
            "la moralité détruit la beauté"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "le jugement déterminant subsume sous des concepts, le jugement réfléchissant cherche des concepts pour le particulier", 
            "le jugement déterminant est esthétique, le jugement réfléchissant est logique", 
            "il n'y a pas de différence"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "le sublime provoque un plaisir mêlé de terreur, le beau un plaisir pur", 
            "le sublime et le beau sont identiques", 
            "le sublime est inférieur au beau"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "l'art est une production du génie qui donne des règles à l'art", 
    ...
    { 
        ...
        answers: [
            "comme la capacité à imiter parfaitement la nature", 
            "comme le talent naturel qui donne ses règles à l'art", 
            "comme la maîtrise technique parfaite"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "le génie prime toujours sur le goût", 
            "le goût discipline le génie", 
    ...
    { 
        ...
        answers: [
            "la nature a une finalité interne, l'art une finalité sans fin", 
            "la nature et l'art n'ont aucune finalité", 
            "seul l'art a une finalité"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "l'imagination est la faculté créatrice libre qui joue avec l'entendement", 
            "l'imagination est une faculté inférieure à copier", 
            "l'imagination n'a aucune importance"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "il les classe selon leur capacité à exprimer des idées esthétiques", 
            "il ne s'intéresse qu'à la peinture", 
            "il les considère tous comme équivalents"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "la beauté est indépendante de la perfection", 
            "la beauté est identique à la perfection", 
            "la perfection détruit la beauté"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "le beau naturel est supérieur car il est désintéressé", 
            "le beau artistique est supérieur car il exprime l'esprit humain", 
    ...
    { 
        ...
        answers: [
            "la culture est nécessaire pour perfectionner le goût naturel", 
            "le goût est inné, la culture n'a aucun effet", 
            "la culture corrompt le goût naturel"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "des représentations de l'imagination qui suscitent une abondance de pensées", 
            "des concepts clairs et distincts", 
            "des impressions sensibles pures"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "ce sont deux formes du jugement réfléchissant", 
    ...
    { 
        ...
        answers: [
            "comme l'accord harmonieux et non contraint de l'imagination et de l'entendement", 
            "comme l'absence de toute règle", 
            "comme le chaos créateur"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "le jugement de goût est essentiellement tourné vers la communication", 
            "l'art est une activité purement solitaire", 
            "la sociabilité corrompt le jugement esthétique"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "la beauté est le symbole de la vérité morale", 
            "la beauté et la vérité n'ont aucun rapport", 
            "la beauté est une vérité supérieure"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "elle a influencé profondément l'esthétique et la philosophie de l'art moderne", 
            "elle a été totalement oubliée", 
            "elle n'a eu d'influence qu'en Allemagne"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "comme un plaisir de réflexion lié au libre jeu des facultés", 
            "comme un plaisir sensoriel immédiat", 
            "comme un plaisir intellectuel de connaissance"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "la critique doit analyser les conditions de possibilité du jugement de goût", 
            "la critique doit imposer des règles aux artistes", 
    ...
    { 
        ...
        answers: [
            "seul la forme est importante pour la beauté, la matière est indifférente", 
            "seule la matière compte", 
            "forme et matière sont inséparables"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "l'éducation esthétique développe la faculté de juger et prépare à la moralité", 
            "l'éducation esthétique est inutile", 
            "l'éducation esthétique corrompt le goût naturel"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "comme la faculté de juger du beau par un sentiment de plaisir ou de déplaisir", 
            "comme la connaissance des règles de l'art", 
            "comme la préférence personnelle"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "l'idéal de beauté est la beauté humaine qui exprime la moralité", 
            "il n'y a pas d'idéal de beauté", 
            "l'idéal de beauté est mathématique"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "la beauté libre est purement formelle, la beauté adhérente dépend d'un concept de ce que l'objet doit être", 
            "il n'y a pas de différence", 
            "la beauté libre est supérieure"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "elle montre la contradiction apparente entre subjectivité et universalité du jugement de goût", 
            "elle prouve que le goût n'existe pas", 
    ...
    { 
        ...
        answers: [
            "comme médiation entre la nature (première Critique) et la liberté (deuxième Critique)", 
            "comme appendice sans importance", 
            "comme fondement de toute la philosophie"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "elle fonde l'autonomie du jugement esthétique et ouvre la voie à l'art moderne", 
            "elle est complètement traditionnelle", 
            "elle nie toute valeur à l'art"
        ], 
        correct: 1,
