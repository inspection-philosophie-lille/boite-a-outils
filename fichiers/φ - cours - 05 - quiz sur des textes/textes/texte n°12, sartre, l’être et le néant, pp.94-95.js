...
const philosophyData = {
    ...
    source: "SARTRE, L'être et le néant (1943), Gallimard, pp.94-95"
};
...
const questions = [
    ...
    { 
        ...
        answers: [
            "Réponse : elle ignore tout des intentions de l'homme", 
            "Réponse : elle sait fort bien les intentions de l'homme à son égard", 
            "Réponse : elle croit à une rencontre amicale"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : qu'elle devra prendre tôt ou tard une décision", 
            "Réponse : qu'elle n'aura jamais à décider", 
            "Réponse : que l'homme décidera pour elle"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "Réponse : elle l'affronte courageusement", 
            "Réponse : elle n'en veut pas sentir l'urgence", 
            "Réponse : elle décide immédiatement"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : à ce qu'offre de respectueux et de discret", 
            "Réponse : à son aspect physique", 
            "Réponse : à ses intentions cachées"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "Réponse : comme une avance sexuelle", 
            "Réponse : en désarmant la phrase de son arrière-fond sexuel", 
            "Réponse : comme une insulte"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : à une qualité objective comme la rondeur d'une table", 
            "Réponse : à une émotion subjective", 
    ...
    { 
        ...
        answers: [
            "Réponse : un respect qui serait uniquement du respect", 
            "Réponse : un sentiment qui reconnaisse sa liberté plénière", 
            "Réponse : une relation purement physique"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : rien ne change", 
            "Réponse : la situation change en appelant une décision immédiate", 
            "Réponse : elle prend immédiatement une décision claire"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : refuser le flirt", 
            "Réponse : consentir au flirt et s'engager", 
    ...
    { 
        ...
        answers: [
            "Réponse : accepter la relation", 
            "Réponse : rompre l'harmonie trouble qui fait le charme de l'heure", 
            "Réponse : provoquer l'homme"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : prendre une décision claire", 
            "Réponse : reculer le plus loin possible l'instant de la décision", 
            "Réponse : fuir immédiatement"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : elle la retire vivement", 
            "Réponse : elle l'abandonne sans s'en apercevoir", 
            "Réponse : elle serre la main de l'homme"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : parce qu'elle est endormie", 
            "Réponse : parce qu'elle est, à ce moment, tout esprit", 
            "Réponse : parce qu'elle est ivre"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : elle résiste activement", 
            "Réponse : elle consent pleinement", 
            "Réponse : elle repose inerte, comme une chose"
        ], 
        correct: 3,
    ...
    { 
        ...
        answers: [
            "Réponse : un mensonge conscient à autrui", 
            "Réponse : un mensonge à soi-même pour fuir sa liberté", 
            "Réponse : une maladie mentale"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : une séparation réelle entre deux substances", 
            "Réponse : une attitude de mauvaise foi où on fait comme si le corps n'était pas soi", 
            "Réponse : une mort imminente"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : la liberté comme absence de contraintes", 
            "Réponse : la liberté comme obligation de choisir et d'assumer ses actes", 
            "Réponse : la liberté comme déterminisme"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : à l'existentialisme athée", 
            "Réponse : au positivisme logique", 
            "Réponse : au structuralisme"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "Réponse : il illustre concrètement le concept de mauvaise foi", 
            "Réponse : il défend la supériorité des femmes", 
            "Réponse : il critique les relations amoureuses"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "Réponse : le temps est sans importance", 
            "Réponse : la mauvaise foi cherche à suspendre le temps de la décision", 
            "Réponse : le temps accélère toujours la décision"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : comme une unité indissoluble", 
            "Réponse : comme une dualité radicale", 
            "Réponse : comme une identité parfaite"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            ...
            "Réponse : le mensonge est conscient, la mauvaise foi est un mensonge à soi-même", 
            "Réponse : la mauvaise fou est un mensonge à autrui"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : en les compliquant délibérément", 
            "Réponse : en les réduisant à leur sens immédiat et objectif", 
            "Réponse : en les inversant systématiquement"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : autrui n'a aucune importance", 
            "Réponse : autrui est le miroir qui révèle la mauvaise foi", 
            "Réponse : autrui est complètement manipulé"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : comme une pulsion purement biologique", 
            "Réponse : comme une relation complexe de liberté à liberté", 
    ...
    { 
        ...
        answers: [
            "Réponse : simple illustration sans portée théorique", 
            "Réponse : point de départ pour une analyse phénoménologique des structures universelles", 
            "Réponse : anecdote destinée à divertir le lecteur"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : en clarifiant constamment ses intentions", 
            "Réponse : en refusant de donner un sens clair aux paroles et aux gestes", 
            "Réponse : en fuyant physiquement la situation"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : ce sont deux concepts sans rapport", 
            "Réponse : l'authenticité est l'opposé de la mauvaise foi", 
            "Réponse : la mauvaise foi est une forme d'authenticité"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : la liberté est indépendante de la situation", 
            "Réponse : la liberté ne s'exerce que dans et à travers une situation", 
            "Réponse : la situation détermine complètement la liberté"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : l'angoisse est un sentiment pathologique sans rapport avec la liberté", 
            "Réponse : l'angoisse est la prise de conscience de sa liberté radicale", 
            "Réponse : l'angoisse empêche toute exercice de la liberté"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : elle clarifie constamment ses intentions par le langage", 
            "Réponse : elle utilise le langage pour maintenir l'ambiguïté", 
            "Réponse : elle refuse tout langage"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : la responsabilité est limitée à ses actes conscients", 
            "Réponse : la responsabilité est totale et inclut même ce qu'on ne fait pas", 
            "Réponse : la responsabilité n'existe pas"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : la passivité n'existe pas, elle est toujours une action déguisée", 
            "Réponse : l'action et la passivité sont deux réalités distinctes", 
            "Réponse : seule la passivité est authentique"
        ], 
        correct: 1,
    ...
    { 
        ...
        answers: [
            "Réponse : le corps est une prison dont il faut se libérer", 
            "Réponse : le corps est le mode d'être fondamental de la conscience au monde", 
            "Réponse : le corps n'a aucune importance philosophique"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : comme un plan prédéfini qu'on suit mécaniquement", 
            "Réponse : comme une orientation fondamentale qui donne sens à tous nos actes", 
            "Réponse : comme une illusion sans réalité"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : la sincérité est l'opposé de la mauvaise foi", 
            "Réponse : la sincérité est une forme particulièrement subtile de mauvaise foi", 
            "Réponse : il n'y a pas de relation entre les deux"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : la femme vit uniquement dans le présent", 
            "Réponse : la femme refuse l'avenir pour se réfugier dans un présent éternel", 
            "Réponse : la femme anticipe activement l'avenir"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : la vérité est une correspondance entre discours et réalité", 
            "Réponse : la vérité est l'accord de la conscience avec elle-même dans l'assomption de sa liberté", 
            "Réponse : la vérité n'existe pas"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : en affirmant vigoureusement sa liberté", 
            "Réponse : en se réduisant à l'immanence de l'objet", 
            "Réponse : en développant ses potentialités"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : la honte est un sentiment moral sans importance philosophique", 
            "Réponse : la honte révèle le regard d'autrui qui nous objectivise", 
            "Réponse : la honte n'a aucun rapport avec autrui"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : l'être et le paraître sont complètement séparés", 
            "Réponse : chez l'être humain, l'être est inséparable du paraître", 
            "Réponse : seul l'être compte, le paraître est une illusion"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : le néant n'a aucune place", 
            "Réponse : le néant est au cœur de la conscience comme pouvoir de négation", 
            "Réponse : le néant est identique à l'être"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : l'individu est complètement déterminé par la société", 
            "Réponse : l'individu est totalement indépendant de la société", 
            "Réponse : l'individu est libre dans une société qui le conditionne"
        ], 
        correct: 3,
    ...
    { 
        ...
        answers: [
            "Réponse : l'amour est fusion harmonieuse de deux consciences", 
            "Réponse : l'amour est conflit entre deux libertés qui veulent à la fois posséder et être reconnues", 
            "Réponse : l'amour est une illusion sans réalité"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : la conscience est séparée du monde", 
            "Réponse : la conscience est toujours conscience de quelque chose (intentionnalité)", 
            "Réponse : le monde est une projection de la conscience"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : la littérature n'a aucun rapport avec la philosophie", 
            "Réponse : la littérature est un moyen privilégié pour explorer les situations concrètes de l'existence", 
            "Réponse : la littérature est inférieure à la philosophie"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : le choix est un événement rare et exceptionnel", 
            "Réponse : nous choisissons à chaque instant, même quand nous ne choisissons pas", 
            "Réponse : le choix n'existe pas"
        ], 
        correct: 2,
    ...
    { 
        ...
        answers: [
            "Réponse : elle est tombée dans l'oubli", 
            "Réponse : elle a influencé la psychologie et la philosophie contemporaines", 
    ...
    { 
        ...
        answers: [
            "Réponse : il montre une préférence pour l'abstraction pure", 
            "Réponse : il illustre l'analyse concrète des situations comme voie d'accès aux structures universelles", 
            "Réponse : il révèle un mépris pour les expériences quotidiennes"
        ], 
        correct: 2,
