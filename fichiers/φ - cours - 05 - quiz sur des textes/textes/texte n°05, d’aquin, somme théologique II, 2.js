...
[6] Ainsi à supposer que dans une ville assiégée on promulgue la loi que les portes doivent demeurer closes, c'est évidemment utile au bien public, en règle générale ; mais s'il arrive que les ennemis poursuivent des citoyens dont dépend le salut de la cité, il serait très préjudiciable à cette ville de ne pas leur ouvrir ses portes. [7] Et par conséquent dans une telle occurrence, il faudrait ouvrir les portes, malgré les termes de la loi, afin de sauvegarder l'intérêt général que le législateur a en vue. »`,
		...
		source: "THOMAS D’AQUIN, Somme théologique, tome II (La Loi), trad. A. Lemonnyer o. p., Paris/Tournai, Desclée & Brouwer et Éditions du Cerf, 1955. pp.174-175."
};
...
const questions = [
	// Question n°1
	{
		...
		answers: [
			"Réponse : l'intérêt particulier du législateur",
			"Réponse : l'intérêt commun des hommes",
			"Réponse : la punition des délinquants"
			],
			correct: 2,
		...
		answers: [
			"Réponse : quand elle est promulguée par l'autorité",
			"Réponse : seulement dans la mesure où elle vise l'intérêt commun",
			"Réponse : quand elle est conforme aux traditions"
			],
			correct: 2,
		...
		answers: [
			"Réponse : sa validité formelle",
			"Réponse : sa force d'obligation",
			"Réponse : son caractère écrit"
			],
			correct: 2,
		...
		answers: [
			"Réponse : elle peut devenir nuisible dans certains cas particuliers",
			"Réponse : elle reste toujours utile",
			"Réponse : elle doit être modifiée immédiatement"
			],
			correct: 1,
		...
		answers: [
			"Réponse : parce qu'il n'a pas assez de temps",
			"Réponse : parce que la nature humaine est imprévisible",
			"Réponse : parce qu'il rédige la loi en fonction de ce qui se présente le plus souvent"
			],
			correct: 3,
		...
		answers: [
			"Réponse : l'utilité commune",
			"Réponse : la volonté divine",
			"Réponse : la tradition juridique"
			],
			correct: 1,
		...
		answers: [
			"Réponse : l'observer quand même",
			"Réponse : ne plus l'observer",
			"Réponse : attendre sa modification officielle"
			],
			correct: 2,
		...
		answers: [
			"Réponse : une ville assiégée où les portes doivent rester closes",
			"Réponse : un tribunal qui doit rendre justice",
			"Réponse : un impôt qui doit être payé"
			],
			correct: 1,
		...
		answers: [
			"Réponse : quand les ennemis poursuivent des citoyens importants pour la cité",
			"Réponse : quand on veut aider un ami",
			"Réponse : quand la loi est trop ancienne"
			],
			correct: 1,
		...
		answers: [
			"Réponse : respecter strictement la loi",
			"Réponse : ouvrir les portes malgré la loi",
			"Réponse : consulter le législateur"
			],
			correct: 2,
		...
		answers: [
			"Réponse : sauvegarder l'intérêt général",
			"Réponse : favoriser des intérêts particuliers",
			"Réponse : établir un précédent juridique"
			],
			correct: 1,
		...
		answers: [
			"Réponse : une conception formaliste et rigide",
			"Réponse : une conception téléologique (orientée vers une fin)",
			"Réponse : une conception volontariste"
			],
			correct: 2,
		...
		answers: [
			"Réponse : la capacité de contraindre moralement",
			"Réponse : la sanction pénale",
			"Réponse : l'autorité du législateur"
			],
			correct: 1,
		...
		answers: [
			"Réponse : son ignorance des cas particuliers",
			"Réponse : sa corruption possible",
			"Réponse : sa durée limitée au pouvoir"
			],
			correct: 1,
		...
		answers: [
			"Réponse : par la supériorité de la loi divine",
			"Réponse : par la primauté de l'intention du législateur sur la lettre",
			"Réponse : par l'urgence de la situation"
			],
			correct: 2,
		...
		answers: [
			"Réponse : entre loi naturelle et loi positive",
			"Réponse : entre règle générale et cas particuliers",
			"Réponse : entre loi divine et loi humaine"
			],
			correct: 2,
		...
		answers: [
			"Réponse : un cas d'application normale de la loi",
			"Réponse : un cas exceptionnel justifiant la dérogation",
			"Réponse : une situation sans issue"
			],
			correct: 2,
		...
		answers: [
			"Réponse : qu'elle soit écrite",
			"Réponse : qu'elle serve effectivement le bien commun",
			"Réponse : qu'elle soit ancienne"
			],
			correct: 2,
		...
		answers: [
			"Réponse : la théorie de l'équité (épikie)",
			"Réponse : la théorie du contrat social",
			"Réponse : la théorie de la souveraineté"
			],
			correct: 1,
		...
		answers: [
			"Réponse : au positivisme juridique",
			"Réponse : au thomisme (philosophie scolastique)",
			"Réponse : à l'utilitarisme moderne"
			],
			correct: 2,
		...
		answers: [
			"Réponse : la loi est indépendante de la moralité",
			"Réponse : la loi doit être moralement juste pour être obligatoire",
			"Réponse : la moralité est une affaire privée, la loi une affaire publique"
			],
			correct: 2,
		...
		answers: [
			"Réponse : comme la somme des intérêts individuels",
			"Réponse : comme l'intérêt objectif de la communauté politique",
			"Réponse : comme l'intérêt de la majorité"
			],
			correct: 2,
		...
		answers: [
			"Réponse : la loi humaine est toujours imparfaite, la loi divine parfaite",
			"Réponse : elles sont identiques dans leur essence",
			"Réponse : la loi humaine prime sur la loi divine"
			],
			correct: 1,
		...
		answers: [
			"Réponse : par la désobéissance civile systématique",
			"Réponse : par l'équité qui corrige la loi sans la détruire",
			"Réponse : par l'attente passive d'une réforme"
			],
			correct: 2,
		...
		answers: [
			"Réponse : elle oblige toujours en conscience",
			"Réponse : elle n'oblige jamais en conscience",
			"Réponse : elle peut obliger pour éviter un plus grand mal"
			],
			correct: 3,
		...
		answers: [
			"Réponse : l'équité respecte l'esprit de la loi, l'exception le viole",
			"Réponse : elles sont identiques",
			"Réponse : l'équité est plus restrictive"
			],
			correct: 1,
		...
		answers: [
			"Réponse : uniquement la volonté du souverain",
			"Réponse : la raison orientée vers le bien commun",
			"Réponse : la coutume et la tradition"
			],
			correct: 2,
		...
		answers: [
			"Réponse : comme absolue et indiscutable",
			"Réponse : comme relative à sa capacité à servir le bien commun",
			"Réponse : comme dérivée uniquement de la force"
			],
			correct: 2,
		...
		answers: [
			"Réponse : l'équité applique la loi naturelle aux cas concrets",
			"Réponse : elles sont indépendantes",
			"Réponse : la loi naturelle prime toujours sur l'équité"
			],
			correct: 1,
		...
		answers: [
			"Réponse : par l'incapacité des dirigeants à juger chaque cas",
			"Réponse : par la méchanceté naturelle des hommes",
			"Réponse : par la volonté divine"
			],
			correct: 1,
		...
		answers: [
			"Réponse : l'équité cherche l'intention du législateur, l'interprétation stricte la lettre",
			"Réponse : elles sont identiques",
			"Réponse : l'équité est plus rigide"
			],
			correct: 1,
		...
		answers: [
			"Réponse : par la hiérarchie des lois (divine, naturelle, humaine)",
			"Réponse : par la préférence pour la loi la plus récente",
			"Réponse : par l'arbitrage du souverain"
			],
			correct: 1,
		...
		answers: [
			"Réponse : elle peut abroger ou modifier la loi écrite",
			"Réponse : elle est sans valeur juridique",
			"Réponse : elle prime toujours sur la loi"
			],
			correct: 1,
		...
		answers: [
			"Réponse : la loi est essentiellement une restriction de la liberté",
			"Réponse : la loi bien faite permet et réalise la liberté",
			"Réponse : liberté et loi sont incompatibles"
			],
			correct: 2,
		...
		answers: [
			"Réponse : elle doit parfois tempérer la rigueur de la justice légale",
			"Réponse : elle n'a aucune place dans le droit",
			"Réponse : elle remplace toujours la justice"
			],
			correct: 1,
		...
		answers: [
			"Réponse : par la crainte des sanctions",
			"Réponse : par la reconnaissance de leur rationalité et de leur justice",
			"Réponse : par l'habitude"
			],
			correct: 2,
		...
		answers: [
			"Réponse : elle oblige en conscience malgré ses imperfections",
			"Réponse : elle n'oblige pas du tout",
			"Réponse : elle oblige seulement sous peine de sanction"
			],
			correct: 1,
		...
		answers: [
			"Réponse : elles ne doivent jamais être obéies",
			"Réponse : elles doivent toujours être obéies",
			"Réponse : on peut désobéir si la loi viole gravement la conscience"
			],
			correct: 3,
		...
		answers: [
			"Réponse : former les citoyens à la vertu",
			"Réponse : seulement réprimer les comportements nuisibles",
			"Réponse : informer sur les règles sociales"
			],
			correct: 1,
		...
		answers: [
			"Réponse : par la diversité des circonstances historiques et culturelles",
			"Réponse : par l'arbitraire des souverains",
			"Réponse : par l'imperfection humaine"
			],
			correct: 1,
		...
		answers: [
			"Réponse : la loi est essentiellement un acte de la raison",
			"Réponse : la loi est essentiellement un acte de la volonté",
			"Réponse : loi et raison sont indépendantes"
			],
			correct: 1,
		...
		answers: [
			"Réponse : comme condition nécessaire de son obligation",
			"Réponse : comme simple formalité",
			"Réponse : comme optionnelle"
			],
			correct: 1,
		...
		answers: [
			"Réponse : elles ne sont pas de vraies lois et n'obligent pas",
			"Réponse : elles obligent quand même par respect pour l'autorité",
			"Réponse : elles obligent seulement sous menace"
			],
			correct: 1,
		...
		answers: [
			"Réponse : les lois doivent évoluer avec les besoins changeants de la société",
			"Réponse : les lois doivent être immuables",
			"Réponse : seules les lois divines peuvent changer"
			],
			correct: 1,
		...
		answers: [
			"Réponse : l'équité est l'application de la charité dans le domaine juridique",
			"Réponse : elles sont indépendantes",
			"Réponse : la charité prime toujours sur l'équité"
			],
			correct: 1,
		...
		answers: [
			"Réponse : par la nature imparfaite de l'homme après le péché originel",
			"Réponse : par la méchanceté naturelle de tous les hommes",
			"Réponse : par la volonté divine"
			],
			correct: 1,
		...
		answers: [
			"Réponse : elle crée les conditions sociales du bonheur terrestre",
			"Réponse : elle donne directement le bonheur",
			"Réponse : elle n'a aucun rapport avec le bonheur"
			],
			correct: 1,
		...
		answers: [
			"Réponse : la loi naturelle est la participation de la créature rationnelle à la loi éternelle",
			"Réponse : elles sont identiques",
			"Réponse : la loi naturelle est contraire à la loi éternelle"
			],
			correct: 1,
		...
		answers: [
			"Réponse : elle a inspiré le droit naturel moderne et les déclarations des droits",
			"Réponse : elle n'a eu aucune influence",
			"Réponse : elle a été totalement rejetée par la modernité"
			],
			correct: 1,
