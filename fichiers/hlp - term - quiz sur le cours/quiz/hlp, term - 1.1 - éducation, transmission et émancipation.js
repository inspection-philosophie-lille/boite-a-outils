...
const questions = [
  ...
  // Question n°3
  {
    question: "Quel philosophe des Lumières a fait de la devise « <em>Sapere aude</em> ! » (« Ose savoir ! ») le mot d'ordre de l'émancipation par l'éducation ?",
    answers: [
  ...
  // Question n°8
  {
    question: "Pourquoi, selon Hannah Arendt dans <em>La Crise de la culture</em>, la remise en cause contemporaine de l'idée de transmission d'un héritage est-elle problématique ?",
    answers: [
  ...
  // Question n°10
  {
    question: "Comment Michel Foucault, dans <em>Surveiller et punir</em>, analyse-t-il la fonction disciplinaire de l'école ?",
    answers: [
  ...
  // Question n°11
  {
    question: "Quelle est la « qualité très spécifique » qui, selon Rousseau dans le <em>Discours sur l'inégalité</em>, distingue radicalement l'homme de l'animal ?",
    answers: [
  ...
  // Question n°12
  {
    question: "Comment Aristote, dans <em>Les Parties des animaux</em>, répond-il à l'idée que l'homme est le moins bien doté par la nature ?",
    answers: [
  ...
  // Question n°13
  {
    question: "Quelle est la finalité ultime de l'éducation selon Kant dans son <em>Traité de pédagogie</em> ?",
    answers: [
  ...
  // Question n°15
  {
    question: "Quelle distinction fondamentale Jules Ferry établit-il dans sa <em>Lettre aux instituteurs</em> (1883) concernant les matières enseignées ?",
    answers: [
  ...
  // Question n°19
  {
    question: "Quel mécanisme Simone de Beauvoir analyse-t-elle dans <em>Le Deuxième Sexe</em> comme aliénant spécifiquement l'éducation des filles ?",
    answers: [
  ...
  // Question n°23
  {
    question: "Que signifie le concept d'éducation « négative » défendu par Rousseau dans <em>Émile</em> ?",
    answers: [
  ...
  // Question n°24
  {
    question: "Selon Condorcet, pourquoi l'égalité politique proclamée par la Déclaration des droits de l'homme (art.6) nécessite-t-elle l'égalité dans l'éducation ?",
    answers: [
  ...
  // Question n°28
  {
    question: "Quelle est la fonction de l'éducation selon la conception <em>réaliste</em> des Lumières, par opposition à la conception humaniste ?",
    answers: [
  ...
  // Question n°31
  {
    question: "Comment Arendt conçoit-elle le rapport paradoxal entre éducation et nouveauté dans <em>La Crise de l'éducation</em> ?",
    answers: [
  ...
  // Question n°32
  {
    question: "Quelle est la différence entre le <em>trivium</em> et le <em>quadrivium</em> dans le modèle scolastique médiéval ?",
    answers: [
  ...
  // Question n°37
  {
    question: "Comment Erasme, dans son <em>Traité de civilité puérile</em>, s'oppose-t-il au modèle scolastique ?",
    answers: [
  ...
  // Question n°47
  {
    question: "Quelle est la critique de Foucault concernant ce que les élèves apprennent (ou n'apprennent pas) à l'école, selon <em>Les Mots et les choses</em> ?",
    answers: [
  ...
  // Question n°49
  {
    question: "Comment Simone de Beauvoir analyse-t-elle la construction sociale de la <em>féminité</em> à travers l'éducation ?",
    answers: [
  ...
  // Question n°61
  {
    question: "Pourquoi l'enfant est-il appelé <em>infans</em> en latin, et quelle conséquence Rousseau en tire-t-il pour l'éducation ?",
    answers: [
  ...
  // Question n°67
  {
    question: "Comment le concept de « pédagogie différenciée » peut-il être vu comme un héritier lointain de la pensée de Rousseau ?",
    answers: [
  ...
  // Question n°71
  {
    question: "Quel est le statut de la « culture » dans le processus éducatif ?",
    answers: [
  ...
  // Question n°73
  {
    question: "Quelle est la thèse défendue par Condorcet concernant le lien entre instruction et progrès ?",
    answers: [
  ...
  // Question n°79
  {
    question: "Comment la notion d'<em>autonomie</em> est-elle comprise dans l'idéal kantien de l'émancipation ?",
    answers: [
  ...
  // Question n°80
  {
    question: "Que révèlent les statistiques sur l'orientation genrée des jeunes à propos de Beauvoir ?",
    answers: [
  ...
  // Question n°83
  {
    question: "Quelle est la différence entre la vision de l'éducation comme <em>viatique</em> et comme <em>propédeutique</em> évoquée à propos de Jules Ferry ?",
    answers: [
  ...
  // Question n°85
  {
    question: "Comment interprèter les politiques de discrimination positive ?",
    answers: [
  ...
  // Question n°86
  {
    question: "Que signifie la possibilité de la <em>maladresse</em> ?",
    answers: [
  ...
  // Question n°98
  {
    question: "Quelle est la signification de l'<em>individualisme</em> dans la critique de Rousseau, et comment l'éducation doit-elle y répondre ?",
    answers: [
