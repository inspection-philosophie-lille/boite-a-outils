...
const questions = [
  // Question n°1
  {
    question: "Question n°01 : Que signifie étymologiquement le terme « éducation », et quelle implication principale en découle ?",
    answers: [
  ...
  // Question n°2
  {
    question: "Question n°02 : Quel changement symbolique majeur est représenté par le passage du « ministère de l'Instruction publique » au « ministère de l'Éducation nationale » en 1932 ?",
    answers: [
  ...
  // Question n°3
  {
    question: "Question n°03 : Quel philosophe des Lumières a fait de la devise « <em>Sapere aude</em> ! » (« Ose savoir ! ») le mot d'ordre de l'émancipation par l'éducation ?",
    answers: [
  ...
  // Question n°4
  {
    question: "Question n°04 : Dans « Gargantua », comment Rabelais caricature-t-il l'éducation scolastique médiévale à travers le personnage de Thubal Holoferne ?",
    answers: [
  ...
  // Question n°5
  {
    question: "Question n°05 : Quelle est la célèbre distinction établie par Montaigne dans « Les Essais » concernant le but de l'éducation ?",
    answers: [
  ...
  // Question n°6
  {
    question: "Question n°06 : Quelle conception utilitariste et sociale de l'éducation le modèle réaliste des Lumières, incarné par Lakanal, a-t-il promu ?",
    answers: [
  ...
  // Question n°7
  {
    question: "Question n°07 : Quel principe fondamental de l'éducation selon Rousseau est énoncé dans cette phrase : « On ne connaît point l'enfance... Ils cherchent toujours l'homme dans l'enfant » ?",
    answers: [
  ...
  // Question n°8
  {
    question: "Question n°08 : Pourquoi, selon Hannah Arendt dans <em>La Crise de la culture</em>, la remise en cause contemporaine de l'idée de transmission d'un héritage est-elle problématique ?",
    answers: [
  ...
  // Question n°9
  {
    question: "Question n°09 : Que signifie, dans la sociologie de Pierre Bourdieu, le concept de « reproduction » sociale par l'école ?",
    answers: [
  ...
  // Question n°10
  {
    question: "Question n°10 : Comment Michel Foucault, dans <em>Surveiller et punir</em>, analyse-t-il la fonction disciplinaire de l'école ?",
    answers: [
  ...
  // Question n°11
  {
    question: "Question n°11 : Quelle est la « qualité très spécifique » qui, selon Rousseau dans le <em>Discours sur l'inégalité</em>, distingue radicalement l'homme de l'animal ?",
    answers: [
  ...
  // Question n°12
  {
    question: "Question n°12 : Comment Aristote, dans <em>Les Parties des animaux</em>, répond-il à l'idée que l'homme est le moins bien doté par la nature ?",
    answers: [
  ...
  // Question n°13
  {
    question: "Question n°13 : Quelle est la finalité ultime de l'éducation selon Kant dans son <em>Traité de pédagogie</em> ?",
    answers: [
  ...
  // Question n°14
  {
    question: "Question n°14 : Que signifie, dans la pensée de Condorcet, l'expression « égalité d'instruction » ?",
    answers: [
  ...
  // Question n°15
  {
    question: "Question n°15 : Quelle distinction fondamentale Jules Ferry établit-il dans sa <em>Lettre aux instituteurs</em> (1883) concernant les matières enseignées ?",
    answers: [
  ...
  // Question n°16
  {
    question: "Question n°16 : Selon John Dewey, comment l'éducation doit-elle être conçue pour être véritablement démocratique ?",
    answers: [
  ...
  // Question n°17
  {
    question: "Question n°17 : Quel risque majeur Tocqueville associe-t-il à l'éducation nationale dans les démocraties ?",
    answers: [
  ...
  // Question n°18
  {
    question: "Question n°18 : Pourquoi, selon Durkheim, l'éducation est-elle avant tout un processus de « socialisation » ?",
    answers: [
  ...
  // Question n°19
  {
    question: "Question n°19 : Quel mécanisme Simone de Beauvoir analyse-t-elle dans <em>Le Deuxième Sexe</em> comme aliénant spécifiquement l'éducation des filles ?",
    answers: [
  ...
  // Question n°20
  {
    question: "Question n°20 : Que dénonce Elena Gianini Belotti à propos des personnages féminins dans les contes traditionnels comme « Blanche-Neige » ou « Cendrillon » ?",
    answers: [
  ...
  // Question n°21
  {
    question: "Question n°21 : Comment Victor Hugo, dans son poème « Chaque enfant qu'on enseigne », justifie-t-il l'importance de l'éducation pour tous ?",
    answers: [
  ...
  // Question n°22
  {
    question: "Question n°22 : Quelle est la critique principale adressée par Bourdieu à la recommandation de Rousseau d'adapter l'éducation à chaque élève ?",
    answers: [
  ...
  // Question n°23
  {
    question: "Question n°23 : Que signifie le concept d'éducation « négative » défendu par Rousseau dans <em>Émile</em> ?",
    answers: [
  ...
  // Question n°24
  {
    question: "Question n°24 : Selon Condorcet, pourquoi l'égalité politique proclamée par la Déclaration des droits de l'homme (art.6) nécessite-t-elle l'égalité dans l'éducation ?",
    answers: [
  ...
  // Question n°25
  {
    question: "Question n°25 : Quelle est la différence fondamentale, selon Kant, entre l'éducation qui « dresse » et l'éducation qui émancipe ?",
    answers: [
  ...
  // Question n°26
  {
    question: "Question n°26 : Que montre l'évolution du taux de bacheliers dans une génération ?",
    answers: [
  ...
  // Question n°27
  {
    question: "Question n°27 : Quel constat alarmant l'OCDE tire-t-elle des résultats PISA 2018 concernant la France, cité par Angel Gurría ?",
    answers: [
  ...
  // Question n°28
  {
    question: "Question n°28 : Quelle est la fonction de l'éducation selon la conception <em>réaliste</em> des Lumières, par opposition à la conception humaniste ?",
    answers: [
  ...
  // Question n°29
  {
    question: "Question n°29 : Pourquoi Rousseau critique-t-il l'usage de la punition et de la récompense dans l'éducation morale de l'enfant ?",
    answers: [
  ...
  // Question n°30
  {
    question: "Question n°30 : Que signifie l'idée, attribuée à Paul Valéry et Catherine Kintzler, que « penser, c'est se disputer avec soi-même » dans le contexte de l'émancipation ?",
    answers: [
  ...
  // Question n°31
  {
    question: "Question n°31 : Comment Arendt conçoit-elle le rapport paradoxal entre éducation et nouveauté dans <em>La Crise de l'éducation</em> ?",
    answers: [
  ...
  // Question n°32
  {
    question: "Question n°32 : Quelle est la différence entre le <em>trivium</em> et le <em>quadrivium</em> dans le modèle scolastique médiéval ?",
    answers: [
  ...
  // Question n°33
  {
    question: "Question n°33 : Quel est le rôle de la « nature » dans l'éducation selon Rousseau, par rapport aux livres ?",
    answers: [
  ...
  // Question n°34
  {
    question: "Question n°34 : En quoi la notion d' « hétérotopie », utilisée par Foucault, peut-elle s'appliquer à l'école ?",
    answers: [
  ...
  // Question n°35
  {
    question: "Question n°35 : Que recommande Kant concernant l'éducation d'un enfant qui « ne fait rien pour être agréable » ?",
    answers: [
  ...
  // Question n°36
  {
    question: "Question n°36 : Quel est l'objectif central de la « pédagogie rationnelle » que Bourdieu appelle de ses vœux pour lutter contre les inégalités ?",
    answers: [
  ...
  // Question n°37
  {
    question: "Question n°37 : Comment Erasme, dans son <em>Traité de civilité puérile</em>, s'oppose-t-il au modèle scolastique ?",
    answers: [
  ...
  // Question n°38
  {
    question: "Question n°38 : Quelle critique peut-on adresser aux politiques de « discrimination positive » mises en place en France (comme la CPGE pour boursiers à Henri IV) ?",
    answers: [
  ...
  // Question n°39
  {
    question: "Question n°39 : Que signifie l'idée que l'homme, selon Rousseau, est « organisé le plus avantageusement de tous » les animaux ?",
    answers: [
  ...
  // Question n°40
  {
    question: "Question n°40 : Quelle distinction Kant opère-t-il entre « impératif catégorique » et « impératif hypothétique » dans le domaine de l'éducation morale ?",
    answers: [
  ...
  // Question n°41
  {
    question: "Question n°41 : Quelle est la fonction principale de l'école primaire selon Jules Ferry, telle qu'elle ressort de ses lois de 1881-1882 ?",
    answers: [
  ...
  // Question n°42
  {
    question: "Question n°42 : Comment le concept de « capital social », évoqué par Arendt, est-il lié aux inégalités scolaires ?",
    answers: [
  ...
  // Question n°43
  {
    question: "Question n°43 : Quelle est la thèse de Platon dans le mythe de Prométhée concernant la nature de l'homme ?",
    answers: [
  ...
  // Question n°44
  {
    question: "Question n°44 : Que signifie l'expression « éducation positive » dans le contexte de la pensée de Rousseau ?",
    answers: [
  ...
  // Question n°45
  {
    question: "Question n°45 : Quel rôle Condorcet assigne-t-il à l'instruction dans la lutte contre les « préjugés » et le « charlatanisme » ?",
    answers: [
  ...
  // Question n°46
  {
    question: "Question n°46 : Comment John Dewey conçoit-il le lien entre l'éducation et la démocratie ?",
    answers: [
  ...
  // Question n°47
  {
    question: "Question n°47 : Quelle est la critique de Foucault concernant ce que les élèves apprennent (ou n'apprennent pas) à l'école, selon <em>Les Mots et les choses</em> ?",
    answers: [
  ...
  // Question n°48
  {
    question: "Question n°48 : Que révèlent les statistiques citées sur le vocabulaire des enfants de 2 ans selon leur milieu social ?",
    answers: [
  ...
  // Question n°49
  {
    question: "Question n°49 : Comment Simone de Beauvoir analyse-t-elle la construction sociale de la <em>féminité</em> à travers l'éducation ?",
    answers: [
  ...
  // Question n°50
  {
    question: "Question n°50 : Quelle est la signification politique du principe de laïcité instauré par Jules Ferry à l'école ?",
    answers: [
  ...
  // Question n°51
  {
    question: "Question n°51 : Que permet de comprendre l'étude des « figures passées de l'éducation » (scolastique, humaniste, réaliste, rousseauiste) ?",
    answers: [
  ...
  // Question n°52
  {
    question: "Question n°52 : En quoi l'école peut-elle être considérée, selon Foucault, comme une « hétérotopie de crise » ?",
    answers: [
  ...
  // Question n°53
  {
    question: "Question n°53 : Quelle est la conséquence du principe de perfectibilité, selon Rousseau, sur la responsabilité de l'éducateur ?",
    answers: [
  ...
  // Question n°54
  {
    question: "Question n°54 : Comment le déisme des Lumières, évoqué à propos de Kant, influence-t-il sa conception de l'éducation morale ?",
    answers: [
  ...
  // Question n°55
  {
    question: "Question n°55 : Quelle différence faire entre « instruire » et « éduquer » ?",
    answers: [
  ...
  // Question n°56
  {
    question: "Question n°56 : Que signifie l'expression « doux despotisme » utilisée par Tocqueville, et en quoi l'éducation y contribue-t-elle ?",
    answers: [
  ...
  // Question n°57
  {
    question: "Question n°57 : Comment Durkheim définit-il le rapport entre l'éducation et la société ?",
    answers: [
  ...
  // Question n°58
  {
    question: "Question n°58 : Que critique Elena Gianini Belotti dans la représentation des « bonnes fées » des contes ?",
    answers: [
  ...
  // Question n°59
  {
    question: "Question n°59 : Quel est le sens de la formule d'Arendt : « éduquer pour un monde déjà hors de ses gonds » ?",
    answers: [
  ...
  // Question n°60
  {
    question: "Question n°60 : Quelle est la tension principale que cherche à résoudre l'éducation ?",
    answers: [
  ...
  // Question n°61
  {
    question: "Question n°61 : Pourquoi l'enfant est-il appelé <em>infans</em> en latin, et quelle conséquence Rousseau en tire-t-il pour l'éducation ?",
    answers: [
  ...
  // Question n°62
  {
    question: "Question n°62 : Comment la notion de « mérite », dans le système scolaire, peut-elle servir à légitimer les inégalités selon Bourdieu ?",
    answers: [
  ...
  // Question n°63
  {
    question: "Question n°63 : Quelle est la place de la Bible et de la religion dans le modèle éducatif humaniste de Rabelais et d'Érasme ?",
    answers: [
  ...
  // Question n°64
  {
    question: "Question n°64 : Quelle est la différence entre « égalité des chances » et « équité » dans les politiques éducatives ?",
    answers: [
  ...
  // Question n°65
  {
    question: "Question n°65 : Comment Kant justifie-t-il la nécessité de la contrainte dans l'éducation ?",
    answers: [
  ...
  // Question n°66
  {
    question: "Question n°66 : Que signifie l'idée que l'éducation vise à « rendre populaire la raison » (cf. Condorcet) ?",
    answers: [
  ...
  // Question n°67
  {
    question: "Question n°67 : Comment le concept de « pédagogie différenciée » peut-il être vu comme un héritier lointain de la pensée de Rousseau ?",
    answers: [
  ...
  // Question n°68
  {
    question: "Question n°68 : Que signifie l'affirmation de Kant : « L'homme est la seule créature qui soit susceptible d'éducation » ?",
    answers: [
  ...
  // Question n°69
  {
    question: "Question n°69 : Comment Arendt définit-elle la « crise de l'éducation » dans le monde moderne ?",
    answers: [
  ...
  // Question n°70
  {
    question: "Question n°70 : Quelle est la signification de l'expression « école mixte » ?",
    answers: [
      ...
      "Une école qui pratique la mixité dans les conditions sociales des enfants."
    ],
    correct: 2,
  ...
  // Question n°71
  {
    question: "Question n°71 : Quel est le statut de la « culture » dans le processus éducatif ?",
    answers: [
  ...
  // Question n°72
  {
    question: "Question n°72 : Comment la notion de « devoir » chez Kant s'articule-t-elle avec l'âge de l'enfant ?",
    answers: [
  ...
  // Question n°73
  {
    question: "Question n°73 : Quelle est la thèse défendue par Condorcet concernant le lien entre instruction et progrès ?",
    answers: [
  ...
  // Question n°74
  {
    question: "Question n°74 : Comment Foucault analyse-t-il l'examen scolaire comme technologie de pouvoir ?",
    answers: [
  ...
  // Question n°75
  {
    question: "Question n°75 : Que signifie l'idée que l'éducation, selon Rousseau, doit se faire « par les choses » plutôt que « par les mots » ?",
    answers: [
  ...
  // Question n°76
  {
    question: "Question n°76 : Quel est l'objectif de l'éducation morale à l'école selon la « Lettre aux instituteurs » de Jules Ferry ?",
    answers: [
  ...
  // Question n°77
  {
    question: "Question n°77 : Comment Bourdieu et Passeron expliquent-ils que l'école puisse être perçue comme juste tout en reproduisant les inégalités ?",
    answers: [
  ...
  // Question n°78
  {
    question: "Question n°78 : Quelle est la place de l'étude des langues dans le programme humaniste de Rabelais pour Pantagruel ?",
    answers: [
  ...
  // Question n°79
  {
    question: "Question n°79 : Comment la notion d'<em>autonomie</em> est-elle comprise dans l'idéal kantien de l'émancipation ?",
    answers: [
  ...
  // Question n°80
  {
    question: "Question n°80 : Que révèlent les statistiques sur l'orientation genrée des jeunes à propos de Beauvoir ?",
    answers: [
  ...
  // Question n°81
  {
    question: "Question n°81 : Quelle est la fonction des « écoles normales » créées par Lakanal ?",
    answers: [
  ...
  // Question n°82
  {
    question: "Question n°82 : Comment Rousseau conçoit-il le rapport entre liberté de l'enfant et éducation ?",
    answers: [
  ...
  // Question n°83
  {
    question: "Question n°83 : Quelle est la différence entre la vision de l'éducation comme <em>viatique</em> et comme <em>propédeutique</em> évoquée à propos de Jules Ferry ?",
    answers: [
  ...
  // Question n°84
  {
    question: "Question n°84 : Que signifie l'expression « sortir de la minorité » chez Kant, et quel est son lien avec l'éducation ?",
    answers: [
  ...
  // Question n°85
  {
    question: "Question n°85 : Comment interprèter les politiques de discrimination positive ?",
    answers: [
  ...
  // Question n°86
  {
    question: "Question n°86 : Que signifie la possibilité de la <em>maladresse</em> ?",
    answers: [
  ...
  // Question n°87
  {
    question: "Question n°87 : Comment la Révolution française a-t-elle investi l'école d'une nouvelle mission selon le modèle réaliste ?",
    answers: [
  ...
  // Question n°88
  {
    question: "Question n°88 : Quel est l'idéal de l'éducation selon les humanistes de la Renaissance, par opposition aux sophistes et aux scolastiques ?",
    answers: [
  ...
  // Question n°89
  {
    question: "Question n°89 : Comment Arendt conçoit-elle le lien entre éducation et natalité (le fait que des êtres nouveaux naissent sans cesse) ?",
    answers: [
  ...
  // Question n°90
  {
    question: "Question n°90 : Quelle est la critique de Rousseau concernant l'éducation par l'interdit ?",
    answers: [
  ...
  // Question n°91
  {
    question: "Question n°91 : Que signifie l'idée que l'éducation vise à « rendre populaire la raison » (cf. Condorcet) ?",
    answers: [
  ...
  // Question n°92
  {
    question: "Question n°92 : Comment Foucault définit-il les « hétérotopies » par rapport aux « utopies » ?",
    answers: [
  ...
  // Question n°93
  {
    question: "Question n°93 : Quelle est la signification de l'objectif des « 80% d'une classe d'âge au niveau du baccalauréat » annoncé par Chevènement en 1985 ?",
    answers: [
  ...
  // Question n°94
  {
    question: "Question n°94 : Comment l'éducation peut-elle contribuer à l'émancipation « générationnelle » selon Arendt ?",
    answers: [
  ...
  // Question n°95
  {
    question: "Question n°95 : Quelle est la conception de l'enfant selon la formule de Rousseau : « La nature veut que les enfants soient enfants avant que d'être hommes » ?",
    answers: [
  ...
  // Question n°96
  {
    question: "Question n°96 : Quel est le rôle de l'école dans la formation du « capital social » selon les analyses contemporaines évoquées par Arendt ?",
    answers: [
  ...
  // Question n°97
  {
    question: "Question n°97 : Comment Montaigne critique-t-il les châtiments corporels dans l'éducation ?",
    answers: [
  ...
  // Question n°98
  {
    question: "Question n°98 : Quelle est la signification de l'<em>individualisme</em> dans la critique de Rousseau, et comment l'éducation doit-elle y répondre ?",
    answers: [
  ...
  // Question n°99
  {
    question: "Question n°99 : Comment Erasme conçoit-il l'étude de la Bible par rapport au modèle scolastique ?",
    answers: [
  ...
  // Question n°100
  {
    question: "Question n°100 : Quelle conclusion tirer sur l'état du système éducatif français aujourd'hui, à la lumière des critiques de Bourdieu et des données de l'OCDE ?",
    answers: [
