...
const questions = [
  // Question n°1
  {
    question: "Selon Alain, pourquoi la guerre est-elle un instrument au service d'intérêts qui la dépassent ?",
    answers: [
...
\nExemple : Les rivalités coloniales pour le contrôle des ressources (comme le charbon ou le caoutchouc) ont été des causes structurelles majeures des tensions ayant conduit à la Première Guerre mondiale, illustrant la thèse d'Alain.`
  ...
  // Question n°2
  {
    question: "Que signifie pour Hannah Arendt l'idée que, sans épée, les pactes ne sont que des mots à l'échelle internationale ?",
    answers: [
      ...
      "L'absence d'une autorité supranationale coercitive rend la menace de la guerre nécessaire pour faire respecter les accords."
    ],
    correct: 3,
...
\nExemple : L'inefficacité de la Société des Nations à empêcher l'invasion de la Mandchourie par le Japon en 1931 ou celle de l'Éthiopie par l'Italie en 1935 a confirmé cette analyse : sans force pour les faire appliquer, les pactes étaient violés.`
  ...
  // Question n°3
  {
    question: "Que nous apprennent les travaux d'anthropologues comme Laurence Keeley sur les sociétés préhistoriques ?",
    answers: [
      ...
      "Le taux de mortalité violente pouvait y être très élevé, invalidant l'idée d'un âge d'or pacifique primordial."
    ],
    correct: 3,
...
\nExemple : Chez les Hiwi de Colombie, le taux de mortalité violente pouvait atteindre des niveaux extrêmes, démontrant que la guerre destructrice a précédé l'apparition des sociétés agricoles et étatiques modernes.`
  ...
  // Question n°4
  {
    question: "Quelle expression de Max Weber définit le fondement de l'État moderne ?",
    answers: [
...
\nExemple : Un citoyen victime d'un vol doit porter plainte et laisser la police et la justice agir. S'il décide de se faire justice lui-même en agressant le voleur, il viole le monopole de l'État et devient lui-même un délinquant.`
  ...
  // Question n°5
  {
    question: "Comment Norbert Elias analyse-t-il l'évolution des comportements en Occident dans 'La Civilisation des mœurs' ?",
    answers: [
      "Il décrit un processus de libération des pulsions et d'augmentation de la violence privée.",
      "Il met en lumière une « civilisation des mœurs » où la violence impulsive est refoulée et codifiée par des règles.",
      "Il affirme que les sociétés sont revenues à un état de nature violent après la chute de l'Empire romain."
    ],
    correct: 2,
...
\nExemple : Au Moyen Âge, un duel pour une insulte était courant. À l'époque moderne, la même insulte mène à un procès en diffamation. La violence se déplace du corps au langage et est traitée par une institution.`
  ...
  // Question n°6
  {
    question: "Que désigne George Mosse par l'expression « brutalisation des sociétés » après 1918 ?",
    answers: [
      "Le retour à des valeurs traditionnelles et pacifiques après l'horreur de la guerre.",
      "L'habituation à la cruauté et à la violence extrême, qui a durablement marqué les mentalités et les pratiques politiques.",
...
\nExemple : Les anciens combattants des corps francs allemands, habitués à une violence extrême dans les tranchées, ont souvent rejoint les rangs des milices paramilitaires comme les SA, transférant les méthodes de la guerre au combat politique.`
  ...
  // Question n°7
  {
    question: "Quelles sont les trois conditions principales de la « guerre juste » selon la théorie classique ?",
    answers: [
...
\nExemple : L'intervention militaire pour arrêter un génocide peut constituer une « cause juste ». Mais bombarder délibérément un marché civil pendant cette intervention violerait le <em>jus in bello</em>.`
  ...
  // Question n°8
  {
    question: "Pourquoi les hommes, selon Hobbes, acceptent-ils de conclure un contrat social et de renoncer à leur liberté naturelle ?",
    answers: [
...
\nExemple : Les confinements stricts durant la pandémie de Covid-19 peuvent être interprétés dans une perspective hobbesienne : l'État use de son pouvoir pour limiter des libertés individuelles au nom de la sécurité collective, ce que les citoyens acceptent pour éviter un pire (la propagation incontrôlée de la maladie).`
  ...
  // Question n°9
  {
    question: "Quel projet l'abbé de Saint-Pierre propose-t-il au 18e siècle pour établir une paix durable en Europe ?",
    answers: [
      ...
      "La création d'une assemblée européenne dotée d'une force armée pour arbitrer les conflits entre nations."
    ],
    correct: 3,
...
\nExemple : Le système de sécurité collective de l'ONU, avec son Conseil de Sécurité pouvant autoriser des interventions armées (casques bleus), est l'héritier lointain de cette idée d'une force commune au service du maintien de la paix.`
  ...
  // Question n°10
  {
    question: "Comment Kant envisage-t-il dans 'Idée d'une histoire universelle' la sortie de l'état de guerre entre nations ?",
    answers: [
      "Par la conquête et l'unification de l'Europe sous l'autorité d'un seul empire universel.",
      "Par le développement du commerce international, qui rendrait la guerre trop coûteuse et irrationnelle.",
      "Par la formation progressive d'une fédération d'États libres, une « société des nations » fondée sur le droit."
    ],
    correct: 3,
...
\nExemple : L'Union européenne, malgré ses limites, incarne partiellement ce projet kantien : des États souverains qui ont renoncé à l'usage de la force entre eux et soumettent leurs différends à des institutions et des tribunaux communs.`
  ...
  // Question n°11
  {
    question: "Quelle distinction fondamentale Hannah Arendt établit-elle entre « pouvoir » et « violence » ?",
    answers: [
      ...
      "Le pouvoir repose sur le consentement et l'action collective, la violence est un moyen instrumental qui signale souvent un pouvoir qui s'affaiblit."
    ],
    correct: 3,
...
\nExemple : Un mouvement social de masse et pacifique (comme les manifestations de 1989 en Europe de l'Est) démontre un pouvoir populaire qui finit par faire tomber des régimes apparemment forts, tandis qu'une dictature qui réprime dans le sang montre la faiblesse de son assise.`
  ...
  // Question n°12
  {
    question: "Quelle est la caractéristique principale d'une guerre de « conquête » ?",
    answers: [
      "Elle vise à libérer un peuple opprimé par un régime tyrannique ou colonial.",
      "Elle a pour objectif de s'approprier des territoires et des richesses pour des motifs économiques ou idéologiques.",
      "Elle cherche à détruire complètement l'ennemi, y compris sa population civile, sans autre motif."
    ],
    correct: 2,
...
\nExemple : Les conquêtes coloniales du 19e siècle en Afrique et en Asie étaient largement motivées par l'exploitation économique (caoutchouc, minerais, ivoire) et justifiées idéologiquement par le « fardeau de l'homme blanc » et la mission civilisatrice.`
  ...
  // Question n°13
  {
    question: "Quelle est la visée première d'une guerre de « libération » ?",
    answers: [
      ...
      "Renverser un ordre oppressif (tyrannie, esclavage, colonisation) pour instaurer plus de liberté ou de justice."
    ],
    correct: 3,
...
\nExemple : La guerre d'indépendance algérienne (1954-1962) était vue par le FLN comme une guerre de libération nationale contre le colonialisme français. La violence extrême des deux côtés fut justifiée, pour les uns, par la fin de l'oppression, et pour les autres, par le maintien de l'ordre et de l'intégrité territoriale.`
  ...
  // Question n°14
  {
    question: "Comment Hannah Arendt définit-elle la spécificité des régimes « totalitaires » ?",
    answers: [
      "Ce sont des régimes autoritaires classiques, similaires aux monarchies absolues de l'Ancien Régime.",
      "Ils visent à transformer la nature humaine et à contrôler totalement la vie des masses atomisées par la terreur et l'idéologie.",
...
\nExemple : Les camps de concentration et d'extermination nazis n'étaient pas seulement des outils de répression, mais des « laboratoires » visant à réduire l'homme à l'état de « déchet » superflu, selon l'analyse d'Arendt.`
  ...
  // Question n°15
  {
    question: "Quel extrait de 'Vie et Destin' de Vassili Grossman illustre la mécanique de la violence totalitaire ?",
    answers: [
...
\nExemple : Ce passage évoque les exécutions arbitraires et les « chasses à l'homme » dans les ghettos, où la vie d'un enfant n'a plus aucune valeur, illustrant la profonde déchéance éthique du régime nazi.`
  ...
  // Question n°16
  {
    question: "Selon les données sociologiques, quelle est la tendance longue de la violence privée (homicides) en France depuis le 19e siècle ?",
    answers: [
      ...
      "Elle est globalement à la baisse, une tendance qui remonte même au Moyen Âge selon la « révolution sécuritaire »."
    ],
    correct: 3,
...
\nExemple : Le taux d'homicides pour 100 000 habitants en France est passé d'environ 3,5 au début du 19e siècle à moins de 1,5 au début du 21e siècle, malgré une population bien plus nombreuse.`
  ...
  // Question n°17
  {
    question: "Pourquoi a-t-on souvent l'impression, aujourd'hui, que la violence augmente partout dans le monde ?",
    answers: [
...
\nExemple : Un attentat terroriste en Europe, bien que statistiquement rare, occupe l'espace médiatique pendant des semaines, tandis que la baisse constante des homicides quotidiens passe inaperçue.`
  ...
  // Question n°18
  {
    ...
    answers: [
      "La violence physique déguisée en accident ou présentée comme légitime par les autorités.",
      "La violence représentée dans les œuvres d'art, au cinéma ou dans la littérature.",
      "Une violence qui s'exerce avec l'assentiment inconscient du dominé, qui intériorise les catégories de pensée du dominant."
    ],
    correct: 3,
...
\nExemple : Un enfant d'ouvrier qui échoue à l'école peut intérioriser qu'il est « pas doué », alors que Bourdieu montre qu'il est surtout confronté à un langage et des références culturelles (la « culture légitime ») qui sont celles des classes dominantes et qu'il n'a pas acquises dans son milieu familial.`
  ...
  // Question n°19
  {
    question: "Comment Bourdieu analyse-t-il le rôle du système éducatif dans la société ?",
    answers: [
      ...
      "L'école présente des critères culturels comme neutres alors qu'ils favorisent les enfants des classes dominantes, légitimant ainsi les inégalités sociales."
    ],
    correct: 3,
...
\nExemple : La dissertation de philosophie valorise un type d'écriture abstrait, une maîtrise de références littéraires et une capacité à manier des concepts qui sont plus familiers dans les milieux intellectuels bourgeois que dans les milieux populaires.`
  ...
  // Question n°20
  {
    ...
    answers: [
      ...
      "Un processus de « disqualification spatiale » où la pauvreté entraîne la stigmatisation du lieu de vie, créant un cercle vicieux d'exclusion."
    ],
    correct: 3,
...
\nExemple : Un jeune habitant d'un quartier dit « sensible » peut voir son adresse devenir un obstacle à l'embauche, indépendamment de ses compétences, à cause des préjugés négatifs associés à son code postal.`
  ...
  // Question n°21
  {
    question: "Comment le personnage de Bardamu dans 'Voyage au bout de la nuit' incarne-t-il l'impact de la Grande Guerre ?",
    answers: [
      ...
      "Il en sort déshumanisé, traumatisé et plongé dans un cynisme absolu, à l'image d'une génération perdue."
    ],
    correct: 3,
...
\nExemple : La célèbre réplique « La guerre, c’est tout ce qui n’est pas la paix. Et c’est tout ce qu’il y a de plus intéressant » est dite sur un ton d'une ironie cinglante qui résume le désespoir et le refus de Bardamu de se laisser berner par les grands discours.`
  ...
  // Question n°22
  {
    question: "Quelle position Céline défend-il à travers Bardamu concernant la guerre ?",
    answers: [
      ...
      "Il faut la refuser car elle est absurde, et seuls ceux qui la refusent survivent, tandis que les morts tombent dans l'oubli le plus total."
    ],
    correct: 3,
...
\nExemple : L'argument de Bardamu – « Avez-vous jamais cherché à en connaître un seul de ces noms [des soldats morts pendant la guerre de Cent Ans] ? » – montre que le sacrifice est inutile car la mémoire des morts est éphémère.`
  ...
  // Question n°23
  {
    ...
    answers: [
      ...
      "Le maréchal Pétain, représentant l'autorité collaborationniste qui justifie ses actes au nom du réalisme et de l'ordre."
    ],
    correct: 3,
...
\nExemple : La réplique de Créon : « C’est – entre beaucoup d’autres – l’avantage de la tyrannie qu’elle a le droit de dire et de faire absolument ce qu’elle veut » peut être lue comme une critique de l'arbitraire du régime de Vichy qui gouvernait par décrets-lois.`
  ...
  // Question n°24
  {
    question: "Quel concept célèbre Hannah Arendt a-t-elle forgé en couvrant le procès d'Adolf Eichmann en 1961 ?",
    answers: [
      ...
      "La « banalité du mal » pour décrire le fonctionnement bureaucratique et déshumanisé du crime de masse."
    ],
    correct: 3,
...
\nExemple : Eichmann arguait à son procès qu'il « suivait les ordres » et n'avait fait que son devoir en organisant efficacement les déportations. Arendt y vit le comble de la pensée absente, où le zèle bureaucratique remplace le jugement moral.`
  ...
  // Question n°25
  {
    ...
    answers: [
      ...
      "Servir d'acte de résistance poétique en affirmant le mot « Liberté » comme un mantra indestructible inscrit sur toutes les choses du monde."
    ],
    correct: 3,
...
\nExemple : Le poème était diffusé sous le manteau, parachuté par la RAF sur la France occupée, et récité dans les réseaux de résistance. Il montrait que la littérature pouvait être une forme de combat, affirmant des valeurs que la violence physique tentait d'étouffer.`
  ...
  // Question n°26
  {
    ...
    answers: [
      ...
      "Une allégorie du nazisme et de tout fléau totalitaire qui isole, sépare et contre lequel il faut résister collectivement."
    ],
    correct: 3,
...
\nExemple : La phrase « Il y a dans les hommes plus de choses à admirer que de choses à mépriser » résume l'humanisme résistant de Camus : malgré l'horreur, il faut choisir le côté des victimes et lutter, car c'est ainsi qu'on affirme sa dignité.`
  ...
  // Question n°27
  {
    question: "Qu'est-ce que la « littérature engagée » selon Jean-Paul Sartre ?",
    answers: [
      ...
      "Une littérature qui prend parti dans les conflits de son temps, dénonce l'oppression et s'engage pour la liberté, sans pour autant devenir un instrument d'oppression."
    ],
    correct: 3,
...
\nExemple : Sartre lui-même s'est engagé contre la guerre d'Algérie, a fondé la revue <em>Les Temps Modernes</em> et a pris position sur de nombreuses causes, considérant que son statut d'intellectuel lui imposait de parler et d'agir.`
  ...
  // Question n°28
  {
    ...
    answers: [
      ...
      "Le 'jus ad bellum' concerne la légitimité de déclarer la guerre, le 'jus in bello' concerne la conduite légitime pendant la guerre.",
...
\nExemple : L'intervention de l'OTAN au Kosovo en 1999 a été débattue : avait-elle une cause juste (arrêter un nettoyage ethnique) ? Mais le bombardement de civils a soulevé des questions sur le respect du <em>jus in bello</em> (proportionnalité, précision).`
  ...
  // Question n°29
  {
    question: "En quoi les attentats du 11 septembre 2001 illustrent-ils le concept de « guerre asymétrique » ?",
    answers: [
...
\nExemple : L'effondrement des tours jumelles, filmé en direct et diffusé en boucle, a créé un trauma collectif à l'échelle planétaire, bien au-delà du nombre de victimes, démontrant la puissance de l'image dans la guerre moderne.`
  ...
  // Question n°30
  {
    question: "Comment le licenciement massif par visioconférence (ex. Better.com, 2021) peut-il être analysé comme une violence ?",
    answers: [
      "C'est un acte de violence physique directe contre les employés licenciés.",
      "C'est un acte de générosité de l'employeur, qui évite aux salariés la gêne d'un entretien en face-à-face.",
      "C'est un acte de violence symbolique et sociale qui humilie, déshumanise et provoque une souffrance psychique liée au déclassement."
    ],
    correct: 3,
...
\nExemple : La brutalité froide de l'annonce (« vous faites partie des malchanceux ») transforme un processus managérial en une épreuve humiliante et traumatisante, mettant en lumière la violence inhérente à certaines pratiques capitalistes contemporaines.`
  ...
  // Question n°31
  {
    question: "Quel événement majeur du 20e siècle a définitivement ébranlé la confiance dans le progrès héritée des Lumières ?",
    answers: [
      ...
      "Les guerres mondiales, la Shoah et les totalitarismes, qui ont détourné la science et la technique vers la destruction de masse."
    ],
    correct: 3,
...
\nExemple : L'utilisation du gaz moutarde à Ypres en 1915, puis la bombe atomique sur Hiroshima en 1945, sont des symboles de ce retournement : la science, censée libérer l'homme, devient un outil de son anéantissement.`
  ...
  // Question n°32
  {
    question: "Que signifie l'expression de Simone Weil « l'âme souffre violence tous les jours » dans le contexte de la guerre ?",
    answers: [
      "La guerre est une expérience spirituellement enrichissante qui fortifie l'âme des combattants.",
      "La violence de la guerre efface jusqu'à la pensée de ses causes et de sa fin, mutilant la capacité même de l'âme à se projeter.",
...
\nExemple : Un soldat dans les tranchées de Verdun, soumis à un bombardement continu, peut perdre jusqu'à l'idée même d'un « après » la guerre ; sa conscience est réduite à la survie immédiate, mutilée dans sa capacité à envisager un futur.`
  ...
  // Question n°33
  {
    ...
    answers: [
      ...
      "Le processus de « civilisation des mœurs » et le monopole étatique de la violence ont internalisé les contrôles sociaux et canalisé la violence."
    ],
    correct: 3,
...
\nExemple : Le duel, pratique courante et souvent légale pour l'honneur à l'époque moderne, est devenu un crime au 19e siècle, signe que l'État ne tolérait plus que les individus règlent leurs comptes par les armes.`
  ...
  // Question n°34
  {
    ...
    answers: [
      ...
      "Les obligations de justice après la guerre : les conditions de paix doivent être équitables et viser la réconciliation pour éviter de futurs conflits."
    ],
    correct: 3,
...
\nExemple : Le Plan Marshall après 1945, qui a aidé à reconstruire l'Europe (y compris l'Allemagne vaincue), est souvent cité comme un exemple de <em>jus post bellum</em> réussi, ayant contribué à la réconciliation et à la stabilité durable.`
  ...
  // Question n°35
  {
    question: "Pourquoi la « trêve olympique » est-elle un exemple d'encadrement traditionnel de la violence ?",
    answers: [
      "Parce qu'elle arrête mécaniquement toutes les guerres dans le monde pendant la durée des Jeux modernes.",
      "Parce qu'elle représente un code coutumier suspendant les conflits pendant les compétitions panhelléniques, montrant que la guerre avait ses règles.",
...
\nExemple : Malgré les guerres incessantes entre Sparte et Athènes, elles respectaient généralement la trêve olympique. Sa violation était considérée comme un sacrilège et provoquait l'opprobre général.`
  ...
  // Question n°36
  {
    question: "Quel paradoxe Sartre soulève-t-il concernant l'engagement contre l'oppression ?",
    answers: [
      ...
      "Peut-on perpétuer l'oppression (par le mensonge, la terreur) sous prétexte de vouloir y mettre fin ? L'engagement doit préserver des moyens éthiques."
    ],
    correct: 3,
...
\nExemple : Un parti révolutionnaire qui ment à ses militants « pour leur bien » ou qui élimine ses opposants internes reproduit les mécanismes autoritaires qu'il prétend abattre, comme l'ont montré les purges staliniennes.`
  ...
  // Question n°37
  {
    ...
    answers: [
      ...
      "Les mouvements totalitaires séduisent des masses atomisées et désocialisées, offrant une pseudo-communauté par l'idéologie et la terreur.",
...
\nExemple : Le parti nazi a recruté parmi les « déclassés » de toutes origines, les chômeurs, les anciens combattants désillusionnés, offrant un sens et une identité par la haine de l'ennemi désigné (le Juif, le bolchevik).`
  ...
  // Question n°38
  {
    ...
    answers: [
      ...
      "Comme ce qui transforme quiconque en chose : la victime en cadavre, le vainqueur en esclave de sa propre violence."
    ],
    correct: 3,
...
\nExemple : Achille, après avoir tué Hector, traîne son cadavre autour de Troie. Cet acte ne rend pas seulement Hector chose, il révèle aussi la déchéance d'Achille, devenu une bête de rage, aliéné à sa propre violence.`
  ...
  // Question n°39
  {
    question: "Quelle est la principale critique adressée à la thèse de Rousseau sur la bonté naturelle, selon les données anthropologiques ?",
    answers: [
      ...
      "Les données montrent que la violence meurtrière est une constante des sociétés pré-étatiques, invalidant le « mythe du bon sauvage »."
    ],
    correct: 3,
...
\nExemple : Les études sur les sociétés amazoniennes comme les Yanomami ont montré des cycles de vengeance et des raids inter-villages causant un pourcentage élevé de décès, contredisant l'image d'une harmonie primitive.`
  ...
  // Question n°40
  {
    ...
    answers: [
      ...
      "Un conflit où un belligérant faible utilise des méthodes non conventionnelles pour compenser son infériorité et viser l'impact psychologique."
    ],
    correct: 3,
...
\nExemple : Après les gaz de 1915, les belligérants ont tous développé leurs propres armes chimiques, malgré les traités, inaugurant une course aux armements et une banalisation de cette arme de terreur.`
  ...
  // Question n°43
  {
    ...
    answers: [
      ...
      "L'école impose une « culture légitime » présentée comme neutre, mais qui favorise les enfants des classes dominantes, légitimant leur réussite comme un « mérite »."
    ],
    correct: 3,
...
\nExemple : L'épreuve de culture générale dans certains concours (Sciences Po) valorise une culture « générale » qui est en fait très spécifique (littérature classique, arts), avantageant les enfants de milieux cultivés.`
  ...
  // Question n°44
  {
    ...
    answers: [
      ...
      "Elle épouse Créon pour le faire changer d'avis de l'intérieur, utilisant la séduction comme arme politique.",
      "Elle incarne l'intransigeance des valeurs individuelles face à la raison d'État du tyran, au prix de sa propre vie."
    ],
    correct: 3,
...
\nExemple : La réplique « Je ne suis pas là pour comprendre, je suis là pour vous dire non » résume le refus absolu d'Antigone de se plier à une logique qu'elle juge inhumaine, même si elle la comprend.`
  ...
  // Question n°45
  {
    ...
    answers: [
      ...
      "Pour décrire l'incrédulité face au mal qui surgit : les hommes habitués à la continuité sont incapables d'imaginer la catastrophe."
    ],
    correct: 3,
...
\nExemple : Beaucoup dans les années 1930 ont sous-estimé la menace nazie, croyant à la rationalité ou à des compromis possibles, incapables d'imaginer l'horreur de la Solution finale.`
  ...
  // Question n°46
  {
    question: "Quelle est la place de la « souffrance psychique » dans une définition élargie de la violence ?",
    answers: [
      "Elle n'est pas considérée comme de la violence, seule la souffrance physique compte légalement et moralement.",
      "La violence est définie comme ce qui génère une souffrance psychique ou physique, incluant le harcèlement, les humiliations, les menaces.",
...
\nExemple : Le harcèlement scolaire ou professionnel, qui n'implique pas nécessairement de coups, peut conduire à la dépression, à l'isolement et même au suicide, ce qui en fait une forme de violence à part entière.`
  ...
  // Question n°47
  {
    question: "Pourquoi la figure du « héros » change-t-elle radicalement dans la littérature du début du 20e siècle ?",
    answers: [
      "Parce que les écrivains manquent d'imagination pour créer de nouveaux personnages héroïques classiques.",
      "L'expérience de la violence de masse rend obsolète le héros traditionnel ; le nouveau héros est un anti-héros désillusionné et passif.",
...
\nExemple : Contrairement aux héros de Balzac qui cherchaient à conquérir le monde, Bardamu (<em>Voyage au bout de la nuit</em>) ne cherche qu'à le fuir. Sa « grandeur » réside dans sa lucidité désespérée.`
  ...
  // Question n°48
  {
    ...
    answers: [
      ...
      "Si elle est ontologique (liée à l'être de l'homme), elle est inévitable ; si elle est politique (produite par la société), elle peut être transformée."
    ],
    correct: 3,
...
\nExemple : L'idée marxiste que la violence disparaîtra avec la société sans classes suppose que la violence est d'origine sociale (la lutte des classes) et non une caractéristique éternelle de l'homme.`
  ...
  // Question n°49
  {
    ...
    answers: [
      ...
      "Ces survivants gravement mutilés au visage sont devenus les symboles vivants d'une violence industrielle qui défigure l'humanité même.",
...
\nExemple : L'Union des Blessés de la Face, fondée en 1921, a milité pour la reconnaissance de ces blessés. Leur image a aussi été utilisée dans les campagnes pacifistes de l'entre-deux-guerres.`
  ...
  // Question n°50
  {
    ...
    answers: [
      ...
      "Elle interdit tous les châtiments corporels et humiliations psychologiques dans l'éducation, reconnaissant leur caractère violent.",
...
\nExemple : Avant cette loi, la France avait été condamnée par la Cour européenne des droits de l'homme pour ne pas interdire explicitement les châtiments corporels. La loi aligne la France sur de nombreux pays ayant une telle interdiction.`
  ...
  // Question n°51
  {
    ...
    answers: [
      ...
      "La violence symbolique est toujours physique, alors que la servitude volontaire est uniquement psychologique.",
      "La servitude volontaire suppose une conscience du choix d'obéir ; la violence symbolique s'exerce avec l'assentiment inconscient du dominé."
    ],
    correct: 3,
...
\nExemple : Un ouvrier qui vote contre ses intérêts de classe par conviction idéologique pourrait relever de la servitude volontaire. Un enfant qui croit qu'il n'est « pas fait pour les études » sans voir le biais social relève de la violence symbolique.`
  ...
  // Question n°52
  {
    question: "Quel est le rôle des médias dans le processus de « disqualification spatiale » décrit par Paugam ?",
    answers: [
      ...
      "Ils le renforcent en focalisant sur la « violence urbaine » et en diffusant des reportages qui stigmatisent ces espaces et leurs habitants."
    ],
    correct: 3,
...
\nExemple : Le terme « quartier sensible » ou « zone de non-droit », employé de manière extensive, crée une représentation monolithique et négative qui peut devenir une prophétie auto-réalisatrice en découragant les investissements et en nourrissant les préjugés.`
  },
  // Question n°53
  {
    ...
    answers: [
      ...
      "N'importe quel belligérant peut prétendre avoir une cause juste et mener une guerre propre, masquant ainsi des intérêts moins avouables.",
...
\nExemple : L'invasion de l'Irak en 2003 a été justifiée par la présence supposée d'armes de destruction massive (une « cause juste » préventive). L'absence de ces armes a jeté le discrédit sur cette justification.`
  },
  // Question n°54
  {
    question: "Pourquoi la violence peut-elle être qualifiée d'« instrumentale » selon Hannah Arendt ?",
    answers: [
      "Parce qu'on utilise toujours des instruments (armes, outils) pour l'exercer, contrairement au pouvoir qui est immatériel.",
      "Parce qu'elle est un moyen en vue d'une fin, nécessitant une justification extérieure, contrairement au pouvoir qui est une fin en soi.",
      "Parce que c'est un art qui s'apprend et se perfectionne avec des techniques spécifiques, comme un instrument de musique."
    ],
    correct: 2,
...
\nExemple : Un État qui réprime une manifestation pacifique par la force montre qu'il a perdu le pouvoir de convaincre ou de négocier ; il utilise alors la violence comme instrument de dernier recours, mais au prix d'une perte de légitimité.`
  ...
  // Question n°55
  {
    ...
    answers: [
      ...
      "C'est un moteur classique de perpétuation de la violence ; le droit étatique tente de rompre ce cycle en se substituant à la vengeance privée."
    ],
    correct: 3,
...
\nExemple : Dans les sociétés où l'État est faible, les cycles de vengeance peuvent durer des générations, comme dans certaines régions d'Albanie ou de Somalie, montrant la difficulté à sortir de cette logique sans une autorité tierce reconnue.`
  ...
  // Question n°56
  {
    question: "Comment la littérature de témoignage contribue-t-elle à la lutte contre la violence ?",
    answers: [
      "En la glorifiant et en en faisant un spectacle fascinant pour le lecteur, comme dans les romans d'aventures.",
      "En donnant une voix aux victimes, en documentant l'horreur pour l'inscrire dans la mémoire collective contre l'oubli et le déni.",
      "En l'oubliant rapidement pour tourner la page et se concenter sur des sujets plus positifs et édifiants."
    ],
    correct: 2,
...
\nExemple : 'Si c'est un homme' de Primo Levi est devenu un texte fondateur de la mémoire de la Shoah précisément parce qu'il décrit avec une précision clinique et une humanité bouleversante l'univers concentrationnaire.`
  ...
  // Question n°57
  {
    question: "Quelle est la différence entre « guerre civile » et « guerre interétatique » du point de vue de la violence ?",
    answers: [
      ...
      "La guerre civile est souvent plus confuse, moins encadrée par le droit, et peut générer des violences atroces (massacres, nettoyages ethniques) en raison de la proximité des belligérants."
    ],
    correct: 3,
...
\nExemple : La guerre civile en ex-Yougoslavie (1991-1995) a été marquée par des sièges de villes, des camps et le massacre de Srebrenica, montrant l'extrême violence de conflits où les enjeux nationaux et identitaires se superposent.`
  ...
  // Question n°58
  {
    ...
    answers: [
      ...
      "Elle a mis fin à toute guerre en rendant les conflits trop horribles pour être envisagés par les nations civilisées.",
      "Elle symbolise l'apogée de la violence industrielle et l'entrée dans une ère où l'humanité détient les moyens de son auto-anéantissement."
    ],
    correct: 3,
...
\nExemple : La « crise des missiles de Cuba » en 1962 a amené le monde au bord d'une guerre nucléaire totale, illustrant le nouvel équilibre de la terreur où la violence absolue devient paradoxalement un facteur de dissuasion.`
  ...
  // Question n°59
  {
    question: "Comment la notion de « crime contre l'humanité », forgée à Nuremberg, modifie-t-elle le regard sur la violence de guerre ?",
    answers: [
      "Elle ne change rien, car elle n'a été appliquée qu'aux vaincus de la Seconde Guerre mondiale.",
      "Elle crée une catégorie pour des crimes d'une gravité exceptionnelle qui violent des lois supérieures à celles des États, engageant la responsabilité pénale individuelle.",
...
\nExemple : La condamnation de Julius Streicher, éditeur du journal antisémite 'Der Stürmer', pour incitation au génocide, a établi que la propagande de haine pouvait constituer un crime contre l'humanité.`
  ...
  // Question n°60
  {
    question: "Pourquoi la violence peut-elle être qualifiée de « spectacle » dans les sociétés médiatiques ?",
    answers: [
      "Parce qu'elle n'existe pas vraiment, elle est une pure construction des médias et de l'imaginaire collectif.",
      "Parce qu'elle est mise en scène, dramatisée et diffusée en continu, devenant un produit de consommation qui peut banaliser l'horreur.",
...
\nExemple : La diffusion en direct et en boucle de l'effondrement des tours jumelles le 11 septembre 2001 a créé un trauma collectif à l'échelle planétaire, faisant de l'événement un « spectacle » global.`
  ...
  // Question n°61
  {
    ...
    answers: [
      ...
      "L'humour noir et la satire peuvent être des armes pour dénoncer l'absurdité de la violence et ridiculiser les tyrans.",
...
\nExemple : Les caricatures de Mahomet publiées par 'Charlie Hebdo' étaient pour ses auteurs une manière d'affirmer la liberté d'expression contre tous les intégrismes. L'attentat de 2015 a montré la dangerosité de cet engagement.`
  ...
  // Question n°62
  {
    question: "Comment la notion de « résilience » est-elle utilisée dans l'analyse des sociétés confrontées à la violence ?",
    answers: [
      "Pour dire qu'elles oublient tout rapidement et reprennent une vie normale sans séquelles.",
      "Pour décrire la capacité à surmonter un traumatisme violent et à reconstruire, sans pour autant nier ou oublier.",
...
\nExemple : Le Mémorial de la Shoah à Paris ou le musée du génocide à Kigali sont des lieux de mémoire qui témoignent de l'horreur, mais aussi de la volonté de transmettre et de reconstruire, illustrant une résilience collective.`
  ...
  // Question n°63
  {
    question: "Quelle est la place de l'enfance dans les représentations de la violence en littérature ?",
    answers: [
...
\nExemple : La photo du petit Aylan Kurdi, enfant syrien noyé échoué sur une plage en 2015, est devenue le symbole mondial de la tragédie des migrants fuyant la guerre.`
  ...
  // Question n°64
  {
    ...
    answers: [
      ...
      "Dans une démocratie, la violence légitime de l'État est contrôlée par le peuple via des institutions, et sa légitimité repose sur le consentement des citoyens.",
      "La démocratie utilise nécessairement plus de violence que les dictatures pour maintenir un ordre complexe et conflictuel."
    ],
    correct: 2,
...
\nExemple : Une intervention policière pour disperser une manifestation non déclarée peut être légale, mais si elle est perçue comme disproportionnée, elle peut perdre sa légitimité aux yeux d'une partie de la population.`
  ...
  // Question n°65
  {
    question: "Quel est l'enjeu du principe de « proportionnalité » dans le 'jus in bello' ?",
    answers: [
      "Utiliser toutes les armes disponibles pour écraser l'ennemi le plus rapidement possible, quelle que soit la puissance destructrice.",
      "Avoir plus de soldats et de matériel que l'adversaire pour assurer une victoire rapide et décisive.",
      "Les dommages collatéraux aux civils ne doivent pas être excessifs par rapport à l'avantage militaire concret attendu."
    ],
    correct: 3,
...
\nExemple : Les frappes aériennes israéliennes à Gaza sont régulièrement accusées de violer le principe de proportionnalité lorsque le bilan civil est très lourd par rapport aux cibles militaires visées.`
  ...
  // Question n°66
  {
    question: "Comment la philosophie des Lumières a-t-elle envisagé la sortie de la violence entre États ?",
    answers: [
      ...
      "Par le commerce, la raison et le droit, croyant que l'interdépendance et le droit international pourraient remplacer la guerre."
    ],
    correct: 3,
...
\nExemple : La construction européenne après 1945 a été fondée sur l'idée de lier économiquement les nations pour rendre la guerre « matériellement impossible » (déclaration Schuman).`
  ...
  // Question n°67
  {
    question: "Quelle est la spécificité de la violence « génocidaire » ?",
    answers: [
      ...
      "Elle vise la destruction intentionnelle, totale ou partielle, d'un groupe en tant que tel (national, ethnique, racial, religieux)."
    ],
    correct: 3,
...
\nExemple : Le génocide des Tutsi au Rwanda en 1994 a été planifié par l'État, utilisant la radio pour la propagande haineuse et distribuant des machettes pour exterminer les Tutsi en quelques semaines.`
  ...
  // Question n°68
  {
    question: "Comment la notion de « trauma » a-t-elle émergé pour décrire les conséquences de la violence ?",
    answers: [
      "Elle n'existe pas, c'est une invention moderne pour justifier la faiblesse et le manque de courage des soldats.",
      "À partir de l'observation des « névroses de guerre » (shell shock) des soldats de 14-18, comme une blessure psychique durable.",
...
\nExemple : Le trouble de stress post-traumatique (TSPT) est aujourd'hui une catégorie diagnostique qui décrit les séquelles d'un événement traumatique, avec des symptômes comme les flashbacks et l'hypervigilance.`
  ...
  // Question n°69
  {
    ...
    answers: [
      ...
      "Un urbanisme de rupture (grands ensembles isolés) peut favoriser la délinquance ; un urbanisme de mixité et de rencontre peut la prévenir.",
      "Les beaux bâtiments et les espaces verts augmentent mécaniquement la violence par la jalousie et la frustration qu'ils provoquent."
    ],
    correct: 2,
    explanation: `La théorie de la « vitre brisée » et les travaux de Jane Jacobs ont mis en lumière le lien entre environnement urbain et criminalité. Un espace abandonné, mal éclairé, où personne ne « surveille » naturellement, peut devenir un lieu de trafic ou d'agression. À l'inverse, une rue commerçante, habitée, dissuade la violence. L'urbanisme est donc un outil de prévention non négligeable, capable de favoriser ou d'entraver le lien social et le sentiment de sécurité.
\nExemple : La rénovation urbaine dans certains quartiers vise à « décloisonner » les grands ensembles, à créer des rues passantes et des commerces pour recréer du lien social et de la surveillance naturelle.`
  },
  // Question n°70
  {
    ...
    answers: [
      ...
      "Elle peut être un prélude, une justification ou une forme autonome de violence qui blesse psychiquement et crée un climat de peur.",
      "Elle est toujours pire que la violence physique, car elle laisse des cicatrices invisibles et inguérissables."
    ],
    correct: 2,
...
\nExemple : Les campagnes de « lynchage » sur les réseaux sociaux, où une personne est insultée, menacée et doxxée, est une forme de violence verbale collective aux conséquences potentiellement désastreuses (dépression, perte d'emploi).`
  ...
  // Question n°71
  {
    ...
    answers: [
      ...
      "Aucun ne la « veut » vraiment, mais ils se laissent entraîner par des mécanismes (alliances, logiques bureaucratiques, intérêts) qu'ils ne maîtrisent pas complètement."
    ],
    correct: 3,
...
\nExemple : Alain analyse que le patriotisme exacerbé et la course aux armements avant 1914 ont créé une atmosphère de peur mutuelle entre les grandes puissances, rendant la guerre presque inévitable, même si aucun dirigeant ne la souhaitait ouvertement.`
  ...
  // Question n°72
  {
    ...
    answers: [
      ...
      "Elle a imposé les catégories de pensée, l'histoire et la langue du colonisateur, en dévalorisant les savoirs autochtones.",
...
\nExemple : Le concept de « négritude » développé par Aimé Césaire et Léopold Sédar Senghor était une réaction à cette violence épistémique : réhabiliter la culture et l'histoire noires, niées par le colonialisme.`
  ...
  // Question n°73
  {
    question: "Comment la notion de « pardon » peut-il intervenir dans le cycle de la violence ?",
    answers: [
      "Elle l'aggrave en légitimant l'impunité des bourreaux et en niant la souffrance des victimes.",
      "Elle efface tout et permet d'oublier complètement le passé pour repartir sur des bases neuves et innocentes.",
      "Elle peut être envisagée comme une manière de rompre le cycle de la vengeance, sans nier la justice ou la mémoire."
    ],
    correct: 3,
...
\nExemple : La Commission Vérité et Réconciliation en Afrique du Sud offrait l'amnistie aux auteurs de crimes en échange de l'aveu public, dans l'espoir de guérir les blessures de la nation sans nouvelles violences.`
  ...
  // Question n°74
  {
    ...
    answers: [
      "La peur n'a aucun rôle, c'est le courage et l'agressivité qui sont les vrais moteurs de la violence.",
      "La peur est un moteur puissant : peur de l'autre, peur de manquer, peur pour sa sécurité, qui peut justifier la violence préventive ou l'oppression.",
      "La peur empêche toujours la violence, car elle pousse à la prudence et à la retenue dans les conflits."
    ],
    correct: 2,
...
\nExemple : La « peur du grand remplacement », théorie complotiste, alimente la violence raciste en présentant certaines populations comme une menace existentielle, justifiant ainsi des actes haineux.`
  ...
  // Question n°75
  {
    question: "Comment la violence est-elle représentée dans les arts visuels du 20e siècle ?",
    answers: [
      "Elle en est absente, les artistes préférant représenter la beauté, l'harmonie et les sujets apaisants.",
      "De manière directe et crue (Guernica), mais aussi de manière métaphorique, en interrogeant la possibilité même de représenter l'horreur (la Shoah).",
...
\nExemple : Le film 'Hiroshima mon amour' d'Alain Resnais mêle histoire d'amour et images documentaires, refusant une représentation spectaculaire pour mieux interroger la mémoire et l'indicible de la violence nucléaire.`
  },
  // Question n°76
  {
    ...
    answers: [
      ...
      "Elle est souvent présentée comme un mal nécessaire, un « accoucheur » de l'histoire pour renverser l'ordre bourgeois oppressif."
    ],
    correct: 3,
...
\nExemple : La révolution d'Octobre 1917 a été justifiée par Lénine comme une violence nécessaire. La terreur rouge qui a suivi a été présentée comme une nécessité pour défendre la révolution.`
  ...
  // Question n°77
  {
    question: "Comment la notion de « sécurité humaine » élargit-elle la conception traditionnelle de la sécurité ?",
    answers: [
      "Elle la réduit à la seule protection contre les agressions militaires venant d'un État étranger.",
      "Elle inclut la protection contre les menaces chroniques (faim, maladie, répression) et la satisfaction des besoins essentiels.",
      "C'est exactement la même chose que la sécurité nationale, simplement rebaptisée pour des raisons de communication politique."
    ],
    correct: 2,
...
\nExemple : Les printemps arabes de 2011 ont été en partie déclenchés par des revendications liées à la sécurité humaine : manque de perspectives pour les jeunes, corruption, répression politique.`
  ...
  // Question n°78
  {
    question: "Quel est le rôle des femmes dans la construction de la paix, selon les études de genre ?",
    answers: [
      "Elles n'ont aucun rôle, la paix et la guerre étant des affaires d'hommes par tradition et par nature.",
      "Les femmes, souvent exclues des processus officiels, sont des actrices clés dans la résolution des conflits au niveau local et la reconstruction sociale.",
...
\nExemple : Au Liberia, le mouvement des femmes, mené par Leymah Gbowee, a joué un rôle décisif pour mettre fin à la guerre civile en 2003, organisant des sit-in et des grèves du sexe. Gbowee a reçu le prix Nobel de la paix en 2011.`
    ...
    // Question n°79
  {
    ...
    answers: [
      ...
      "À travers des inégalités extrêmes, l'exploitation, la précarité imposée, les embargos qui frappent les populations civiles."
    ],
    correct: 3,
...
\nExemple : L'embargo américain contre l'Irak dans les années 1990 est accusé d'avoir causé la mort de centaines de milliers d'enfants par malnutrition et manque de médicaments.`
  ...
  // Question n°80
  {
    question: "Quel est l'apport de la psychologie sociale dans la compréhension de la violence de masse ?",
    answers: [
      "Aucun, elle prouve que seuls les individus psychologiquement anormaux ou fous peuvent commettre des atrocités.",
      "Elle étudie des mécanismes comme l'obéissance à l'autorité et la conformité au groupe, montrant que des personnes « ordinaires » peuvent commettre des actes violents.",
      "Elle confirme l'idée de Hobbes selon laquelle l'homme est un loup pour l'homme, avec une agressivité naturelle et universelle."
    ],
    correct: 2,
...
\nExemple : Milgram a montré qu'une majorité de participants étaient prêts à administrer des chocs électriques potentiellement mortels à un inconnu, simplement parce qu'un scientifique en blouse blanche le leur ordonnait.`
  ...
  // Question n°81
  {
    question: "Comment la notion de « responsabilité de protéger » (R2P) modifie-t-elle le droit international ?",
    answers: [
      "Elle renforce la souveraineté absolue des États, interdisant toute ingérence sous quelque prétexte que ce soit.",
      "Elle établit que la communauté internationale a la responsabilité d'intervenir, y compris par la force, pour protéger des populations contre des crimes de masse si l'État défaillant.",
      "Elle interdit toute intervention militaire, privilégiant exclusivement les moyens diplomatiques et les sanctions économiques."
    ],
    correct: 2,
...
\nExemple : L'intervention militaire en Libye en 2011, sous mandat de l'ONU, a été justifiée par la R2P pour protéger les civils menacés par le régime de Kadhafi. Les critiques estiment que cette intervention a dépassé son mandat.`
  ...
  // Question n°82
  {
    ...
    answers: [
      "Il n'y a pas de lien, l'environnement est un cadre neutre et passif dans lequel se déroulent les conflits humains.",
      "Un environnement propre et bien entretenu empêche mécaniquement toute forme de violence sociale ou criminelle.",
      "La dégradation environnementale (raréfaction de l'eau, désertification) peut être une cause de conflits violents pour l'accès aux ressources."
    ],
    correct: 3,
...
\nExemple : Le conflit au Darfour (Soudan) a été en partie analysé comme un conflit environnemental : la désertification a exacerbé les tensions entre éleveurs nomades et agriculteurs sédentaires.`
  ...
  // Question n°83
  {
    ...
    answers: [
      ...
      "Elles attribuent les actes de violence à des coupables cachés et maléfiques, simplifiant le monde et nourrissant la haine contre des boucs émissaires.",
      "Elles l'expliquent toujours de manière rationnelle et documentée, en identifiant les responsabilités politiques et économiques réelles."
    ],
    correct: 2,
...
\nExemple : Après la fusillade de l'école de Sandy Hook (2012), des théoriciens du complot ont prétendu que c'était une mise en scène, harcelant et menaçant les parents des enfants tués.`
  ...
  // Question n°84
  {
    question: "Quel est le sens de la phrase d'Alain : « Je ne puis appeler guerre... cette chasse sans pitié que la faim, l'avidité... éperonnent » ?",
    answers: [
      "La faim et l'avidité sont les seules causes véritables de toutes les guerres de l'histoire humaine.",
      "La violence individuelle motivée par le besoin ou la convoitise n'est pas la « guerre », qui est une entreprise collective et organisée.",
      "La guerre est une chasse à l'homme, un sport cruel pratiqué par les élites militaires pour leur divertissement."
    ],
    correct: 2,
...
\nExemple : Les exactions commises par des soldats affamés qui pillent un village sont des crimes de guerre, mais elles ne définissent pas à elles seules le conflit, qui peut avoir pour cause des rivalités géopolitiques à grande échelle.`
  ...
  // Question n°85
  {
    question: "Comment définir la « violence politique » de type idéologique en France aujourd'hui ?",
    answers: [
      "Elle n'existe plus, la France étant un pays pleinement pacifié et dépassionné sur le plan politique.",
      "Elle peut émaner de groupes informels (extrême-droite, extrême-gauche, intégrismes) et viser à interpeller le pouvoir ou à fédérer autour d'un ennemi.",
      "Elle est toujours et exclusivement le fait de l'État, qui réprime par la police et l'armée les contestations populaires."
    ],
    correct: 2,
...
\nExemple : L'incendie d'un cinéma projetant <em>La Dernière Tentation du Christ</em> en 1988 par des intégristes catholiques visait à censurer par la violence une œuvre jugée blasphématoire.`
  ...
  // Question n°86
  {
    question: "Quelle est la thèse de 'La révolution sécuritaire' de Nicolas Bourgoin sur l'évolution de la criminalité violente ?",
    answers: [
...
\nExemple : Alors que le débat public est saturé de discours sur l'« insécurité », le nombre d'homicides volontaires en France est passé d'environ 2 000 par an dans les années 1970 à moins de 900 par an dans les années 2010, pour une population qui a augmenté.`
  ...
  // Question n°87
  {
    question: "Pourquoi évoquer la chanson 'Strange Fruit' de Billie Holiday dans le contexte des luttes pour la liberté ?",
    answers: [
      "C'est une chanson d'amour mélancolique sans rapport avec la politique ou la violence.",
      "Elle célèbre la beauté des paysages du Sud des États-Unis et la douceur de vivre sous le climat subtropical.",
      "C'est un réquisitoire artistique contre la violence raciste des lynchages, montrant que l'art peut être une arme de dénonciation."
    ],
    correct: 3,
...
\nExemple : La chanson était si subversive que Billie Holiday a souvent dû la chanter en dernier, les lumières éteintes, et a subi des pressions. Elle est devenue un hymne contre le racisme.`
  ...
  // Question n°88
  {
    ...
    answers: [
      ...
      "La recherche de la victoire totale, l'industrialisation de la mort et l'idéologisation ont conduit à pousser la violence à ses limites extrêmes (tranchées, Shoah).",
      "Elle devient plus gentille et plus chirurgicale, avec des armes de précision qui évitent les victimes civiles."
    ],
    correct: 2,
...
\nExemple : Le bombardement de Dresde en février 1945 par les Alliés, qui a fait environ 25 000 morts civils, n'avait pas d'objectif militaire stratégique clair et relevait d'une logique de terreur, illustrant cette violence poussée à l'extrême.`
  ...
  // Question n°89
  {
    ...
    answers: [
      ...
      "Il est « désespérément nécessaire » de connaître et transmettre l'histoire pour comprendre et résister à une répétition possible.",
...
\nExemple : Le négationnisme est considéré non seulement comme une insulte aux victimes, mais comme un danger politique, car il efface les leçons qui devraient en être tirées sur les dangers du totalitarisme.`
  ...
  // Question n°90
  {
    ...
    answers: [
      ...
      "Elle combine la conquête militaire violente avec un système politique d'oppression et d'exploitation justifié par une idéologie raciste.",
...
\nExemple : La répression du soulèvement de Sétif en Algérie en 1945 par l'armée française, qui fit des milliers de morts algériens, illustre la violence politique utilisée pour maintenir l'ordre colonial.`
  ...
  // Question n°91
  {
    ...
    answers: [
      ...
      "À travers le droit international humanitaire (Conventions de Genève) qui définit des règles pour protéger les civils et limiter les moyens de combat.",
...
\nExemple : Le procès de Slobodan Milošević devant le TPIY pour crimes de guerre montrait la volonté de juger les responsables politiques de violences massives, au-delà du principe de souveraineté.`
  ...
  // Question n°92
  {
    question: "Quelle est la différence entre « potestas » et « auctoritas » dans la pensée d'Hannah Arendt ?",
    answers: [
      "La potestas est le pouvoir légitime, l'auctoritas est la violence illégitime et arbitraire.",
      "La potestas est le pouvoir fondé sur la force ; l'auctoritas est l'autorité morale fondée sur le respect et le consentement.",
      "Ce sont des synonymes dans le vocabulaire politique romain, qu'Arendt utilise indifféremment."
    ],
    correct: 2,
...
\nExemple : Un professeur respecté par ses élèves a de l'<em>auctoritas</em> ; ils travaillent par intérêt et respect. Un professeur qui doit sans cesse menacer de sanctions (<em>potestas</em>) a perdu cette autorité.`
  ...
  // Question n°93
  {
    question: "Quel est le sens de la phrase de John Rawls définissant la « désobéissance civile » ?",
    answers: [
      "Un acte violent de rébellion armée contre l'État pour le renverser et instaurer un nouveau régime.",
      "Un simple refus individuel et discret de payer ses impôts par protestation contre une politique injuste.",
      "Un acte public, non-violent, contraire à la loi, accompli en conscience pour protester contre une injustice majeure et amener un changement."
    ],
    correct: 3,
...
\nExemple : Les sit-in des militants des droits civiques aux États-Unis dans les années 1960, qui enfreignaient délibérément les lois de ségrégation tout en restant non-violents, incarnent la désobéissance civile rawlsienne.`
  ...
  // Question n°94
  {
    question: "Pourquoi la littérature enfantine qui contient des scènes de maltraitance ne constitue-t-elle pas une incitation à la violence éducative ?",
    answers: [
      "Parce que les enfants sont trop stupides pour comprendre ce qu'ils lisent et ne font pas le lien avec la réalité.",
      "Parce que l'enfant est capable de distinguer le réel de la fiction, et que la littérature a pour rôle de représenter la complexité du monde pour faire réfléchir.",
...
\nExemple : Dans <em>Matilda</em> de Roald Dahl, l'héroïne est maltraitée par ses parents. L'enfant lecteur s'identifie à Matilda et comprend la nécessité de résister à l'injustice, ce qui est un message positif.`
  ...
  // Question n°95
  {
    ...
    answers: [
      "Elle n'existe pas et ne doit donc pas être représentée, car elle contredit la nature pacifique et maternelle des femmes.",
      "Seuls les hommes peuvent être violents dans les romans, c'est une convention littéraire immuable depuis l'Antiquité.",
...
\nExemple : Le personnage de Lisbeth Salander dans la saga <em>Millénium</em> est une femme victime de violences masculines, mais qui use aussi d'une violence froide et calculée pour se venger, bousculant les représentations traditionnelles.`
  ...
  // Question n°96
  {
    ...
    answers: [
      ...
      "Le système institutionnel (galeries, collectionneurs) est partie intégrante de l'œuvre ; il valide et donne sa valeur à un geste simple.",
      "Il veut vendre des fruits en les présentant comme des œuvres d'art pour faire de l'argent facilement."
    ],
    correct: 2,
...
\nExemple : Quand un performeur a mangé la banane en 2019, il n'a pas détruit l'œuvre, il l'a transformée, créant un nouvel événement médiatique et confirmant que l'« œuvre » était le concept et son récit.`
  ...
  // Question n°97
  {
    ...
    answers: [
      ...
      "Les quartiers pauvres sont objectivement plus beaux et plus vivants, ce qui compense la stigmatisation.",
      "La concentration des pauvres dans certains quartiers entraîne une stigmatisation de l'espace, qui devient une violence symbolique pesant sur les identités."
    ],
    correct: 3,
...
\nExemple : Les politiques de « discrimination positive » tentent de lutter contre cette violence symbolique en changeant l'image des quartiers et en y attirant des populations plus diversifiées.`
  },
  // Question n°98
  {
    question: "Quel est le sens de l'expression de Simone Weil sur la guerre : « L'âme souffre violence tous les jours » ?",
    answers: [
      "La guerre est une expérience spirituellement enrichissante qui fortifie le caractère des combattants jour après jour.",
      "Les soldats sont des âmes sensibles qui souffrent moralement de devoir tuer, même lorsque c'est nécessaire.",
      "La violence de la guerre est si totale qu'elle efface jusqu'à la pensée de ses causes et de sa fin, mutilant la capacité de l'âme à se projeter."
    ],
    correct: 3,
    explanation: `Simone Weil, commentant <em>L'Iliade</em>, décrit la guerre comme une force écrasante qui abîme les âmes de tous. Elle est si totale qu'elle rend inconcevable aussi bien son déclenchement que sa fin. La pensée et l'aspiration sont annihilées. La violence n'est plus un moyen pour une fin, elle devient une fin en soi, un état permanent qui annule la réflexion et l'action orientée vers la paix, révélant une dimension tragique de la condition humaine face à la mort.
\nExemple : Un soldat dans les tranchées de Verdun, soumis à un bombardement continu, peut perdre jusqu'à l'idée même d'un « après » la guerre ; sa conscience est réduite à la survie immédiate.`
  },
  // Question n°99
  {
    question: "Comment la violence coloniale illustre-t-elle le concept de violence à la fois martiale et politique ?",
    answers: [
      "La colonisation était un processus entièrement pacifique, fondé sur le commerce et la coopération culturelle.",
      "Elle a été menée sans aucune violence militaire, uniquement par la persuasion et la supériorité technique des Européens.",
      "Elle combine la conquête militaire violente avec un système politique d'oppression et d'exploitation, justifié par une idéologie raciste."
    ],
    correct: 3,
...
\nExemple : La conquête de l'Algérie par la France au 19e siècle a impliqué une guerre longue et brutale, puis l'instauration d'un régime politique qui refusait la pleine citoyenneté aux « indigènes » musulmans.`
  ...
  // Question n°100
  {
    question: "Quel fil directeur permet de relier les différentes dimensions de la violence abordées dans ce module ?",
    answers: [
      ...
      "L'idée que la violence, sous ses multiples formes, est une question centrale pour comprendre le 20e siècle, ses causes, ses manifestations, les tentatives pour la limiter et les moyens de la dénoncer."
    ],
    correct: 3,
