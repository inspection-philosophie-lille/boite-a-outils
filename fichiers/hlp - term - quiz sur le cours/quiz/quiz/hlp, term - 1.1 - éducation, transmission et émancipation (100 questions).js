...
const questions = [
  // Question n°1
  {
    question: "Que signifie étymologiquement le terme 'éducation', et quelle implication principale en découle ?",
    answers: [
      "Il vient de 'educare' (nourrir), impliquant qu'il s'agit de remplir l'esprit de connaissances.",
      "Il vient de 'ex-ducere' (conduire hors de), impliquant un arrachement à la familiarité et à soi-même.",
      "Il vient de 'instruere' (construire), impliquant un édifice progressif du savoir."
    ],
    correct: 2,
    explanation: `Le terme 'éducation' dérive du latin 'ex-ducere', qui signifie littéralement 'conduire hors de'. Cette étymologie révèle l'essence même du processus éducatif : il ne s'agit pas d'un simple ajout, mais d'un déplacement, d'une sortie. L'éducation conduit l'individu hors de ce qui lui est familier (sa famille, sa culture immédiate), et par là même, hors de ses préjugés initiaux et de son état de nature. Cette sortie est la condition de l'accès à l'universel, à la pensée critique et à l'autonomie. L'émancipation intellectuelle commence par ce mouvement de distanciation.\nExemple : Un enfant élevé dans un milieu rural isolé découvrant, par l'école, l'histoire mondiale et les sciences, est littéralement 'conduit hors' du cadre limité de ses expériences premières pour accéder à une compréhension élargie du monde.`
  },

  // Question n°2
  {
    question: "Quel changement symbolique majeur est représenté par le passage du 'ministère de l'Instruction publique' au 'ministère de l'Éducation nationale' en 1932 ?",
    answers: [
  ...
  // Question n°3
  {
    question: "Quel philosophe des Lumières a fait de la devise 'Sapere aude !' (Ose savoir !) le mot d'ordre de l'émancipation par l'éducation ?",
    answers: [
    ...
    correct: 3,
    explanation: `C'est Emmanuel Kant, dans son texte 'Réponse à la question : Qu'est-ce que les Lumières ?' (1784), qui érige 'Sapere aude !' en devise fondamentale. Pour Kant, les Lumières désignent la sortie de l'homme de sa 'minorité', c'est-à-dire de son incapacité à se servir de son entendement sans la direction d'autrui. L'éducation doit donc cultiver le courage de penser par soi-même, de sortir de la paresse intellectuelle et de la soumission confortable à l'autorité d'un livre, d'un directeur de conscience ou d'un médecin. L'émancipation kantienne est avant tout une auto-émancipation par l'exercice de la raison.\nExemple : Refuser une information parce qu'elle est relayée par une autorité (politique, médiatique) et prendre le temps de la vérifier par soi-même par des sources diverses est un acte concret de 'Sapere aude'.`
  },

  // Question n°4
  {
    question: "Dans 'Gargantua', comment Rabelais caricature-t-il l'éducation scolastique médiévale à travers le personnage de Thubal Holoferne ?",
    answers: [
  ...
  // Question n°5
  {
    question: "Quelle est la célèbre distinction établie par Montaigne dans 'Les Essais' concernant le but de l'éducation ?",
    answers: [
  ...
  // Question n°6
  {
    question: "Quelle conception utilitariste et sociale de l'éducation le modèle réaliste des Lumières, incarné par Lakanal, a-t-il promu ?",
    answers: [
      "Une éducation centrée sur l'étude désintéressée des textes anciens pour former l'esprit.",
      "Une éducation ancrée dans la société et l'économie, privilégiant les savoirs scientifiques et techniques utiles professionnellement.",
  ...
  // Question n°7
  {
    question: "Quel principe fondamental de l'éducation selon Rousseau est énoncé dans cette phrase : 'On ne connaît point l'enfance... Ils cherchent toujours l'homme dans l'enfant' ?",
    answers: [
      ...
      "Le principe de spécificité de l'enfance, qui exige de considérer l'enfant comme un enfant et non comme un adulte miniature."
    ],
    correct: 3,
  ...
  // Question n°8
  {
    question: "Pourquoi, selon Hannah Arendt dans 'La Crise de la culture', la remise en cause contemporaine de l'idée de transmission d'un héritage est-elle problématique ?",
    answers: [
      "Parce qu'elle conduit à un nivellement par le bas, sacrifiant l'exigence et la qualité au nom d'une démocratisation mal comprise.",
  ...
  // Question n°9
  {
    question: "Que signifie, dans la sociologie de Pierre Bourdieu, le concept de 'reproduction' sociale par l'école ?",
    answers: [
      ...
      "L'école fait croire à l'égalité des chances alors qu'elle ne fait que reproduire et légitimer les inégalités sociales préexistantes."
    ],
    correct: 3,
  ...
  // Question n°10
  {
    question: "Comment Michel Foucault, dans 'Surveiller et punir', analyse-t-il la fonction disciplinaire de l'école ?",
    answers: [
      "Comme un lieu de libre épanouissement de l'individu en dehors des contraintes familiales.",
      "Comme un espace analogue à la prison, destiné à produire des corps dociles et des esprits contrôlés pour les besoins de la société productive.",
  ...
  // Question n°11
  {
    question: "Quelle est la 'qualité très spécifique' qui, selon Rousseau dans le 'Discours sur l'inégalité', distingue radicalement l'homme de l'animal ?",
    answers: [
      "La raison théorique, capable de concevoir des idées abstraites.",
      "La perfectibilité, c'est-à-dire la faculté de se perfectionner, de développer ses facultés.",
  ...
  // Question n°12
  {
    question: "Comment Aristote, dans 'Les Parties des animaux', répond-il à l'idée que l'homme est le moins bien doté par la nature ?",
    answers: [
      "Il affirme que la main, outil universel, est la preuve que l'homme est au contraire le mieux doté pour l'adaptation.",
  ...
  // Question n°13
  {
    question: "Quelle est la finalité ultime de l'éducation selon Kant dans son 'Traité de pédagogie' ?",
    answers: [
      ...
      "Discipliner l'animalité, cultiver l'habileté et former la moralité, pour que l'homme choisisse de 'bonnes fins'."
    ],
    correct: 3,
  ...
  // Question n°16
  {
    question: "Selon John Dewey, comment l'éducation doit-elle être conçue pour être véritablement démocratique ?",
    answers: [
      "Comme la transmission rigoureuse d'un canon de grands textes et de savoirs disciplinaires établis.",
      "Comme une investigation active par l'élève, à partir de ses expériences, intégrant savoirs et capacités sociales comme la coopération.",
  ...
  // Question n°17
  {
    question: "Quel risque majeur Tocqueville associe-t-il à l'éducation nationale dans les démocraties ?",
    answers: [
      "Le risque de l'élitisme, créant une nouvelle aristocratie du savoir.",
      "Le risque de l'homogénéisation et de l'uniformisation des esprits, au détriment de la diversité et de la liberté.",
  ...
  // Question n°18
  {
    question: "Pourquoi, selon Durkheim, l'éducation est-elle avant tout un processus de 'socialisation' ?",
    answers: [
      "Parce qu'elle se déroule nécessairement dans un cadre collectif, l'école, et non à la maison.",
      "Parce qu'elle a pour fonction de créer, à partir de l'être égoïste et asocial qu'est l'enfant à la naissance, un être moral et social capable de vivre en société.",
  ...
  // Question n°19
  {
    question: "Quel mécanisme Simone de Beauvoir analyse-t-elle dans 'Le Deuxième Sexe' comme aliénant spécifiquement l'éducation des filles ?",
    answers: [
      "Le fait qu'on leur apprend à être autonomes et compétitives, à l'image des garçons.",
      "Le conflit fondamental qu'on instaure en elles entre leur existence autonome de sujet et leur 'être-objet' destiné à plaire.",
  ...
  // Question n°20
  {
    question: "Que dénonce Elena Gianini Belotti à propos des personnages féminins dans les contes traditionnels comme 'Blanche-Neige' ou 'Cendrillon' ?",
    answers: [
      "Leur intelligence et leur ruse, qui leur permettent toujours de triompher des méchants.",
      "Leur beauté et leur vertu domestique, présentées comme des dons naturels et non comme des mérites, et leur salut qui dépend toujours d'un homme.",
  ...
  // Question n°21
  {
    question: "Comment Victor Hugo, dans son poème 'Chaque enfant qu'on enseigne', justifie-t-il l'importance de l'éducation pour tous ?",
    answers: [
  ...
  // Question n°22
  {
    question: "Quelle est la critique principale adressée par Bourdieu à la recommandation de Rousseau d'adapter l'éducation à chaque élève ?",
    answers: [
  ...
  // Question n°23
  {
    question: "Que signifie le concept d'éducation 'négative' défendu par Rousseau dans 'Émile' ?",
    answers: [
      "Une éducation qui consiste à corriger les défauts et les vices de l'enfant par la punition.",
      "Une éducation qui suit et préserve le développement naturel de l'enfant plutôt que d'imposer précocement des savoirs.",
  ...
  // Question n°24
  {
    question: "Selon Condorcet, pourquoi l'égalité politique proclamée par la Déclaration des droits de l'homme nécessite-t-elle l'égalité dans l'éducation ?",
    answers: [
      "Parce que seuls les citoyens instruits peuvent occuper des postes de responsabilité.",
      "Parce que l'article 6 de la Déclaration, qui promet l'accès aux emplois selon les capacités, serait vide de sens sans une éducation permettant de développer ces capacités indépendamment de la naissance.",
  ...
  // Question n°27
  {
    question: "Quel constat alarmant l'OCDE tire-t-elle des résultats PISA 2018 concernant la France, cité par Angel Gurría ?",
    answers: [
      "La France est championne en mathématiques mais très faible en compréhension de l'écrit.",
      "La France est l'un des pays où le poids de l'origine sociale pèse le plus sur la performance scolaire, créant une forte fracture.",
  ...
  // Question n°28
  {
    question: "Quelle est la fonction de l'éducation selon la conception 'réaliste' des Lumières, par opposition à la conception humaniste ?",
    answers: [
      "Former un 'honnête homme' cultivé dans tous les domaines.",
      "Donner à l'enfant la capacité de remplir ses fonctions dans la société et l'économie.",
  ...
  // Question n°29
  {
    question: "Pourquoi Rousseau critique-t-il l'usage de la punition et de la récompense dans l'éducation morale de l'enfant ?",
    answers: [
      "Parce qu'elles sont inefficaces et que l'enfant finit toujours par désobéir.",
      "Parce qu'elles ne font que produire une obéissance intéressée ou craintive, sans développer le jugement moral authentique.",
  ...
  // Question n°30
  {
    question: "Que signifie l'idée, attribuée à Paul Valéry et Catherine Kintzler, que 'penser, c'est se disputer avec soi-même' dans le contexte de l'émancipation ?",
    answers: [
      "Que la pensée authentique est nécessairement conflictuelle et agressive.",
      "Que l'émancipation par la pensée implique de sortir de l'individualisme en mettant à distance et en critiquant ses propres opinions.",
  ...
  // Question n°31
  {
    question: "Comment Arendt conçoit-elle le rapport paradoxal entre éducation et nouveauté dans 'La Crise de l'éducation' ?",
    answers: [
      "L'éducation doit tout révolutionner pour préparer les enfants au monde nouveau.",
      "Pour préserver la nouveauté révolutionnaire de chaque enfant, l'éducation doit être conservatrice et lui transmettre un monde ancien.",
      "L'éducation est par nature incapable de faire face à la nouveauté, qui ne peut venir que de l'expérience extra-scolaire."
    ],
    correct: 2,
  ...
  // Question n°32
  {
    question: "Quelle est la différence entre le 'trivium' et le 'quadrivium' dans le modèle scolastique médiéval ?",
    answers: [
      "Le trivium concerne les études religieuses, le quadrivium les études profanes.",
      "Le trivium regroupe les arts de la parole (grammaire, rhétorique, dialectique), le quadrivium les arts du nombre (géométrie, arithmétique, astronomie, musique).",
      "Le trivium est enseigné aux enfants, le quadrivium aux adolescents et aux adultes."
    ],
    correct: 2,
  ...
  // Question n°33
  {
    question: "Quel est le rôle de la 'nature' dans l'éducation selon Rousseau, par rapport aux livres ?",
    answers: [
      ...
      "Il faut mettre l'enfant à l'écoute de la nature et des choses plutôt que des livres, qu'il 'haït' car ils n'apprennent 'qu'à parler de ce qu'on ne sait pas'."
    ],
    correct: 3,
  ...
  // Question n°34
  {
    question: "En quoi la notion d' 'hétérotopie', utilisée par Foucault, peut-elle s'appliquer à l'école ?",
    answers: [
      "L'école est une utopie réalisée, un lieu idéal et parfait.",
      "L'école est un 'autre lieu' réel qui fonctionne comme une parenthèse, un espace du dehors à l'intérieur de la société.",
  ...
  // Question n°35
  {
    question: "Que recommande Kant concernant l'éducation d'un enfant qui 'ne fait rien pour être agréable' ?",
    answers: [
      ...
      "Ne rien faire non plus pour lui être agréable, pour qu'il expérimente par lui-même la réciprocité des relations."
    ],
    correct: 3,
  ...
  // Question n°36
  {
    question: "Quel est l'objectif central de la 'pédagogie rationnelle' que Bourdieu appelle de ses vœux pour lutter contre les inégalités ?",
    answers: [
      "Une pédagogie entièrement informatisée et personnalisée par l'intelligence artificielle.",
      "Une pédagogie qui explicite les règles du jeu scolaire et organise les études pour compenser activement les désavantages initiaux.",
      "Une pédagogie qui supprime toute évaluation et tout classement pour ne pas stigmatiser les élèves en difficulté."
    ],
    correct: 2,
  ...
  // Question n°37
  {
    question: "Comment Erasme, dans son 'Traité de civilité puérile', s'oppose-t-il au modèle scolastique ?",
    answers: [
      "En prônant une éducation purement religieuse et ascétique, rejetant les arts libéraux.",
      "En défendant une éducation où l'enfant est actif et cherche par lui-même, plutôt que passif et 'abruit' par l'érudition.",
      "En proposant un enseignement strictement militaire et physique pour former des soldats chrétiens."
    ],
    correct: 2,
    explanation: `Érasme, humaniste comme Rabelais et Montaigne, rejette la pédagogie médiévale de la mémorisation mécanique et de l'autorité incontestée du maître. Son 'De civilitate morum puerilium' (Traité de la civilité puérile) insiste sur l'importance de former l'enfant à la politesse, aux bonnes manières et à la maîtrise de soi, mais dans un esprit nouveau. Il veut que l'enfant soit actif dans son apprentissage, qu'il cultive la curiosité et le goût de la découverte. L'étude de la Bible et des textes anciens est maintenue, mais elle doit être une connaissance vivante et personnelle, non une érudition morte accumulée pour briller. Il s'agit de former un être humain équilibré, capable de raisonner et de se comporter avec élégance dans la société.\nExemple : Apprendre les règles de la conversation polie, savoir se tenir à table, respecter ses aînés, tout en cultivant son esprit par la lecture personnelle des textes, tel est l'idéal érasmien, loin du psittacisme scolastique.`
  },

  // Question n°38
  {
    question: "Quelle critique peut-on adresser aux politiques de 'discrimination positive' mises en place en France (comme la CPGE pour boursiers à Henri IV) ?",
    answers: [
      "Elles sont présentées comme la solution miracle qui a résolu les inégalités scolaires.",
      "Elles sont présentées comme des mesures d'équité visant à compenser les inégalités en donnant plus à ceux qui ont moins, mais leur efficacité est limitée.",
      "Elles sont dénoncées comme une forme de racisme anti-majoritaire qui pénalise les enfants des classes moyennes."
    ],
    correct: 2,
  ...
  // Question n°39
  {
    question: "Que signifie l'idée que l'homme, selon Rousseau, est 'organisé le plus avantageusement de tous' les animaux ?",
    answers: [
      "Il est le plus fort et le plus rapide physiquement.",
      "Sa faiblesse native et son absence de spécialisation sont ses atouts, car elles le rendent adaptable et perfectible.",
  ...
  // Question n°40
  {
    question: "Quelle distinction Kant opère-t-il entre 'impératif catégorique' et 'impératif hypothétique' dans le domaine de l'éducation morale ?",
    answers: [
      "L'impératif catégorique s'adresse aux enfants, l'impératif hypothétique aux adultes.",
      "L'impératif catégorique commande inconditionnellement ('tu dois'), l'impératif hypothétique est conditionnel ('si tu veux ceci, alors tu dois faire cela').",
  ...
  // Question n°41
  {
    question: "Quelle est la fonction principale de l'école primaire selon Jules Ferry, telle qu'elle ressort de ses lois de 1881-1882 ?",
    answers: [
      "Préparer une élite pour les grandes écoles et l'enseignement supérieur.",
      "Éduquer le plus grand nombre aux valeurs de la République, à la laïcité et aux 'savoirs de base' (lire, écrire, compter).",
  ...
  // Question n°42
  {
    question: "Comment le concept de 'capital social', évoqué par Arendt, est-il lié aux inégalités scolaires ?",
    answers: [
      "Le capital social, c'est l'argent que les parents investissent dans les cours particuliers.",
      "Le capital social désigne le réseau de relations qui peut favoriser l'orientation et l'insertion professionnelle, et son accès inégal aggrave les inégalités scolaires.",
      "Le capital social est la somme des connaissances accumulées par un élève tout au long de sa scolarité."
    ],
    correct: 2,
  ...
  // Question n°45
  {
    question: "Quel rôle Condorcet assigne-t-il à l'instruction dans la lutte contre les 'préjugés' et le 'charlatanisme' ?",
    answers: [
      "Aucun, car les préjugés sont naturels et inévitables.",
      "Un rôle central : l'instruction donne les outils intellectuels pour juger par soi-même et se défendre contre la manipulation.",
  ...
  // Question n°46
  {
    question: "Comment John Dewey conçoit-il le lien entre l'éducation et la démocratie ?",
    answers: [
      ...
      "L'école doit être une micro-société démocratique où l'on apprend par la coopération et le débat, formant ainsi les dispositions nécessaires à la vie démocratique."
    ],
    correct: 3,
  ...
  // Question n°47
  {
    question: "Quelle est la critique de Foucault concernant ce que les élèves apprennent (ou n'apprennent pas) à l'école, selon 'Les Mots et les choses' ?",
    answers: [
      "Ils apprennent trop de choses inutiles et pas assez de compétences pratiques.",
      "Ils apprennent à connaître, mais pas à 'se connaître', à 'prendre soin d'eux-mêmes' et à 'penser par eux-mêmes'.",
      "Ils apprennent des savoirs dépassés qui ne correspondent plus au monde moderne."
    ],
    correct: 2,
    explanation: `Foucault, dans sa critique des institutions, distingue différents régimes de savoir. L'école traditionnelle, selon lui, transmet un savoir objectif, disciplinaire, organisé en champs de connaissances (histoire, géographie, mathématiques). Mais elle néglige ce que les Grecs appelaient l' 'epimeleia heautou', le 'souci de soi'. Il s'agit d'un savoir-être, d'une pratique de soi qui permet de se constituer comme sujet éthique, de travailler sur ses passions, de développer une relation à soi et aux autres qui n'est pas de pure soumission ou de pure consommation de savoirs. Pour Foucault, une éducation complète devrait inclure cet apprentissage de la liberté intérieure, de la maîtrise de soi et de la pensée autonome, au-delà de l'acquisition des connaissances canoniques.\nExemple : Un cours de philosophie qui se limiterait à l'histoire des doctrines sans jamais inviter l'élève à s'interroger sur sa propre vie, ses désirs, ses choix, manquerait selon Foucault à cette dimension essentielle de la 'culture de soi'.`
  },

  // Question n°48
  {
    question: "Que révèlent les statistiques citées sur le vocabulaire des enfants de 2 ans selon leur milieu social ?",
    answers: [
      ...
      "Les enfants de classes supérieures ont un vocabulaire légèrement plus étendu, montrant un avantage culturel très précoce."
    ],
    correct: 3,
  ...
  // Question n°49
  {
    question: "Comment Simone de Beauvoir analyse-t-elle la construction sociale de la 'féminité' à travers l'éducation ?",
    answers: [
      ...
      "La féminité est 'devenue' un destin par une éducation qui apprend aux filles à se faire objet passif et à renoncer à leur autonomie de sujet."
    ],
    correct: 3,
  ...
  // Question n°50
  {
    question: "Quelle est la signification politique du principe de laïcité instauré par Jules Ferry à l'école ?",
    answers: [
      "Interdire toute manifestation religieuse pour créer un espace totalement athée.",
      "Séparer les croyances religieuses (privées et libres) des connaissances et de la morale civique (communes à tous), pour unir la nation autour d'un socle républicain partagé.",
  ...
  // Question n°51
  {
    question: "Que permet de comprendre l'étude des 'figures passées de l'éducation' (scolastique, humaniste, réaliste, rousseauiste) ?",
    answers: [
      "Que l'éducation a toujours été la même à travers les siècles.",
      "Que les modèles éducatifs sont historiquement situés et répondent à des conceptions différentes de l'homme, du savoir et de la société.",
      "Que le progrès en éducation est linéaire, chaque modèle remplaçant et améliorant le précédent."
    ],
    correct: 2,
  ...
  // Question n°52
  {
    question: "En quoi l'école peut-elle être considérée, selon Foucault, comme une 'hétérotopie de crise' ?",
    answers: [
      ...
      "Parce qu'elle est un lieu de passage obligé et ritualisé pour une classe d'âge en transition (l'enfance vers l'âge adulte)."
    ],
    correct: 3,
  ...
  // Question n°53
  {
    question: "Quelle est la conséquence du principe de perfectibilité, selon Rousseau, sur la responsabilité de l'éducateur ?",
    answers: [
      "L'éducateur est totalement déresponsabilisé, car l'enfant se perfectionne tout seul.",
      "L'éducateur porte une responsabilité immense, car l'homme n'est que ce que l'éducation fait de lui ; la perfectibilité peut produire le pire comme le meilleur.",
  ...
  // Question n°54
  {
    question: "Comment le déisme des Lumières, évoqué à propos de Kant, influence-t-il sa conception de l'éducation morale ?",
    answers: [
      ...
      "Il sépare la morale de la religion révélée : la norme morale est la raison elle-même et l'impératif catégorique, rendant Dieu comme hypothèse inutile pour fonder l'obligation."
    ],
    correct: 3,
  ...
  // Question n°57
  {
    question: "Comment Durkheim définit-il le rapport entre l'éducation et la société ?",
    answers: [
      ...
      "L'éducation est le moyen par lequel la société se régénère et assure sa continuité en créant des êtres sociaux à son image."
    ],
    correct: 3,
  ...
  // Question n°58
  {
    question: "Que critique Elena Gianini Belotti dans la représentation des 'bonnes fées' des contes ?",
    answers: [
      "Leur laideur et leur méchanceté, qui effraient les enfants.",
      "Le fait qu'elles n'utilisent pas leurs ressources personnelles (intelligence, courage) mais seulement un pouvoir magique extérieur, ne fournissant pas de modèle de compétence féminine active.",
      "Leur absence totale dans les contes, laissant les héroïnes sans protection."
    ],
    correct: 2,
  ...
  // Question n°59
  {
    question: "Quel est le sens de la formule d'Arendt : 'éduquer pour un monde déjà hors de ses gonds' ?",
    answers: [
      "Il faut éduquer à la révolution permanente pour détruire l'ordre établi.",
      "Parce que le monde est créé par des mortels, il est toujours en train de vieillir et de décliner ; l'éducation doit préparer les nouveaux venus à y vivre et à le renouveler.",
  ...
  // Question n°60
  {
    question: "Quelle est la tension principale que cherche à résoudre l'éducation, selon la synthèse proposée en introduction de la séquence ?",
    answers: [
      "La tension entre coût et efficacité.",
      "La tension entre transmission d'un héritage (conservation) et émancipation de l'individu (libération).",
  ...
  // Question n°61
  {
    question: "Pourquoi l'enfant est-il appelé 'infans' en latin, et quelle conséquence Rousseau en tire-t-il pour l'éducation ?",
    answers: [
      "Infans signifie 'sans parole' ; l'éducation doit donc commencer par le développement du langage avant toute chose.",
      "Infans signifie 'sans défense' ; l'éducation doit donc être protectrice et sécurisante.",
      "Infans signifie 'qui ne parle pas' ; Rousseau en tire que l'éducation première doit passer par les choses et l'expérience sensible plutôt que par des discours."
    ],
    correct: 3,
    explanation: `L'étymologie est ici éclairante. 'Infans' signifie littéralement 'celui qui ne parle pas'. Rousseau en conclut que les premières éducations doivent être muettes. Avant d'être capable de comprendre des raisonnements et des préceptes verbaux, l'enfant perçoit le monde par ses sens. L'éducation doit donc s'adresser d'abord à cette sensibilité, par 'la peinture vive et naïve' des choses, par l'expérience directe. C'est le fondement de sa pédagogie 'négative' et de sa méfiance envers les livres et les longs discours. Il faut laisser les choses parler d'elles-mêmes, laisser l'enfant se heurter aux conséquences naturelles de ses actes, plutôt que de lui faire des sermons qu'il ne comprend pas. Le langage viendra ensuite, pour nommer et organiser les expériences déjà vécues.\nExemple : Pour apprendre la notion de chaleur à un jeune enfant, Rousseau préfère qu'il approche prudemment sa main du feu et ressente la sensation de brûlure (expérience contrôlée), plutôt qu'on lui explique verbalement le danger.`
  },

  // Question n°62
  {
    question: "Comment la notion de 'mérite', dans le système scolaire, peut-elle servir à légitimer les inégalités selon Bourdieu ?",
    answers: [
      "En rendant les inégalités invisibles, puisque tout le monde a théoriquement les mêmes chances.",
      "En attribuant les réussites et les échecs à des qualités personnelles (intelligence, travail) plutôt qu'à des avantages sociaux hérités, ce qui rend les inégalités socialement acceptables.",
  ...
  // Question n°63
  {
    question: "Quelle est la place de la Bible et de la religion dans le modèle éducatif humaniste de Rabelais et d'Érasme ?",
    answers: [
      "Elles sont rejetées au profit exclusif des textes antiques païens.",
      "Elles restent centrales, mais doivent être étudiées dans un esprit de recherche personnelle et de piété éclairée, non comme un dogme imposé.",
      "Elles sont réduites à un objet d'étude historique et critique, sans dimension spirituelle."
    ],
    correct: 2,
  ...
  // Question n°64
  {
    question: "Quelle est la différence entre 'égalité des chances' et 'équité' dans les politiques éducatives ?",
    answers: [
      "L'égalité des chances vise à donner strictement la même chose à tous, l'équité à donner plus à ceux qui ont moins pour compenser les inégalités initiales.",
  ...
  // Question n°65
  {
    question: "Comment Kant justifie-t-il la nécessité de la contrainte dans l'éducation ?",
    answers: [
      "La contrainte est un mal nécessaire pour maintenir l'ordre dans la classe.",
      "La contrainte est le moyen de discipliner l'animalité et de forger la volonté, afin de rendre possible l'accès futur à l'autonomie de la raison.",
      "La contrainte n'est jamais justifiée ; l'éducation doit être entièrement libre pour être authentique."
    ],
    correct: 2,
  ...
  // Question n°66
  {
    question: "Quelle est la critique implicite que l'on peut porter à des lycées sélectifs ?",
    answers: [
      "Ils illustrent la persistance d'une ségrégation scolaire basée sur la condition sociale, contraire à l'idéal d'égalité.",
      "Ils sont des modèles d'excellence pédagogique que l'école publique devrait imiter.",
      "Ils prouvent que la mixité sociale est parfaitement réalisée dans le système éducatif français."
    ],
    correct: 1,
    explanation: `Un lycée très sélectif et coûteux poser la question de l'égalité réelle entre les élèves. L'école mixte (garçons/filles) et l'absence de classe réservée aux HPI (enfants intellectuellement précoces) sont des avancées vers l'égalité formelle. Mais elles masquent des inégalités profondes de condition sociale qui se traduisent par une ségrégation géographique et économique entre établissements. Les enfants de milieux favorisés se concentrent dans certains établissements aux résultats excellents, tandis que d'autres établissements concentrent les difficultés sociales et scolaires. L'égalité des chances est ainsi vidée de son sens par la réalité de la carte scolaire et des stratégies familiales.\nExemple : Un enfant dont les parents peuvent payer des cours ou déménager dans un quartier huppé pour avoir accès à un bon lycée a des 'chances' bien supérieures à un enfant dont la famille n'a pas ces ressources, même si officiellement ils ont tous les deux le droit d'aller au lycée.`
  },

  // Question n°67
  {
    question: "En quoi le concept de 'pédagogie différenciée' peut-il être vu comme un héritier lointain de la pensée de Rousseau ?",
    answers: [
      "Parce qu'elle prône un retour à la nature et l'abolition des programmes scolaires.",
      "Parce qu'elle part du principe qu'il faut adapter l'enseignement aux capacités, au rythme et aux intérêts de chaque enfant, et non appliquer un programme uniforme à tous.",
  ...
  // Question n°68
  {
    question: "Que signifie l'affirmation de Kant : 'L'homme est la seule créature qui soit susceptible d'éducation' ?",
    answers: [
      "Seul l'homme a inventé des écoles et des systèmes éducatifs formels.",
      "Seul l'homme a besoin d'être éduqué parce qu'il est le seul à naître dans un état d'immaturité totale et de perfectibilité.",
  ...
  // Question n°69
  {
    question: "Comment Arendt définit-elle la 'crise de l'éducation' dans le monde moderne ?",
    answers: [
      "Une crise financière due au coût croissant des systèmes éducatifs.",
      "Une crise d'autorité et de transmission, où l'on a cessé de croire qu'il fallait introduire l'enfant dans un monde commun préexistant.",
  ...
  // Question n°73
  {
    question: "Quelle est la thèse défendue par Condorcet dans son 'Esquisse d'un tableau historique des progrès de l'esprit humain' concernant le lien entre instruction et progrès ?",
    answers: [
      "Le progrès de l'esprit humain (l'accumulation des connaissances) doit être diffusé par l'instruction pour amener le progrès social et moral de l'humanité.",
  ...
  // Question n°74
  {
    ...
    answers: [
      ...
      "Comme un dispositif de surveillance et de normalisation qui classe, hiérarchise et sanctionne, produisant ainsi des individus 'dociles et utiles'."
    ],
    correct: 3,
  ...
  // Question n°75
  {
    question: "Que signifie l'idée que l'éducation, selon Rousseau, doit se faire 'par les choses' plutôt que 'par les mots' ?",
    answers: [
      "Il faut remplacer tous les livres par des objets à manipuler.",
      "Il faut privilégier l'expérience sensible et les leçons que l'enfant tire lui-même de ses actions et de leurs conséquences naturelles, plutôt que les explications verbales et les préceptes.",
  ...
  // Question n°76
  {
    question: "Quel est l'objectif de l'éducation morale à l'école selon la 'Lettre aux instituteurs' de Jules Ferry ?",
    answers: [
      "Remplacer la morale religieuse par une morale athée fondée sur la science.",
      "Enseigner une morale laïque, fondée sur la raison et le droit, qui constitue le socle commun des valeurs républicaines indispensables à la vie en société.",
  ...
  // Question n°77
  {
    question: "Comment Bourdieu et Passeron expliquent-ils que l'école puisse être perçue comme juste tout en reproduisant les inégalités ?",
    answers: [
      "Par une manipulation consciente des élites qui contrôlent les programmes.",
      "Parce qu'elle utilise le mérite comme critère de sélection, ce qui masque l'inégalité des chances réelles et fait croire que les vainqueurs méritent leur succès.",
      "Parce que les enseignants sont majoritairement issus des classes populaires et favorisent inconsciemment leurs semblables."
    ],
    correct: 2,
  ...
  // Question n°78
  {
    question: "Quelle est la place de l'étude des langues dans le programme humaniste de Rabelais pour Pantagruel ?",
    answers: [
      "Les langues sont inutiles, seul compte le fond des idées.",
      "Il faut se concentrer sur le français, la langue nationale.",
      "Il faut apprendre le grec, le latin, l'hébreu, les langues vulgaires (vivantes) pour avoir un accès direct aux textes et aux cultures."
    ],
    correct: 3,
  ...
  // Question n°81
  {
    question: "Quelle est la fonction des 'écoles normales' créées par Lakanal ?",
    answers: [
      "Former une élite normale, c'est-à-dire conforme aux valeurs républicaines.",
      "Former les enseignants, en leur apprenant à enseigner selon des méthodes standardisées ('qui font norme').",
  ...
  // Question n°82
  {
    question: "Comment Rousseau conçoit-il le rapport entre liberté de l'enfant et éducation ?",
    answers: [
      "L'enfant doit être entièrement libre, sans aucune contrainte ni directive.",
      "L'éducateur doit canaliser la nature de l'enfant et organiser son environnement pour qu'il apprenne par l'expérience, plutôt que de le contraindre par des interdits et des ordres.",
  ...
  // Question n°83
  {
    question: "Quelle est la différence entre la vision de l'éducation comme 'viatique' et comme 'propédeutique' évoquée à propos de Jules Ferry ?",
    answers: [
      "Le viatique est un secours pour la vie entière (école primaire), la propédeutique est une préparation à des études supérieures (lycée).",
      "Le viatique est religieux, la propédeutique est laïque.",
      "Le viatique concerne les filles, la propédeutique les garçons."
    ],
    correct: 1,
  ...
  // Question n°84
  {
    question: "Que signifie l'expression 'sortir de la minorité' chez Kant, et quel est son lien avec l'éducation ?",
    answers: [
      "Devenir majeur juridiquement, à 18 ans.",
      "Sortir de l'état de dépendance intellectuelle où l'on se contente de suivre l'autorité d'un livre, d'un directeur ou d'un médecin, pour penser par soi-même à l'aide de sa propre raison.",
      "Quitter le domicile familial pour vivre de façon indépendante."
    ],
    correct: 2,
    explanation: `La 'minorité' chez Kant n'est pas d'abord un âge légal, mais un état intellectuel et moral. C'est 'l'incapacité de se servir de son entendement sans la direction d'autrui'. Le mineur est paresseux et lâche ; il préfère qu'un livre pense pour lui, qu'un directeur de conscience décide du bien et du mal, qu'un médecin choisisse son régime. Sortir de cette minorité, c'est avoir le courage ('Sapere aude !') d'utiliser sa propre raison pour comprendre le monde, juger moralement et prendre ses décisions. L'éducation a précisément pour but de développer cette capacité à l'auto-direction rationnelle. Elle doit nous apprendre à nous passer progressivement de tuteurs, à devenir nos propres guides. C'est en ce sens que l'éducation est émancipation : elle nous libère de la tutelle des autres pour nous rendre à nous-mêmes.\nExemple : Un étudiant qui, au lieu de recopier passivement le cours du professeur, va chercher d'autres sources, les confronte, et se forge sa propre compréhension du sujet, pratique cette sortie de la minorité intellectuelle.`
  },

  // Question n°85
  {
    question: "Comment interprèter les politiques de discrimination positive comme une réponse aux critiques de Bourdieu et Foucault ?",
    answers: [
      "Comme une preuve que leurs critiques étaient infondées et que le système se corrige de lui-même.",
      "Comme des mesures d'équité qui tentent de corriger les inégalités pointées par Bourdieu, mais sans remettre en cause fondamentalement les mécanismes de pouvoir analysés par Foucault.",
  ...
  // Question n°86
  {
    question: "Quelle est la signification de la 'maladresse' selon la remarque faite à propos de Rousseau ?",
    answers: [
      "Un défaut naturel qu'il faut corriger par des exercices de psychomotricité.",
      "Un signe de bêtise et d'incapacité à s'adapter.",
      "Un phénomène spécifiquement humain, lié à la conscience et à la perfectibilité, que l'animal ne connaît pas."
    ],
    correct: 3,
  ...
  // Question n°87
  {
    question: "Comment la Révolution française a-t-elle investi l'école d'une nouvelle mission selon le modèle réaliste ?",
    answers: [
      "L'école doit désormais former des prêtres citoyens pour la nouvelle religion révolutionnaire.",
      "L'école devient l'instrument chargé de donner à l'enfant 'la capacité de remplir ses fonctions dans la société'.",
  ...
  // Question n°88
  {
    question: "Quel est l'idéal de l'éducation selon les humanistes de la Renaissance, par opposition aux sophistes et aux scolastiques ?",
    answers: [
      "Former des spécialistes techniques très pointus.",
      "Former des orateurs habiles à persuader par tous les moyens, y compris la tromperie.",
      "Former un 'honnête homme' ou un 'homme universel', libre de pensée, ouvert à tous les savoirs, cultivant l'esprit critique et les arts de la parole (rhétorique vraie)."
    ],
    correct: 3,
    explanation: `Les humanistes (Rabelais, Érasme, Montaigne) réagissent contre deux modèles qu'ils rejettent. Contre les sophistes antiques (qu'ils connaissent par Platon), ils refusent une rhétorique purement instrumentale, détachée de la vérité. Contre les scolastiques médiévaux, ils rejettent une éducation livresque, dogmatique, fondée sur la mémorisation et l'autorité incontestée. Leur idéal est celui de l'''uomo universale'' : un être cultivé dans tous les domaines (lettres, sciences, arts), capable de penser par lui-même, de juger avec discernement, de s'exprimer avec éloquence et élégance, et de vivre une vie vertueuse. L'éducation doit allumer un feu (curiosité, amour du savoir) plutôt que remplir un vase. Elle vise la formation intégrale de la personne, non l'utilité immédiate.\nExemple : Léonard de Vinci incarne cet idéal : artiste de génie, il est aussi ingénieur, anatomiste, architecte, musicien, témoignant d'une curiosité insatiable et d'une volonté de comprendre tous les aspects du monde.`
  },

  // Question n°89
  {
    question: "Comment Arendt conçoit-elle le lien entre éducation et natalité (le fait que des êtres nouveaux naissent sans cesse) ?",
    answers: [
      "L'éducation est inutile car chaque génération recommence à zéro.",
      "L'éducation est la réponse à ce défi : comment introduire ces êtres nouveaux, ces 'nouveautés radicales', dans un monde ancien qui les précède ?",
      "La natalité prouve que l'éducation doit être entièrement tournée vers l'avenir et rompre avec le passé."
    ],
    correct: 2,
  ...
  // Question n°90
  {
    question: "Quelle est la critique de Rousseau concernant l'éducation par l'interdit ?",
    answers: [
      "Les interdits sont toujours injustes car ils limitent la liberté naturelle.",
      "L'interdit, en frustrant l'enfant, ne fait que reporter et renforcer son désir de transgression, sans lui faire comprendre la raison de la règle.",
  ...
  // Question n°91
  {
    question: "Que signifie l'idée que l'éducation vise à 'rendre populaire la raison' (cf. Condorcet) ?",
    answers: [
      "Adapter la raison aux goûts du peuple, quitte à la simplifier à l'extrême.",
      "Diffuser les lumières de la raison dans l'ensemble de la population, et non les réserver à une élite, pour que chacun puisse juger par lui-même.",
  ...
  // Question n°93
  {
    ...
    answers: [
      ...
      "La volonté de faire du baccalauréat un diplôme sanctionnant la fin des études secondaires pour la grande majorité, et non plus un diplôme élitiste, afin de démocratiser l'accès à l'enseignement supérieur.",
  ...
  // Question n°94
  {
    question: "Comment l'éducation peut-elle contribuer à l'émancipation 'générationnelle' selon Arendt ?",
    answers: [
      "En enseignant aux enfants à mépriser et rejeter le monde de leurs parents.",
      "En transmettant les méthodes de travail et les savoirs des générations précédentes, ce qui donne aux nouveaux venus les outils pour en faire émerger de nouvelles et transformer le monde.",
  ...
  // Question n°95
  {
    question: "Quelle est la conception de l'enfant selon la formule de Rousseau : 'La nature veut que les enfants soient enfants avant que d'être hommes' ?",
    answers: [
      "L'enfant est un adulte en miniature, qu'il faut former le plus tôt possible.",
      "L'enfant a une valeur et une dignité propres en tant qu'enfant ; il faut respecter et accompagner les étapes de son développement naturel, sans vouloir brûler les étapes.",
  ...
  // Question n°96
  {
    question: "Quel est le rôle de l'école dans la formation du 'capital social' selon les analyses contemporaines évoquées par Arendt ?",
    answers: [
      "L'école est le principal lieu d'acquisition du capital social pour tous, indépendamment de l'origine.",
      "L'école peut, si elle n'y prend pas garde, renforcer les inégalités de capital social, car les relations qui s'y nouent reproduisent souvent les clivages sociaux extérieurs.",
  ...
  // Question n°97
  {
    question: "Comment Montaigne critique-t-il les châtiments corporels dans l'éducation ?",
    answers: [
      "Il les trouve inefficaces car les enfants finissent par s'y habituer.",
      "Il les assimile à un dressage animal ('on dresse les instruits') qui brime l'esprit au lieu de l'éveiller.",
      "Il les approuve comme un mal nécessaire pour maintenir la discipline."
    ],
    correct: 2,
    expression: `Montaigne, dans 'Les Essais', exprime une vive réprobation contre la violence éducative. Pour lui, frapper un enfant, c'est le traiter comme un animal que l'on dresse par la peur et la douleur. Cette méthode peut obtenir une obéissance extérieure, mais elle tue dans l'œuf l'essentiel : la curiosité, le plaisir d'apprendre, la liberté de l'esprit. Elle produit des élèves soumis et craintifs, non des esprits éveillés et critiques. Montaigne prône au contraire une éducation douce, qui 'éveille l'esprit de l'enfant', qui lui donne 'le goût d'apprendre'. Il faut que l'enfant aime son maître et respecte son savoir, non qu'il le craigne. La finalité étant la 'liberté de pensée', elle ne peut s'accommoder d'une pédagogie de la contrainte et de la terreur.\nExemple : Montaigne raconte comment son propre précepteur, humaniste, avait su lui faire aimer l'étude en mêlant le jeu et l'apprentissage, sans jamais recourir aux coups.`
  },

  // Question n°98
  {
    question: "Quelle est la signification de l' 'individualisme' dans la critique de Rousseau, et comment l'éducation doit-elle y répondre ?",
    answers: [
      "L'individualisme est une vertu à cultiver : il faut centrer l'éducation sur l'épanouissement personnel de l'enfant.",
      "L'individualisme est un danger qui consiste à centrer le sujet sur lui-même ; l'éducation doit l'en libérer en le mettant à l'écoute des autres et de la nature.",
  ...
  // Question n°99
  {
    question: "Comment Erasme conçoit-il l'étude de la Bible par rapport au modèle scolastique ?",
    answers: [
      "Comme un texte à apprendre par cœur dans la version latine de la Vulgate, sans discussion.",
      "Comme un objet d'étude historique et philologique, à lire dans les langues originales (grec, hébreu) pour en comprendre le sens véritable par soi-même.",
      "Comme un livre dangereux qu'il vaut mieux ne pas mettre entre les mains des laïcs."
    ],
    correct: 2,
    explanation: `Érasme incarne le projet humaniste chrétien. Il s'oppose à la pratique scolastique qui consistait à commenter à l'infini la Vulgate (traduction latine officielle) et les commentaires des Pères de l'Église, sans jamais revenir au texte source. Pour lui, il faut retourner 'ad fontes' (aux sources). Cela signifie apprendre le grec et l'hébreu pour lire la Bible dans sa langue d'origine, afin d'en saisir le sens exact et l'esprit. Cette étude n'est pas réservée aux clercs ; elle doit être accessible à tout chrétien éclairé. Elle doit être une recherche personnelle, guidée par la piété et la raison, non une réception passive d'un dogme imposé. Érasme édite ainsi le Nouveau Testament en grec, y apportant des corrections philologiques qui auront un impact considérable sur la Réforme protestante.\nExemple : En traduisant le mot grec 'metanoeite' par 'repentez-vous' (changez d'esprit) plutôt que par 'faites pénitence', Érasme propose une interprétation plus intérieure et spirituelle du repentir, en opposition aux pratiques extérieures de pénitence vendues par l'Église.`
  },

  // Question n°100
  {
    question: "Quelle conclusion tirer sur l'état du système éducatif français aujourd'hui, à la lumière des critiques de Bourdieu et des données de l'OCDE ?",
    answers: [
      "Le système français est parfaitement équitable et a résolu le problème des inégalités sociales.",
      "Malgré une massification quantitative réussie (beaucoup de diplômés), le système français reste l'un des plus inéquitaires de l'OCDE, où l'origine sociale pèse très lourd sur la réussite scolaire, et où les inégalités culturelles et linguistiques précoces ne sont pas compensées.",
