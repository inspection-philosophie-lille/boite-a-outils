...
const questions = [
  // Question n°1
  {
    question: "Que signifie étymologiquement le terme 'expression', tel qu'il est défini en introduction de la séquence ?",
    answers: [
  ...
  // Question n°2
  {
    ...
    correct: 2,
    explanation: `Dans le mythe de l'attelage ailé, Platon utilise une allégorie pour décrire la structure de l'âme. Le cocher représente la raison (le 'logistikon'), chargée de diriger l'ensemble. Le cheval blanc symbolise la partie de l'âme liée aux sentiments nobles comme le courage et l'honneur, qui obéit relativement bien. Le cheval noir représente la partie désirante et appetitive ('epithumetikon'), attirée par les plaisirs sensibles, l'absence de mesure, et qui n'obéit qu'à la force. Cette image illustre le conflit interne de l'homme et la nécessité pour la raison de dominer les pulsions pour atteindre la sagesse. Exemple : Le combat intérieur d'une personne qui résiste à une tentation immédiate par respect pour un principe moral illustre cette lutte entre le cheval noir et le cocher guidé par la raison.`
  },
  // Question n°3
  {
    question: "Comment Kant, dans son 'Anthropologie', distingue-t-il principalement la passion de l'émotion ?",
    answers: [
    ...
    correct: 2,
    explanation: `Kant établit une distinction morale cruciale entre l'émotion ('Affekt') et la passion ('Leidenschaft'). L'émotion est un mouvement soudain et intense de l'âme, une 'ivresse' qui porte une atteinte momentanée à la liberté et à la maîtrise de soi. La passion, en revanche, est une inclination durable et réfléchie, un attachement constant à un objet. Elle est une 'maladie' car elle s'enracine, se concilie avec le raisonnement et installe une servitude volontaire qui exclut l'amélioration morale. Pour Kant, la passion est donc plus dangereuse car elle corrompt durablement la liberté interne. Exemple : Une colère subite face à une injustice est une émotion ; une rancune tenace et calculée qui oriente toute la conduite d'une personne est une passion.`
  },
  // Question n°4
  {
    ...
    correct: 3,
    explanation: `Schopenhauer propose une vision désenchantée et vitaliste du sentiment amoureux. Dans 'Le Monde comme volonté et représentation', il affirme que ce que nous prenons pour un sentiment élevé n'est que l'expression déguisée de la 'Volonté' métaphysique, une force aveugle et sans finalité qui pousse à la reproduction de l'espèce. L'individu croit aimer une personne unique, mais il est en réalité le jouet d'une pulsion vitale (le 'conatus') qui le dépasse. Le sentiment amoureux est ainsi une illusion qui masque le désir sexuel fondamental. Exemple : Schopenhauer explique l'infidélité non par un manque de sentiment, mais par l'action de cette force vitale aveugle qui pousse l'individu à chercher de nouveaux partenaires pour la perpétuation de l'espèce.`
  },
  // Question n°5
  {
    ...
    correct: 2,
    explanation: `La naissance d'un intérêt prononcé pour la sensibilité est historiquement située. On peut la relier au contexte du XVIIIe siècle, marqué par des bouleversements politiques, sociaux et intellectuels (les Lumières, la Révolution). Ce climat d'instabilité et de remise en question des anciens cadres (monarchie, religion) pousse les individus à se replier sur leur intériorité et à chercher dans leurs sentiments une vérité personnelle. Ce mouvement pré-romantique pose les bases du romantisme du XIXe siècle, qui fera de l'expression de la sensibilité son credo. Exemple : Les 'Rêveries du promeneur solitaire' de Rousseau, écrites dans un contexte d'exil et de désillusion politique, sont emblématiques de cette exploration de l'intimité sensible.`
  },
  // Question n°6
  {
  ...
  // Question n°7
  {
    ...
    correct: 2,
    explanation: `L'anthropologue David Le Breton, dans 'La Saveur du monde', propose de corriger l'intellectualisme du 'Je pense donc je suis' de Descartes. Il soutient que notre existence n'est pas d'abord une existence de 'chose pensante', mais une existence corporelle et sensible. Avant toute élaboration rationnelle, nous sommes immergés dans le monde par nos sens. La formule 'Je sens donc je suis' souligne que la conscience de soi et du monde émerge d'abord de cette expérience sensorielle continue. Elle replace le corps et la sensibilité au fondement de l'identité et de la connaissance. Exemple : Un nouveau-né qui tète, sent la chaleur et entend une voix construit son sentiment d'existence et son premier rapport au monde bien avant de pouvoir formuler la moindre pensée conceptuelle.`
  },
  // Question n°8
  {
  ...
  // Question n°10
  {
    ...
    correct: 2,
    explanation: `Il faut insister sur une distinction étymologique et conceptuelle importante. La sympathie (du grec 'syn', avec, et 'pathos', souffrance) désigne la capacité à partager ou à compatir à la souffrance d'autrui, à 'souffrir avec' lui. L'empathie (du grec 'en', dans, et 'pathos') désigne une forme plus profonde et problématique d'identification : c'est le fait de se mettre à la place de l'autre, de ressentir ce qu'il ressent, comme si l'on 'souffrait à sa place'. Cette distinction questionne la possibilité et les limites de la compréhension d'autrui : peut-on vraiment sortir de soi pour éprouver le vécu d'un autre ? Exemple : Voir un ami triste et se sentir triste avec lui relève de la sympathie ; imaginer et ressentir physiquement la douleur d'un patient subissant une intervention relève d'un effort d'empathie.`
  },
  // Question n°11
  {
    question: "Dans l'extrait des 'Rêveries du promeneur solitaire', comment Rousseau décrit-il l'effet du spectacle du lac de Bienne sur son âme ?",
    answers: [
  ...
  // Question n°12
  {
    ...
    correct: 2,
    explanation: `'Les Souffrances du jeune Werther' de Goethe (1774) a eu un retentissement sociologique inattendu. Le roman épistolaire, qui raconte le suicide par désespoir amoureux du jeune Werther, a provoqué une vague de suicides mimétiques parmi ses jeunes lecteurs en Europe. Les sociologues ont nommé 'effet Werther' ce phénomène de contagion sociale par lequel la médiatisation d'un suicide peut en provoquer d'autres. Il s'oppose à 'l'effet Papageno' (du personnage de Mozart), où la présentation d'alternatives positives à la crise prévient le passage à l'acte. Cet effet montre la puissance de l'expression artistique de la sensibilité et son impact réel sur les comportements. Exemple : Les inquiétudes autour de la diffusion de certaines séries traitant du suicide parmi les adolescents s'appuient sur la connaissance de 'l'effet Werther'.`
  },
  // Question n°13
  {
    ...
    correct: 2,
    explanation: `La mélancolie est l'humeur emblématique du héros romantique. Contrairement à une tristesse passagère liée à un événement, la mélancolie (étymologiquement 'bile noire' dans la théorie des humeurs) est un état durable de profonde tristesse, souvent sans cause clairement identifiable. Elle traduit un sentiment de vide existentiel, un désenchantement face au monde, un mal-être ontologique. Les romantiques comme Chateaubriand, Musset ou Baudelaire (qui parle de 'spleen') en ont fait le ressort de leur création, explorant les nuances de cette souffrance intime qui devient le signe d'une âme supérieure et incomprise. Exemple : Le personnage de René chez Chateaubriand incarne cette mélancolie qui le pousse à se replier sur lui-même et à errer sans but.`
  },
  // Question n°14
  {
    question: "Dans 'Lorenzaccio' d'Alfred de Musset, pourquoi le personnage éponyme compare-t-il le meurtre qu'il projette à 'un brin d'herbe' ?",
    answers: [
  ...
  // Question n°15
  {
    ...
    correct: 2,
    explanation: `Dans la 'Critique de la faculté de juger', Kant analyse le sentiment du sublime. Face à une manifestation démesurée de la nature (un océan déchaîné, une montagne écrasante), l'homme prend d'abord conscience de sa faiblesse physique et de sa vulnérabilité en tant qu'être naturel. Mais cette même expérience lui révèle en contrepoint une 'supériorité' d'un tout autre ordre : sa capacité de juger cette puissance, sa liberté morale et sa destination spirituelle, qui le rendent indépendant de la nature sensible. Le sublime ne réside pas dans l'objet, mais dans l'élévation de l'esprit humain qu'il provoque. Exemple : Se sentir écrasé par une tempête en mer, mais en même temps fier de la résistance de l'esprit humain qui peut la concevoir et l'affronter, illustre ce mouvement du sublime.`
  },
  // Question n°16
  {
    question: "Dans la citation de Chateaubriand (René), comment le narrateur décrit-il le rapport entre le 'chant naturel de l'homme' et le bonheur ?",
    answers: [
  ...
  // Question n°21
  {
    ...
    correct: 2,
    explanation: `Dans 'Essai sur les données immédiates de la conscience', Bergson critique les conceptions spatialisantes et quantitatives des états psychiques. L'intensité d'une émotion ou d'un sentiment (comme un désir qui devient passion) n'est pas une grandeur mesurable. Elle se définit qualitativement par son pouvoir de pénétration et d'organisation de la vie psychique. Un désir intense est un désir qui a cessé d'être 'isolé' pour 'pénétrer un plus grand nombre d'éléments psychiques', les 'teignant pour ainsi dire de sa propre couleur' jusqu'à changer 'le point de vue sur l'ensemble des choses'. L'intensité est donc une qualité expansive et transformatrice. Exemple : Une passion amoureuse qui, de simple attirance, finit par colorer tous les souvenirs, projets et perceptions d'une personne, modifiant son rapport au monde entier.`
  },
  // Question n°22
  {
  ...
  // Question n°30
  {
    ...
    correct: 2,
    explanation: `William James renverse la conception intuitive de l'émotion. Le sens commun pense que la perception d'un danger (un ours) provoque l'émotion de peur, qui elle-même cause des réactions physiques (tremblements, fuite). James inverse cet ordre : la perception provoque *directement* des changements corporels (par des voies réflexes). C'est la conscience *rétrospective* de ces changements (je sens que je tremble, que mon cœur bat) qui constitue l'émotion elle-même. L'émotion n'est donc pas la cause, mais la conséquence de la physiologie. 'Je tremble donc j'ai peur', et non l'inverse. Exemple : Selon James, si on pouvait supprimer tous les symptômes physiques de la peur (tremblement, pâleur, etc.), il ne resterait plus qu'une perception froide et intellectuelle du danger, sans l'émotion de peur.`
  },
  // Question n°31
  {
  ...
  // Question n°35
  {
    ...
    correct: 3,
    explanation: `Ces deux approces sont des étapes historiques successives, mais comme deux interprétations philosophiques puissantes et toujours en tension. D'un côté, le vitalisme (Schopenhauer, et plus tard Freud) 'désenchante' le sentiment en le ramenant à des forces inconscientes (pulsion sexuelle, volonté de vie). De l'autre, le romantisme 'réenchante' la sensibilité en en faisant l'expression authentique du moi, une quête spirituelle et esthétique. La conclusion ne privilégie pas l'une sur l'autre ; elle montre que le débat entre une explication naturaliste et une valorisation subjective de l'amour reste ouvert et structurant pour penser notre sensibilité. Exemple : Aujourd'hui encore, on peut expliquer une attirance par des critères biologiques (phéromones) ou la vivre comme une rencontre unique et inexplicable des âmes, montrant la persistance de ces deux grilles de lecture.`
  },
  // Question n°36
  {
    ...
    correct: 2,
    explanation: `L'usage du mot 'sensibilité' renvoie à la racine latine 'sentire' (sentir, percevoir). La sensibilité désigne notre capacité fondamentale à recevoir des impressions par les sens, à être affecté physiquement et émotionnellement, que cette affection vienne du monde extérieur (une douce mélodie, un paysage) ou de notre intériorité (un souvenir, une pensée). Elle est le socle de l'expérience vécue, antérieur à la raison raisonnante. Toute la séquence explore les formes, les expressions et les conflits de cette faculté. Exemple : Se sentir ému par un film, avoir mal à une blessure, ou être nostalgique en repensant à son enfance sont toutes des manifestations de la sensibilité.`
  },
  // Question n°37
  {
  ...
  // Question n°47
  {
    ...
    correct: 2,
    explanation: `La thermoception est notre capacité à percevoir la chaleur et le froid. Comme les autres sens, elle peut présenter des dysfonctionnements. L'exemple est l'incapacité de certaines personnes à régler correctement la température de l'eau sous la douche. Elles ne parviennent pas à percevoir avec justesse si l'eau est trop chaude ou trop froide, et peuvent se brûler ou se laver à l'eau glacée sans s'en rendre compte. Ce trouble, qui peut être lié à des lésions nerveuses, montre que la perception de la température n'est pas un simple fait brut, mais une capacité sensorielle fine qui peut être altérée. Exemple : Les personnes atteintes de certaines neuropathies diabétiques perdent la sensibilité thermique (et douloureuse) dans les pieds, ce qui les expose à des brûlures sans qu'elles ne s'en aperçoivent.`
  },
  // Question n°48
  {
  ...
  // Question n°49
  {
    ...
    correct: 2,
    explanation: `Cette expression idiomatique est riche de sens. Elle montre à quel point, dans notre imaginaire, l'identité d'une personne est associée à son enveloppe corporelle, à sa 'peau'. 'Se mettre dans la peau de' signifie tenter de sortir de sa propre subjectivité pour accéder à celle d'autrui, adopter son cadre de référence, comprendre ses émotions et ses motivations. C'est une métaphore de l'empathie. Elle révèle aussi la difficulté de cet exercice : il s'agit d'un 'mettre dans', comme si l'on endossait un vêtement étranger, suggérant que l'identité de l'autre reste toujours en partie inaccessible, une peau qu'on ne peut jamais totalement faire sienne. Exemple : Un acteur qui prépare un rôle cherche à 'se mettre dans la peau' de son personnage pour incarner de manière crédible ses émotions et ses gestes.`
  },
  // Question n°50
  {
  ...
  // Question n°53
  {
    ...
    correct: 3,
    explanation: `L'affirmation selon laquelle la sensibilité conditionne notre rapport au monde signifie que notre manière d'être présent au monde, de le connaître, de lui donner du sens, et d'y agir, est d'abord et fondamentalement une affaire de corps et de sensations. Avant toute théorie, nous sommes des êtres sensibles immergés dans un environnement que nous percevons et avec lequel nous interagissons par nos sens. Cette idée, bien que thématisée différemment, est présente depuis l'Antiquité. Par exemple, la médecine hippocratique considérait le corps du patient comme un système sensible dont les déséquilibres (les 'humeurs') se manifestaient par des symptômes perceptibles. La sensibilité n'est donc pas un voile sur la réalité, mais notre mode d'accès originaire à elle. Exemple : Un artisan qui 'sent' la bonne consistance de l'argile avec ses mains, ou un marin qui 'sent' le vent changer sur sa peau, ont une connaissance pratique du monde passant par une sensibilité éduquée.`
  },
  // Question n°54
  {
  ...
  // Question n°58
  {
    ...
    correct: 3,
    explanation: `La peau est notre interface avec le monde social. Elle est le siège du sens du toucher, fondamental pour la communication non verbale. Le contact physique (une poignée de main, une caresse, une tape amicale) transmet des messages émotionnels et sociaux puissants. La peau régule aussi la distance : on ne touche pas n'importe qui (cf. l'exemple du roi d'Angleterre). Son état (rougeur de honte, pâleur de peur, transpiration de stress) communique involontairement nos émotions. Enfin, son apparence (couleur, marques, parures) signale une appartenance sociale, culturelle ou ethnique. La peau est donc un organe de communication à part entière. Exemple : La différence entre une poignée de main ferme et une poignée de main molle envoie un message immédiat sur la confiance ou l'assurance de la personne.`
  },
  // Question n°59
  {
  ...
  // Question n°61
  {
    ...
    correct: 2,
    explanation: `Cette formule célèbre est de Maurice Merleau-Ponty, dans la 'Phénoménologie de la perception'. Elle résume sa position qui cherche à dépasser l'opposition classique entre nature et culture, inné et acquis. Concernant les émotions, elle signifie qu'elles ne sont ni de purs réflexes biologiques (comme le croit le naturalisme naïf), ni de pures conventions arbitraires (comme le croirait un culturalisme radical). Elles sont à la fois 'naturelles' car elles engagent le corps, ses sensations et ses réponses physiologiques, et 'fabriquées' car la manière de les vivre, de les interpréter, de les exprimer est modelée par la culture et l'histoire. L'émotion est une institution humaine qui émerge à l'intersection du biologique et du social. Exemple : Le sentiment amoureux engage des mécanismes hormonaux et cérébraux (naturel), mais la façon de le vivre (coup de foudre, amour courtois, mariage arrangé) est profondément culturelle (fabriqué).`
  },
  // Question n°62
  {
  ...
  // Question n°65
  {
    ...
    correct: 2,
    explanation: `Dans 'Les Passions de l'âme', Descartes, en bon dualiste, attribue l'origine de nombreuses passions au corps. L'âme, unie au corps, reçoit par l'intermédiaire des nerfs et des 'esprits animaux' des informations sur l'état corporel. Ces perceptions, que l'âme éprouve, sont les passions. Par exemple, la perception d'un danger cause un certain mouvement des esprits animaux dans le corps, et l'âme perçoit ce mouvement comme la passion de la peur. Ainsi, les passions sont d'abord pour Descartes des affects *subis* par l'âme du fait de son union avec le corps, et non des produits de sa volonté ou de sa raison. Exemple : La sensation de faim ou de soif, qui pousse à l'action, est pour Descartes une passion d'origine somatique.`
  },
  // Question n°66
  {
  ...
  // Question n°70
  {
    ...
    correct: 2,
    explanation: `L''amour platonicien', inspiré du 'Banquet' de Platon, désigne originellement un amour qui commence par l'attirance pour un beau corps mais qui doit s'élever progressivement vers l'amour de la Beauté en soi, intelligible et éternelle. C'est une ascension spirituelle qui ne méprise pas le corps mais l'utilise comme un marchepied. À l'époque romantique, cette notion est souvent déformée en 'amour platonique' au sens d'un amour purement spirituel, désincarné, impossible à consommer charnellement, et parfois teinté d'une méfiance envers la sensualité. Cet amour 'glorifie la raison contre la jouissance' et devient une 'prétention à être désincarné'. Exemple : Les amours chastes et idéalisées, mais souvent malheureuses, des héros de romans romantiques comme 'Les Liaisons dangereuses' (la relation entre la Présidente de Tourvel et Valmont avant la chute) ou 'René' illustrent cette conception.`
  },
  // Question n°71
  {
  ...
  // Question n°83
  {
    ...
    correct: 2,
    explanation: `L'équilibrioception est un sens interne souvent oublié. Il nous permet de maintenir notre équilibre, de connaître l'orientation de notre tête et de notre corps dans l'espace, et de percevoir les accélérations (mouvements linéaires et rotatifs). Il repose principalement sur le système vestibulaire, situé dans l'oreille interne, qui contient des canaux remplis de liquide et des otolithes sensibles à la gravité. Ce sens est essentiel pour la coordination des mouvements et la station debout. Son dysfonctionnement provoque des vertiges et des pertes d'équilibre. Exemple : Le 'mal de mer' ou le 'mal des transports' est causé par un conflit entre les informations de l'équilibrioception (qui perçoit le mouvement du bateau ou de la voiture) et celles de la vue (qui peut, dans un habitacle, indiquer l'immobilité), créant une confusion sensorielle nauséeuse.`
  },
  // Question n°84
  {
  ...
  // Question n°85
  {
    ...
    correct: 2,
    explanation: `Dans la philosophie antique, notamment chez Platon et Aristote, la tempérance (sophrosunè en grec) est l'une des quatre vertus cardinales. Il ne s'agit pas d'une répression brutale des désirs, mais d'une juste mesure, d'un contrôle raisonnable des plaisirs et des appétits sensibles. L'homme tempérant n'est pas insensible ; il éprouve des désirs, mais sa raison lui indique la mesure à ne pas dépasser. Pour les Anciens, cette vertu de modération est une 'meilleure conseillère' que le sentiment ou la passion, car ces derniers, désordonnés, peuvent mener à l'excès et au malheur. La tempérance est donc une forme de sagesse pratique qui gouverne la sensibilité. Exemple : Savoir apprécier un bon repas sans tomber dans la gloutonnie, ou savourer un vin sans s'enivrer, sont des manifestations contemporaines de l'idéal antique de tempérance.`
  },
  // Question n°86
  {
    ...
    correct: 1,
    explanation: `Les ailes de l'attelage dans le 'Phèdre' ne sont pas un détail décoratif ; elles sont symboliquement essentielles. Elles représentent la capacité naturelle de l'âme à s'élever vers les réalités supérieures, les Idées éternelles (le Vrai, le Beau, le Bien). Lorsque le cocher (la raison) parvient à maîtriser les deux chevaux, surtout le cheval noir des désirs désordonnés, l'attelage peut prendre son essor et contempler les réalités intelligibles. En revanche, si les chevaux, en particulier le noir, ne sont pas maîtrisés, ils entraînent l'attelage vers le bas, vers le monde sensible, et les ailes se cassent ou s'alourdissent, empêchant l'ascension. Les ailes symbolisent donc la dimension transcendante de l'âme et sa destination spirituelle, qui ne peut être atteinte que par la maîtrise de la sensibilité. Exemple : L'expérience de l'amour véritable, pour Platon, doit 'donner des ailes' à l'âme et la faire s'élever de l'amour d'un beau corps à l'amour de la Beauté absolue.`
  },
  // Question n°87
  {
  ...
  // Question n°91
  {
    ...
    correct: 2,
    explanation: `Le 'vague à l'âme' est une notion clé de la sensibilité romantique, particulièrement associée à Lamartine. Il ne s'agit pas d'une émotion définie (tristesse, joie), mais d'un état diffus, d'un sentiment d'inquiétude, de nostalgie, d'aspiration vers un idéal indéfinissable. L'âme est comme agitée par des 'vagues' intérieures dont elle ne connaît pas la source ni la destination. C'est le sentiment d'un manque, d'une attente, d'une capacité de désir qui excède tous les objets concrets du monde. Ce 'vague' est à la fois une souffrance (celle de l'insatisfaction permanente) et la marque d'une âme supérieure, trop grande pour se contenter des réalités terrestres. Exemple : Le début du poème 'L'Isolement' de Lamartine – 'Souvent sur la montagne, à l'ombre du vieux chêne, / Je m'assieds au hasard, et je contemple en vain / (...) / Un vague et violent désir de choses inconnues' – est une parfaite illustration de ce 'vague à l'âme'.`
  },
  // Question n°92
  {
  ...
  // Question n°96
  {
    ...
    correct: 3,
    explanation: `Cette distinction étymologique et conceptuelle est souvent floue dans le langage courant. La sympathie (ou son équivalent latin, la compassion) signifie littéralement 'souffrir avec' (syn-pathos). C'est le fait de partager la peine d'autrui, d'être ému par son sort, de compatir. L'empathie (en-pathos) signifie 'souffrir dans', c'est-à-dire se mettre intérieurement à la place de l'autre, essayer de ressentir ce qu'il ressent, d'adopter son point de vue de l'intérieur. C'est un processus plus actif et plus profond d'identification. La question philosophique est de savoir si une telle identification totale est vraiment possible, ou si elle reste une projection de notre propre sensibilité. Exemple : Un médecin peut avoir de la compassion (sympathie) pour la douleur de son patient, et tenter de comprendre son vécu (empathie) pour mieux le soigner, sans pour autant pouvoir littéralement 'sentir' sa douleur.`
  },
  // Question n°97
  {
