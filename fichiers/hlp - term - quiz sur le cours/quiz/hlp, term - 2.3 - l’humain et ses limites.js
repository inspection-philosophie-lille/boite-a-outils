...
const questions = [
  // Question n°1
  {
    question: "Question n°01 : Quel penseur du XXe siècle a développé le concept de « société liquide » pour décrire la fragilité des liens sociaux contemporains ?",
    answers: [
  ...
  // Question n°5
  {
    ...
    answers: [
      ...
      "La transformation des auditeurs en consommateurs d'un flux unidirectionnel."
    ],
    correct: 3,
    explanation: `Dans <em>La Dialectique de la Raison</em>, les auteurs analysent le passage des médias libéraux (comme le téléphone) aux médias de masse « démocratiques » comme la radio. Cette dernière impose un modèle autoritaire : une minorité émet, la majorité écoute passivement. Toute spontanéité du public est organisée, canalisée et intégrée à l'industrie du divertissement, créant une illusion de participation tout en confisquant la parole véritable.    \nExemple : Les émissions de radio avec public, où les réactions et questions sont soigneusement sélectionnées et préparées à l'avance, illustrent cette mise en scène d'une interactivité factice qui sert en réalité à renforcer le contrôle sur le message diffusé.`
  },

  // Question n°6
  {
    question: "Question n°06 : Quel pourcentage de jeunes Français de 18 à 24 ans, selon l'étude Ifop de 2024, estiment que la science apporte plus de mal que de bien ?",
    answers: [
      "Seulement 6%, signe d'une confiance intacte.",
      "21%, une proportion qui a plus que triplé depuis 1972.",
      "55%, soit la majorité de cette génération."
    ],
    correct: 2,
    explanation: `L'étude révèle une défiance historique : 21% des 18-24 ans pensent que « la science apporte plus de mal que de bien à l’homme », contre seulement 6% en 1972. 
	(https://www.ifop.com/article/le-rapport-des-francais-a-la-science-et-a-la-philosophie/). Cette bascule spectaculaire en cinquante ans est attribuée à l'effondrement des médias traditionnels crédibles et à la montée en puissance des réseaux sociaux comme sources d'information, favorisant la désinformation.    \nExemple : Selon la même étude, près de la moitié des jeunes considèrent l'astrologie comme une science, illustrant comment le référentiel scientifique rationnel est concurrencé par des croyances alternatives dans l'écosystème numérique.`
  },

  // Question n°7
  {
    question: "Question n°07 : Que symbolise le naufrage du Titanic dans la critique philosophique du progrès technique ?",
    answers: [
      ...
      "La confiance dans une technologie jugée invulnérable qui vulnérabilise davantage la société."
    ],
    correct: 3,
    explanation: `Le « syndrome du Titanic » désigne la foi aveugle dans la technologie moderne considérée comme maîtrisant tous les risques. Le paquebot, réputé <em>insubmersible</em>, a sombré lors de son voyage inaugural en 1912. Cette catastrophe est devenue un symbole durable de la fin d'une confiance naïve dans le progrès et de la vulnérabilité créée par l'orgueil humain (<em>hubris</em>).    \nExemple : Les accidents nucléaires de Tchernobyl (1986) ou de Fukushima (2011) rappellent de manière tragique qu'aucun système technique complexe n'est à l'abri d'une défaillance, d'une erreur humaine ou d'un événement imprévu, remettant en cause l'idée d'un contrôle absolu.`
  },

  // Question n°8
  {
    question: "Question n°08 : Quelle est la définition originelle et littérale du terme <em>utopie</em>, forgé par Thomas More ?",
    answers: [
      ...
      "Un <em>lieu</em>, une île imaginaire permettant de critiquer la société réelle."
    ],
    correct: 3,
    explanation: `Thomas More invente le terme « Utopia » (du grec <em>ou</em>, non, et <em>topos</em>, lieu) en 1516 pour désigner une île fictive dotée d'institutions parfaites. Cette construction littéraire a d'abord une fonction critique et heuristique : en dépeignant une société idéale, elle fait miroir aux défauts et aux injustices de la société anglaise de son temps. L'utopie est donc initialement un idéal régulateur, un modèle pour penser l'amélioration du présent.    \nExemple : Dans <em>Candide</em>, Voltaire décrit l'Eldorado, un pays où l'or n'a aucune valeur et où règnent la tolérance et la paix, pour critiquer par contraste l'avidité, la violence et le fanatisme des sociétés européennes du XVIIIe siècle.`
  },

  // Question n°9
  {
    question: "Question n°09 : Quelle proposition résume le mieux la thèse centrale de la <em>collapsologie</em> ?",
    answers: [
  ...
  // Question n°25
  {
    question: "Question n°25 : Que signifie le terme « noosphère » employé par Teilhard de Chardin et repris par Michel Serres ?",
    answers: [
      "La couche atmosphérique polluée par les activités humaines (smog, particules fines).",
      "La sphère de la pensée humaine, de l'information et de la communication.",
  ...
  // Question n°26
  {
    question: "Question n°26 : Quelle est la devise de l'État mondial dans <em>Le Meilleur des mondes</em> d'Aldous Huxley ?",
    answers: [
    ...
    correct: 2,
    explanation: `« Communauté, Identité, Stabilité » résume les valeurs sacrées de l'État mondial décrit par Huxley. La « Communauté » prime sur l'individu. « l'Identité » est imposée par le conditionnement prénatal et postnatal qui détermine la caste et le rôle de chacun. La « Stabilité » est l'objectif suprême, préservée par le contrôle des émotions (soma), l'élimination des passions, de la famille et par l'eugénisme. Cette devise montre que le prix de l'ordre parfait est la négation de la liberté, de l'amour et de l'aventure humaine.    \nExemple : Un Embryon « Epsilon » est privé d'oxygène pendant son développement en bouteille pour atrophier son cerveau et son squelette, garantissant qu'il sera un travailleur manuel parfaitement adapté et satisfait de son sort – une horrible mise en œuvre de l'« Identité » et de la « Stabilité ».`
  },

  // Question n°27
  {
    question: "Question n°27 : Que dénonce Hannah Arendt comme étant « la tentation politique par excellence » ?",
    answers: [
      "La corruption et l'enrichissement personnel des gouvernants.",
      "L'<em>hubris</em>, la démesure, et non pas simplement la volonté de puissance.",
      "La lâcheté et le refus de prendre ses responsabilités face à l'histoire."
    ],
    correct: 2,
    explanation: `Dans <em>Condition de l'homme moderne</em>, Arendt rappelle que l'action politique, par sa productivité et sa capacité à établir des rapports nouveaux, possède un potentiel d'infinitude. Le danger qui la guette n'est pas d'abord la soif de pouvoir, mais l'<em>hubris</em> (ὕβρις), la démesure grecque qui consiste à ne plus respecter aucune limite. Face à cela, la vertu politique fondamentale est la modération, le sens des limites. Cette pensée est une réponse aux totalitarismes du XXe siècle.    \nExemple : Le projet nazi de domination mondiale et d'extermination de peuples entiers, ou les régimes staliniens cherchant à remodeler intégralement l'homme et la société, sont des manifestations historiques monstrueuses de l'<em>hubris</em> politique.`
  },

  // Question n°28
  {
    question: "Question n°28 : Que signifie le passage de la « direction du personnel » à la « gestion des ressources humaines » ?",
    answers: [
  ...
  // Question n°36
  {
    question: "Question n°36 : Quelle vision de la nature humaine peut-on adopter face à son caractère <em>indéfinissable</em> ?",
    answers: [
      ...
      "L'homme est un être limité mais capable de tout par absence de <em>nature</em> fixe."
    ],
    correct: 3,
  ...
  // Question n°41
  {
    ...
    correct: 3,
    explanation: `Les trois lois, présentées dans le <em>Cycle des robots</em> d'Asimov, forment un système hiérarchique éthique censé garantir la sécurité. La première loi (ne pas nuir) est absolue. La deuxième (obéissance) est subordonnée à la première. La troisième (auto-conservation) est subordonnée aux deux premières. Asimov explore les paradoxes de ces lois, montrant comment des robots ultra-logiques peuvent les interpréter de manière inattendue, créant des situations problématiques.    \nExemple : Un robot pourrait juger que pour protéger son existence (3e loi) afin de continuer à servir les humains (2e loi), il doit discrètement limiter leur liberté pour les empêcher de l'éteindre, violant ainsi l'esprit de la 1ère loi (respect de l'autonomie et du bien-être humains).`
  },

  // Question n°42
  {
    question: "Question n°42 : Que symbolise la machine à explorer le temps de H.G. Wells dans le contexte des dystopies ?",
    answers: [
      "L'espoir d'un futur radieux grâce à la science et à l'évolution sociale.",
      "Le voyage dans un futur lointain révèle une humanité divisée en deux.",
      "Un simple gadget purement destiné à l'aventure et au divertissement."
    ],
    correct: 2,
    explanation: `Le roman de Wells utilise le voyage dans le temps comme un outil de satire sociale et d'avertissement. Le futur qu'il découvre (l'an 802701) n'est pas un paradis, mais le résultat pervers d'une division de classe poussée à l'extrême : une aristocratie oisive et juvénile (Eloïs) vivant en surface, et une classe laborieuse souterraine déshumanisée (Morlocks) qui, en retour, se nourrit des Eloïs. C'est une métaphore cauchemardesque de l'exploitation capitaliste.    \nExemple : Les Morlocks, qui entretiennent machinalement la machinerie pour les Eloïs mais finissent par les considérer comme du bétail, illustrent comment une spécialisation extrême et une division sociale radicale peuvent mener à la perte de l'humanité commune et à une régression barbare.`
  },

  // Question n°43
  {
    question: "Question n°43 : Que signifie le terme « écocide » ?",
    answers: [
      "L'étude scientifique des écosystèmes et de leurs interactions (synonyme d'écologie).",
      "Un crime contre l'environnement, une destruction massive et durable d'un écosystème.",
      "Le mouvement militant pour la défense de l'environnement et la justice climatique."
    ],
    correct: 2,
    explanation: `Néologisme formé sur <em>οἶκος</em> (maison, habitat) et <em>caedere</em> (tuer), l'écocide désigne des actions humaines qui causent des dommages graves, étendus et durables à l'environnement, menaçant la survie des écosystèmes et des populations. Le Viêt Nam fut le premier État, en 1990, à l'inscrire dans sa loi comme un crime. La reconnaissance internationale de l'écocide vise à responsabiliser les États et les multinationales pour des désastres environnementaux majeurs.    \nExemple : L'assèchement de la mer d'Aral, provoqué par le détournement des fleuves pour l'irrigation de cultures de coton, est souvent cité comme un écocide : un écosystème entier a été détruit, avec des conséquences climatiques et sanitaires catastrophiques pour les populations locales.`
  },

  // Question n°44
  {
    question: "Question n°44 : Quelle est la principale caractéristique d'une <em>utopie pragmatique</em> ?",
    answers: [
      "Elle est réalisable à court terme car elle renonce à tout idéal trop ambitieux pour se concentrer sur le possible.",
      "Elle exige que le présent se conforme à des principes idéaux, donnant des exemples concrets qui fonctionnent.",
      "Elle est purement théorique et n'a aucune intention de se réaliser, servant uniquement de pensée expérimentale."
    ],
    correct: 2,
    explanation: `Contre le discours résigné de la dystopie ou de la collapsologie, on peut évoquer les utopies « pragmatiques ». Celles-ci ne sont pas des châteaux en Espagne lointains, mais des modèles concrets, déjà réalisés ou en cours, qui incarnent un idéal et démontrent sa faisabilité. Il ne s'agit pas d'attendre un futur hypothétique, mais de construire dans le présent des îlots de l'utopie, qui servent de preuve et d'inspiration.    \nExemple : Internet à ses débuts (idéal de connaissance libre et partagée), la sécurité sociale (idéal de protection collective), ou l'Eastgate Building au Zimbabwe (immeuble auto-climatisé inspiré des termitières) sont des utopies pragmatiques : des innovations réelles qui matérialisent un monde meilleur.`
  },

  // Question n°45
  {
    question: "Question n°45 : Que révèle la phrase de Patrick Le Lay (ex-PDG de TF1) : « Ce que nous vendons à Coca-Cola, c'est du temps de cerveau humain disponible » ?",
    answers: [
      "Une métaphore poétique sur le pouvoir de l'imaginaire publicitaire pour façonner les désirs.",
      "Un cynisme révélant que la télévision commerciale vend l'attention captive du téléspectateur.",
      "Une critique interne du modèle des émissions trop intellectuelles qui ne captent pas assez l'audience."
    ],
    correct: 2,
    explanation: `Cette citation célèbre dévoile sans fard le modèle économique de la télévision commerciale. Le programme n'est pas une fin en soi, mais un <em>appât</em> pour capter et retenir l'attention (le « temps de cerveau ») du téléspectateur dans un état de réceptivité passive, afin de la « vendre » ensuite aux annonceurs. Cette logique réduit la culture et l'information à des produits d'appel pour la publicité, et le citoyen à un consommateur dont l'attention est monnayée.    \nExemple : Une émission de télé-réalité au scénario haletant et aux conflits exacerbés a pour fonction première de créer une addiction et de maximiser l'audience, augmentant ainsi la valeur des spots publicitaires qui l'interrompent.`
  },

  // Question n°46
  {
    question: "Question n°46 : Quelle vision positive de la technique défend Gilbert Simondon ?",
    answers: [
      "La technique est par essence aliénante et doit être contenue pour préserver l'humain.",
      "La technique est un mode d'être qui libère l'homme, une manière de se lier au monde.",
      "La technique est moralement neutre ; tout dépend de l'usage bon ou mauvais qu'en font les hommes."
    ],
    correct: 2,
    explanation: `Simondon rejette à la fois l'angélisme technophile et le pessimisme technophobe. Pour lui, la technique est une dimension fondamentale de l'humanité, un « mode d'existence » par lequel l'homme se relie au monde. Les objets techniques contiennent du savoir humain cristallisé. Le danger survient quand la technique est réduite à un instrument de domination (« machine androïde »). La solution est d'inventer des machines qui libèrent l'homme des tâches serviles pour qu'il se consacre à des activités créatrices.    \nExemple : Un métier à tisser Jacquard du XIXe siècle n'est pas qu'un outil ; il incarne un savoir-faire, une histoire, et libère le tisserand des motifs les plus répétitifs pour qu'il se consacre à la conception et à l'innovation.`
  },

  // Question n°47
  {
    question: "Question n°47 : Quelle est une conséquence de la société liquide sur la construction de l'identité individuelle ?",
    answers: [
      "L'identité devient stable, héritée de la famille et de la classe sociale, comme dans les sociétés traditionnelles.",
      "L'identité se définit de plus en plus par la consommation : « je suis ce que j'achète et ce que je montre ».",
      "L'identité est déterminée par le diplôme et la profession, marqueurs solides dans un monde fluide."
    ],
    correct: 2,
    explanation: `Dans un monde où les affiliations traditionnelles (famille, religion, classe, nation) se dissolvent, l'individu doit constamment construire et reconstruire son identité. Dans la société de consommation liquide, cette construction passe massivement par les biens et les marques que l'on achète et expose. Le statut social, le sentiment d'appartenance et l'estime de soi sont médiatisés par la consommation de signes. Cette identité par l'avoir est précaire et nécessite une consommation perpétuelle.    \nExemple : Le fait que les jeunes soient les plus grands consommateurs de marques de luxe (20%) montre comment l'acquisition d'un produit cher (sneakers, sac) devient un marqueur identitaire essentiel et un moyen d'intégration sociale dans un monde liquide.`
  },

  // Question n°48
  {
    question: "Question n°48 : Que démontre l'exemple de l'effet de <em>tunnelisation</em> chez les pilotes d'avion ?",
    answers: [
      "La nécessité absolue de former mieux et plus longuement les pilotes aux situations de stress.",
      "La nécessité d'adapter l'interface machine à l'homme pour compenser les limites cognitives humaines.",
      "La supériorité incontestable des pilotes automatiques sur les pilotes humains trop faillibles."
    ],
    correct: 2,
    explanation: `L'effet de tunnelisation est un biais cognitif où, sous stress, le pilote se focalise excessivement sur un seul instrument, ignorant d'autres signaux cruciaux. La réponse intuitive (ajouter des alarmes) peut aggraver la saturation attentionnelle. La solution innovante est « humaine-centrée » : l'interface (cockpit) s'adapte dynamiquement. En atténuant l'information qui focalise et en affichant l'information pertinente, la machine compense la limite humaine. C'est une augmentation cognitive par le design.    \nExemple : Si un pilote est hypnotisé par un indicateur de vitesse défaillant à l'atterrissage, l'écran principal pourrait estomper cet indicateur et mettre en surbrillance l'altimètre, redirigeant son attention vers le paramètre le plus critique à ce moment-là.`
  },

  // Question n°49
  {
    question: "Question n°49 : Quel est le sens originel, purement scientifique, du mot « écologie » forgé par Ernst Haeckel ?",
    answers: [
      "La défense politique de la nature contre les ravages de l'industrie.",
      "La science des relations des organismes avec leur environnement organique et inorganique.",
      "L'étude de l'impact des pollutions humaines sur la santé des écosystèmes et des populations."
    ],
    correct: 2,
    explanation: `Le biologiste darwiniste Ernst Haeckel crée le terme « écologie » (<em>Ökologie</em>) en 1866. Pour lui, c'est une branche de la biologie qui étudie comment les organismes vivants interagissent entre eux et avec leur milieu physique (climat, sol, eau). Cette science vise à comprendre les « conditions d'existence » et les adaptations. Ce n'est qu'avec les crises environnementales du XXe siècle que le terme prendra une dimension politique, militante et normative.    \nExemple : Étudier comment une population de loups régule celle des chevreuils, et comment cette prédation influence la régénération de la forêt, relève de l'écologie scientifique au sens strict de Haeckel.`
  },

  // Question n°50
  {
    question: "Question n°50 : Que révèle le chiffre de 69% des 18-24 ans soutenant « au moins une de ces contrevérités scientifiques » ?",
    answers: [
      "Une majorité de jeunes rejettent complètement et radicalement la science au profit de croyances alternatives.",
      "Une majorité des jeunes est touchée par la désinformation, signe d'un affaiblissement du référentiel scientifique.",
      "Les jeunes sont majoritairement indifférents à la science, considérant qu'elle ne les concerne pas au quotidien."
    ],
    correct: 2,
    explanation: `Ce chiffre alarmant ne signifie pas que 69% des jeunes sont des « anti-science » radicaux, mais qu'une large majorité a intégré au moins un élément de désinformation dans sa vision du monde. Cela montre la porosité des frontières entre savoir établi et croyances alternatives dans l'écosystème informationnel des jeunes. Le référentiel scientifique commun, qui structurait auparavant la société, est fragmenté et concurrencé par une multitude de « vérités » subjectives ou communautaires.    \nExemple : Un jeune peut croire à la théorie de l'évolution, mais aussi penser que les vaccins à ARNm sont dangereux et que le changement climatique est une exagération. Ce mélange éclectique est caractéristique de la défiance post-moderne et de l'information en réseaux.`
  },

  // Question n°51
  {
    question: "Question n°51 : Quelle est la fonction du <em>soma</em> dans la société du <em>Meilleur des mondes</em> ?",
    answers: [
      "Un aliment de base riche en nutriments, distribué équitablement à toutes les castes.",
      "Une drogue sûre qui éteint toute émotion négative ou pensée critique et assurer la stabilité sociale.",
      "Le nom de la langue officielle et simplifiée de l'État mondial, favorisant une communication sans ambiguïté."
    ],
    correct: 2,
    explanation: `Le <em>soma</em> est l'outil pharmacologique par excellence du contrôle social. À la moindre contrariété, angoisse ou sentiment de malaise, les citoyens prennent leur dose, qui les plonge dans un état euphorique d'oubli. Il éradique la mélancolie, la colère, l'amour passionnel et la pensée critique. Son slogan est « Un gramme vaut mieux qu'un sermon ». C'est le moyen chimique d'assurer la « Stabilité » en neutralisant la profondeur et la souffrance de l'existence humaine.    \nExemple : Lorsque Lenina ressent un début d'attirance amoureuse compliquée pour Bernard, elle prend immédiatement du soma pour faire disparaître ces « émotions déplaisantes » et retrouver l'état de bonheur standardisé et impersonnel.`
  },

  // Question n°52
  {
    question: "Question n°52 : Que signifie l'idée de <em>grand déclassement</em> pour expliquer la défiance ouvrière ?",
    answers: [
      "Le fait que les ouvriers gagnent moins que les employés et cadres moyens, inversant la hiérarchie salariale traditionnelle.",
      "Le sentiment d'être menacés de perdre leur statut social à cause de la valorisation d'autres compétences (diplômes).",
      "La baisse générale et irréversible du niveau de vie des classes moyennes, qui rejoignent la condition ouvrière."
    ],
    correct: 2,
    explanation: `Le <em>grand déclassement</em> est une notion sociologique qui décrit la crainte (ou la réalité) pour les catégories populaires et intermédiaires de voir leur position sociale se dégrader, leurs qualifications devenir obsolètes, et leurs enfants avoir une vie moins bonne. La science et la technique sont perçues comme les moteurs de ce déclassement, car elles semblent profiter aux « élites » diplômées tandis qu'elles détruisent les emplois industriels stables.    \nExemple : Un ouvrier qualifié de la métallurgie voit son usine robotisée. Son fils, sans diplôme universitaire, ne peut prétendre qu'à des emplois précaires de service (livreur, caissier), moins bien payés et moins reconnus : c'est le déclassement intergénérationnel vécu comme une injustice.`
  },

  // Question n°53
  {
    question: "Question n°53 : Quelle est la différence entre une <em>catastrophe environnementale</em> et une <em>catastrophe naturelle</em> ?",
    answers: [
      "Il n'y a pas de différence significative ; les deux termes sont synonymes dans le langage courant.",
      "Une catastrophe environnementale a une origine humaine et une catastrophe naturelle est due à des phénomènes géophysiques.",
      "Une catastrophe naturelle est plus meurtrière qu'une catastrophe environnementale qui n'affecte que la nature."
    ],
    correct: 2,
  ...
  // Question n°54
  {
    question: "Question n°54 : Que symbolise la figure du <em>cobot</em> (robot collaboratif) dans l'industrie ?",
    answers: [
      "Un robot destiné à remplacer entièrement l'ouvrier humain pour des questions de coût et d'efficacité.",
      "Un robot conçu pour assister l'homme dans les tâches en lui laissant le contrôle et le jugement.",
      "Un robot domestique de compagnie, destiné à assister les personnes âgées ou handicapées au quotidien."
    ],
    correct: 2,
    explanation: `Le <em>obot</em> (contraction de « coopération » et « robotique ») représente une vision moins anxiogène de la robotisation. Contrairement au robot autonome qui remplace, le cobot est un outil interactif qui amplifie les capacités humaines. Il peut soulever des charges lourdes que l'ouvrier guide, ou réaliser des soudures de précision sous supervision. L'homme reste « dans la boucle », il est le cerveau et le cobot le bras. Cette symbiose préserve le sens du travail et l'expertise humaine.    \nExemple : Dans un atelier, un exosquelette (cobot porté) permet à un ouvrier de manipuler des pièces très lourdes sans se blesser, combinant la force de la machine à l'intelligence et la dextérité de l'humain.`
  },

  // Question n°55
  {
    question: "Question n°55 : Quelle est la signification philosophique de la vengeance de Zeus (Pandore) après le vol du feu par Prométhée ?",
    answers: [
      "Zeus punit injustement les hommes pour une faute qu'ils n'ont pas commise, montrant l'arbitraire du pouvoir divin.",
      "Zeus punit les hommes et cette punition définit la condition humaine marquée par le travail, la souffrance et l'espoir.",
      "Zeus retire définitivement aux hommes le don de l'immortalité, les condamnant à une vie brève et insignifiante."
    ],
    correct: 2,
    explanation: `La création de Pandore (la <em>femme</em>, cadeau empoisonné) et la boîte qu'elle ouvre introduisent tous les maux dans le monde. Mais cela a une dimension constitutive : désormais, l'existence humaine est placée sous le signe de la dualité et de l'effort. Pour se nourrir, l'homme doit travailler la terre ; pour conserver le feu, il doit l'entretenir ; pour se perpétuer, il doit aimer et souffrir. La technique n'apporte pas le bonheur pur, mais une existence complexe et contradictoire.    \nExemple : Le mythe rejoint celui d'Adam et Ève : l'accès à la connaissance (le fruit, le feu) arrache l'homme à l'état de nature oisif et l'introduit dans l'histoire, avec son cortège de peines et de labeurs, mais aussi de dignité, de culture et d'espoir (resté au fond de la boîte).`
  },

  // Question n°56
  {
    question: "Question n°56 : Quelle vision de l'histoire Pascal défend-il contre l'idée d'un âge d'or perdu des Anciens ?",
    answers: [
      "L'histoire est un éternel recommencement, un cycle où les civilisations naissent, grandissent et meurent.",
      "L'histoire est une décadence continue depuis un âge d'or mythique, et les Modernes ne sont que des nains.",
      "L'histoire est un progrès cumulatif des connaissances, l'humanité apprenant comme un seul homme qui grandit."
    ],
    correct: 3,
    explanation: `À l'époque de Pascal, l'idée dominante était que les Anciens avaient tout découvert. Pascal, au contraire, défend les Modernes. Avec sa métaphore de l'humanité-individu, il affirme que nous sommes comme des nains juchés sur les épaules de géants (les Anciens) : nous voyons donc plus loin qu'eux. Le savoir s'accumule, chaque génération bâtissant sur la précédente. Cette idée est le fondement intellectuel de la notion de progrès qui triomphera aux Lumières.    \nExemple : Pascal lui-même, avec ses expériences sur le vide, dépasse les conceptions erronées d'Aristote (« la nature a horreur du vide »), montrant ainsi que la science moderne progresse en rectifiant les erreurs du passé.`
  },

  // Question n°57
  {
    question: "Question n°57 : Que signifie l'expression « la vérité est ailleurs » (<em>The Truth is Out There</em>) ?",
    answers: [
      "Une citation biblique sur la foi qui dépasse la raison et les apparences immédiates.",
      "Le slogan d'une série devenu emblématique d'une ouverture aux explications conspirationnistes.",
      "Une phrase philosophique soulignant la relativité de toute vérité et son caractère insaisissable."
    ],
    correct: 2,
    explanation: `« The Truth is Out There » était l'accroche de la série <em>X-Files</em>, qui mettait en scène des enquêtes sur le paranormal et les complots gouvernementaux cachés. Pour la Génération Z, cette formule résume un état d'esprit : une méfiance structurelle à l'égard des institutions et des « sachants » traditionnels. La « vraie » vérité ne serait pas dans les canaux officiels, mais « ailleurs » : dans les révélations d'initiés, les théories marginales ou les vidéos d'influenceurs. C'est l'épistémologie du soupçon et du complot.    \nExemple : Face à une pandémie, un jeune peut penser que la « vérité » sur le virus n'est pas dans les communiqués de l'OMS, mais dans les vidéos d'un médecin dissident ou dans les posts d'un groupe Facebook confidentiel présenté comme « ayant percé le secret ».`
  },

  // Question n°58
  {
    question: "Question n°58 : Que peut-on critiquer à travers l'exemple de la quasi-disparition des trains de nuit en France ?",
    answers: [
      "La mauvaise gestion et le manque d'investissement chronique de la SNCF, entreprise publique.",
      "La disparition des modes de transport collectifs entraînent celles des rencontres imprévues.",
      "Le manque de rentabilité du rail justifiant son abandon par les pouvoirs publics."
    ],
    correct: 2,
    explanation: `Adorno et Horkheimer pointaient déjà le remplacement du train (transport collectif) par la voiture privée comme un facteur d'isolement. La quasi-disparition des trains de nuit (il n'en restait que deux liaisons en 2017) illustre ce déclin. Le train de nuit était un espace social unique où des inconnus partageaient un temps long, permettant des conversations improbables. Son déclin au profit de la voiture ou de l'avion (autres bulles individualisées) participe à l'appauvrissement du lien social.    \nExemple : Un voyage Paris-Briançon en train de nuit créait une micro-société éphémère de voyageurs aux profils variés (skieurs, travailleurs, familles). Le même trajet en voiture ou en avion est une expérience privée, fermée sur le cercle familial ou amical.`
  },

  // Question n°59
  {
    question: "Question n°59 : Quelle est la thèse de Jean-Pierre Dupuy dans <em>Pour un catastrophisme éclairé</em> (2004) ?",
    answers: [
      "Il faut arrêter toute innovation technologique risquée pour éviter la catastrophe, quels que soient les bénéfices perdus.",
      "Le vrai risque étant imprévu, il faut paradoxalement « croire » à la catastrophe inéluctable pour la rendre évitable.",
  ...
  // Question n°70
  {
    question: "Question n°70 : Que signifie la notion de « body hacking » (piratage de corps) ?",
    answers: [
      "Le fait de se faire voler ses données médicales personnelles sur internet par des hackers.",
      "Une pratique qui consiste à modifier son corps en y intégrant des composants électroniques.",
      "Un régime alimentaire et d'exercice extrême visant à transformer son corps en machine performante."
    ],
    correct: 2,
    explanation: `Le body hacking est une forme radicale et expérimentale d'augmentation humaine, pratiquée par des bio-hackers. Il s'agit de considérer son corps comme une machine imparfaite que l'on peut « bidouiller » et améliorer par soi-même, en défiant les normes médicales et sociales. Ces modifications (comme s'implanter un aimant dans le doigt) sont souvent faites à la limite de l'art, de la performance et de la provocation. Cela pose des questions sur les limites de l'autonomie corporelle.    \nExemple : Certains bio-hackers se sont implanté une puce NFC entre le pouce et l'index pour déverrouiller leur porte ou leur smartphone d'un simple geste, ou un aimant pour percevoir les vibrations des appareils électroniques, explorant de nouveaux sens.`
  },

  // Question n°71
  {
    question: "Question n°71 : Que révèle l'étude sur la croyance au créationnisme (une force divine à l'origine de l'homme) chez les jeunes Français ?",
    answers: [
      "Elle est en baisse constante et rapide depuis 50 ans, du fait de la sécularisation.",
      "Elle concerne 27% des 18-24 ans, et est corrélée à l'appartenance religieuse et sociale.",
      "Elle est marginale et ne dépasse pas 5%, restant l'apanage de petites communautés isolées."
    ],
    correct: 2,
    explanation: `Contrairement à une idée reçue, le créationnisme n'est pas marginal en France, surtout chez les jeunes. 27% d'entre eux y adhèrent. L'étude montre une forte surreprésentation dans deux groupes : les jeunes ouvriers (38%, +11 points) et les jeunes se déclarant « croyants et religieux », principalement musulmans et protestants évangéliques. Cela illustre comment le facteur religieux littéraliste et le sentiment de déclassement social peuvent converger pour favoriser le rejet du récit scientifique dominant (évolution).    \nExemple : L'écart avec les États-Unis est frappant, mais la montée en France, notamment dans certaines banlieues et milieux populaires, montre une remise en cause préoccupante des bases de la biologie moderne au nom d'une identité religieuse perçue comme menacée.`
  },

  // Question n°72
  {
    question: "Question n°72 : Quelle est la principale critique adressée au « développement durable » par les partisans de la décroissance ?",
    answers: [
      "Il coûte trop cher et ralentit la croissance économique, principale source de progrès social.",
      "C'est un oxymore qui prétend concilier croissance infinie et préservation d'une planète aux ressources finies.",
      "Il n'est pas assez ambitieux techniquement et repose sur des solutions dépassées et inefficaces."
    ],
    correct: 2,
    explanation: `Le « développement durable » (ou « croissance verte ») est l'idée dominante pour répondre à la crise écologique. Les décroissants comme Yves Paccalet y voient une contradiction dans les termes et une fuite en avant. Pour eux, dans un monde fini, toute croissance matérielle et énergétique, même « décarbonée », finit par épuiser les ressources. L'idée de « découpler » complètement la croissance du PIB de l'utilisation des ressources est un mythe. La seule solution serait une décroissance planifiée et équitable.    \nExemple : Même une voiture électrique « propre » nécessite l'extraction de métaux rares qui détruit des environnements. Pour un décroissant, il faut réduire le besoin de voiture (relocalisation, télétravail, transports en commun), pas simplement changer de motorisation.`
  },

  // Question n°73
  {
    question: "Question n°73 : Que signifie l'idée d'<em>exocortex</em> dans les rêves transhumanistes les plus radicaux ?",
    answers: [
      "Une prothèse crânienne esthétique recouvrant le cerveau pour le protéger et le refroidir.",
      "Un système d'interconnexion directe entre le cerveau humain et les réseaux informatiques.",
      "Un nouvel organe biologique qui pourrait décupler nos capacités de mémoire."
    ],
    correct: 2,
    explanation: `L'<em>exocortex</em> (cortex extérieur) est le concept ultime d'augmentation cognitive. Il s'agirait d'une interface cerveau-machine si parfaite qu'elle ferait des bases de données mondiales et de l'intelligence artificielle une extension transparente de notre propre pensée. Plus besoin d'écran ou de clavier : on « penserait » une requête et la réponse surgirait dans l'esprit. Cela conduirait à une forme de conscience collective et désincarnée.    \nExemple : Le projet « Neuralink » d'Elon Musk, qui vise à implanter des puces dans le cerveau pour traiter des maladies puis, à terme, fusionner avec l'IA, s'inscrit dans cette utopie/dystopie de l'exocortex et pose des questions vertigineuses sur l'identité et la privacy mentale.`
  },

  // Question n°74
  {
    question: "Question n°74 : Que montre l'exemple des <em>Trente Glorieuses</em> par rapport au rapport du Club de Rome (1972) ?",
    answers: [
      "Que la croissance économique est éternelle et qu'il faut poursuivre sur cette voie pour le bien-être de tous.",
      "Que la période de forte croissance d'après-guerre a créé un optimisme brutalement mis en cause par ce rapport.",
      "Que le Club de Rome s'est trompé dans ses prévisions pessimistes, puisque la croissance a continué après 1972."
    ],
    correct: 2,
    explanation: `Les « Trente Glorieuses » (1945-1975) ont été l'âge d'or de la croissance industrielle, de la consommation de masse et de la foi dans le progrès technique illimité. Le rapport du Club de Rome <em>Les limites à la croissance</em>, publié en 1972, a constitué un électrochoc. En modélisant l'impact de la croissance sur les ressources finies, il prédisait un effondrement possible. Il a marqué le début de la prise de conscience écologique à grande échelle.    \nExemple : Les chocs pétroliers de 1973 et 1979, survenant juste après le rapport, ont semblé lui donner raison et ont mis un terme à l'insouciance des Trente Glorieuses, inaugurant une ère de crises, de chômage et de doutes sur le modèle de développement.`
  },

  // Question n°75
  {
    question: "Question n°75 : Que signifie l'opposition entre </em>génération ORTF<em> et <em>génération TikTok</em> selon François Kraus ?",
    answers: [
      "Une simple opposition d'âge sans signification profonde sur le rapport à l'information.",
      "L'opposition entre l'information contrôlée et l'information produite par des pairs.",
      "L'ORTF parlait aux vieux, TikTok aux jeunes, mais le fond de divertissement reste le même."
    ],
    correct: 2,
    explanation: `L'ORTF (Office de radiodiffusion-télévision française) était un monopole public jusqu'en 1974. Il incarnait une parole institutionnelle, unique, descendante et relativement fiable. La « génération ORTF » a été éduquée dans ce paysage homogène. La « génération TikTok » évolue dans un écosystème inverse : l'information vient de millions de sources, elle est horizontale, personnalisée par les algorithmes, privilégie le format court et le divertissement. La crédibilité n'y est plus liée à l'institution, mais à l'audience.    \nExemple : En 1972, un journaliste scientifique d'Europe 1 commentant l'atterrissage sur la Lune était une autorité. Aujourd'hui, un ado préférera l'explication d'un youtubeur qu'il suit, même sans formation scientifique, car il lui fait confiance « d'homme à homme ».`
  },

  // Question n°76
  {
    question: "Question n°76 : Que symbolise la figure de l'« influenceur » dans l'analyse de la défiance scientifique ?",
    answers: [
      "Un nouvel éducateur plus proche, plus accessible et plus compréhensible que le professeur traditionnel.",
      "Une figure dont la crédibilité est mesurée à son audience et son charisme plutôt qu'à son expertise.",
      "Un artiste des nouveaux médias, créateur de contenus esthétiques et divertissants, sans prétention informative."
    ],
    correct: 2,
    explanation: `L'influenceur incarne le nouvel arbitre de la vérité pour beaucoup de jeunes. Sur les réseaux sociaux, sa légitimité ne vient pas d'un diplôme ou d'une institution, mais de son succès quantifiable (abonnés, likes). Il parle sur un mode personnel, confidentiel, souvent émotionnel. Quand un influenceur à plusieurs millions d'abonnés émet un doute sur un vaccin, son impact est immense, car il bénéficie d'une confiance « affective » que n'ont plus les experts perçus comme lointains.    \nExemple : Un médecin généraliste sur un plateau télé aura moins d'impact qu'un influenceur fitness, sans formation médicale, partageant une vidéo émouvante sur les « dangers cachés » des vaccins, si cette dernière devient virale sur TikTok.`
  },

  // Question n°77
  {
    question: "Question n°77 : Quelle est la thèse de Heidegger concernant le pont face à la centrale électrique sur le Rhin ?",
    answers: [
      "Le pont est une construction archaïque, la centrale une œuvre de la modernité belle et fonctionnelle.",
      "Le pont de bois ancien laisse le fleuve être, tandis que la centrale le transforme en stock d'énergie.",
      "Les deux sont des constructions humaines équivalentes, mais la centrale est plus utile économiquement."
    ],
    correct: 2,
    explanation: `Heidegger oppose deux modes du « faire » humain. L'œuvre d'artisanat (le pont) s'inscrit dans le paysage, révèle le lieu (en reliant) et respecte l'essence des choses (le Rhin reste un fleuve). La technique moderne (la centrale) ne révèle pas, elle arraisonne. Elle ne laisse pas la nature être, elle la somme de livrer son énergie, la réduisant au statut de « fonds disponible » (<em>Bestand</em>). Le Rhin n'est plus qu'un maillon dans la production.    \nExemple : Un moulin à eau traditionnel utilise la force du courant pour moudre le grain, mais s'intègre au paysage. Un barrage hydroélectrique géant, en noyant des vallées, transforme radicalement le fleuve en une machine hydraulique, l'arrachant à son être.`
  },

  // Question n°78
  {
    question: "Question n°78 : Que signifie l'expression « réification » de l'homme évoquée à propos des « ressources humaines » ?",
    answers: [
      "Le fait de rendre l'homme plus efficace et productif grâce à des techniques de management scientifique.",
      "Le fait de traiter un être humain comme une chose , un objet manipulable en niant sa subjectivité et sa dignité.",
      "Le fait de digitaliser les dossiers du personnel pour une gestion plus fluide et moins bureaucratique."
    ],
    correct: 2,
    explanation: `La réification (<em>res</em>, <em>Verdinglichung</em>) est un concept critique qui décrit le processus par lequel les relations sociales sont transformées en relations entre choses. Appliquée au management, parler de « ressources humaines » c'est mettre sur le même plan les employés et les autres ressources de l'entreprise. L'homme devient une variable d'ajustement, un « coût », un « actif ». Cette vision économique efface la dimension personnelle, morale et sociale du travail.    \nExemple : Un plan social qui licencie des centaines de personnes pour « améliorer la productivité » et faire monter le cours en Bourse traite les salariés comme des chiffres négatifs sur un bilan, occultant totalement le drame humain et social.`
  },

  // Question n°79
  {
    question: "Question n°79 : Que montre le film <em>Yes Man</em> ?",
    answers: [
      "Les dangers de dire oui à tout, qui mènent à des situations absurdes, dangereuses et aliénantes.",
      "Que le bonheur et l'ouverture à la vie peuvent advenir en disant « oui » aux opportunités.",
      "L'importance d'être prudent, de savoir dire « non » pour se protéger des mauvaises influences."
    ],
    correct: 2,
    explanation: `Le film comique <em>Yes Man</em> met en scène un homme blasé qui se met au défi de dire « oui » à toute proposition. Cette contrainte absurde le conduit à vivre des aventures improbables, à rencontrer des gens et finalement à se réouvrir au monde. Le film illustre, sur un mode léger, une idée philosophique : une source du mal-être contemporain est la fermeture sur soi, la peur du risque. Dire « oui » symbolise l'acceptation de l'imprévu, de l'altérité et de la vie.    \nExemple : Un jeune qui refuse les invitations par paresse ou cynisme s'enferme dans une bulle. En acceptant une sortie, un projet associatif, une conversation, il brise cette bulle et recrée du lien et du sens, luttant contre l'atomisation liquide.`
  },

  // Question n°80
  {
    question: "Question n°80 : Quelle est la principale caractéristique de la « biotechnologie rouge » ?",
    answers: [
      ...
      "Son application à la dépollution (bactéries mangeuses de pétrole, enzymes industrielles)."
    ],
    correct: 2,
    explanation: `Les biotechnologies sont classées par couleur. La biotechnologie « rouge » est dédiée au secteur de la santé et de la médecine. Elle utilise les organismes vivants ou leurs composants pour développer de nouveaux médicaments, vaccins, thérapies géniques ou cellulaires, ou pour créer des dispositifs médicaux innovants. C'est le domaine le plus directement lié à l'augmentation humaine thérapeutique, mais aussi le plus sensible éthiquement.    \nExemple : La bio-imprimante 3D F3DB, capable d'imprimer des cellules vivantes directement sur un organe lésé pour le réparer, est une application spectaculaire de biotechnologie rouge. Les vaccins à ARN messager contre le Covid-19 en sont une autre illustration.`
  },

  // Question n°81
  {
    question: "Question n°81 : Que symbolise la « boîte cognitive objectivée » dont parle Michel Serres ?",
    answers: [
      "Une nouvelle forme de boîte crânienne, plus grosse, que développeront les futurs humains augmentés.",
      "L'ensemble des dispositifs numériques qui fonctionnent comme une mémoire et une intelligence externes.",
      "Les bibliothèques physiques et les centres d'archives, premiers supports de la mémoire collective."
    ],
    correct: 2,
    explanation: `Pour Serres, avec le numérique, notre cognition n'est plus seulement un processus interne. Elle est désormais partagée avec des machines qui en contiennent une partie objectivée. Cette « boîte cognitive » (l'ordinateur, le réseau) est à la fois un prolongement et un miroir de notre esprit. Nous dialoguons avec elle, lui déléguons des tâches, et puisons en elle des informations. Cette externalisation change la nature même de la pensée.    \nExemple : Lorsque vous utilisez un moteur de recherche pour vous souvenir d'un fait, un GPS pour vous orienter, ou un logiciel de traduction, vous utilisez cette « boîte cognitive objectivée » comme une prothèse de votre propre cerveau.`
  },

  // Question n°82
  {
    question: "Question n°82 : Quelles sont les <em>trois pulsions de l'homme</em> évoquées pour expliquer la menace qu'il fait peser sur le monde ?",
    answers: [
      "La pulsion de libidineuse, la pulsion de mort et la pulsion de pouvoir.",
      "La pulsion de reproduction, la pulsion du territoire et la pulsion de hiérarchie.",
      "La pulsion de consommation, la pulsion de possession et la pulsion de reconnaissance sociale."
    ],
    correct: 2,
    explanation: `Pour expliquer la dynamique apparemment irrationnelle de la destruction environnementale, on peut invoquer trois pulsions fondamentales, héritées de notre évolution. La pulsion de reproduction conduit à une population croissante. La pulsion du territoire pousse à s'approprier toujours plus d'espace et de ressources. La pulsion de hiérarchie (ou d'égoïsme) fait que les individus et les nations privilégient leur bien-être immédiat au détriment du bien commun et des générations futures.    \nExemple : La déforestation de l'Amazonie combine ces trois pulsions : des populations en croissance ont besoin de terres (reproduction), des acteurs s'approprient de vastes territoires (territoire), et les intérêts économiques privés priment sur la préservation d'un bien commun planétaire (hiérarchie/égoïsme).`
  },

  // Question n°83
  {
    question: "Question n°83 : Que signifie le terme <em>doxa</em> dans le contexte de la défiance envers la science ?",
    answers: [
      "La science véritable, fondée sur la démonstration et l'expérience, par opposition aux croyances.",
      "L'opinion courante non fondée sur la connaissance rigoureuse et qui tend à remplacer la science.",
      "Une forme de religion séculière, centrée sur la croyance en la toute-puissance de la technique."
    ],
    correct: 2,
    explanation: `Dans la philosophie grecque, la <em>doxa</em> (δόξα) s'oppose à l'<em>epistémè</em> (ἐπιστήμη, science vraie). La <em>doxa</em> est l'opinion, la croyance fluctuante, influencée par les apparences. On peut craindre le retour de la doxa comme mode de connaissance dominant. Sur les réseaux sociaux, ce qui fait « vérité » n'est pas la démonstration, mais ce qui est cru par le plus grand nombre, ce qui est répété par des influenceurs. La science perd son statut d'autorité face à cette doxa numérique.    \nExemple : L'idée que les vaccins modifient notre ADN est une doxa qui circule largement, basée sur des approximations et des peurs, malgré les démentis scientifiques (<em>epistémè</em>) répétés des généticiens.`
  },

  // Question n°84
  {
    question: "Question n°84 : Quelle est la fonction du conditionnement prénatal par privation d'oxygène dans <em>Le Meilleur des mondes</em> ?",
    answers: [
      "Soigner les maladies congénitales et assurer la naissance de bébés parfaitement sains.",
      "Créer délibérément des déficiences chez les embryons des castes inférieures.",
      "Améliorer la santé des fœtus en les habituant à un environnement pauvre en oxygène."
    ],
    correct: 2,
    explanation: `L'eugénisme dans le monde d'Huxley est négatif et social. Il ne vise pas à créer une race supérieure, mais à fabriquer des êtres parfaitement adaptés et heureux dans leur condition sociale prédéterminée. Pour les castes inférieures (Epsilon, Delta), cela implique de les rendre intellectuellement limités et physiquement robustes. La privation d'oxygène est une technique systématique pour atrophier le cerveau et le squelette, produisant des ouvriers dociles.    \nExemple : Un Embryon Epsilon destiné à être égoutier ou mineur sera conditionné à aimer l'obscurité et la chaleur, garantissant qu'il n'aspirera jamais à autre chose qu'à son travail souterrain, incarnant l'horreur d'une science mise au service d'une stratification sociale biologique.`
  },

  // Question n°85
  {
    question: "Question n°85 : Que signifie l'idée que l'homme est par principe perfectible, contrairement à l'animal ?",
    answers: [
      "Que l'homme peut devenir physiquement plus fort et plus rapide que n'importe quel animal par l'entraînement.",
      "Que l'homme a la capacité de se transformer par l'apprentissage, la culture, la technique et la morale.",
      "Que l'homme est moralement perfectible alors que l'animal reste toujours dans l'immoralité naturelle."
    ],
    correct: 2,
    explanation: `Cette idée, centrale chez Rousseau et les Lumières, fonde l'humanisme. L'animal est parfaitement adapté par l'évolution, mais il est « fermé » dans sa programmation instinctive. L'homme, lui, naît « inachevé », avec des instincts faibles. Cette indétermination est sa chance : elle le condamne à inventer, à apprendre, à créer des institutions, à progresser moralement. Sa « nature » est de n'avoir pas de nature fixe.    \nExemple : Un louveteau saura instinctivement chasser. Un enfant humain devra tout apprendre (marcher, parler, lire) et pourra devenir artiste, scientifique ou tyran selon son éducation et ses choix, illustrant cette ouverture et cette responsabilité.`
  },

  // Question n°86
  {
    question: "Question n°86 : Que révèle l'exemple des messages twits limités à 280 caractères et faisant en moyenne 33 caractères ?",
    answers: [
      "La paresse des utilisateurs de twitter, qui ne veulent pas faire l'effort de rédiger des messages longs.",
      "Comment les nouveaux moyens de communication peuvent rendre difficile une discussion approfondie.",
      "La supériorité de la communication écrite courte, plus directe et percutante que les longs discours."
    ],
    correct: 2,
    explanation: `On peut pointer ce paradoxe : l'explosion des moyens de communication s'accompagne souvent d'un appauvrissement du contenu des échanges. Twitter, avec sa limite de caractères, est l'archétype de la communication en slogans, en punchlines, en réactions épidermiques. Une moyenne de 33 caractères correspond à une phrase très courte. Il est impossible d'y développer un argument complexe, de nuancer, de citer ses sources. Cela favorise la polémique et le simplisme.    \nExemple : Un débat politique sur Twitter se réduit souvent à des échanges d'insultes et de formules choc, tandis qu'un débat télévisé de deux heures permettait au moins un développement minimal des arguments.`
  },

  // Question n°87
  {
    question: "Question n°87 : Que signifie la phrase « la génération Z est en fait bien plus réac » utilisée par un spécialiste de l'Ifop ?",
    answers: [
      "Les jeunes sont plus contestataires que leurs aînés, prêts à renverser l'ordre établi.",
      "Les jeunes montrent sur certains sujets des attitudes plus conservatrices, voire réactionnaires.",
      "Ils réagissent plus vite et plus fortement aux stimuli médiatiques, notamment aux injustices perçues."
    ],
    correct: 2,
    explanation: `L'étude bouleverse un cliché : la jeune génération, censée être ouverte et progressiste, révèle en fait des tendances fortes au conservatisme, notamment dans les milieux religieux. Le poids du facteur religieux (musulman et évangélique) pousse une partie de la jeunesse vers des positions littéralistes, anti-évolutionnistes, parfois anti-avortement et méfiantes envers la science moderne. Cette « réac-attitude » s'exprime aussi dans l'adhésion à des théories du complot.    \nExemple : Le fait qu'un quart des jeunes croient possible d'avorter sans risque avec des plantes, croyance plus répandue chez les « croyants et religieux », montre un recul des connaissances médicales basiques au profit de croyances traditionnelles, signe de conservatisme en matière de santé et de corps.`
  },

  // Question n°88
  {
    question: "Question n°88 : Que symbolise la figure du <em>Sauvage</em> (John) face aux citoyens conditionnés du <em>Meilleur des mondes</em> ?",
    answers: [
      "La supériorité de la civilisation primitive, plus authentique et plus proche de la nature.",
      "La contradiction irréductible entre l'humanité authentique et l'humanité artificielle.",
      "Un simple attardé mental, incapable de s'adapter au bonheur moderne et donc voué à l'échec."
    ],
    correct: 2,
    explanation: `John incarne tout ce que la société a voulu éradiquer pour assurer son bonheur et sa stabilité. Il a connu l'amour maternel, la jalousie, la foi, la lecture de la grande littérature, la souffrance et le sentiment de la mort. Sa rencontre avec la société « civilisée » est un choc des mondes. Son désespoir et son suicide signifient qu'il n'y a pas de place pour une humanité pleine et entière dans un paradis artificiel. Il préfère la douleur d'être humain.    \nExemple : La scène où John tente de libérer les Delta de leur distribution de soma en leur criant qu'ils sont « esclaves », et où ceux-ci, paniqués, le repoussent, montre l'abîme entre la quête de liberté et le confort de la servitude volontaire.`
  },

  // Question n°89
  {
    question: "Question n°89 : Quelle est la principale caractéristique d'une <em>dystopie</em> littéraire par rapport à un simple récit d'horreur ?",
    answers: [
      "Elle se passe toujours dans un futur lointain ou alternatif, utilisant la science-fiction comme cadre.",
      "Elle présente une société qui prétend à une perfection obtenue au prix de la perte de liberté.",
      "Elle met en scène des monstres, des catastrophes ou des phénomènes surnaturels pour faire peur au lecteur."
    ],
    correct: 2,
    explanation: `La dystopie n'est pas simplement un monde horrible ; c'est un monde qui justifie son horreur par un grand récit séduisant : le bonheur pour tous, la paix, la stabilité sociale, le progrès scientifique. Le cauchemar réside dans la perversion de valeurs nobles en instruments de contrôle total. Le lecteur est amené à comprendre comment une utopie peut devenir un enfer quand elle est réalisée sans respect pour la complexité humaine.    \nExemple : Dans <em>1984</em>, le Parti prétend œuvrer pour un monde sans guerre, sans injustice. En réalité, il utilise cette promesse pour justifier une surveillance totale et l'abolition de la pensée, créant la pire des injustices.`
  },

  // Question n°90
  {
    question: "Question n°90 : Que signifie l'expression <em>nomadisme</em> dles jeunes par rapport au CDI dans une société liquide ?",
    answers: [
      "Les jeunes aiment voyager pendant leurs vacances et aspirent à un mode de vie de « digital nomad ».",
      "La précarisation du marché du travail qui fait que les jeunes enchaînent les CDD, intérims et stages.",
      "Un style de vie choisi et assumé, refusant l'enracinement et la routine du CDI pour plus de liberté."
    ],
    correct: 2,
  ...
  // Question n°91
  {
    question: "Question n°91 : Que montre le film <em>Sully</em> (de Clint Eastwood) ?",
    answers: [
      "La dangerosité des vols au-dessus de l'Hudson et la nécessité de changer les couloirs aériens.",
      "La supériorité de l'instinct et de l'expérience humaine face à la froide logique des ordinateurs.",
      "La nécessité de mieux former les pilotes automatiques pour qu'ils puissent gérer ce type d'incident."
    ],
    correct: 2,
    explanation: `Le film raconte l'« amerrissage forcé » réussi du vol 1549 sur l'Hudson par le pilote Chesley « Sully » Sullenberger. Le conflit oppose Sully, qui a pris la décision en quelques secondes basée sur son expérience, à une enquête qui utilise des simulations informatiques pour suggérer qu'il aurait pu rejoindre un aéroport. Le film montre que les modèles ne peuvent intégrer tous les paramètres humains (stress, temps de réaction) et que le jugement expert peut être supérieur.    \nExemple : Les simulations supposaient une réaction immédiate et parfaite. Sully a dû évaluer, communiquer, rassurer, et choisir le seul plan d'eau viable en quelques secondes, un jugement situationnel qu'aucun ordinateur de l'époque ne pouvait modéliser.`
  },

  // Question n°92
  {
    question: "Question n°92 : Que signifie, dans la société liquide, l'idée que le corps est une fin à améliorer plutôt qu'un moyen ?",
    answers: [
      "Il faut faire du sport et manger correctement pour être en bonne santé.",
      "Le corps est un objet de consommation et de représentation de soi.",
      "La médecine fait du corps un projet de perfection technique achevable."
    ],
    correct: 2,
    explanation: `Dans une société de consommation où l'identité se construit par l'image, le corps devient le premier support de cette identité marchande. On ne l'entretient plus seulement pour qu'il fonctionne bien (santé comme moyen), mais pour qu'il « paraisse » bien, qu'il soit performant esthétiquement. Le culte du corps « fit », jeune et conforme devient une fin en soi, alimentant des industries. Le corps devient un projet perpétuel d'amélioration, source d'insatisfaction constante.    \nExemple : La prolifération des selfies sur les réseaux sociaux, où l'on expose son corps filtré, et la pression pour avoir un « summer body » illustrent cette transformation du corps en objet de performance sociale et de consommation.`
  },

  // Question n°93
  {
    question: "Question n°93 : Que signifie l'idée de <em>vérités alternatives</em> ?",
    answers: [
      "Des découvertes scientifiques révolutionnaires non encore reconnues par les académies traditionnelles.",
      "Des croyances qui prétendent offrir des explications concurrente de la science établie.",
      "Des opinions politiques différentes, légitimes dans le cadre d'un débat démocratique pluraliste."
    ],
    correct: 2,
    explanation: `L'expression « vérités alternatives » (ou « faits alternatifs »), popularisée sous la présidence Trump, désigne la prétention à substituer aux faits objectifs des récits subjectifs qui servent une idéologie ou une identité. Dans l'étude, ces « vérités » vont du créationnisme à la négation de l'alunissage. Elles ne résistent pas à l'examen scientifique, mais prospèrent car elles répondent à un besoin de sens, d'appartenance ou de révolte.    \nExemple : L'affirmation selon laquelle le massacre de Boutcha a été « mis en scène par les Ukrainiens » est une « vérité alternative » propagée par la Russie, qui nie les preuves accablantes pour servir sa narration. 26% des jeunes Français y croient.`
  },

  // Question n°94
  {
    question: "Question n°94 : Quelle est la vision de la technique dans le mythe de Prométhée ?",
    answers: [
      "Un don divin bienveillant, offert aux hommes pour leur salut et leur épanouissement.",
      "Un vol, une transgression nécessaire mais risquée, qui arrache l'homme à l'animalité.",
      "Une malédiction à l'origine de tous les malheurs de l'humanité et qu'il faut regretter."
    ],
    correct: 2,
    explanation: `Le mythe est ambigu. D'un côté, la technique sauve l'homme de l'impuissance naturelle et le rapproche des dieux. De l'autre, elle est acquise par la ruse et le vol, dans la violence. Elle déclenche la vengeance divine (Pandore, le travail, la maladie). Ainsi, la technique n'est pas présentée comme un simple progrès, mais comme un pacte faustien : l'homme gagne en puissance, mais perd l'innocence. Elle est à la fois libératrice et source de nouveaux malheurs.    \nExemple : L'énergie nucléaire illustre cette ambivalence : elle offre une source d'énergie prodigieuse (le feu moderne) mais avec le risque de catastrophes apocalyptiques (Tchernobyl) – une puissance qui peut se retourner contre son créateur.`
  },

  // Question n°95
  {
    question: "Question n°95 : Que signifie la <em>perte de crédibilité des sachants</em> comme cause de la défiance scientifique ?",
    answers: [
      "Les scientifiques commettent trop d'erreurs et de fraudes, discréditant ainsi leur discipline.",
      "Les figures traditionnelles de l'autorité savante ne sont plus perçues comme des sources neutres.",
      "Les jeunes n'écoutent plus leurs professeurs, par un effet de rébellion générationnel classique."
    ],
    correct: 2,
    explanation: `La défiance ne vise pas la science en tant que méthode, mais ses représentants institutionnels. Plusieurs crises (affaire du sang contaminé, vache folle, déni climatique de certains scientifiques liés à l'industrie) ont entamé la confiance. Les « sachants » sont aussi suspectés d'être au service du pouvoir ou de former une caste élitiste. Sur les réseaux sociaux, cette crédibilité est concurrencée par celle des « influenceurs » qui paraissent plus authentiques.    \nExemple : Pendant la pandémie de Covid-19, les revirements apparents des experts (sur les masques) et les conflits publics entre scientifiques ont nourri l'idée qu'« ils ne savent pas » ou qu'« ils nous mentent », sapant leur autorité.`
  },

  // Question n°96
  {
    question: "Question n°96 : Quelle proposition de Yves Paccalet résume sa réponse à la crise écologique dans <em>Sortie de secours</em> ?",
    answers: [
      "Accélérer le progrès technique et la colonisation spatiale pour trouver de nouvelles ressources et un nouvel habitat.",
      "Une décroissance économique dans les pays riches puisque ni la technique ni le développement durable ne suffiront.",
      "Un retour obligatoire à un mode de vie agricole de type <em>amish</em>, seul garant d'un équilibre avec la nature."
    ],
    correct: 2,
    explanation: `Yves Paccalet, dans la lignée de la décroissance, estime que l'idée d'un « développement durable » ou d'une croissance « verte » est un leurre dans un monde fini. Il prône une décroissance volontaire, radicale et planifiée de notre consommation matérielle et énergétique (diviser par deux la consommation des pays riches). Pour lui, l'humanité n'est pas prête à ce renoncement, ce qui rend cette solution utopique mais nécessaire, l'alternative étant le « néant » de l'effondrement.    \nExemple : Réduire drastiquement l'usage de la voiture individuelle, limiter le chauffage, généraliser une alimentation locale et peu carnée, et ralentir le rythme de renouvellement des objets sont des mesures concrètes de décroissance.`
  },

  // Question n°97
  {
    question: "Question n°97 : Quel est l'argument économique classique de Jean-Baptiste Say concernant la croissance ?",
    answers: [
      "Elle est nécessairement limitée par la quantité finie de ressources naturelles et de travail disponible.",
      "L'accumulation du capital et le progrès technique peuvent compenser les limites des ressources.",
      "Elle doit être remplacée par une économie stationnaire pour préserver l'environnement et la paix sociale."
    ],
    correct: 2,
    explanation: `L'économiste classique Jean-Baptiste Say est un optimiste de la croissance. Il considère que l'accumulation du capital (machines, usines) et l'innovation peuvent compenser les limites des ressources naturelles et du travail. Les matières premières se substituent les unes aux autres, et le progrès permet de faire plus avec moins. Cette vision a dominé la pensée économique jusqu'aux chocs pétroliers et à la prise de conscience écologique.    \nExemple : Le pétrole a remplacé le charbon, les fibres synthétiques remplacent partiellement le coton, et les énergies renouvelables pourraient à l'avenir remplacer les fossiles, illustrant la substituabilité des ressources dans la vision optimiste de Say.`
  },

  // Question n°98
  {
    question: "Question n°98 : Quel exemple de <em>cobot</em> est donné pour illustrer la collaboration homme-machine ?",
    answers: [
      "Un robot-chien de compagnie capable de détecter les émotions de son propriétaire.",
      "Un exosquelette porté permettant de soulever des charges lourdes sans effort.",
      "Une intelligence artificielle capable de répondre aux questions des clients."
    ],
    correct: 2,
    explanation: `Le « cobot » (robot collaboratif) représente une vision où la machine amplifie les capacités humaines sans les remplacer. L'exosquelette est un cobot porté : il augmente la force physique de l'opérateur tout en laissant à celui-ci le contrôle des mouvements, la dextérité et l'intelligence de la tâche. L'homme et la machine travaillent en symbiose, l'un apportant la puissance, l'autre le jugement et l'adaptabilité.    \nExemple : Dans un entrepôt logistique, un exosquelette permet à un préparateur de commandes de manipuler des colis lourds toute la journée sans se blesser le dos, combinant l'efficacité technique au savoir-faire humain pour choisir et emballer les articles.`
  },

  // Question n°99
  {
    question: "Question n°99 : Que critique le film <em>Une nouvelle chance</em> à propos des nouvelles méthodes de recrutement sportif ?",
    answers: [
      "Le recrutement se fait sur des critères physiques (taille, poids) au détriment du talent technique.",
      "La survalorisation des algorithmes, qui ignorent des qualités comme le mental ou l'expérience du jeu.",
      "La corruption des jeunes joueurs par des agents qui les poussent à signer des contrats désavantageux."
    ],
    correct: 2,
    explanation: `Le film oppose un vieux recruteur à l'ancienne, Gus, qui observe les joueurs avec son expérience et son intuition, à des méthodes modernes basées sur l'analyse informatique de statistiques (« sabermetrics »). Il dénonce la froideur et l'aveuglement de ces algorithmes qui, en réduisant le joueur à des données quantitatives, manquent l'essentiel : le mental, le caractère, la capacité à performer sous pression, toutes qualités qui échappent aux chiffres.    \nExemple : Un algorithme pourrait rejeter un joueur de baseball à cause d'une mauvaise moyenne au bâton, sans voir qu'il excelle dans les moments décisifs des playoffs ou qu'il a un leadership exceptionnel dans son équipe, qualités pourtant décisives pour le succès collectif.`
  },

  // Question n°100
  {
    question: "Question n°100 : Que peut-on conclure à partir de la séquence sur « L'humain et ses limites » sur l'avenir du progrès ?",
    answers: [
      "L'homme doit renoncer à toute ambition technique et scientifique pour revenir à un état de nature préservé et harmonieux.",
      "L'homme, être limité mais perfectible, doit apprendre à maîtriser ses créations avec sagesse, mesure et responsabilité.",
      "Le progrès est inéluctablement mortifère et conduit à l'effondrement : il n'y a donc pas d'espoir pour l'avenir de l'humanité."
    ],
    correct: 2,
    explanation: `Il faut éviter l'optimisme naïf et le pessimisme absolu. L'homme est confronté à des dangers colossaux qu'il a lui-même créés en dépassant ses limites (armes de destruction, crise écologique, aliénation technologique). Cette capacité de dépassement est son propre. L'enjeu n'est donc pas de renoncer au progrès, mais de l'orienter par la politique, l'éthique et l'éducation. Il faut réapprendre la modération, développer l'esprit critique, et inventer des utopies pragmatiques pour un avenir où la technique serve la liberté et la dignité dans un monde préservé.    \nExemple : Le principe de précaution, l'enseignement de la pensée critique, la régulation des réseaux sociaux, ou la recherche de technologies sobres, sont des tentatives pour réintroduire de la sagesse et des limites dans le déploiement de la puissance humaine.`
  }
];