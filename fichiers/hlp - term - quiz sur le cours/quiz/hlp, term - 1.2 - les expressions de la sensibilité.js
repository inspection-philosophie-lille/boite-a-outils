...
const questions = [
  // Question n°1
  {
    question: "Question 1 : Que signifie étymologiquement le terme <em>expression</em> ?",
    answers: [
  ...
  // Question n°2
  {
    question: "Question 2 : Selon la comparaison développée par Platon dans le <em>Phèdre</em>, que symbolisent les deux chevaux noir et blanc de l'attelage qui représente l'âme humaine ?",
    answers: [
  ...
  // Question n°3
  {
    question: "Question 3 : Comment Kant, dans son <em>Anthropologie</em>, distingue-t-il principalement la passion de l'émotion ?",
    answers: [
  ...
  // Question n°4
  {
    question: "Question 4 : Quelle est la thèse centrale de Schopenhauer, présentée dans la séance 1, concernant le sentiment amoureux ?",
    answers: [
  ...
  // Question n°5
  {
    question: "Question 5 : Pourquoi faut-il attendre le XVIIIe siècle pour voir un intérêt marqué pour la sensibilité en littérature et en philosophie ?",
    answers: [
  ...
  // Question n°6
  {
    question: "Question 6 : Quelle affirmation de Maurice Merleau-Ponty résume le rôle du corps dans notre rapport au monde ?",
    answers: [
  ...
  // Question n°7
  {
    question: "Question 7 : Selon David Le Breton, quelle reformulation du cogito cartésien mettrait mieux en lumière la condition humaine ?",
    answers: [
  ...
  // Question n°8
  {
    question: "Question 8 : Outre les cinq sens traditionnels, quel sens est défini comme « la capacité à localiser les parties de son corps dans l'espace sans utiliser la vue » ?",
    answers: [
      "La proprioception.",
      "La nociception.",
      "L'équilibrioception."
  ...
  // Question n°9
  {
    question: "Question 9 : Dans la réflexion sur la peau comme lieu de la sensibilité, que permet-elle par rapport à l'identité ?",
    answers: [
  ...
  // Question n°10
  {
    question: "Question 10 : Quelle est la principale différence entre « sympathie » et « empathie » ?",
    answers: [
  ...
  // Question n°11
  {
    question: "Question 11 : Dans l'extrait des <em>Rêveries du promeneur solitaire</em>, comment Rousseau décrit-il l'effet du spectacle du lac de Bienne sur son âme ?",
    answers: [
  ...
  // Question n°12
  {
    question: "Question 12 : Quel est « l'effet Werther », évoqué à propos du roman de Goethe ?",
    answers: [
  ...
  // Question n°13
  {
    question: "Question 13 : Quelle émotion spécifique, profonde et sans cause apparente, caractérise le « mal du siècle » romantique ?",
    answers: [
  ...
  // Question n°14
  {
    question: "Question 14 : Dans <em>Lorenzaccio</em> d'Alfred de Musset, pourquoi le personnage éponyme compare-t-il le meurtre qu'il projette à « un brin d'herbe » ?",
    answers: [
  ...
  // Question n°15
  {
    question: "Question 15 : Selon l'analyse kantienne du sublime, que découvre l'homme face à la puissance irrésistible de la nature ?",
    answers: [
  ...
  // Question n°16
  {
    question: "Question 16 : Dans la citation de Chateaubriand (<em>René</em>), comment le narrateur décrit-il le rapport entre le « chant naturel de l'homme » et le bonheur ?",
    answers: [
  ...
  // Question n°17
  {
    question: "Question 17 : Dans « Le Lac » de Lamartine, quelle est la requête adressée au temps par les amants ?",
    answers: [
  ...
  // Question n°18
  {
    question: "Question 18 : Comment Alfred de Musset, dans <em>La Confession d'un enfant du siècle</em>, décrit-il la situation de sa génération entre le passé et l'avenir ?",
    answers: [
  ...
  // Question n°19
  {
    question: "Question 19 : Quelle mission Victor Hugo assigne-t-il au poète dans l'extrait des <em>Rayons et les ombres</em> ?",
    answers: [
  ...
  // Question n°20
  {
    question: "Question 20 : Selon Hegel, cité dans la séance 3, de quelle double manière l'homme acquiert-il la conscience de lui-même ?",
    answers: [
  ...
  // Question n°21
  {
    question: "Question 21 : Que signifie, selon Bergson, « l'intensité » d'un état d'âme comme un désir profond ?",
    answers: [
  ...
  // Question n°22
  {
    question: "Question 22 : Pourquoi, selon Bergson, une personne non initiée à la musique classique a-t-elle du mal à apprécier une symphonie de Beethoven ?",
    answers: [
  ...
  // Question n°23
  {
    question: "Question 23 : Que signifie la formule de Pascal « L'homme passe l'homme » par rapport à l'expression spirituelle de la sensibilité ?",
    answers: [
  ...
  // Question n°24
  {
    question: "Question 24 : Pourquoi Bergson affirme-t-il, dans <em>L'Énergie spirituelle</em>, qu'une connaissance parfaite du cerveau ne permettrait pas de déduire avec certitude l'état d'âme correspondant ?",
    answers: [
  ...
  // Question n°25
  {
    question: "Question 25 : Dans <em>La Nausée</em> de Sartre, que découvre soudainement le personnage Roquentin en contemplant la racine du marronnier ?",
    answers: [
  ...
  // Question n°26
  {
    question: "Question 26 : Dans les définitions d'Alain, comment se situe le « sentiment » par rapport à l'« émotion » et à la « passion » ?",
    answers: [
  ...
  // Question n°27
  {
    question: "Question 27 : Selon Merleau-Ponty dans <em>Le doute de Cézanne</em>, en quoi la peinture de Cézanne se distingue-t-elle de celle des Impressionnistes ?",
    answers: [
  ...
  // Question n°28
  {
    question: "Question 28 : Selon Nietzsche dans <em>Par-delà le bien et le mal</em>, sur quoi repose fondamentalement la capacité de se comprendre mutuellement par le langage ?",
    answers: [
  ...
  // Question n°29
  {
    question: "Question 29 : Contre quelle opinion Rousseau s'élève-t-il dans l'<em>Essai sur l'origine des langues</em> concernant l'invention de la parole ?",
    answers: [
  ...
  // Question n°30
  {
    question: "Question 30 : Dans l'approche naturaliste, quelle est la thèse originale de William James sur le lien entre l'émotion et les modifications corporelles ?",
    answers: [
  ...
  // Question n°31
  {
    question: "Question 31 : Quelle expérience de Duchenne de Boulogne suggère une approche matérialiste des expressions émotionnelles ?",
    answers: [
  ...
  // Question n°32
  {
    question: "Question 32 : Selon la perspective constructiviste défendue par Merleau-Ponty, pourquoi la mimique de la colère n'est-elle pas la même chez un Japonais et un Occidental ?",
    answers: [
  ...
  // Question n°33
  {
    question: "Question 33 : Quel concept émotionnel danois désigne un sentiment de bien-être lié à la convivialité et au confort ?",
    answers: [
      "Hygge.",
      "Saudade.",
      "Sisu."
  ...
  // Question n°34
  {
    question: "Question 34 : Quel serait l'effet combiné de la culture de la consommation et de la technologie sur les relations amoureuses contemporaines ?",
    answers: [
  ...
  // Question n°35
  {
    question: "Question 35 : Entre le « vitalisme » de Schopenhauer et le « romantisme », quelle approche semble finalement prévaloir dans la compréhension du sentiment amoureux ?",
    answers: [
  ...
  // Question n°36
  {
    question: "Question 36 : Que signifie étymologiquement le terme « sensibilité » ?",
    answers: [
  ...
  // Question n°37
  {
    question: "Question 37 : Quelle est la conséquence principale, selon Platon, si le cocher (la raison) ne parvient pas à maîtriser le cheval noir (les désirs désordonnés) ?",
    answers: [
  ...
  // Question n°38
  {
    question: "Question 38 : Quelle image Rousseau utilise-t-il pour décrire l'effet des vagues du lac sur son esprit dans les <em>Rêveries</em> ?",
    answers: [
  ...
  // Question n°39
  {
    question: "Question 39 : Quelle est la caractéristique de l'angoisse, évoquée dans la séance 4, par rapport à la peur ?",
    answers: [
  ...
  // Question n°40
  {
    question: "Question 40 : Dans la théorie constructiviste des émotions, que signifie l'affirmation selon laquelle les émotions seraient « inventées comme les mots » ?",
    answers: [
  ...
  // Question n°41
  {
    question: "Question 41 : Quelle est la thèse défendue par Lisa Feldman Barrett concernant la création des émotions ?",
    answers: [
  ...
  // Question n°42
  {
    question: "Question 42 : Quelle affirmation résume le mieux le point de vue du romantisme sur le rapport entre l'individu et la Nature ?",
    answers: [
  ...
  // Question n°43
  {
    question: "Question 43 : Que recherche fondamentalement le héros romantique à travers l'expression de sa souffrance et de sa mélancolie ?",
    answers: [
  ...
  // Question n°44
  {
    question: "Question 44 : En quoi l'exemple de Pierre Scerri (12 ans pour construire une voiture miniature) illustre-t-il la conception kantienne de la passion ?",
    answers: [
  ...
  // Question n°45
  {
    question: "Question 45 : Que permet de comprendre l'expérience de <em>l'hallucination</em> ?",
    answers: [
  ...
  // Question n°46
  {
    question: "Question 46 : Pourquoi Aristote a-t-il « spatialisé » les sens et les a-t-il organisés en deux groupes ?",
    answers: [
  ...
  // Question n°47
  {
    question: "Question 47 : Quel est le « dysfonctionnement » associé à la thermoception, le sens de la température ?",
    answers: [
  ...
  // Question n°48
  {
    question: "Question 48 : Pourquoi le vocabulaire pour décrire les odeurs est-il généralement plus pauvre que celui pour décrire les choses vues ?",
    answers: [
  ...
  // Question n°49
  {
    question: "Question 49 : Que signifie l'expression « se mettre dans la peau de quelqu'un », analysée dans la partie sur la peau et l'identité ?",
    answers: [
  ...
  // Question n°50
  {
    question: "Question 50 : Comment définir le « sentiment » par opposition à l'« émotion », dans le cadre général de la sensibilité ?",
    answers: [
  ...
  // Question n°51
  {
    question: "Question 51 : Quelle idée Chateaubriand exprime-t-il lorsqu'il écrit, dans <em>René</em>, « notre cœur est un instrument incomplet » ?",
    answers: [
  ...
  // Question n°52
  {
    question: "Question 52 : Dans la théorie de William James, quelle serait la conséquence logique si l'on supprimait toutes les sensations corporelles associées à une émotion ?",
    answers: [
  ...
  // Question n°53
  {
    question: "Question 53 : Quel argument avancer pour dire que la sensibilité « conditionne notre rapport au monde » depuis l'Antiquité ?",
    answers: [
  ...
  // Question n°54
  {
    question: "Question 54 : Que désigne le <em>conatus</em> chez Schopenhauer ?",
    answers: [
  ...
  // Question n°55
  {
    question: "Question 55 : Selon la lecture essentialiste du romantisme (René Wellek), que cherche-t-on à identifier ?",
    answers: [
  ...
  // Question n°56
  {
    question: "Question 56 : Selon la lecture relativiste du romantisme, comment faut-il parler du romantisme ?",
    answers: [
  ...
  // Question n°57
  {
    question: "Question 57 : Que signifie « l'effet Papageno », opposé à « l'effet Werther » ?",
    answers: [
  ...
  // Question n°58
  {
    question: "Question 58 : Quelle est la fonction attribuée à la peau dans la communication sociale ?",
    answers: [
  ...
  // Question n°59
  {
    question: "Question 59 : Comment définir la « passion » dans son sens philosophique fort ?",
    answers: [
  ...
  // Question n°60
  {
    question: "Question 60 : Quelle est la « difficulté méthodologique » principale lorsqu'on cherche à étudier la sensibilité ?",
    answers: [
  ...
  // Question n°61
  {
    question: "Question 61 : Quel auteur du XXe siècle affirme que « tout est fabriqué et tout est naturel chez l'homme » à propos des émotions ?",
    answers: [
  ...
  // Question n°62
  {
    question: "Question 62 : Selon Hegel, pourquoi l'art est-il capable de nous toucher universellement, même à travers la singularité d'une œuvre ?",
    answers: [
  ...
  // Question n°63
  {
    question: "Question 63 : Quelle est la critique adressée par le romantisme au rationalisme des Lumières du XVIIIe siècle ?",
    answers: [
  ...
  // Question n°64
  {
    question: "Question 64 : Comment caractériser l'engagement politique des écrivains romantiques comme Hugo ou Lamartine ?",
    answers: [
  ...
  // Question n°65
  {
    question: "Question 65 : Quelle est la thèse de Descartes sur l'origine <em>somatique</em> des passions ?",
    answers: [
  ...
  // Question n°66
  {
    question: "Question 66 : Quel sens particulier le romantisme donne-t-il au terme « rêverie », notamment chez Rousseau ?",
    answers: [
  ...
  // Question n°67
  {
    question: "Question 67 : Quelle définition donner du « spleen » baudelairien ?",
    answers: [
  ...
  // Question n°68
  {
    question: "Question 68 : Comment expliquer la phrase de Descartes : « en les examinant, je les [les passions] ai trouvées presque toutes bonnes » ?",
    answers: [
  ...
  // Question n°69
  {
    question: "Question 69 : Quelle est la fonction de la « nociception » ?",
    answers: [
  ...
  // Question n°70
  {
    question: "Question 70 : Comment interpréter l'expression « amour platonique » telle qu'elle est comprise à l'époque romantique ?",
    answers: [
  ...
  // Question n°71
  {
    question: "Question 71 : Quelle est la position de Lactance concernant le corps et la sensualité ?",
    answers: [
  ...
  // Question n°72
  {
    question: "Question 72 : Que cherche-t-on fondamentalement dans le sentiment amoureux ?",
    answers: [
  ...
  // Question n°73
  {
    question: "Question 73 : Quel est le principal obstacle à la transmission de sa sensibilité à autrui ?",
    answers: [
  ...
  // Question n°74
  {
    question: "Question 74 : Comment présenter le rapport du romantisme à l'Histoire ?",
    answers: [
  ...
  // Question n°75
  {
    question: "Question 75 : Quelle est la signification philosophique de l'exemple d'Aron Ralston, qui s'est amputé le bras pour survivre, cité à propos de la nociception ?",
    answers: [
  ...
  // Question n°76
  {
    question: "Question 76 : En quoi l'exemple de la tribu brésilienne Sateré-Mawé porte des gants recouverts de fourmis <em>tucandira</em> (balle de fusil) illustre-t-il le caractère culturel de la sensibilité ?",
    answers: [
  ...
  // Question n°77
  {
    question: "Question 77 : Quelle conception de l'amour est attribué à Socrate dans le <em>Banquet</em> de Platon ?",
    answers: [
  ...
  // Question n°78
  {
    question: "Question 78 : Comment analyser l'expression « avoir quelqu'un dans la peau » ?",
    answers: [
  ...
  // Question n°79
  {
    question: "Question 79 : Selon la thèse de la « construction conceptuelle » des émotions (Lisa Feldman Barrett), que se passe-t-il lorsqu'une culture invente un nouveau mot pour une émotion ?",
    answers: [
  ...
  // Question n°80
  {
    question: "Question 80 : En quoi l'exemple des « nez » en parfumerie répond-il à la « difficulté langagière » concernant l'odorat ?",
    answers: [
  ...
  // Question n°81
  {
    question: "Question 81 : Comment expliquer que l'on puisse être « ponctuellement insensible à la douleur », par exemple lors d'une opération sans anesthésie ?",
    answers: [
  ...
  // Question n°82
  {
    question: "Question 82 : Que signifie l'expression « le temps, comme l'eau, s'écoule inexorablement » dans le contexte romantique ?",
    answers: [
  ...
  // Question n°83
  {
    question: "Question 83 : Quelle est la définition de « l'équilibrioception » ?",
    answers: [
  ...
  // Question n°84
  {
    question: "Question 84 : Pourquoi dire que « la sensibilité n'est pas le désir » ?",
    answers: [
  ...
  // Question n°85
  {
    question: "Question 85 : Comment caractériser la <em>tempérance</em> (φρόνησις) dans la pensée antique, notamment platonicienne ?",
    answers: [
  ...
  // Question n°86
  {
    question: "Question 86 : Que symbolise l'attelage ailé dans le mythe de Phèdre de Platon ?",
    answers: [
  ...
  // Question n°87
  {
    question: "Question 87 : Quelle est la position de Schopenhauer sur la « chose en soi » kantienne ?",
    answers: [
  ...
  // Question n°88
  {
    question: "Question 88 : Pourquoi l'homme romantique se sent-il à la fois faible et fort face à la Nature ?",
    answers: [
  ...
  // Question n°89
  {
    question: "Question 89 : Comment interpréter la phrase de Mme de Staël : « Je suis poète lorsque j’admire, lorsque je méprise, lorsque je hais, non par des sentiments personnels... mais pour la dignité de l’espèce humaine » ?",
    answers: [
  ...
  // Question n°90
  {
    question: "Question 90 : Quelle est, selon la théorie constructiviste, la principale cause des différences observables dans l'expression des émotions d'une culture à l'autre ?",
    answers: [
  ...
  // Question n°91
  {
    question: "Question 91 : Comment définir le « vague à l'âme » lamartinien ?",
    answers: [
  ...
  // Question n°92
  {
    question: "Question 92 : Quel est le sens profond de l'expression « les passions sont des maladies de l'âme » ?",
    answers: [
  ...
  // Question n°93
  {
    question: "Question 93 : En quoi l'art romantique est-il souvent un « art de plein air » ?",
    answers: [
  ...
  // Question n°94
  {
    question: "Question 94 : Pourquoi affirmer que la sensibilité nous confronte à ce à quoi nous sommes sensibles ?",
    answers: [
  ...
  // Question n°95
  {
    question: "Question 95 : Quel est le rôle du « cocher » dans l'allégorie platonicienne de l'attelage ?",
    answers: [
  ...
  // Question n°96
  {
    question: "Question 96 : Comment définir « l'empathie » par distinction avec la simple « sympathie » ?",
    answers: [
  ...
  // Question n°97
  {
    question: "Question 97 : Que signifie l'idée, présente chez Schopenhauer et Freud, selon laquelle le sentiment serait « fictif » ?",
    answers: [
  ...
  // Question n°98
  {
    question: "Question 98 : Pourquoi l'exemple de la personne morte de froid dans une chambre froide en panne peut-il être donné à propos de la thermoception ?",
    answers: [
  ...
  // Question n°99
  {
    question: "Question 99 : Quel est le sens de la phrase de Rousseau : « J’existe, et j’ai des sens par lesquels je suis affecté. Voilà la première vérité qui me frappe » ?",
    answers: [
  ...
  // Question n°100
  {
    question: "Question 100 : Comment faut-il comprendre le débat entre <em>vitalisme</em> et <em>romantisme</em> concernant la sensibilité ?",
    answers: [
