...
const questions = [
  // Question n°1
  {
    question: "Question n°01 : Que signifie étymologiquement le terme <em>expression</em> ?",
    answers: [
      "L'action d'imprimer une marque indélébile sur un support ou dans l'esprit.",
      "L'action de transformer une première impression en quelque chose d'abstrait.",
      "L'action de faire sortir en pressant, de rendre visible ce qui est à l'intérieur."
    ],
    correct: 3,
    explanation: `Étymologiquement, <em>expression</em> vient du latin <em>expressio</em>, qui signifie « action de presser pour faire sortir ». Cela correspond à l'idée de rendre manifeste et visible une réalité intérieure, comme le jus d'un citron qu'on presse. Cette définition est fondamentale : exprimer sa sensibilité, c'est faire advenir à l'extérieur des émotions ou des sentiments d'abord éprouvés intérieurement. Le processus d'expression est ainsi conçu comme une extériorisation et une mise en forme.
    \nExemple : Un artiste qui peint un tableau mélancolique exprime et donne à voir un état d'âme qui était d'abord en lui.`
  },
  // Question n°2
  {
    question: "Question n°02 : Selon la comparaison développée par Platon dans le <em>Phèdre</em>, que symbolisent les deux chevaux noir et blanc de l'attelage qui représente l'âme humaine ?",
    answers: [
      "L'un (blanc) obéit à la raison et aime la modération, l'autre (noir) est rétif et est attiré par le désordre.",
      "L'un (noir) représente l'amour charnel et l'autre (blanc) représente l'amour désincarné.",
      "L'un (noir) symbolise les sens et l'autre (blanc) symbolise la mémoire, les deux étant nécessaires à la connaissance."
    ],
    correct: 1,
  ...
  // Question n°3
  {
    question: "Question n°03 : Comment Kant, dans son <em>Anthropologie</em>, distingue-t-il principalement la passion de l'émotion ?",
    answers: [
      "L'émotion relève du corps, la passion relève exclusivement de l'esprit.",
      "L'émotion est une ivresse passagère, la passion est une maladie enracinée.",
  ...
  // Question n°4
  {
    question: "Question n°04 : Quelle est la thèse centrale de Schopenhauer, présentée dans la séance 1, concernant le sentiment amoureux ?",
    answers: [
  ...
  // Question n°5
  {
    question: "Question n°05 : Pourquoi faut-il attendre le XVIIIe siècle pour voir un intérêt marqué pour la sensibilité en littérature et en philosophie ?",
    answers: [
      "Parce que l'Église a perdu son emprise et a autorisé l'expression des sentiments personnels.",
      "Parce que les périodes de troubles favorisent l'introspection et l'expression du moi.",
  ...
  // Question n°6
  {
    question: "Question n°06 : Quelle affirmation de Maurice Merleau-Ponty résume le rôle du corps dans notre rapport au monde ?",
    answers: [
      "Le corps est une prison pour l'âme, qui l'empêche d'accéder au monde des idées.",
      "Le corps est aussi l'instrument général qui rend possible ma compréhension.",
  ...
  // Question n°7
  {
    question: "Question n°07 : Selon David Le Breton, quelle reformulation du cogito cartésien mettrait mieux en lumière la condition humaine ?",
    answers: [
  ...
  // Question n°8
  {
    question: "Question n°08 : Outre les cinq sens traditionnels, quel sens est défini comme « la capacité à localiser les parties de son corps dans l'espace sans utiliser la vue » ?",
    answers: [
      "La proprioception.",
      "La nociception.",
      "L'équilibrioception."
  ...
  // Question n°9
  {
    question: "Question n°09 : Dans la réflexion sur la peau comme lieu de la sensibilité, que permet-elle par rapport à l'identité ?",
    answers: [
  ...
  // Question n°10
  {
    question: "Question n°10 : Quelle est la principale différence entre « sympathie » et « empathie » ?",
    answers: [
      "La sympathie signifie « souffrir avec », l'empathie signifie « souffrir à la place de ».",
  ...
  // Question n°11
  {
    question: "Question n°11 : Dans l'extrait des <em>Rêveries du promeneur solitaire</em>, comment Rousseau décrit-il l'effet du spectacle du lac de Bienne sur son âme ?",
    answers: [
      "Il le plonge dans une « rêverie délicieuse » qui chasse toute agitation.",
  ...
  // Question n°12
  {
    question: "Question n°12 : Quel est « l'effet Werther », évoqué à propos du roman de Goethe ?",
    answers: [
      "Le phénomène de contagion par lequel le lecteur se suicide à la suite de son héros.",
  ...
  // Question n°13
  {
    question: "Question n°13 : Quelle émotion spécifique, profonde et sans cause apparente, caractérise le « mal du siècle » romantique ?",
    answers: [
      "La mélancolie (tristesse vague).",
  ...
  // Question n°14
  {
    question: "Question n°14 : Dans <em>Lorenzaccio</em> d'Alfred de Musset, pourquoi le personnage éponyme compare-t-il le meurtre qu'il projette à « un brin d'herbe » ?",
    answers: [
      "Parce que c'est la seule chose à laquelle il peut encore se raccrocher.",
  ...
  // Question n°15
  {
    question: "Question n°15 : Selon l'analyse kantienne du sublime, que découvre l'homme face à la puissance irrésistible de la nature ?",
    answers: [
      "Sa supériorité spirituelle qui le rend indépendant de la puissance physique.",
  ...
  // Question n°16
  {
    question: "Question n°16 : Dans la citation de Chateaubriand (<em>René</em>), comment le narrateur décrit-il le rapport entre le « chant naturel de l'homme » et le bonheur ?",
    answers: [
      "Le chant naturel est toujours triste, car notre cœur est un instrument incomplet.",
  ...
  // Question n°17
  {
    question: "Question n°17 : Dans « Le Lac » de Lamartine, quelle est la requête adressée au temps par les amants ?",
    answers: [
  ...
  // Question n°18
  {
    question: "Question n°18 : Comment Alfred de Musset, dans <em>La Confession d'un enfant du siècle</em>, décrit-il la situation de sa génération entre le passé et l'avenir ?",
    answers: [
      "Comme une génération sacrifiée, errant entre un passé détruit et un avenir incertain.",
      "Comme une génération chanceuse, héritière des Lumières et promise à un avenir radieux.",
      "Comme une génération devant reconstruire l'ordre ancien sur des fondements plus solides."
    ],
    correct: 1,
  ...
  // Question n°19
  {
    question: "Question n°19 : Quelle mission Victor Hugo assigne-t-il au poète dans l'extrait des <em>Rayons et les ombres</em> ?",
    answers: [
      "D'être l'homme des utopies qui prépare des jours meilleurs.",
  ...
  // Question n°20
  {
    question: "Question n°20 : Selon Hegel, cité dans la séance 3, de quelle double manière l'homme acquiert-il la conscience de lui-même ?",
    answers: [
      "En se représentant intérieurement et en transformant le monde pour y laisser son cachet.",
  ...
  // Question n°21
  {
    question: "Question n°21 : Que signifie, selon Bergson, « l'intensité » d'un état d'âme comme un désir profond ?",
    answers: [
      "Elle correspond au nombre d'états psychiques simples qu'il a réussi à pénétrer.",
  ...
  // Question n°22
  {
    question: "Question n°22 : Pourquoi, selon Bergson, une personne non initiée à la musique classique a-t-elle du mal à apprécier une symphonie de Beethoven ?",
    answers: [
      "Parce que l'attention perçoit est trop éloigné des souvenirs musicaux qu'elle possède.",
  ...
  // Question n°23
  {
    question: "Question n°23 : Que signifie la formule de Pascal « L'homme passe l'homme » par rapport à l'expression spirituelle de la sensibilité ?",
    answers: [
      "L'homme est capable de dépasser sa condition individuelle et naturelle.",
  ...
  // Question n°24
  {
    question: "Question n°24 : Pourquoi Bergson affirme-t-il, dans <em>L'Énergie spirituelle</em>, qu'une connaissance parfaite du cerveau ne permettrait pas de déduire avec certitude l'état d'âme correspondant ?",
    answers: [
      "Parce qu'à un même état cérébral pourraient correspondre des états d'âme également possibles.",
  ...
  // Question n°25
  {
    question: "Question n°25 : Dans <em>La Nausée</em> de Sartre, que découvre soudainement le personnage Roquentin en contemplant la racine du marronnier ?",
    answers: [
      "L'existence brute et contingente des choses.",
  ...
  // Question n°26
  {
    question: "Question n°26 : Dans les définitions d'Alain, comment se situe le « sentiment » par rapport à l'« émotion » et à la « passion » ?",
    answers: [
      "Il est l'état formé par la volonté qui surmonte la passion.",
  ...
  // Question n°27
  {
    question: "Question n°27 : Selon Merleau-Ponty dans <em>Le doute de Cézanne</em>, en quoi la peinture de Cézanne se distingue-t-elle de celle des Impressionnistes ?",
    answers: [
      "Elle veut restituer la structure des choses, et pas seulement leur « enveloppe lumineuse ».",
  ...
  // Question n°28
  {
    question: "Question n°28 : Selon Nietzsche dans <em>Par-delà le bien et le mal</em>, sur quoi repose fondamentalement la capacité de se comprendre mutuellement par le langage ?",
    answers: [
      "Sur la communauté de certaines expériences intérieures fréquentes.",
  ...
  // Question n°29
  {
    question: "Question n°29 : Contre quelle opinion Rousseau s'élève-t-il dans l'<em>Essai sur l'origine des langues</em> concernant l'invention de la parole ?",
    answers: [
      "Contre l'idée que les hommes ont inventé la parole pour exprimer leurs besoins.",
  ...
  // Question n°30
  {
    question: "Question n°30 : Dans l'approche naturaliste, quelle est la thèse originale de William James sur le lien entre l'émotion et les modifications corporelles ?",
    answers: [
  ...
  // Question n°31
  {
    question: "Question n°31 : Quelle expérience de Duchenne de Boulogne suggère une approche matérialiste des expressions émotionnelles ?",
    answers: [
      "Il a provoqué par stimulation électrique du visage certaines expressions.",
      "Il a mesuré la vitesse de propagation des influx nerveux liés à la joie.",
      "Il a cartographié les zones cérébrales activées lors de l'écoute de musiques tristes."
    ],
    correct: 1,
  ...
  // Question n°32
  {
    question: "Question n°32 : Selon la perspective constructiviste défendue par Merleau-Ponty, pourquoi la mimique de la colère n'est-elle pas la même chez un Japonais et un Occidental ?",
    answers: [
      "Parce que la manière d'accueillir et de vivre la situation  elle-même est façonnée par la culture.",
  ...
  // Question n°33
  {
    question: "Question n°33 : Quel concept émotionnel danois désigne un sentiment de bien-être lié à la convivialité et au confort ?",
    answers: [
      "Hygge.",
      "Saudade.",
      "Sisu."
  ...
  // Question n°34
  {
    question: "Question n°34 : Quel serait l'effet combiné de la culture de la consommation et de la technologie sur les relations amoureuses contemporaines ?",
    answers: [
      "Elles les transforment en favorisant des « non-relations » et un désarroi.",
      "Elles les rendent moins passionnelles, éliminant la souffrance amoureuse.",
  ...
  // Question n°35
  {
    question: "Question n°35 : Entre le « vitalisme » de Schopenhauer et le « romantisme », quelle approche semble finalement prévaloir dans la compréhension du sentiment amoureux ?",
    answers: [
  ...
  // Question n°36
  {
    question: "Question n°36 : Que signifie étymologiquement le terme « sensibilité » ?",
    answers: [
      "La faculté d'éprouver des sensations et d'en être affecté.",
  ...
  // Question n°37
  {
    question: "Question n°37 : Quelle est la conséquence principale, selon Platon, si le cocher (la raison) ne parvient pas à maîtriser le cheval noir (les désirs désordonnés) ?",
    answers: [
      "L'âme reste ne peut s'élever vers la contemplation des Idées.",
      "Le corps devient malade, car les humeurs ne sont plus équilibrées.",
      "L'individu devient un artiste, car la créativité naît du désordre."
    ],
    correct: 1,
  ...
  // Question n°38
  {
    question: "Question n°38 : Quelle image Rousseau utilise-t-il pour décrire l'effet des vagues du lac sur son esprit dans les <em>Rêveries</em> ?",
    answers: [
  ...
  // Question n°39
  {
    question: "Question n°39 : Quelle est la caractéristique de l'angoisse, évoquée dans la séance 4, par rapport à la peur ?",
    answers: [
      "L'angoisse est une peur sans objet déterminé.",
      "L'angoisse a un objet précis, la peur est un sentiment diffus.",
      "L'angoisse est socialement construite, la peur est une réaction naturelle."
    ],
    correct: 1,
  ...
  // Question n°40
  {
    question: "Question n°40 : Dans la théorie constructiviste des émotions, que signifie l'affirmation selon laquelle les émotions seraient « inventées comme les mots » ?",
    answers: [
      "Qu'elles sont des constructions qui donnent forme et nom à des sensations corporelles.",
  ...
  // Question n°41
  {
    question: "Question n°41 : Quelle est la thèse défendue par Lisa Feldman Barrett concernant la création des émotions ?",
    answers: [
      "Nous créons nos émotions en appliquant des concepts culturels à nos perceptions.",
  ...
  // Question n°42
  {
    question: "Question n°42 : Quelle affirmation résume le mieux le point de vue du romantisme sur le rapport entre l'individu et la Nature ?",
    answers: [
      "La Nature est le miroir des états d'âme de l'individu.",
  ...
  // Question n°43
  {
    question: "Question n°43 : Que recherche fondamentalement le héros romantique à travers l'expression de sa souffrance et de sa mélancolie ?",
    answers: [
      "Une forme d'absolu que le monde réel lui refuse.",
  ...
  // Question n°44
  {
    question: "Question n°44 : En quoi l'exemple de Pierre Scerri (12 ans pour construire une voiture miniature) illustre-t-il la conception kantienne de la passion ?",
    answers: [
      "Il montre que la passion est un attachement qui occupe toute la vie d'un homme.",
  ...
  // Question n°45
  {
    question: "Question n°45 : Que permet de comprendre l'expérience de <em>l'hallucination</em> ?",
    answers: [
      "Que la sensibilité peut être une perception sans objet car l'esprit produit ses propres contenus sensibles.",
  ...
  // Question n°46
  {
    question: "Question n°46 : Pourquoi Aristote a-t-il « spatialisé » les sens et les a-t-il organisés en deux groupes ?",
    answers: [
      "Pour distinguer les sens de la distance (vue, ouïe) des sens du contact (toucher, goût).",
  ...
  // Question n°47
  {
    question: "Question n°47 : Quel est le « dysfonctionnement » associé à la thermoception, le sens de la température ?",
    answers: [
  ...
  // Question n°48
  {
    question: "Question n°48 : Pourquoi le vocabulaire pour décrire les odeurs est-il généralement plus pauvre que celui pour décrire les choses vues ?",
    answers: [
      "Parce que, dans notre culture, la vue est liée la connaissance et l'odorat à la sensualité.",
      "Parce que l'odorat est un sens moins développé et moins important que la vue chez l'homme.",
  ...
  // Question n°49
  {
    question: "Question n°49 : Que signifie l'expression « se mettre dans la peau de quelqu'un », analysée dans la partie sur la peau et l'identité ?",
    answers: [
      "Comprendre son point de vue et ses sentiments par un effort d'empathie.",
  ...
  // Question n°50
  {
    question: "Question n°50 : Comment définir le « sentiment » par opposition à l'« émotion », dans le cadre général de la sensibilité ?",
    answers: [
      "Le sentiment est une émotion durable et réfléchie.",
  ...
  // Question n°51
  {
    question: "Question n°51 : Quelle idée Chateaubriand exprime-t-il lorsqu'il écrit, dans <em>René</em>, « notre cœur est un instrument incomplet » ?",
    answers: [
      "Que la sensibilité humaine est marquée par un manque ontologique.",
  ...
  // Question n°52
  {
    question: "Question n°52 : Dans la théorie de William James, quelle serait la conséquence logique si l'on supprimait toutes les sensations corporelles associées à une émotion ?",
    answers: [
      "Il ne resterait qu'une perception froide et intellectuelle des situations.",
  ...
  // Question n°53
  {
    question: "Question n°53 : Quel argument avancer pour dire que la sensibilité « conditionne notre rapport au monde » depuis l'Antiquité ?",
    answers: [
      "Parce que la sensibilité est notre moyen premier d'être impliqué dans le monde.",
      "Parce que les Grecs avaient déjà découvert tous les sens.",
      "Parce que l'on sait que le corps sensible est un outil de diagnostic médical."
    ],
    correct: 1,
  ...
  // Question n°56
  {
    question: "Question n°56 : Selon la lecture relativiste du romantisme, comment faut-il parler du romantisme ?",
    answers: [
      "Au pluriel, comme d'une multiplicité de « romantismes » nationaux.",
      "Au singulier, comme d'une doctrine unifiée.",
      "Comme d'un simple synonyme de « lyrisme » ou de « subjectivisme »."
    ],
    correct: 1,
    explanation: `Arthur Lovejoy (philosophe américain) défend une approche nominaliste ou relativiste. Selon lui, il n'existe pas une essence unique du romantisme, mais une multitude de mouvements, d'idées, de sensibilités, qui ont été rassemblés sous le même nom de façon confuse. Il préconise donc de parler des « romantismes » au pluriel, et de les étudier dans leur contexte historique, géographique et culturel spécifique (le romantisme allemand n'est pas le romantisme français, etc.). Cette approche est plus rigoureuse historiquement, mais elle rend plus difficile toute tentative de généralisation sur « le » romantisme comme phénomène philosophique et esthétique.
  ...
  // Question n°57
  {
    question: "Question n°57 : Que signifie « l'effet Papageno », opposé à « l'effet Werther » ?",
    answers: [
      "L'influence positive de l'art qui prévient le passage à l'acte désespéré.",
  ...
  // Question n°58
  {
    question: "Question n°58 : Quelle est la fonction attribuée à la peau dans la communication sociale ?",
    answers: [
      "Elle est un medium de communication non verbale, régissant le contact.",
  ...
  // Question n°59
  {
    question: "Question n°59 : Comment définir la « passion » dans son sens philosophique fort ?",
    answers: [
      "Une inclination constante, exclusive et réfléchie de l'âme vers un objet.",
  ...
  // Question n°60
  {
    question: "Question n°60 : Quelle est la « difficulté méthodologique » principale lorsqu'on cherche à étudier la sensibilité ?",
    answers: [
      "La nécessité de parler objectivement de ce qui est par essence subjectif et vécu.",
  ...
  // Question n°61
  {
    question: "Question n°61 : Quel auteur du XXe siècle affirme que « tout est fabriqué et tout est naturel chez l'homme » à propos des émotions ?",
    answers: [
  ...
  // Question n°62
  {
    question: "Question n°62 : Selon Hegel, pourquoi l'art est-il capable de nous toucher universellement, même à travers la singularité d'une œuvre ?",
    answers: [
      "Parce qu'il renseigne sur l'humain en révélant l'universel dans le singulier.",
      "Parce qu'il utilise un langage symbolique directement compréhensible de tous.",
      "Parce qu'il représente la vie quotidienne auxquelles on peut tous s'identifier."
    ],
    correct: 1,
  ...
  // Question n°63
  {
    question: "Question n°63 : Quelle est la critique adressée par le romantisme au rationalisme des Lumières du XVIIIe siècle ?",
    answers: [
      "Le rationalisme est trop optimiste et naïf, il néglige la dimension irrationnelle de l'homme.",
  ...
  // Question n°64
  {
    question: "Question n°64 : Comment caractériser l'engagement politique des écrivains romantiques comme Hugo ou Lamartine ?",
    answers: [
      "Comme le prolongement naturel de préparer un avenir meilleur.",
  ...
  // Question n°65
  {
    question: "Question n°65 : Quelle est la thèse de Descartes sur l'origine <em>somatique</em> des passions ?",
    answers: [
      "Les passions sont des perceptions de l'âme d'origine corporelle.",
  ...
  // Question n°66
  {
    question: "Question n°66 : Quel sens particulier le romantisme donne-t-il au terme « rêverie », notamment chez Rousseau ?",
    answers: [
      "Un état de dérive paisible de la pensée, souvent en plein air.",
  ...
  // Question n°67
  {
    question: "Question n°67 : Quelle définition donner du « spleen » baudelairien ?",
    answers: [
      "Une forme de mélancolie liée à l'ennui et au dégoût.",
  ...
  // Question n°68
  {
    question: "Question n°68 : Comment expliquer la phrase de Descartes : « en les examinant, je les [les passions] ai trouvées presque toutes bonnes » ?",
    answers: [
      "L'âme, selon Descartes, n'aurait pas de raison de rester unie au corps sans les passions.",
  ...
  // Question n°69
  {
    question: "Question n°69 : Quelle est la fonction de la « nociception » ?",
    answers: [
  ...
  // Question n°70
  {
    question: "Question n°70 : Comment interpréter l'expression « amour platonique » telle qu'elle est comprise à l'époque romantique ?",
    answers: [
      "Un amour qui vise l'union des âmes plus que celle des corps qui peut basculer dans la haine du corps.",
  ...
  // Question n°71
  {
    question: "Question n°71 : Quelle est la position de Lactance concernant le corps et la sensualité ?",
    answers: [
      "Il associe la sensibilité sensorielle à la sensualité et la considère comme un égarement potentiel.",
  ...
  // Question n°72
  {
    question: "Question n°72 : Que cherche-t-on fondamentalement dans le sentiment amoureux ?",
    answers: [
      "La réponse à des questions sur la fusion des âmes, l'assouvissement du désir...",
  ...
  // Question n°74
  {
    question: "Question n°74 : Comment présenter le rapport du romantisme à l'Histoire ?",
    answers: [
      "Le romantique est nostalgiques du passé, déçus par le présent et attend un avenir utopique.",
      "Le romantique déteste l'Histoire, qu'il considère comme une suite d'horreurs sans signification.",
      "Le romantique est tourné uniquement vers l'avenir et le progrès, comme les Lumières."
    ],
    correct: 1,
  ...
  // Question n°75
  {
    question: "Question n°75 : Quelle est la signification philosophique de l'exemple d'Aron Ralston, qui s'est amputé le bras pour survivre, cité à propos de la nociception ?",
    answers: [
      "Elle illustre le fait que la volonté de survie peut dominer la sensation de douleur.",
  ...
  // Question n°77
  {
    question: "Question n°77 : Quelle conception de l'amour est attribué à Socrate dans le <em>Banquet</em> de Platon ?",
    answers: [
      "Un amour libérateur possible si l'on désire le vrai et le bien.",
  ...
  // Question n°78
  {
    question: "Question n°78 : Comment analyser l'expression « avoir quelqu'un dans la peau » ?",
    answers: [
      "Comme l'expression d'un amour possessif et fusionnel.",
    ...
    \nExemple : La chanson de Sinatra écrite par Cole Porter « I've got you under my skin, I've got you deep in the heart of me, So deep in my heart, that you're really a part of me » utilise cette même image pour exprimer un attachement viscéral et ineffaçable.`
  },
  // Question n°79
  {
    question: "Question n°79 : Selon la thèse de la « construction conceptuelle » des émotions (Lisa Feldman Barrett), que se passe-t-il lorsqu'une culture invente un nouveau mot pour une émotion ?",
    answers: [
      "Cela permet de vivre consciemment une nuance d'expérience sensible qui pouvait rester diffuse.",
  ...
  // Question n°80
  {
    question: "Question n°80 : En quoi l'exemple des « nez » en parfumerie répond-il à la « difficulté langagière » concernant l'odorat ?",
    answers: [
      "Il illustre comment une profession a dû pallier la pauvreté du langage courant concernant les odeurs.",
  ...
  // Question n°81
  {
    question: "Question n°81 : Comment expliquer que l'on puisse être « ponctuellement insensible à la douleur », par exemple lors d'une opération sans anesthésie ?",
    answers: [
      "Par le fait que la douleur est une construction mentale.",
  ...
  // Question n°82
  {
    question: "Question n°82 : Que signifie l'expression « le temps, comme l'eau, s'écoule inexorablement » dans le contexte romantique ?",
    answers: [
      "L'idée que le temps est une substance fluide et insaisissable.",
      "Une métaphore scientifique sur le cycle de l'eau dans la nature.",
      "L'affirmation que le temps est cyclique et éternel comme les vagues."
    ],
    correct: 1,
  ...
  // Question n°83
  {
    question: "Question n°83 : Quelle est la définition de « l'équilibrioception » ?",
    answers: [
  ...
  // Question n°86
  {
    question: "Question n°86 : Que symbolise l'attelage ailé dans le mythe de Phèdre de Platon ?",
    answers: [
      "La capacité de l'âme bien conduite à s'élever vers l'intelligible.",
  ...
  // Question n°87
  {
    question: "Question n°87 : Quelle est la position de Schopenhauer sur la « chose en soi » kantienne ?",
    answers: [
      "Il affirme que mon corps est une chose en soi que je connais immédiatement.",
  ...
  // Question n°88
  {
    question: "Question n°88 : Pourquoi l'homme romantique se sent-il à la fois faible et fort face à la Nature ?",
    answers: [
      "Faible physiquement face à ses forces, mais fort par sa capacité à juger la Nature.",
  ...
  // Question n°89
  {
    question: "Question n°89 : Comment interpréter la phrase de Mme de Staël : « Je suis poète lorsque j’admire, lorsque je méprise, lorsque je hais, non par des sentiments personnels... mais pour la dignité de l’espèce humaine » ?",
    answers: [
      "Comme la définition d'une sensibilité poétique qui dépasse l'individualité.",
  ...
  // Question n°90
  {
    question: "Question n°90 : Quelle est, selon la théorie constructiviste, la principale cause des différences observables dans l'expression des émotions d'une culture à l'autre ?",
    answers: [
      "Des différences dans les concepts, les valeurs et les pratiques sociales.",
  ...
  // Question n°91
  {
    question: "Question n°91 : Comment définir le « vague à l'âme » lamartinien ?",
    answers: [
      "Un sentiment d'incomplétude sans objet clair.",
  ...
  // Question n°92
  {
    question: "Question n°92 : Quel est le sens profond de l'expression « les passions sont des maladies de l'âme » ?",
    answers: [
      "Les passions perturbent l'ordre et la santé de l'âme en l'asservissant.",
  ...
  // Question n°93
  {
    question: "Question n°93 : En quoi l'art romantique est-il souvent un « art de plein air » ?",
    answers: [
      "Parce que la Nature est pour eux un refuge où ils consolent leur sensibilité.",
  ...
  // Question n°94
  {
    question: "Question n°94 : Pourquoi affirmer que la sensibilité nous confronte à ce à quoi nous sommes sensibles ?",
    answers: [
      "Parce que notre univers sensoriel est lié à notre culture.",
  ...
  // Question n°95
  {
    question: "Question n°95 : Quel est le rôle du « cocher » dans l'allégorie platonicienne de l'attelage ?",
    answers: [
      "Il représente la raison chargée de conduire l'âme vers sa destination.",
    ...
    correct: 1,
    explanation: `Le cocher est la figure centrale de l'allégorie. Il symbolise la partie rationnelle de l'âme (le λογιστικόν, <em>logistikon</em>. Son rôle est essentiel et difficile : il doit tenir les rênes et conduire l'attelage. Cela signifie qu'il doit utiliser la raison pour maîtriser les deux forces pulsionnelles représentées par les chevaux. Il doit encourager et guider le cheval blanc (les sentiments nobles) et, surtout, contenir et dompter par la force (le « fouet ») le cheval noir rétif (les désirs désordonnés). Le cocher n'est pas un tyran qui écrase les chevaux ; sa tâche est de les harmoniser pour que l'attelage puisse avancer droit et, surtout, s'élever vers les hauteurs. Il représente l'idéal du gouvernement de soi par la raison.
  ...
  // Question n°96
  {
    question: "Question n°96 : Comment définir « l'empathie » par distinction avec la simple « sympathie » ?",
    answers: [
      "L'empathie est le fait de « souffrir à la place de », la sympathie est de « souffrir avec ».",
      "L'empathie est intellectuelle tandis que la sympathie est émotionnelle.",
      "L'empathie est le fait de « souffrir avec », la sympathie de « souffrir à la place de »."
    ],
    correct: 1,
  ...
  // Question n°97
  {
    question: "Question n°97 : Que signifie l'idée, présente chez Schopenhauer et Freud, selon laquelle le sentiment serait « fictif » ?",
    answers: [
      "Que les prétendus sentiments authentiques ne sont que des déguisements de forces pulsionnelles.",
  ...
  // Question n°98
  {
    question: "Question n°98 : Pourquoi l'exemple de la personne morte de froid dans une chambre froide en panne peut-il être donné à propos de la thermoception ?",
    answers: [
      "Pour illustrer le dysfonctionnement de la thermoception.",
      "Pour montrer que le froid tue.",
      "Pour démontrer la supériorité des instruments sur les sens humains."
    ],
    correct: 1,
  ...
  // Question n°99
  {
    question: "Question n°99 : Quel est le sens de la phrase de Rousseau : « J’existe, et j’ai des sens par lesquels je suis affecté. Voilà la première vérité qui me frappe » ?",
    answers: [
      "La sensibilité est une des données les plus certaines de la conscience.",
  ...
  // Question n°100
  {
    question: "Question n°100 : Comment faut-il comprendre le débat entre <em>vitalisme</em> et <em>romantisme</em> concernant la sensibilité ?",
    answers: [
      "Comme deux pôles : l'explication naturaliste et la valorisation subjective.",
      "Comme un débat dépassé, la science contemporaine ayant définitivement donné raison au vitalisme.",
      "Comme la preuve que le romantisme était une erreur corrigée par le sérieux des sciences humaines."
    ],
    correct: 1,
