...
const questions = [
	// Question n°1
	{
		question: "Question n°01 : Quelle est la maxime inscrite sur le fronton du temple d'Apollon à Delphes, souvent considérée comme l'origine de la quête philosophique de soi ?",
		answers: [
			"« Rien de trop » (Μηδὲν ἄγαν), un appel à la modération en toutes choses.",
			"« La mesure est ce qu'il y a de meilleur » (Μέτρον ἄριστον), formule attribuée à Cléobule.",
			"« Connais-toi toi-même » (Γνῶθι σεαυτόν), une invitation à l'examen de sa propre nature."
		],
		correct: 3,
	...
	// Question n°2
	{
		question: "Question n°02 : Comment Platon, dans le <em>Théétète</em>, définit-il l'acte de penser ?",
		answers: [
	...
	// Question n°3
	{
		question: "Question n°03 : Quelle capacité, selon Kant dans son <em>Anthropologie</em>, distingue fondamentalement l'homme de l'animal ?",
		answers: [
	...
	// Question n°4
	{
		question: "Question n°04 : Que signifie l'expression « Je est un autre », formulée par Arthur Rimbaud dans ses lettres dites « du voyant » ?",
		answers: [
			...
			"Le sujet créateur ne coïncide pas avec lui-même ; une altérité s'exprime dans la création poétique."
		],
		correct: 3,
	...
	// Question n°5
	{
		question: "Question n°05 : Dans la « première topique » freudienne, comment l'appareil psychique est-il organisé ?",
		answers: [
			"En trois instances principales : le conscient, l'inconscient et le subconscient.",
			"En trois sphères fonctionnelles : la pulsion, la représentation et la conscience.",
	...
	// Question n°6
	{
		question: "Question n°06 : Selon la lecture de Bergson, comment les romanciers réalistes présentent-ils généralement la vie intérieure de leurs personnages ?",
		answers: [
			"Avec une profondeur psychologique qui saisit parfaitement la fluidité des sentiments.",
			"Comme une « ombre » conventionnelle, une juxtaposition d'états simplifiés et étiquetés.",
	...
	// Question n°7
	{
		question: "Question n°07 : Quelle est la principale difficulté que rencontre Rousseau dans l'écriture de ses <em>Confessions</em>, selon son propre aveu ?",
		answers: [
			...
			"Les lacunes de sa mémoire, qui l'obligent parfois à combler des vides."
		],
		correct: 3,
	...
	// Question n°8
	{
		question: "Question n°08 : Dans <em>Lorenzaccio</em> de Musset, comment le héros justifie-t-il son projet d'assassinat du tyran Alexandre de Médicis ?",
		answers: [
	...
	// Question n°9
	{
		question: "Question n°09 : Selon la « seconde topique » freudienne, quelle est la fonction principale du « moi » (<em>Ich</em>) ?",
		answers: [
			...
			"Assurer le compromis entre les exigences du ça, les interdits du surmoi et les contraintes extérieures."
		],
		correct: 3,
	...
	// Question n°10
	{
		question: "Question n°10 : Que découvre Œdipe dans la tragédie de Sophocle, et en quoi cette découverte constitue-t-elle une révélation catastrophique sur le moi ?",
		answers: [
			...
			"Il découvre qu'il est l'assassin de son père, l'époux de sa mère : à l'opposé de ce qu'il pensait être."
		],
		correct: 3,
	...
	// Question n°11
	{
		question: "Question n°11 : Quelle critique principale Alain adresse-t-il à la notion freudienne d'inconscient ?",
		answers: [
			...
			"Il y voit une « idolâtrie du corps », faisant du corps un « autre Moi » doué d'intentions."
		],
		correct: 3,
	...
	// Question n°12
	{
		question: "Question n°12 : Selon David Hume, dans son <em>Traité de la nature humaine</em>, que découvre-t-on lorsque l'on essaie de percevoir son propre « moi » par l'introspection ?",
		answers: [
			"Une substance simple, immatérielle et permanente : l'âme ou le sujet pensant.",
			"Un flux incessant et changeant de perceptions distinctes, sans noyau permanent.",
	...
	// Question n°13
	{
		question: "Question n°13 : Quelle distinction majeure Paul Ricœur établit-il dans son analyse de l'identité personnelle ?",
		answers: [
			...
			"Entre la <em>mêmeté</em> et l'<em>ipséité</em>), fidélité à soi par la promesse."
		],
		correct: 3,
	...
	// Question n°14
	{
		question: "Question n°14 : Quelle est la position de Nietzsche sur la formule cartésienne « Je pense » ?",
		answers: [
			"Il la voit comme le fondement inébranlable de toute certitude et de la philosophie moderne.",
			"Il l'approuve, en ajoutant la dimension corporelle et des pulsions négligées par Descartes.",
			"Il la voit comme une illusion qui postule un sujet là où il n'y a qu'une activité impersonnelle."
		],
		correct: 3,
	...
	// Question n°15
	{
		question: "Question n°15 : Comment le sociologue Émile Durkheim caractérise-t-il la différence entre les sociétés animales et les sociétés humaines ?",
		answers: [
			"Les sociétés animales sont fondées sur la domination hiérarchique, les sociétés humaines sur la coopération égalitaire.",
			"Il n'y a pas de différence fondamentale entre ces sociétés, l'homme étant un animal social comme les autres.",
			"Dans les sociétés animales l'individu est soumis à l'instinct, dans les sociétés humaines, il est soumis à des lois."
		],
		correct: 3,
	...
	// Question n°16
	{
		question: "Question n°16 : Que signifie l'expression de Montaigne « Je peins le passage », dans le contexte de ses <em>Essais</em> ?",
		answers: [
			...
			"Il décrit non un être fixe, mais un moi saisi dans le flux du temps."
		],
		correct: 3,
	...
	// Question n°17
	{
		question: "Question n°17 : Dans la psychanalyse de Carl Gustav Jung, qu'est-ce que « l'inconscient collectif » ?",
		answers: [
			...
			"Un réservoir de structures psychiques universelles et archaïques communes à toute l'humanité."
		],
		correct: 3,
	...
	// Question n°18
	{
		question: "Question n°18 : Quelle est la critique logique de Sartre à l'égard de la notion freudienne d'inconscient ?",
		answers: [
			...
			"Elle est suppose une conscience qui refoulerait sans savoir ce qu'elle refoule."
		],
		correct: 3,
	...
	// Question n°19
	{
		question: "Question n°19 : Quel problème célèbre de l'identité à travers le temps est illustré par le <em>bateau de Thésée</em> rapporté par Plutarque ?",
		answers: [
			"Le problème de l'identité des jumeaux parfaits, indiscernables l'un de l'autre.",
			"Le problème de savoir jusqu'à quand il reste le même malgré ses parties remplacées.",
	...
	// Question n°20
	{
		question: "Question n°20 : Comment la littérature romantique utilise-t-elle le « je » dans des récits fictionnels ?",
		answers: [
			...
			"Pour métamorphoser l'auteur en projetant dans un personnage fictionnel ses tourments intimes."
		],
		correct: 3,
	...
	// Question n°21
	{
		question: "Question n°21 : Que met en lumière l'exemple du « couteau de saint Hubert » concernant la notion d'identité ?",
		answers: [
			...
			"Que l'identité d'un objet peut être préservée par la croyance et la tradition."
		],
		correct: 3,
	...
	// Question n°22
	{
		question: "Question n°22 : Selon Kant dans les <em>Fondements de la métaphysique des mœurs</em>, quand l'homme est-il véritablement lui-même ?",
		answers: [
			...
			"En tant qu'intelligence appartenant au monde intelligible et non en tant qu'homme sensible."
		],
		correct: 3,
	...
	// Question n°23
	{
		question: "Question n°23 : Selon Hegel, pourquoi une violence faite à mon corps est-elle une violence faite à « moi » ?",
		answers: [
			...
			"Parce que, dans l'existence concrète, je ne suis pas un pur esprit logé dans un corps."
		],
		correct: 3,
	...
	// Question n°24
	{
		question: "Question n°24 : Quelle est la thèse de John Locke sur l'identité personnelle, illustrée par l'exemple du chêne ?",
		answers: [
			...
			"L'identité personnelle réside dans la continuité de la conscience et de la mémoire."
		],
		correct: 3,
	...
	// Question n°25
	{
		question: "Question n°25 : Dans <em>Le Horla</em> de Maupassant, quel symptôme manifeste de façon spectaculaire la dépossession de soi du narrateur ?",
		answers: [
			"Il entend des voix distinctes qui lui ordonnent de faire du mal à son entourage.",
			"Il ne voit plus son reflet dans le miroir, un autre ayant pris possession de son corps.",
	...
	// Question n°26
	{
		question: "Question n°26 : Que signifie philosophiquement l'expression « autrui est un <em>alter ego</em> » ?",
		answers: [
			"Autrui est mon ennemi naturel (<em>alter</em> = autre, <em>ego</em> = moi).",
			"Autrui est le miroir parfait dans lequel je me reconnais.",
			"Autrui est un autre moi, radicalement distinct et séparé."
		],
		correct: 3,
	...
	// Question n°27
	{
		question: "Question n°27 : Quelle est la fonction du « surmoi » (<em>Über-Ich</em>) dans la seconde topique freudienne ?",
		answers: [
			...
			"Il incarne l'idéal du moi, la conscience morale, les interdits parentaux et sociaux internalisés."
		],
		correct: 3,
	...
	// Question n°28
	{
		question: "Question n°28 : Comment Nietzsche, dans <em>Aurore</em>, caractérise-t-il notre connaissance des instincts qui nous constituent ?",
		answers: [
			...
			"Elle est totalement incomplète ; nous ignorons leur nombre, leur force et leurs lois."
		],
		correct: 3,
	...
	// Question n°29
	{
		question: "Question n°29 : Que désigne le « soi » (<em>Selbst</em>) dans la psychologie analytique de Carl Gustav Jung ?",
		answers: [
			...
			"L'ensemble total de la <em>psyché</em> consciente et inconsciente, l'unité ultime de la personne."
		],
		correct: 3,
	...
	// Question n°30
	{
		question: "Question n°30 : Quelle est la position de Descartes sur la relation entre l'âme (le moi) et le corps, dans sa Sixième Méditation ?",
		answers: [
			...
			"Ils sont étroitement conjoints en restant deux substances que l'on peut concevoir séparément."
		],
		correct: 3,
	...
	// Question n°31
	{
		question: "Question n°31 : Quel est le risque majeur pour le moi s'il est trop dominé par le « surmoi » ?",
		answers: [
			"La perversion, c'est-à-dire le débridement sans frein des pulsions du ça.",
			"La névrose, c'est-à-dire un bridage excessif des pulsions et une culpabilité paralysante.",
	...
	// Question n°32
	{
		question: "Question n°32 : Que signifie de dire que l'autre n'est ni un sujet ni un objet mais un projet dans le contexte de la quête de soi ?",
		answers: [
			"Autrui est un être incomplet qu'il faut éduquer et transformer selon nos propres idéaux.",
			"La relation à autrui est un projet politique de construction d'une société harmonieuse.",
			"Dans la relation à moi-même, l'autre n'est pas une donnée fixe mais une existence à construire."
		],
		correct: 3,
	...
	// Question n°33
	{
		question: "Question n°33 : Quel est le sens du poème d'Antonio Machado : « Voyageur, il n'y a pas de chemin, le chemin se fait en marchant » ?",
		answers: [
			...
			"Le « moi » n'est pas un trésor à découvrir, il se construit dans sa recherche."
		],
		correct: 3,
	...
	// Question n°34
	{
		question: "Question n°34 : Pourquoi, selon Augustin dans ses <em>Confessions</em>, est-il devenu « une énigme » pour lui-même ?",
		answers: [
			...
			"Parce qu'il y a en lui une part d'inconnu qui le rend mystérieux à lui-même."
		],
		correct: 3,
	...
	// Question n°35
	{
		question: "Question n°35 : Dans <em>L'Étrange Cas du Dr Jekyll et de Mr Hyde</em>, comment le Dr Jekyll décrit-il sa double nature avant l'invention du sérum ?",
		answers: [
			"Comme une hypocrisie totale : il feignait d'être bon alors qu'il était foncièrement mauvais.",
			"Comme une « double conscience » où ses deux facettes étaient également d'une sincérité parfaite.",
	...
	// Question n°36
	{
		question: "Question n°36 : Quelle est la « superstition des logiciens » que Nietzsche dénonce dans <em>Par-delà le bien et le mal</em> ?",
		answers: [
			...
			"Croire que s'il y a une pensée, il doit y avoir un « je » (un sujet) qui en est la cause."
		],
		correct: 3,
	...
	// Question n°37
	{
		question: "Question n°37 : Comment définir le « préconscient » dans la première topique freudienne ?",
		answers: [
			...
			"Un lieu intermédiaire de ce qui n'est pas encore conscient mais qui peut le devenir."
		],
		correct: 3,
	...
	// Question n°38
	{
		question: "Question n°38 : Quel est l'argument de Leibniz pour dépasser le dualisme âme/corps cartésien ?",
		answers: [
			...
			"Il considère que l'âme est la manifestation d'une substance (la monade) qui exprime l'ensemble du corps."
		],
		correct: 3,
	...
	// Question n°39
	{
		question: "Question n°39 : Que signifie la métaphore du « pilote en son navire » employée par Descartes, et quelles sont ses limites ?",
		answers: [
			"Une description de la relation d'extériorité entre l'âme et le corps.",
			"La preuve que le corps est un simple instrument passif et contrôlé par l'âme.",
			"Une métaphore imparfaite car l'âme, contrairement au pilote, ressent les affections du corps."
		],
		correct: 3,
	...
	// Question n°40
	{
		question: "Question n°40 : Quelle est la fonction de l'autobiographie selon Rousseau, telle qu'elle apparaît dans le préambule des <em>Confessions</em> ?",
		answers: [
			...
			"Montrer un homme avec une sincérité totale pour se présenter tel qu'il fut."
		],
		correct: 3,
	...
	// Question n°41
	{
		question: "Question n°41 : Quel est le risque majeur pour le moi s'il est trop dominé par le <em>ça</em> ?",
		answers: [
			"La névrose, caractérisée par l'anxiété et les inhibitions.",
			"La perversion, c'est-à-dire le débridement des pulsions.",
	...
	// Question n°42
	{
		question: "Question n°42 : Selon la conception kantienne de la conscience de soi, que permet la synthèse du « Je pense » ?",
		answers: [
			...
			"D'unifier la diversité des représentations en une conscience unique et identique."
		],
		correct: 3,
	...
	// Question n°43
	{
		question: "Question n°43 : Comment Nietzsche, dans <em>Le Gai Savoir</em>, remet-il en cause l'idée de « santé » de l'âme ?",
		answers: [
			...
			"En se demandant si notre soif de connaissance n'aurait pas besoin de la santé et de la maladie de l'âme."
		],
		correct: 3,
	...
	// Question n°44
	{
		question: "Question n°44 : Que signifie la formule de Jules Michelet s'adressant à lui-même dans son <em>Journal</em> : « Profitons au moins de ce moment de repos ; écoutez-moi » ?",
		answers: [
			...
			"Une illustration de la distance à soi : « je » qui écrit s'adresse à « moi » comme à un autre."
		],
		correct: 3,
	...
	// Question n°45
	{
		question: "Question n°45 : Quelle est la conception du moi défendue par Alain ?",
		answers: [
			...
			"Un moi maître de lui qui doit assumer sa liberté et sa responsabilité."
		],
		correct: 3,
	...
	// Question n°46
	{
		question: "Question n°46 : En quoi M. Hyde est-il, selon le Dr Jekyll, « plus intégral et plus un » que le Dr Jekyll lui-même ?",
		answers: [
			...
			"Parce qu'il incarne de manière pure, sans conflit, le mal, alors que Jekyll est partagé."
		],
		correct: 3,
	...
	// Question n°47
	{
		question: "Question n°47 : Quelle est la position de Sartre sur le rapport du « moi » à ses propres attitudes, comme l'attention en classe ?",
		answers: [
			"Le moi coïncide avec ses attitudes ; si je joue à être attentif, alors je suis réellement attentif.",
			"Le moi « échappe » toujours à l'être ; je n'joue toujours plus ou moins à être mes attitudes.",
			"Le moi est déterminé par son inconscient, donc ses attitudes sont le résultat de mécanismes cachés."
		],
		correct: 2,
	...
	// Question n°48
	{
		question: "Question n°48 : Quel était le rôle de l'hypnose dans les premiers travaux de Freud et de Breuer ?",
		answers: [
			"Un simple outil de spectacle et de divertissement, sans valeur scientifique.",
			"Un moyen thérapeutique d'imposer la guérison par la parole de l'hypnotiseur.",
			"Un moyen d'accéder à des souvenirs traumatiques refoulés."
		],
		correct: 3,
	...
	// Question n°49
	{
		question: "Question n°49 : Que signifie l'expression « ipséité » (<em>selfhood</em>) chez Paul Ricœur, opposée à la « mêmeté » ?",
		answers: [
			...
			"L'identité du « soi » comme capacité à se maintenir comme auteur de ses actes et de ses promesses."
		],
		correct: 3,
	...
	// Question n°50
	{
		question: "Question n°50 : Comment la question des personnes transgenres éclaire-t-elle le débat philosophique sur l'identité ?",
		answers: [
			...
			"Elle illustre la possibilité d'une dissociation entre l'identité biologique et l'identité psychologique."
		],
		correct: 3,
	...
	// Question n°51
	{
		question: "Question n°51 : Que signifie l'expression « archéologie de la subjectivité » ?",
		answers: [
			...
			"Une méthode qui creuse le psychisme pour trouver les fondements de la construction du moi."
		],
		correct: 3,
	...
	// Question n°52
	{
		question: "Question n°52 : Comment interpréter la phrase de Nietzsche : « Ô mon frère, derrière tes sentiments et tes pensées se cache un maître puissant, un sage inconnu ; il se nomme toi-même (<em>Selbst</em>). Il habite ton corps, il est ton corps. » ?",
		answers: [
			"Comme une affirmation d'un moi spirituel distinct du corps, qui l'habite et le contrôle.",
			"Comme une invitation à identifier le « soi » véritable au corps vivant et à ses instincts.",
	...
	// Question n°53
	{
		question: "Question n°53 : Quel est l'enjeu du « paradoxe du train sans frein » évoqué en marge de l'analyse de <em>Lorenzaccio</em> ?",
		answers: [
			...
			"Poser le problème éthique de l'action dans une situation où toute décision semble immorale."
		],
		correct: 3,
	...
	// Question n°55
	{
		...
		answers: [
			...
			"Une métaphore pour dire que le moi « fond et échappe à lui-même » avec le temps."
		],
		correct: 3,
	...
	// Question n°56
	{
		question: "Question n°56 : Quel est le statut du « ça » (<em>Es</em>) dans la seconde topique freudienne ?",
		answers: [
			"Le siège de la raison, de la perception de la réalité et de l'action adaptée.",
			"Le réservoir des pulsions, des désirs refoulés, de l'énergie psychique brute.",
	...
	// Question n°57
	{
		question: "Question n°57 : En quoi le « mal du siècle » romantique est-il lié à une certaine conception du moi ?",
		answers: [
			"Il exprime la joie et l'exaltation d'un moi libéré des contraintes sociales et traditionnelles.",
			"Il traduit la confiance en un moi rationnel, capable de comprendre et de maîtriser le monde.",
			"Il manifeste le désespoir d'un moi qui se sent démesuré mais coincé dans un monde médiocre."
		],
		correct: 3,
	...
	// Question n°58
	{
		question: "Question n°58 : Quelle conception du temps est impliquée dans la définition du moi comme « passage » chez Montaigne ?",
		answers: [
			"Un temps cyclique et éternel, comme celui des saisons ou des réincarnations.",
			"Un temps mesurable et linéaire, comme celui d'une horloge ou d'un calendrier.",
			"Un temps continu dans lequel le moi est saisi comme un être impossible à fixer."
		],
		correct: 3,
	...
	// Question n°61
	{
		question: "Question n°61 : Selon la conception freudienne, que sont les « actes manqués » (lapsus, oublis, etc.) ?",
		answers: [
			...
			"Des expressions déguisées de désirs qui échappent au contrôle du moi et le trahissent."
		],
		correct: 3,
	...
	// Question n°62
	{
		question: "Question n°62 : Comment définir la <em>maïeutique</em> socratique, en lien avec la pensée du moi ?",
		answers: [
			...
			"Socrate aide son interlocuteur à prendre conscience de ce qu'il sait déjà sans le savoir."
		],
		correct: 3,
	...
	// Question n°63
	{
		question: "Question n°63 : Qu'est-ce que le <em>processus d'individuation</em> dans la psychologie de Jung ?",
		answers: [
			...
			"Le processus par lequel le moi conscient se différencie de l'inconscient collectif."
		],
		correct: 3,
	...
	// Question n°65
	{
		...
		answers: [
			...
			"Une balançoire éternelle, image d'un mouvement de va-et-vient perpétuel."
		],
		correct: 3,
	...
	// Question n°66
	{
		question: "Question n°66 : Quelle est la différence fondamentale entre l'<em>inconscient</em> et le <em>préconscient</em> dans la première topique freudienne ?",
		answers: [
			...
			"Le préconscient est accessible à la conscience et l'accès à l'inconscient est censuré."
		],
		correct: 3,
	...
	// Question n°67
	{
		question: "Question n°67 : Comment le « regard d'autrui » constitue-t-il le moi, selon l'analyse de Sartre ?",
		answers: [
			...
			"En me regardant, autrui me fige dans une identité : je deviens un « être-pour-autrui »."
		],
		correct: 3,
	...
	// Question n°68
	{
		question: "Question n°68 : Que signifie l'idée que le moi est un <em>choix moral</em> ?",
		answers: [
			...
			"Que le moi se définit par la capacité à imputer des actes à un auteur responsable."
		],
		correct: 3,
	...
	// Question n°69
	{
		question: "Question n°69 : Qu'est-ce que la <em>double conscience</em> évoquée par Freud dans ses premières études sur l'hystérie ?",
		answers: [
			...
			"L'existence d'un état de conscience <em>normal</em> et d'un état <em>hypnoïde</em> où des souvenirs traumatiques sont maintenus séparés."
		],
		correct: 3,
	...
	// Question n°70
	{
		question: "Question n°70 : Que signifie l'expression « l'âme est un principe d'animation » dans la conception aristotélicienne ?",
		answers: [
			...
			"L'âme est le principe qui fait vivre, croître, se mouvoir les êtres vivants."
		],
		correct: 3,
	...
	// Question n°71
	{
		question: "Question n°71 : Comment le « positivisme » d'Auguste Comte influence-t-il la conception du moi au XIXe siècle ?",
		answers: [
			"Il réhabilite la foi religieuse et l'intuition comme seules sources valables de connaissance de soi.",
			"Il alimente une confiance absolue en la raison scientifique pour tout expliquer, y compris le moi.",
	...
	// Question n°72
	{
		question: "Question n°72 : Quelle est la signification de l'expression « inquiétante étrangeté » (<em>Unheimliche</em>) de Freud ?",
		answers: [
			"La peur des fantômes et des revenants, typique des contes et des légendes populaires.",
			"Le sentiment éprouvé quand quelque chose de familier et d'intime devient soudain étranger.",
	...
	// Question n°73
	{
		question: "Question n°73 : En quoi la métaphore du « <em>Holzweg</em> » (chemin forestier) de Heidegger s'applique-t-elle à la quête du moi ?",
		answers: [
			...
			"Elle illustre que la connaissance de soi est un sentier qui se dessine en avançant et qui ne mène à rien de définitif."
		],
		correct: 3,
	...
	// Question n°74
	{
		question: "Question n°74 : Quelle est la conception du moi dans le roman réaliste du XIXe siècle, selon l'analyse de Bergson ?",
		answers: [
			"Un moi fluide, insaisissable, saisi dans sa durée pure et son interpénétration d'états.",
			"Un moi conventionnel, une <em>ombre</em> simplifiée, une juxtaposition d'états psychiques.",
	...
	// Question n°77
	{
		question: "Question n°77 : Comment la notion de « projet » s'applique-t-elle à la construction du moi, selon les perspectives existentialistes ?",
		answers: [
			...
			"Le moi n'est pas une essence prédéfinie, mais il se construit et se définit par ses choix."
		],
		correct: 3,
	...
	// Question n°78
	{
		question: "Question n°78 : Quel est le rôle de la mémoire dans la conception lockéenne de l'identité personnelle ?",
		answers: [
			"La mémoire est un simple outil de stockage d'informations, sans lien direct avec l'identité.",
			"La mémoire est un fil conducteur : je suis la même personne que celui qui a vécu un événement si je peux m'en souvenir.",
	...
	// Question n°79
	{
		question: "Question n°79 : Comment interpréter la citation de Sartre : « Le beau parleur est celui qui joue à parler » (Sartre, <em>L'Être et le Néant</em>, Gallimard, coll. Tel, Paris, 1976, p.94) ?",
		answers: [
			"Comme une simple critique de l'éloquence vide de sens et purement formelle.",
			"Comme une illustration de la distance sartrienne entre le moi et ses attitudes.",
			"Comme une remarque sur l'éducation : les enfants doivent apprendre à parler correctement."
		],
		correct: 2,
	...
	// Question n°80
	{
		question: "Question n°80 : Quel est l'apport de la psychanalyse à la compréhension des « métamorphoses du moi » ?",
		answers: [
			"Elle nie toute métamorphose, affirmant la fixité des structures psychiques dès l'enfance.",
			"Elle montre que le moi n'est pas une unité maîtresse, mais une instance fragile.",
			"Elle réduit les métamorphoses à des changements biologiques et chimiques du cerveau."
		],
		correct: 2,
	...
	// Question n°81
	{
		question: "Question n°81 : Quelle est la conception du moi dans la pensée d'Héraclite, évoquée par la formule « on ne se baigne jamais deux fois dans le même fleuve » ?",
		answers: [
			"Le moi est une substance immuable comme le lit du fleuve, qui demeure identique sous le flux.",
			"Le moi, comme toute chose, est en perpétuel changement (<em>πάντα ῥεῖ</em>, « tout s'écoule »).",
	...
	// Question n°82
	{
		question: "Question n°82 : Comment le « principe de plaisir », régissant le ça, entre-t-il en conflit avec la réalité ?",
		answers: [
			"Il n'y a pas de conflit, le principe de plaisir s'adapte automatiquement et intelligemment à la réalité.",
			"Le principe de plaisir cherche la satisfaction immédiate et complète, le moi doit modifier cette satisfaction.",
			"Le principe de plaisir est la recherche du bonheur à long terme, donc il intègre les contraintes de la réalité."
		],
		correct: 2,
	...
	// Question n°83
	{
		question: "Question n°83 : Quelle est la signification des concepts d'« être-pour-soi » et d'« être-pour-autrui » chez Sartre ?",
		answers: [
			...
			"Être-pour-soi : la conscience comme liberté ; être-pour-autrui : le moi figé sous le regard d'autrui."
		],
		correct: 3,
	...
	// Question n°84
	{
		question: "Question n°84 : Comment le « surmoi » se forme-t-il, selon la théorie freudienne ?",
		answers: [
			"Il est inné, présent à la naissance comme une instance morale universelle.",
			"Il se forme par l'intériorisation (introjection) des interdits des parents puis de la société.",
			"Il émerge spontanément de la confrontation du ça avec la réalité extérieure, sans médiation parentale."
		],
		correct: 2,
		explanation: `Le surmoi n'est pas présent à la naissance. Il se construit progressivement dans l'enfance, notamment lors de la résolution du complexe d'Œdipe (entre 3 et 6 ans). L'enfant, face aux interdits parentaux (notamment l'interdit de l'inceste et du parricide), intériorise ces interdits pour résoudre le conflit psychique et s'identifier au parent du même sexe. Il incorpore les figures parentales, leurs voix, leurs commandements, leurs idéaux. Plus tard, d'autres autorités (enseignants, société, religion, culture) viennent renforcer et élargir cette instance. Le surmoi est donc l'héritier du complexe d'Œdipe et le représentant interne de la morale sociale. Sa sévérité dépend de la rigueur des parents et des valeurs de la culture.		\nExemple : Un enfant à qui on répète avec force « il ne faut pas mentir » finit par intérioriser cette interdiction ; plus tard, lorsqu'il ment, il éprouvera de la culpabilité et de la honte même si personne ne le sait et qu'il n'y a pas de conséquence pratique, car son surmoi intériorisé le punit intérieurement.`
	},
	// Question n°85
	{
		question: "Question n°85 : Quelle est la critique adressée par Nietzsche à la notion de « sujet » comme cause de la pensée ?",
		answers: [
			"Elle est trop matérialiste, réduisant la pensée à un épiphénomène du cerveau.",
			"Elle est une projection dans la réalité la structure sujet-verbe de notre langage.",
	...
	// Question n°86
	{
		question: "Question n°86 : En quoi l'exemple de la personne transgenre met-il en crise une définition purement « ontologique » ou « substantielle » du moi ?",
		answers: [
			...
			"Il illustre qu'une définition du moi est insuffisante face à l'identité psychologique vécue."
		],
		correct: 3,
	...
	// Question n°87
	{
		question: "Question n°87 : Quelle est la fonction de la <em>censure</em> dans le modèle freudien de la première topique ?",
		answers: [
			"Elle empêche les contenus conscients de tomber dans l'inconscient et d'être oubliés.",
			"Elle filtre les contenus de l'inconscient et les déforme lorsqu'ils passent.",
			"Elle contrôle ce que nous disons, pour éviter les paroles socialement inacceptables."
		],
		correct: 2,
	...
	// Question n°88
	{
		question: "Question n°88 : Comment le poème d'Eminescu (« Ô ! entendre ma vie comme on écoute un conte… ») exprime-t-il une certaine relation à soi ?",
		answers: [
			...
			"Le souhait de se distancer de sa propre vie en éprouvant l'impossibilité de cette distance."
		],
		correct: 3,
	...
	// Question n°89
	{
		question: "Question n°89 : Quelle est la conception du moi implicite dans l'expérience de la honte, selon l'analyse sartrienne ?",
		answers: [
			"La honte prouve l'existence d'un moi substantiel et moral, qui juge ses propres actes.",
			"La honte révèle que mon moi est immédiatement constitué par le regard d'autrui.",
			"La honte est un sentiment irrationnel qu'il faut surmonter par l'affirmation de soi."
		],
		correct: 2,
	...
	// Question n°90
	{
		question: "Question n°90 : Comment la notion de <em>responsabilité</em> est-elle liée à celle de <em>moi</em>, selon les perspectives juridique et éthique ?",
		answers: [
			"La responsabilité est un fardeau imposé par la société qui limite et entrave la libre expression du <em>moi</em>.",
			"Le <em>moi</em>, en tant qu'auteur de ses actes, est le présupposé et le support de la responsabilité.",
			"Seuls les adultes ayant un <em>moi</em> pleinement formé et rationnel peuvent être tenus pour responsables."
		],
		correct: 2,
		explanation: `On glisse d'une définition métaphysique ou psychologique du moi vers une définition pratique et éthique. Le <em>moi</em> n'est plus seulement une entité à découvrir, mais celui qui peut répondre de ses actes. Dans le droit, la notion de « personne juridique » implique la capacité à être sujet de droits et de devoirs, et à être tenu pour responsable de ses actions (imputabilité). En morale, être une personne, c'est pouvoir s'engager, tenir parole, être fidèle à ses promesses, c'est-à-dire manifester une ipséité (Ricœur). Ainsi, le moi se constitue dans et par l'exercice de la responsabilité. Il est moins ce que je suis que ce que je fais et ce dont je réponds. La responsabilité n'est pas un attribut secondaire, elle est constitutive de l'identité personnelle en société.		\nExemple : Un tribunal ne juge pas « l'âme » ou le « moi profond » d'un accusé, mais il le considère comme une personne responsable, c'est-à-dire comme un moi capable d'avoir compris la portée de son acte et d'avoir fait un choix libre, pour lequel il doit rendre des comptes.`
	},
	// Question n°91
	{
		question: "Question n°91 : Quelle est la différence entre le <em>moi</em> (ego) et le <em>soi</em> (Selbst) chez Jung ?",
		answers: [
			"Le <em>moi</em> est inconscient, le <em>soi</em> est conscient et il correspond à la personnalité sociale.",
			"Le <em>moi</em> est l'instance centrale de la conscience, le <em>soi</em> est l'archétype de la totalité psychique.",
			"Le <em>moi</em> est individuel et unique, le <em>soi</em> est collectif et commun à tous les membres d'une culture."
		],
		correct: 2,
	...
	// Question n°97
	{
		question: "Question n°97 : En quoi la notion de <em>métamorphose</em> est-elle problématique pour penser le moi ?",
		answers: [
			"Parce que la métamorphose implique un changement complet, une rupture.",
			"Parce que si le moi est une substance stable, il ne peut se métamorphoser.",
			"Parce que seuls les insectes et les amphibiens se métamorphosent."
		],
		correct: 2,
		explanation: `On peut soulever ici une aporie logique. La notion de « métamorphose du moi » est centrale, mais elle est conceptuellement difficile. En effet, si l'on conçoit le moi comme une substance immuable (moi ontologique), parler de métamorphose est contradictoire : une substance ne change pas d'essence, elle reste identique à elle-même. Si, à l'opposé, on nie l'existence d'un moi substantiel (comme Hume ou Nietzsche), ou si on le considère comme un pur flux insaisissable, alors il n'y a rien qui « se » métamorphose, juste du changement pur, une succession d'états sans sujet. La métamorphose, au sens fort (changer de forme tout en restant le même individu), semble nécessiter à la fois la permanence d'un substrat et le changement radical de ses attributs. Cette tension est au centre du problème philosophique de l'identité personnelle.		\nExemple : La chenille qui devient papillon : est-ce le même être ? La matière est largement la même, la forme et les fonctions sont radicalement différentes. Pour le moi, la question est similaire : qu'est-ce qui persiste à travers les changements radicaux de personnalité, d'opinions, de corps ? La mémoire ? La conscience ? Un substrat biologique ?`
	},
	// Question n°98
	{
		question: "Question n°98 : Quel est l'apport de la phénoménologie (Merleau-Ponty, Sartre) à la compréhension du moi ?",
		answers: [
			"Elle réduit le moi à des processus cérébraux et neuronaux observables scientifiquement.",
			"Elle décrit le moi tel qu'il se donne dans l'expérience vécue, mettant en lumière son caractère incarné.",
			"Elle prouve scientifiquement l'existence de l'inconscient par l'analyse des phénomènes de conscience."
		],
		correct: 2,
	...
	// Question n°99
	{
		question: "Question n°99 : Comment la notion de « folie » est-elle revalorisée par Nietzsche dans <em>Le Gai Savoir</em> ?",
		answers: [
			"Comme un état supérieur de conscience, seul capable d'accéder à des vérités métaphysiques inaccessibles à la raison.",
			"Non comme un état supérieur, mais comme une condition possiblement nécessaire au développement de certaines vertus.",
