...
const questions = [
	// Question n°1
	{
		question: "Question 1 : Quelle est la maxime inscrite sur le fronton du temple d'Apollon à Delphes, souvent considérée comme l'origine de la quête philosophique de soi ?",
		answers: [
	...
	// Question n°2
	{
		question: "Question 2 : Comment Platon, dans le <em>Théétète</em>, définit-il l'acte de penser ?",
		answers: [
	...
	// Question n°3
	{
		question: "Question 3 : Quelle capacité, selon Kant dans son <em>Anthropologie</em>, distingue fondamentalement l'homme de l'animal ?",
		answers: [
	...
	// Question n°4
	{
		question: "Question 4 : Que signifie l'expression « Je est un autre », formulée par Arthur Rimbaud dans ses lettres dites « du voyant » ?",
		answers: [
	...
	// Question n°5
	{
		question: "Question 5 : Dans la « première topique » freudienne, comment l'appareil psychique est-il organisé ?",
		answers: [
	...
	// Question n°6
	{
		question: "Question 6 : Selon la lecture de Bergson, comment les romanciers réalistes présentent-ils généralement la vie intérieure de leurs personnages ?",
		answers: [
	...
	// Question n°7
	{
		question: "Question 7 : Quelle est la principale difficulté que rencontre Rousseau dans l'écriture de ses <em>Confessions</em>, selon son propre aveu ?",
		answers: [
	...
	// Question n°8
	{
		question: "Question 8 : Dans <em>Lorenzaccio</em> de Musset, comment le héros justifie-t-il son projet d'assassinat du tyran Alexandre de Médicis ?",
		answers: [
	...
	// Question n°9
	{
		question: "Question 9 : Selon la « seconde topique » freudienne, quelle est la fonction principale du « moi » (<em>Ich</em>) ?",
		answers: [
	...
	// Question n°10
	{
		question: "Question 10 : Que découvre Œdipe dans la tragédie de Sophocle, et en quoi cette découverte constitue-t-elle une révélation catastrophique sur le moi ?",
		answers: [
	...
	// Question n°11
	{
		question: "Question 11 : Quelle critique principale Alain adresse-t-il à la notion freudienne d'inconscient ?",
		answers: [
	...
	// Question n°12
	{
		question: "Question 12 : Selon David Hume, dans son <em>Traité de la nature humaine</em>, que découvre-t-on lorsque l'on essaie de percevoir son propre « moi » par l'introspection ?",
		answers: [
	...
	// Question n°13
	{
		question: "Question 13 : Quelle distinction majeure Paul Ricœur établit-il dans son analyse de l'identité personnelle ?",
		answers: [
	...
	// Question n°14
	{
		question: "Question 14 : Quelle est la position de Nietzsche sur la formule cartésienne « Je pense » ?",
		answers: [
	...
	// Question n°15
	{
		question: "Question 15 : Comment le sociologue Émile Durkheim caractérise-t-il la différence entre les sociétés animales et les sociétés humaines ?",
		answers: [
	...
	// Question n°16
	{
		question: "Question 16 : Que signifie l'expression de Montaigne « Je peins le passage », dans le contexte de ses <em>Essais</em> ?",
		answers: [
	...
	// Question n°17
	{
		question: "Question 17 : Dans la psychanalyse de Carl Gustav Jung, qu'est-ce que « l'inconscient collectif » ?",
		answers: [
	...
	// Question n°18
	{
		question: "Question 18 : Quelle est la critique logique de Sartre à l'égard de la notion freudienne d'inconscient ?",
		answers: [
	...
	// Question n°19
	{
		question: "Question 19 : Quel problème célèbre de l'identité à travers le temps est illustré par le <em>bateau de Thésée</em> rapporté par Plutarque ?",
		answers: [
	...
	// Question n°20
	{
		question: "Question 20 : Comment la littérature romantique utilise-t-elle le « je » dans des récits fictionnels ?",
		answers: [
	...
	// Question n°21
	{
		question: "Question 21 : Que met en lumière l'exemple du « couteau de saint Hubert » concernant la notion d'identité ?",
		answers: [
	...
	// Question n°22
	{
		question: "Question 22 : Selon Kant dans les <em>Fondements de la métaphysique des mœurs</em>, quand l'homme est-il véritablement lui-même ?",
		answers: [
	...
	// Question n°23
	{
		question: "Question 23 : Selon Hegel, pourquoi une violence faite à mon corps est-elle une violence faite à « moi » ?",
		answers: [
	...
	// Question n°24
	{
		question: "Question 24 : Quelle est la thèse de John Locke sur l'identité personnelle, illustrée par l'exemple du chêne ?",
		answers: [
	...
	// Question n°25
	{
		question: "Question 25 : Dans <em>Le Horla</em> de Maupassant, quel symptôme manifeste de façon spectaculaire la dépossession de soi du narrateur ?",
		answers: [
	...
	// Question n°26
	{
		question: "Question 26 : Que signifie philosophiquement l'expression « autrui est un <em>alter ego</em> » ?",
		answers: [
	...
	// Question n°27
	{
		question: "Question 27 : Quelle est la fonction du « surmoi » (<em>Über-Ich</em>) dans la seconde topique freudienne ?",
		answers: [
	...
	// Question n°28
	{
		question: "Question 28 : Comment Nietzsche, dans <em>Aurore</em>, caractérise-t-il notre connaissance des instincts qui nous constituent ?",
		answers: [
	...
	// Question n°29
	{
		question: "Question 29 : Que désigne le « soi » (<em>Selbst</em>) dans la psychologie analytique de Carl Gustav Jung ?",
		answers: [
	...
	// Question n°30
	{
		question: "Question 30 : Quelle est la position de Descartes sur la relation entre l'âme (le moi) et le corps, dans sa Sixième Méditation ?",
		answers: [
	...
	// Question n°31
	{
		question: "Question 31 : Quel est le risque majeur pour le moi s'il est trop dominé par le « surmoi » ?",
		answers: [
	...
	// Question n°32
	{
		question: "Question 32 : Que signifie de dire que l'autre n'est ni un sujet ni un objet mais un projet dans le contexte de la quête de soi ?",
		answers: [
	...
	// Question n°33
	{
		question: "Question 33 : Quel est le sens du poème d'Antonio Machado : « Voyageur, il n'y a pas de chemin, le chemin se fait en marchant » ?",
		answers: [
	...
	// Question n°34
	{
		question: "Question 34 : Pourquoi, selon Augustin dans ses <em>Confessions</em>, est-il devenu « une énigme » pour lui-même ?",
		answers: [
	...
	// Question n°35
	{
		question: "Question 35 : Dans <em>L'Étrange Cas du Dr Jekyll et de Mr Hyde</em>, comment le Dr Jekyll décrit-il sa double nature avant l'invention du sérum ?",
		answers: [
	...
	// Question n°36
	{
		question: "Question 36 : Quelle est la « superstition des logiciens » que Nietzsche dénonce dans <em>Par-delà le bien et le mal</em> ?",
		answers: [
	...
	// Question n°37
	{
		question: "Question 37 : Comment définir le « préconscient » dans la première topique freudienne ?",
		answers: [
	...
	// Question n°38
	{
		question: "Question 38 : Quel est l'argument de Leibniz pour dépasser le dualisme âme/corps cartésien ?",
		answers: [
	...
	// Question n°39
	{
		question: "Question 39 : Que signifie la métaphore du « pilote en son navire » employée par Descartes, et quelles sont ses limites ?",
		answers: [
	...
	// Question n°40
	{
		question: "Question 40 : Quelle est la fonction de l'autobiographie selon Rousseau, telle qu'elle apparaît dans le préambule des <em>Confessions</em> ?",
		answers: [
	...
	// Question n°41
	{
		question: "Question 41 : Quel est le risque majeur pour le moi s'il est trop dominé par le <em>ça</em> ?",
		answers: [
	...
	// Question n°42
	{
		question: "Question 42 : Selon la conception kantienne de la conscience de soi, que permet la synthèse du « Je pense » ?",
		answers: [
	...
	// Question n°43
	{
		question: "Question 43 : Comment Nietzsche, dans <em>Le Gai Savoir</em>, remet-il en cause l'idée de « santé » de l'âme ?",
		answers: [
	...
	// Question n°44
	{
		question: "Question 44 : Que signifie la formule de Jules Michelet s'adressant à lui-même dans son <em>Journal</em> : « Profitons au moins de ce moment de repos ; écoutez-moi » ?",
		answers: [
	...
	// Question n°45
	{
		question: "Question 45 : Quelle est la conception du moi défendue par Alain ?",
		answers: [
	...
	// Question n°46
	{
		question: "Question 46 : En quoi M. Hyde est-il, selon le Dr Jekyll, « plus intégral et plus un » que le Dr Jekyll lui-même ?",
		answers: [
	...
	// Question n°47
	{
		question: "Question 47 : Quelle est la position de Sartre sur le rapport du « moi » à ses propres attitudes, comme l'attention en classe ?",
		answers: [
	...
	// Question n°48
	{
		question: "Question 48 : Quel était le rôle de l'hypnose dans les premiers travaux de Freud et de Breuer ?",
		answers: [
	...
	// Question n°49
	{
		question: "Question 49 : Que signifie l'expression « ipséité » (<em>selfhood</em>) chez Paul Ricœur, opposée à la « mêmeté » ?",
		answers: [
	...
	// Question n°50
	{
		question: "Question 50 : Comment la question des personnes transgenres éclaire-t-elle le débat philosophique sur l'identité ?",
		answers: [
	...
	// Question n°51
	{
		question: "Question 51 : Que signifie l'expression « archéologie de la subjectivité » ?",
		answers: [
	...
	// Question n°52
	{
		question: "Question 52 : Comment interpréter la phrase de Nietzsche : « Ô mon frère, derrière tes sentiments et tes pensées se cache un maître puissant, un sage inconnu ; il se nomme toi-même (<em>Selbst</em>). Il habite ton corps, il est ton corps. » ?",
		answers: [
	...
	// Question n°53
	{
		question: "Question 53 : Quel est l'enjeu du « paradoxe du train sans frein » évoqué en marge de l'analyse de <em>Lorenzaccio</em> ?",
		answers: [
	...
	// Question n°54
	{
		question: "Question 54 : Pourquoi le « moi » peut-il être considéré comme une « construction » ?",
		answers: [
	...
	// Question n°55
	{
		question: "Question 55 : Quelle est la signification de l'expérience décrite par Montaigne : la perte d'une dent comme analogie de la mort ?",
		answers: [
	...
	// Question n°56
	{
		question: "Question 56 : Quel est le statut du « ça » (<em>Es</em>) dans la seconde topique freudienne ?",
		answers: [
	...
	// Question n°57
	{
		question: "Question 57 : En quoi le « mal du siècle » romantique est-il lié à une certaine conception du moi ?",
		answers: [
	...
	// Question n°58
	{
		question: "Question 58 : Quelle conception du temps est impliquée dans la définition du moi comme « passage » chez Montaigne ?",
		answers: [
	...
	// Question n°59
	{
		question: "Question 59 : Comment la psychanalyse a-t-elle transformé le regard sur la folie au XXe siècle ?",
		answers: [
	...
	// Question n°60
	{
		question: "Question 60 : Que permet de comprendre l'exemple des nombreux autoportraits de Rembrandt ?",
		answers: [
	...
	// Question n°61
	{
		question: "Question 61 : Selon la conception freudienne, que sont les « actes manqués » (lapsus, oublis, etc.) ?",
		answers: [
	...
	// Question n°62
	{
		question: "Question 62 : Comment définir la <em>maïeutique</em> socratique, en lien avec la pensée du moi ?",
		answers: [
	...
	// Question n°63
	{
		question: "Question 63 : Qu'est-ce que le <em>processus d'individuation</em> dans la psychologie de Jung ?",
		answers: [
	...
	// Question n°64
	{
		question: "Question 64 : Pourquoi la quête du moi est-elle finalement une <em>énigme</em> ?",
		answers: [
	...
	// Question n°65
	{
		question: "Question 65 : Quel est le sens de l'expression <em>branloire pérenne</em> utilisée par Montaigne pour décrire le monde et le moi ?",
		answers: [
	...
	// Question n°66
	{
		question: "Question 66 : Quelle est la différence fondamentale entre l'<em>inconscient</em> et le <em>préconscient</em> dans la première topique freudienne ?",
		answers: [
	...
	// Question n°67
	{
		question: "Question 67 : Comment le « regard d'autrui » constitue-t-il le moi, selon l'analyse de Sartre ?",
		answers: [
	...
	// Question n°68
	{
		question: "Question 68 : Que signifie l'idée que le moi est un <em>choix moral</em> ?",
		answers: [
	...
	// Question n°69
	{
		question: "Question 69 : Qu'est-ce que la <em>double conscience</em> évoquée par Freud dans ses premières études sur l'hystérie ?",
		answers: [
	...
	// Question n°70
	{
		question: "Question 70 : Que signifie l'expression « l'âme est un principe d'animation » dans la conception aristotélicienne ?",
		answers: [
	...
	// Question n°71
	{
		question: "Question 71 : Comment le « positivisme » d'Auguste Comte influence-t-il la conception du moi au XIXe siècle ?",
		answers: [
	...
	// Question n°72
	{
		question: "Question 72 : Quelle est la signification de l'expression « inquiétante étrangeté » (<em>Unheimliche</em>) de Freud ?",
		answers: [
	...
	// Question n°73
	{
		question: "Question 73 : En quoi la métaphore du « <em>Holzweg</em> » (chemin forestier) de Heidegger s'applique-t-elle à la quête du moi ?",
		answers: [
	...
	// Question n°74
	{
		question: "Question 74 : Quelle est la conception du moi dans le roman réaliste du XIXe siècle, selon l'analyse de Bergson ?",
		answers: [
	...
	// Question n°75
	{
		question: "Question 75 : Comment le « dérèglement de tous les sens » prôné par Rimbaud est-il lié à sa conception du « Je est un autre » ?",
		answers: [
	...
	// Question n°76
	{
		question: "Question 76 : Quelle est la position de Descartes sur la certitude de l'existence du moi, résumée par « <em>cogito ergo sum</em> » ?",
		answers: [
	...
	// Question n°77
	{
		question: "Question 77 : Comment la notion de « projet » s'applique-t-elle à la construction du moi, selon les perspectives existentialistes ?",
		answers: [
	...
	// Question n°78
	{
		question: "Question 78 : Quel est le rôle de la mémoire dans la conception lockéenne de l'identité personnelle ?",
		answers: [
	...
	// Question n°79
	{
		question: "Question 79 : Comment interpréter la citation de Sartre : « Le beau parleur est celui qui joue à parler » (Sartre, <em>L'Être et le Néant</em>, Gallimard, coll. Tel, Paris, 1976, p.94) ?",
		answers: [
	...
	// Question n°80
	{
		question: "Question 80 : Quel est l'apport de la psychanalyse à la compréhension des « métamorphoses du moi » ?",
		answers: [
	...
	// Question n°81
	{
		question: "Question 81 : Quelle est la conception du moi dans la pensée d'Héraclite, évoquée par la formule « on ne se baigne jamais deux fois dans le même fleuve » ?",
		answers: [
	...
	// Question n°82
	{
		question: "Question 82 : Comment le « principe de plaisir », régissant le ça, entre-t-il en conflit avec la réalité ?",
		answers: [
	...
	// Question n°83
	{
		question: "Question 83 : Quelle est la signification des concepts d'« être-pour-soi » et d'« être-pour-autrui » chez Sartre ?",
		answers: [
	...
	// Question n°84
	{
		question: "Question 84 : Comment le « surmoi » se forme-t-il, selon la théorie freudienne ?",
		answers: [
	...
	// Question n°85
	{
		question: "Question 85 : Quelle est la critique adressée par Nietzsche à la notion de « sujet » comme cause de la pensée ?",
		answers: [
	...
	// Question n°86
	{
		question: "Question 86 : En quoi l'exemple de la personne transgenre met-il en crise une définition purement « ontologique » ou « substantielle » du moi ?",
		answers: [
	...
	// Question n°87
	{
		question: "Question 87 : Quelle est la fonction de la <em>censure</em> dans le modèle freudien de la première topique ?",
		answers: [
	...
	// Question n°88
	{
		question: "Question 88 : Comment le poème d'Eminescu (« Ô ! entendre ma vie comme on écoute un conte… ») exprime-t-il une certaine relation à soi ?",
		answers: [
	...
	// Question n°89
	{
		question: "Question 89 : Quelle est la conception du moi implicite dans l'expérience de la honte, selon l'analyse sartrienne ?",
		answers: [
	...
	// Question n°90
	{
		question: "Question 90 : Comment la notion de <em>responsabilité</em> est-elle liée à celle de <em>moi</em>, selon les perspectives juridique et éthique ?",
		answers: [
	...
	// Question n°91
	{
		question: "Question 91 : Quelle est la différence entre le <em>moi</em> (ego) et le <em>soi</em> (Selbst) chez Jung ?",
		answers: [
	...
	// Question n°92
	{
		question: "Question 92 : Comment caractériser l'évolution de la conception du moi entre le XVIIe et le XXe siècle ?",
		answers: [
	...
	// Question n°93
	{
		question: "Question 93 : Que signifie l'idée que le moi est une « fiction grammaticale » selon Nietzsche ?",
		answers: [
	...
	// Question n°94
	{
		question: "Question 94 : Quel est le rôle de l'artiste, selon Bergson, par rapport à la connaissance du moi ?",
		answers: [
	...
	// Question n°95
	{
		question: "Question 95 : Comment la « mémoire » est-elle à la fois ce qui permet et ce qui limite la connaissance de soi ?",
		answers: [
	...
	// Question n°96
	{
		question: "Question 96 : Quelle est la signification de l'expression « moi ontologique » ?",
		answers: [
	...
	// Question n°97
	{
		question: "Question 97 : En quoi la notion de <em>métamorphose</em> est-elle problématique pour penser le moi ?",
		answers: [
	...
	// Question n°98
	{
		question: "Question 98 : Quel est l'apport de la phénoménologie (Merleau-Ponty, Sartre) à la compréhension du moi ?",
		answers: [
	...
	// Question n°99
	{
		question: "Question 99 : Comment la notion de « folie » est-elle revalorisée par Nietzsche dans <em>Le Gai Savoir</em> ?",
		answers: [
	...
	// Question n°100
	{
		question: "Question 100 : Que devient le moi une fois qu'on a parcouru les différentes <em>métamorphoses</em> de ses conceptions ?",
		answers: [
