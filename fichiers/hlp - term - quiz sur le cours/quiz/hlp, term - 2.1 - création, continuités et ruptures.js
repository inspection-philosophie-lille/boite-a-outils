...
const questions = [
  // Question n°1
  {
    question: "Question n°01 : Quelle conviction héritée du 19e siècle est radicalement ébranlée par les événements du 20e siècle ?",
    answers: [
  ...
  // Question n°2
  {
    question: "Question n°02 : Quel est le principal défi du monde contemporain face à son passé ?",
    answers: [
  ...
  // Question n°3
  {
    question: "Question n°03 : L’exemple d'un candidat aux municipales de Denain (2020) offrant des bons d’essence illustre principalement :",
    answers: [
  ...
  // Question n°4
  {
    question: "Question n°04 : Que signifie précisément l’expression « faire monde » dans le contexte philosophique contemporain ?",
    answers: [
  ...
  // Question n°5
  {
    question: "Question n°05 : Pourquoi la découverte des Amériques est-elle un bon exemple pour penser la relativité de la notion de rupture ?",
    answers: [
  ...
  // Question n°6
  {
    question: "Question n°06 : Quelle question fondamentale est posée par l’opposition entre rupture et continuité ?",
    answers: [
  ...
  // Question n°7
  {
    question: "Question n°07 : Quelle est la singularité potentielle des ruptures à l’époque contemporaine ?",
    answers: [
  ...
  // Question n°8
  {
    question: "Question n°08 : Quel concept permet d’articuler de manière plus subtile et nuancée les notions de rupture et de continuité ?",
    answers: [
  ...
  // Question n°9
  {
    question: "Question n°09 : Que montre la psychanalyse à propos de la nature humaine et de la conscience ?",
    answers: [
  ...
  // Question n°10
  {
    question: "Question n°10 : Contre quelle tradition philosophique précise Ludwig Wittgenstein rompt-il dans <em>De la certitude</em> ?",
    answers: [
  ...
  // Question n°11
  {
    question: "Question n°11 : Que signifie l’affirmation de Wittgenstein selon laquelle l’homme est « d’abord un être de croyance et de certitude » ?",
    answers: [
  ...
  // Question n°12
  {
    question: "Question n°12 : Que sont les « obstacles épistémologiques » selon Gaston Bachelard ?",
    answers: [
  ...
  // Question n°13
  {
    question: "Question n°13 : Quelle est la prescription principale de Bachelard pour former un authentique esprit scientifique ?",
    answers: [
  ...
  // Question n°14
  {
    question: "Question n°14 : Selon Robert Nozick dans <em>Anarchie, État et utopie</em>, quel devrait être le rôle légitime de l’État ?",
    answers: [
  ...
  // Question n°15
  {
    question: "Question n°15 : Quel principe de justice John Rawls met-il en avant à travers l’article 6 de la Déclaration des Droits de l’Homme et du Citoyen ?",
    answers: [
  ...
  // Question n°16
  {
    question: "Question n°16 : Quelle thèse célèbre de Hegel sur l’art est citée pour introduire l’idée de la « fin de l’art » ?",
    answers: [
  ...
  // Question n°17
  {
    question: "Question n°17 : Quelle caractéristique de l’œuvre d’art classique, selon Kant, est remise en cause par certaines pratiques de l’art contemporain ?",
    answers: [
  ...
  // Question n°18
  {
    question: "Question n°18 : Quel exemple Walter Benjamin donne-t-il pour illustrer comment la technique modifie radicalement l’œuvre d’art ?",
    answers: [
  ...
  // Question n°19
  {
    question: "Question n°19 : Qu’est-ce qu’une « performance » dans le champ de l’art contemporain ?",
    answers: [
  ...
  // Question n°20
  {
    question: "Question n°20 : Quel est l’objectif principal de la performance <em>I like America and America likes me</em> de Joseph Beuys (1974) ?",
    answers: [
  ...
  // Question n°21
  {
    question: "Question n°21 : Que critique l’art conceptuel, selon Joseph Kosuth, à propos de l’art traditionnel ?",
    answers: [
  ...
  // Question n°22
  {
    question: "Question n°22 : Quelle controverse illustre la question « qui est l’auteur ? » dans le monde de l’art contemporain ?",
    answers: [
  ...
  // Question n°23
  {
    question: "Question n°23 : Comment Jean Cocteau, dans <em>La Machine infernale</em>, traite-t-il le mythe antique d’Œdipe ?",
    answers: [
  ...
  // Question n°24
  {
    question: "Question n°24 : Quel est l’enjeu principal de la pièce <em>La guerre de Troie n’aura pas lieu</em> de Jean Giraudoux ?",
    answers: [
  ...
  // Question n°25
  {
    question: "Question n°25 : Quel aspect du roman courtois médiéval Marcel Proust reprend-il dans <em>Du côté de chez Swann</em> ?",
    answers: [
  ...
  // Question n°26
  {
    question: "Question n°26 : Que signifie le concept d’« hantologie » en musique, tel qu’appliqué par Leyland Kirby (The Caretaker) ?",
    answers: [
  ...
  // Question n°27
  {
    question: "Question n°27 : Quel est le projet philosophique fondamental d’Edmund Husserl avec la phénoménologie ?",
    answers: [
  ...
  // Question n°28
  {
    question: "Question n°28 : Que reproche Husserl, dans <em>La Crise des sciences européennes</em>, à la science moderne ?",
    answers: [
  ...
  // Question n°29
  {
    question: "Question n°29 : Comment Heidegger, dans <em>Être et Temps</em>, décrit-il l’existence inauthentique de l’être-là (Dasein) ?",
    answers: [
  ...
  // Question n°30
  {
    question: "Question n°30 : Quelle est la thèse centrale du <em>Tractatus logico-philosophicus</em> de Wittgenstein concernant la tâche de la philosophie ?",
    answers: [
  ...
  // Question n°31
  {
    question: "Question n°31 : Quelle célèbre proposition du <em>Tractatus</em> résume sa position sur les limites du langage sensé ?",
    answers: [
  ...
  // Question n°32
  {
    question: "Question n°32 : Quel est le projet du « Cercle de Vienne » et de Rudolf Carnap ?",
    answers: [
  ...
  // Question n°33
  {
    question: "Question n°33 : Quel type d’énoncé Rudolf Carnap qualifie-t-il de « tautologie » ?",
    answers: [
  ...
  // Question n°34
  {
    question: "Question n°34 : Pourquoi Carnap considère-t-il que les mots métaphysiques comme « Dieu » ou « l’Être » sont dénués de sens ?",
    answers: [
  ...
  // Question n°35
  {
    question: "Question n°35 : Quel philosophe et quel texte Carnap critique-t-il explicitement comme exemple paradigmatique du non-sens métaphysique ?",
    answers: [
  ...
  // Question n°36
  {
    question: "Question n°36 : Quelle est la « différence ontologique » selon Martin Heidegger ?",
    answers: [
  ...
  // Question n°37
  {
    question: "Question n°37 : Pourquoi Heidegger considère-t-il que la poésie est essentielle pour penser l’être ?",
    answers: [
  ...
  // Question n°38
  {
    question: "Question n°38 : Quelle expérience concrète Alain Finkielkraut évoque-t-il pour illustrer la notion d’« il y a » (être impersonnel) ?",
    answers: [
  ...
  // Question n°39
  {
    question: "Question n°39 : En quoi la peinture d’Édouard Manet, avec <em>Le Déjeuner sur l’herbe</em> (1863), rompt-elle avec la peinture académique ?",
    answers: [
  ...
  // Question n°40
  {
    question: "Question n°40 : Quelle affirmation d’Émile Zola résume le mieux la rupture opérée par Manet selon l’analyse présentée ?",
    answers: [
  ...
  // Question n°41
  {
    question: "Question n°41 : Que signifie l’idée de « faire monde » dans un contexte où « la croyance individuelle prévaut sur la connaissance universelle » ?",
    answers: [
  ...
  // Question n°42
  {
    question: "Question n°42 : Pourquoi la crise écologique actuelle constitue-t-elle une rupture « sans précédent historique » ?",
    answers: [
  ...
  // Question n°43
  {
    question: "Question n°43 : Selon les perspectives ouvertes par la psychanalyse, quelle conséquence a la découverte de l’inconscient sur le projet de « faire monde » ?",
    answers: [
  ...
  // Question n°44
  {
    question: "Question n°44 : En quoi la critique de la métaphysique par le Cercle de Vienne est-elle aussi une critique de la philosophie traditionnelle dans son ensemble ?",
    answers: [
  ...
  // Question n°45
  {
    question: "Question n°45 : Comment l’art contemporain, en cherchant à désacraliser l’art, peut-il être vu comme une continuité avec l’art antique ?",
    answers: [
  ...
  // Question n°46
  {
    question: "Question n°46 : Quelle est la relation entre la phrase de Marx (« Les philosophes n’ont fait qu’interpréter le monde… ») et le projet de la phénoménologie ?",
    answers: [
  ...
  // Question n°47
  {
    question: "Question n°47 : Pourquoi le « je sais » a-t-il un sens problématique selon l’analyse de Wittgenstein ?",
    answers: [
  ...
  // Question n°48
  {
    question: "Question n°48 : Que signifie « laisser sa raison inquiète » selon la prescription de Gaston Bachelard ?",
    answers: [
  ...
  // Question n°49
  {
    question: "Question n°49 : Quel est le principal problème soulevé par la thèse libertarienne de Robert Nozick sur l’État minimal ?",
    answers: [
  ...
  // Question n°50
  {
    question: "Question n°50 : Comment la notion de « seuil » permet-elle de dépasser l’opposition binaire entre rupture et continuité ?",
    answers: [
  ...
  // Question n°51
  {
    question: "Question n°51 : Quel est le statut des jugements de valeur (éthiques ou esthétiques) dans la perspective du Cercle de Vienne ?",
    answers: [
  ...
  // Question n°52
  {
    question: "Question n°52 : En quoi l’art de Patricia Piccinini, qui cherche « délibérément la laideur », s’inscrit-il dans une critique de l’esthétique ?",
    answers: [
  ...
  // Question n°53
  {
    question: "Question n°53 : Quel rôle joue l’angoisse (<em>Angst</em>) dans la philosophie de Martin Heidegger ?",
    answers: [
  ...
  // Question n°54
  {
    question: "Question n°54 : Pourquoi associer le retour de la crinoline dans la mode (2025) à une recherche de continuité ?",
    answers: [
  ...
  // Question n°55
  {
    question: "Question n°55 : Que signifie l’idée de <em>Geworfenheit</em> (déréliction) chez Heidegger ?",
    answers: [
  ...
  // Question n°56
  {
    question: "Question n°56 : Quelle est la différence entre un jugement analytique et un jugement synthétique selon Kant, reprise par Carnap ?",
    answers: [
  ...
  // Question n°57
  {
    question: "Question n°57 : Quelle est l’importance du concept d’« intentionnalité » dans la phénoménologie de Husserl ?",
    answers: [
  ...
  // Question n°58
  {
    question: "Question n°58 : Pourquoi dire que la performance de Marina Abramović et Ulay <em>Relation in Time</em> (assis dos à dos) est une œuvre d’art ?",
    answers: [
  ...
  // Question n°59
  {
    question: "Question n°59 : Quel est l’enjeu de la performance de Chris Burden <em>Shoot</em> (1971) où il se fait tirer dessus au bras ?",
    answers: [
  ...
  // Question n°60
  {
    question: "Question n°60 : Comment le concept de <em>jeu de langage</em> pourrait-il répondre aux difficultés de <em>faire monde</em> ?",
    answers: [
  ...
  // Question n°61
  {
    question: "Question n°61 : En quoi la figure de Marcel Duchamp est-elle une « charnière » selon l’analyse de Joseph Kosuth ?",
    answers: [
  ...
  // Question n°62
  {
    question: "Question n°62 : Quelle est la signification de l’œuvre <em>La Nona Ora</em> de Maurizio Cattelan (le pape écrasé par une météorite) ?",
    answers: [
  ...
  // Question n°63
  {
    question: "Question n°63 : Qu’est-ce que la « réduction eidétique » (de εἶδος, l’idée) chez Husserl ?",
    answers: [
  ...
  // Question n°64
  {
    question: "Question n°64 : Que signifie l’idée que « l’art est mort » avec l’avènement de l’art contemporain ?",
    answers: [
  ...
  // Question n°65
  {
    question: "Question n°65 : Comment le mythe est-il utilisé au 20e siècle dans le théâtre, selon les exemples de Cocteau et Giraudoux ?",
    answers: [
  ...
  // Question n°66
  {
    question: "Question n°66 : Pourquoi la « banane » scotchée au mur par Maurizio Cattelan est-elle devenue une œuvre d’art célèbre ?",
    answers: [
  ...
  // Question n°67
  {
    question: "Question n°67 : Quel est le sens de la performance d’Orlan qui se fait poser des implants de silicone sur le visage en direct ?",
    answers: [
  ...
  // Question n°68
  {
    question: "Question n°68 : En quoi le travail de l’artiste Saburō Murakami (percer des écrans de papier) implique-t-il le spectateur ?",
    answers: [
  ...
  // Question n°69
  {
    question: "Question n°69 : Que signifie l’affirmation de Kant : « Il n’est pas douteux que toutes nos connaissances ne commencent avec l’expérience » ?",
    answers: [
  ...
  // Question n°70
  {
    question: "Question n°70 : Quel est le sens de la performance de Michel Journiac <em>Messe pour un corps</em> où il distribue une hostie faite de son sang ?",
    answers: [
  ...
  // Question n°71
  {
    question: "Question n°71 : Pourquoi Heidegger reproche-t-il à la métaphysique traditionnelle d’avoir « oublié l’être » ?",
    answers: [
  ...
  // Question n°72
  {
    question: "Question n°72 : Quel est le sens politique de la pièce de Giraudoux <em>La guerre de Troie n’aura pas lieu</em> au moment de son écriture ?",
    answers: [
  ...
  // Question n°73
  {
    question: "Question n°73 : Quelle est la différence entre l’« être jeté » et le « projet » chez Heidegger ?",
    answers: [
  ...
  // Question n°74
  {
    question: "Question n°74 : En quoi la performance de Gina Pane <em>je</em> (1972) explore-t-elle la relation entre l’individu et l’autre ?",
    answers: [
  ...
  // Question n°75
  {
    question: "Question n°75 : Que signifie l’idée que l’art contemporain a tué « l’artiste » au sens romantique du génie ?",
    answers: [
  ...
  // Question n°76
  {
    question: "Question n°76 : Pourquoi la phénoménologie de Husserl est-elle dite « transcendantale » ?",
    answers: [
  ...
  // Question n°77
  {
    question: "Question n°77 : Quel est le rôle de la technique dans la modification du statut de l’œuvre d’art selon Walter Benjamin ?",
    answers: [
  ...
  // Question n°78
  {
    question: "Question n°78 : Quel est le sens de la performance de Chris Burden <em>Trans-Fixed</em> où il se fait crucifier sur une Coccinelle ?",
    answers: [
  ...
  // Question n°79
  {
    question: "Question n°79 : Comment la phrase de Hegel « l’art est pour nous quelque chose du passé » doit-elle être comprise ?",
    answers: [
  ...
  // Question n°80
  {
    question: "Question n°80 : Quelle est la signification de l’épigraphe de l’article 6 de la DDHC reprise par Rawls ?",
    answers: [
  ...
  // Question n°81
  {
    question: "Question n°81 : Quelle critique peut-on adresser à la thèse de Nozick en citant ensuite la théorie de Rawls ?",
    answers: [
  ...
  // Question n°82
  {
    question: "Question n°82 : Que signifie « l’esprit scientifique se forme en se réformant » selon Bachelard ?",
    answers: [
  ...
  // Question n°83
  {
    question: "Question n°83 : Comment l’exemple du coq de Locke illustre-t-il un obstacle épistémologique ?",
    answers: [
  ...
  // Question n°84
  {
    question: "Question n°84 : Quelle vision de l’homme Wittgenstein propose-t-il contre le cartésianisme ?",
    answers: [
  ...
  // Question n°85
  {
    question: "Question n°85 : Pourquoi peut-on dire que l’art contemporain, en rompant avec l’art classique, renoue avec une fonction de l’art antique ?",
    answers: [
  ...
  // Question n°86
  {
    question: "Question n°86 : Quel est le sens du titre <em>La Machine infernale</em> de Jean Cocteau ?",
    answers: [
  ...
  // Question n°87
  {
    question: "Question n°87 : En quoi le traitement du temps par Husserl diffère-t-il d’une conception linéaire ?",
    answers: [
  ...
  // Question n°88
  {
    question: "Question n°88 : Que signifie l’affirmation « Tout ce qui peut être dit, peut être dit clairement » dans le contexte du <em>Tractatus</em> ?",
    answers: [
  ...
  // Question n°89
  {
    question: "Question n°89 : Pourquoi l’art conceptuel de Kosuth considère-t-il que « l’art après la philosophie » commence avec Duchamp ?",
    answers: [
  ...
  // Question n°90
  {
    question: "Question n°90 : Quel est le paradoxe de la notion de « progrès » au 20e siècle ?",
    answers: [
  ...
  // Question n°91
  {
    question: "Question n°91 : Comment l’exemple de « l’artiste et robots » illustre-t-il la « mort de l’artiste » au sens traditionnel ?",
    answers: [
  ...
  // Question n°92
  {
    question: "Question n°92 : Que signifie l’idée de « modernité relative » ?",
    answers: [
  ...
  // Question n°93
  {
    question: "Question n°93 : Quelle est la fonction de l’« époché » ou réduction phénoménologique chez Husserl ?",
    answers: [
  ...
  // Question n°94
  {
    question: "Question n°94 : Pourquoi évoquer le fait qu’Hitler et Wittgenstein sont nés à quelques jours d’intervalle ?",
    answers: [
  ...
  // Question n°95
  {
    question: "Question n°95 : Quelle est la différence entre <em>vouloir savoir</em> et <em>pouvoir savoir</em> évoquée à propos de Wittgenstein ?",
    answers: [
  ...
  // Question n°96
  {
    question: "Question n°96 : Comment la performance de Chris Burden <em>Five Day Locker Piece</em> peut-elle être interprétée ?",
    answers: [
  ...
  // Question n°97
  {
    question: "Question n°97 : Quel est le statut des mathématiques dans l’empirisme logique de Rudolf Carnap ?",
    answers: [
  ...
  // Question n°98
  {
    question: "Question n°98 : En quoi le « body art » ou « art corporel » représente-t-il une rupture avec la tradition artistique ?",
    answers: [
  ...
  // Question n°99
  {
    question: "Question n°99 : Que signifie l’idée que « la crise écologique est sans précédent historique » ?",
    answers: [
  ...
  // Question n°100
  {
    question: "Question n°100 : Quel est le fil conducteur qui relie les différentes parties de la séquence « création, continuités et ruptures » ?",
    answers: [
