...
/* attention aux " que l'on ajouterait dans la définition. A remplacer par '' */
  	...
  	{ colonne_de_gauche: "Faux dilemme", colonne_de_droite: "Soit vous soutenez la recherche nucléaire, soit vous êtes contre le progrès scientifique."},
  	{ colonne_de_gauche: "Appel à la nature", colonne_de_droite: "Les OGM ne sont pas naturels, donc ils sont forcément dangereux pour la santé."},
  	{ colonne_de_gauche: "Ad hominem", colonne_de_droite: "Vous ne pouvez pas parler d'écologie, vous prenez l'avion comme tout le monde !"},
  	{ colonne_de_gauche: "Pente glissante", colonne_de_droite: "Si on autorise l'aide médicale à mourir, bientôt on éliminera les personnes handicapées."},
  	{ colonne_de_gauche: "Homme de paille", colonne_de_droite: "Les féministes veulent dominer les hommes et renverser la société."},
  	{ colonne_de_gauche: "Généralisation hâtive", colonne_de_droite: "Mon cousin a eu des effets secondaires avec ce vaccin, donc tous les vaccins sont dangereux."},
  	{ colonne_de_gauche: "Argument d'autorité", colonne_de_droite: "Ce célèbre influenceur recommande ce produit, donc il est efficace."},
  	{ colonne_de_gauche: "Appel à l'émotion", colonne_de_droite: "Comment pouvez-vous critiquer cette politique d'accueil des migrants ? Pensez à tous ces enfants qui souffrent !"},
  	{ colonne_de_gauche: "Post hoc ergo propter hoc", colonne_de_droite: "J'ai utilisé ce talisman et j'ai trouvé un travail, donc il porte chance."},
  	{ colonne_de_gauche: "Appel à l'ignorance", colonne_de_droite: "Personne n'a prouvé que les extraterrestres ne nous visitent pas, donc les OVNI existent."},
  	{ colonne_de_gauche: "Fausse analogie", colonne_de_droite: "L'État devrait gérer l'économie comme un père de famille gère son budget."},
  	{ colonne_de_gauche: "Non sequitur", colonne_de_droite: "Il pleut aujourd'hui, donc le changement climatique est une invention."},
  	{ colonne_de_gauche: "Tu quoque", colonne_de_droite: "Tu me critiques pour ma consommation, mais toi aussi tu as un smartphone !"},
  	{ colonne_de_gauche: "Appel à la tradition", colonne_de_droite: "L'école a toujours fonctionné ainsi, inutile de changer les méthodes d'enseignement."},
  	{ colonne_de_gauche: "Sophisme du Texas", colonne_de_droite: "Nous avons eu une vague de froid, donc le réchauffement climatique est un mythe."},
  	{ colonne_de_gauche: "Sophisme du joueur", colonne_de_droite: "Cette machine à sous n'a pas payé depuis longtemps, elle va forcément donner le jackpot."},
  	{ colonne_de_gauche: "Sophisme de composition", colonne_de_droite: "Chaque citoyen de ce pays est riche, donc le pays est riche."},
  	{ colonne_de_gauche: "Sophisme de division", colonne_de_droite: "Cette entreprise est performante, donc chaque employé est performant."},
  	{ colonne_de_gauche: "Sophisme du vrai Écossais", colonne_de_droite: "Aucun vrai écologiste ne prendrait sa voiture pour faire 500 mètres."},
  	{ colonne_de_gauche: "Sophisme de l'anecdote", colonne_de_droite: "Ma grand-mère a fumé toute sa vie et elle a vécu jusqu'à 90 ans, donc fumer n'est pas si nocif."},
  	{ colonne_de_gauche: "Double faute", colonne_de_droite: "Ce n'est pas grave de jeter mes déchets par terre, les autres le font aussi."},
  	{ colonne_de_gauche: "Sophisme de la solution parfaite", colonne_de_droite: "Pourquoi trier nos déchets ? Cela ne résoudra pas complètement le problème de la pollution."},
  	{ colonne_de_gauche: "Sophisme du juste milieu", colonne_de_droite: "Certains disent que la Terre est ronde, d'autres qu'elle est plate, donc elle doit être en forme de ballon de rugby."},
  	{ colonne_de_gauche: "Appel à la popularité", colonne_de_droite: "Tout le monde utilise les réseaux sociaux, donc ils ne peuvent pas être nuisibles."},
  	{ colonne_de_gauche: "Pétition de principe", colonne_de_droite: "La liberté d'expression est essentielle car sans elle nous ne serions pas libres de nous exprimer."},
  	{ colonne_de_gauche: "Sophisme de la cause unique", colonne_de_droite: "La violence à l'école est due aux jeux vidéo, point final."},
  	{ colonne_de_gauche: "Sophisme de l'appel à la crainte", colonne_de_droite: "Si vous ne votez pas pour nous, le pays va sombrer dans le chaos économique."},
  	{ colonne_de_gauche: "Fausse alternative", colonne_de_droite: "Soit on développe l'économie, soit on protège l'environnement."},
  	{ colonne_de_gauche: "Sophisme de la preuve anecdotique", colonne_de_droite: "Je connais quelqu'un qui a guéri son cancer avec des plantes, donc la médecine naturelle est plus efficace."},
  	{ colonne_de_gauche: "Sophisme de la corrélation implique causalité", colonne_de_droite: "Les pays qui ont le plus de médecins ont aussi la plus forte mortalité, donc les médecins tuent des patients"},
