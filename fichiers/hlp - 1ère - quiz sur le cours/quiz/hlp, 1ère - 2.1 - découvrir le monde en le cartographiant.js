...
const questions = [
  ...
  // Question n°8
  {
    ...
    answers: [
      ...
      "Sur la sensibilité naturelle, et particulièrement sur le principe de pitié envers tout être souffrant."
    ],
    correct: 3,
  ...
  // Question n°12
  {
    ...
    answers: [
      ...
      "En proposant une carte <em>Australie-centrique</em> qui met en cause l'habitude de centrer la carte sur l'Europe et le nord en haut."
    ],
    correct: 3,
  ...
  // Question n°15
  {
    ...
    answers: [
      ...
      "L'exotisme naïf représente l'autre à travers les codes de sa propre culture, l'exotisme ethnologique le décrit dans son cadre culturel."
    ],
    correct: 3,
  ...
  // Question n°16
  {
    ...
    answers: [
      ...
      "Parce qu'elle place l'homme au centre de ses préoccupations et mobilise des savoirs humanistes."
    ],
    correct: 3,
  ...
  // Question n°17
  {
    ...
    answers: [
      ...
      "Il parle de <em>conquête</em> et de <em>prise de possession</em>, tout en décrivant les habitants comme doux et confiants."
    ],
    correct: 3,
  ...
  // Question n°19
  {
    ...
    answers: [
      ...
      "Par son utilité pratique pour l'homme et parce qu'elle témoigne de la sagesse du Dieu qui a tout organisé pour son bien."
    ],
    correct: 3,
  ...
  // Question n°20
  {
    ...
    answers: [
      ...
      "Montrer le monde en création centrée sur Jérusalem avec une signification religieuse."
    ],
    correct: 3,
  ...
  // Question n°21
  {
    ...
    answers: [
      ...
      "Ptolémée, avec ses projections géométriques dans sa <em>Géographie</em>."
    ],
    correct: 3,
  ...
  // Question n°23
  {
    ...
    answers: [
      ...
      "En objectivant le monde en objets situables, elle a permis de le considérer comme un tableau que l'on peut contempler."
    ],
    correct: 3,
  ...
  // Question n°24
  {
    ...
    answers: [
      ...
      "Elle exprime la grandeur paradoxale de l'homme : fragile et perdu dans l'univers, mais conscient de sa condition."
    ],
    correct: 3,
  ...
  // Question n°25
  {
    question: "Quelle est la signification de l'inscription grecque γνῶθι σεαυτόν (connais-toi toi-même) sur le temple d'Apollon à Delphes ?",
    answers: [
      ...
      "Un avertissement à l'homme de connaître sa place dans l'ordre du κόσμος (cosmos) pour ne pas rivaliser avec les dieux."
    ],
    correct: 3,
  ...
  // Question n°27
  {
    ...
    answers: [
      ...
      "Elle constitue un miroir qui renvoie à la femme occidentale, interrogeant les artifices de la civilisation."
    ],
    correct: 3,
  ...
  // Question n°28
  {
    ...
    answers: [
      ...
      "Une croyance lucide : admettre que l'homme a besoin de croire et de lois conventionnelles et non absolues."
    ],
    correct: 3,
  ...
  // Question n°29
  {
    ...
    answers: [
      ...
      "Il montre que les vérités peuvent être erronées, et que nos propres vérités pourraient un jour être révisées."
    ],
    correct: 3,
  ...
  // Question n°30
  {
    ...
    answers: [
      ...
      "Un miroir critique de la société européenne corrompue, incarnant un état de nature présumé innocent."
    ],
    correct: 3,
  ...
  // Question n°31
  {
    ...
    answers: [
      ...
      "Un changement de paradigme où le sujet impose activement ses structures à ce qu'il connaît."
    ],
    correct: 3,
  ...
  // Question n°34
  {
    ...
    answers: [
      ...
      "Elle oblige à considérer que les peuples nouvellement découverts sont des hommes dont les mœurs méritent d'être comprises."
    ],
    correct: 3,
  ...
  // Question n°35
  {
    ...
    answers: [
      ...
      "Elle est lue soit comme un signe d'innocence édénique, soit comme une marque de barbarie et d'immoralité."
    ],
    correct: 3,
  ...
  // Question n°38
  {
    ...
    answers: [
      ...
      "Comme une construction scientifique, utilisant des critères physiques pour établir des classifications hiérarchiques."
    ],
    correct: 3,
  ...
  // Question n°39
  {
    ...
    answers: [
      ...
      "Il partage les terres à découvrir, montrant que la cartographie sert à affirmer des prétentions impériales."
    ],
    correct: 3,
  ...
  // Question n°40
  {
    ...
    answers: [
      ...
      "Ce sont les sauvages qui posent des questions critiques, faisant ainsi office d'ethnologues observant les Européens."
    ],
    correct: 3,
  ...
  // Question n°41
  {
    ...
    answers: [
      ...
      "La connaissance scientifique est par nature falsifiable et progresse par la mise en cause des modèles explicatifs antérieurs."
    ],
    correct: 3,
  ...
  // Question n°42
  {
    ...
    answers: [
      ...
      "Il est renforcé, car malgré la diversité des mœurs, les humanistes cherchent un fonds commun universel comme la raison."
    ],
    correct: 3,
  ...
  // Question n°45
  {
    ...
    answers: [
      ...
      "Une métaphore frappante du relativisme des coutumes humaines qui n'ont absolument rien d'absolu."
    ],
    correct: 3,
  ...
  // Question n°47
  {
    ...
    answers: [
      ...
      "Elle a montré l'existence d'une civilisation païenne, mais dotée d'une haute moralité et d'un gouvernement raffiné."
    ],
    correct: 3,
  ...
  // Question n°48
  {
    ...
    answers: [
      ...
      "Une idée marginale rejetée par les scientifiques de l'époque comme superstitieuse et fausse."
    ],
    correct: 2,
  ...
  // Question n°49
  {
    ...
    answers: [
      ...
      "Montaigne doute pour douter, comme une fin en soi, Descartes doute pour fonder une science certaine."
    ],
    correct: 3,
  ...
  // Question n°50
  {
    ...
    answers: [
      ...
      "Il faut sans cesse confronter l'autorité des livres avec les observations nouvelles faites sur le terrain."
    ],
    correct: 3,
  ...
  // Question n°54
  {
    ...
    answers: [
      ...
      "À des usages multiples et providentiels pour l'homme : assainir l'air, permettre la navigation..."
    ],
    correct: 3,
  ...
  // Question n°55
  {
    ...
    answers: [
      ...
      "En présentant des sociétés où les biens sont partagés, il a servi de contremodèle pour dénoncer l'appropriation privée."
    ],
    correct: 3,
  ...
  // Question n°58
  {
    ...
    answers: [
      ...
      "Par la bulle <em>Sublimis Deus</em>, elle a affirmé que les Indiens étaient des hommes donc non asservissables."
    ],
    correct: 3,
  ...
  // Question n°61
  {
    ...
    answers: [
      ...
      "<em>Potentia</em> désigne la puissance en acte, <em>potestas</em> désigne le pouvoir institutionnel, la souveraineté légale."
    ],
    correct: 3,
  ...
  // Question n°62
  {
    ...
    answers: [
      ...
      "Tous deux considèrent qu'une théorie scientifique n'a de valeur que si elle est réfutable."
    ],
    correct: 3,
  ...
  // Question n°63
  {
    question: "Quel est l'enjeu de la représentation du monde ?",
    answers: [
  ...
  // Question n°64
  {
    ...
    answers: [
      ...
      "Elle a <em>géométrisé</em> l'espace, le pensant comme un réseau de points qui permet de calculer des déplacements."
    ],
    correct: 3,
  ...
  // Question n°65
  {
    ...
    answers: [
      ...
      "Face à l'infini du cosmos, le silence peut être l'expression d'une prise de conscience des limites du langage humain."
    ],
    correct: 3,
  ...
  // Question n°66
  {
    ...
    answers: [
      ...
      "Un paradigme fournit un cadre de pensée si puissant que les anomalies sont d'abord ignorées ou expliquées."
    ],
    correct: 3,
  ...
  // Question n°67
  {
    ...
    answers: [
      ...
      "Il est considéré comme le premier grand débat sur les droits de l'homme, la guerre juste et le relativisme culturel."
    ],
    correct: 3,
  ...
  // Question n°68
  {
    ...
    answers: [
      ...
      "Le médecin doit connaître le climat, les vents et les eaux d'un lieu pour comprendre la santé de ses habitants."
    ],
    correct: 3,
  ...
  // Question n°69
  {
    ...
    answers: [
      ...
      "Le développement technique et scientifique ne s'accompagne pas nécessairement d'un progrès moral."
    ],
    correct: 3,
  ...
  // Question n°70
  {
    ...
    answers: [
      ...
      "Le <em>monde</em> tend à désigner un environnement extérieur que l'homme peut étudier et exploiter."
    ],
    correct: 3,
  ...
  // Question n°72
  {
    ...
    answers: [
      ...
      "Deux modèles s'opposent : habiter et s'enraciner, ou venir au monde en errant et en acceptant la mobilité."
    ],
    correct: 3,
  ...
  // Question n°73
  {
    ...
    answers: [
      ...
      "Il a créé la projection qui permet de représenter les lignes de cap constant facilitant la navigation."
    ],
    correct: 3,
  ...
  // Question n°74
  {
    ...
    answers: [
      ...
      "Ils ont souvent mêlé observations réelles et exagérations créant un réservoir d'images stéréotypées."
    ],
    correct: 3,
  ...
  // Question n°78
  {
    ...
    answers: [
      ...
      "Elle radicalise les critiques de l'ethnocentrisme, en s'appuyant sur les récits de voyage."
    ],
    correct: 3,
  ...
  // Question n°79
  {
    ...
    answers: [
      ...
      "Convaincre fait appel à des arguments universels, tandis que persuader fait appel aux émotions."
    ],
    correct: 3,
  ...
  // Question n°82
  {
    ...
    answers: [
      ...
      "La répression violente de ces personnes révèle le rejet absolu d'une identité de genre non binaire."
    ],
    correct: 3,
  ...
  // Question n°83
  {
    ...
    answers: [
      ...
      "Elle oblige à rechercher un fondement au sens, non plus dans un ordre cosmique divin mais dans l'homme lui-même."
    ],
    correct: 3,
  ...
  // Question n°84
  {
    ...
    answers: [
      ...
      "La fiction peut mettre en question le monde présent et ouvrir la voie à sa transformation."
    ],
    correct: 3,
  ...
  // Question n°86
  {
    ...
    answers: [
      ...
      "La sagesse consiste à suivre les lois de son pays en ayant conscience qu'elles ne sont pas absolues."
    ],
    correct: 3,
  ...
  // Question n°87
  {
    ...
    answers: [
      ...
      "En projetant la surface terrestre sur un cône tangent à un parallèle."
    ],
    correct: 3,
  ...
  // Question n°88
  {
    ...
    answers: [
      ...
      "L'étonnement ouvre à la curiosité, l'horreur peut susciter l'indignation, la pitié fonde la compassion universelle."
    ],
    correct: 3,
  ...
  // Question n°89
  {
    ...
    answers: [
      ...
      "La modernité apparaît comme une époque de ruptures et de crises, porteuse d'émancipation et de domination."
    ],
    correct: 3,
  ...
  // Question n°90
  {
    ...
    answers: [
      ...
      "Pour Rousseau, le sentiment de pitié est antérieure et supérieure à la raison comme fondement de la morale."
    ],
    correct: 3,
  ...
  // Question n°92
  {
    ...
    answers: [
      ...
      "La certitude est souvent le fait de ceux qui réfléchissent le moins."
    ],
    correct: 3,
  ...
  // Question n°93
  {
    question: "Comment l'idée de <em>guerre juste</em> est-elle mise en cause par les écrits de Las Casas ?",
    answers: [
      ...
      "Il approuve la guerre pour convertir les païens si elle est menée avec une intention droite."
    ],
    correct: 2,
  ...
  // Question n°97
  {
    ...
    answers: [
      ...
      "La connaissance est possible parce que l'esprit impose des structures à l'expérience pour la rendre intelligible."
    ],
    correct: 3,
  ...
  // Question n°98
  {
    ...
    answers: [
      ...
      "Une définition de l'ethnocentrisme, qui dissout l'objectivité du jugement moral sur d'autres cultures."
    ],
    correct: 3,
  ...
  // Question n°99
  {
    ...
    answers: [
      ...
      "Il soutient que la violence est contre-productive en dressant les Indiens contre le christianisme"
    ],
    correct: 3,
  ...
  // Question n°100
  {
    question: "Quel est le principal enseignement philosophique que l'on peut tirer de cette séquence ?",
    answers: [
      ...
      "La rencontre avec l'altérité est un choc qui oblige à chercher les principes d'une humanité commune dans le respect des différences."
    ],
    correct: 3,
