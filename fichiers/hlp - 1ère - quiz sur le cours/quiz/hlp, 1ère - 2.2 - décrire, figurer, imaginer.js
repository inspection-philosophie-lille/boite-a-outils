...
const questions = [
  // Question n°1
  {
    question: "Comment Gorgias, dans l'Éloge d'Hélène, justifie-t-il l'innocence d'Hélène, ayant quitté son mari pour suivre Pâris ?",
    answers: [
      ...
      "En démontrant qu'elle fut persuadée par le discours (λόγος) de Pâris, puissance aussi irrésistible qu'une force physique."
    ],
    correct: 3,
...
Exemple : Un discours publicitaire sophistiqué peut nous persuader d'acheter un objet dont nous n'avons pas besoin, en agissant sur nos désirs et nos peurs, tout comme le discours de Pâris a agi sur Hélène.`
  ...
  // Question n°2
  {
    question: "Quelle distinction fondamentale la rhétorique classique établit-elle entre les genres de discours ?",
    answers: [
...
Exemple : Le réquisitoire d'un procureur est un discours judiciaire, un débat parlementaire est délibératif, et l'éloge funèbre d'un soldat inconnu est un discours épidictique.`
  ...
  // Question n°3
  {
    question: "Que signifie l'expression « parole performative », conceptualisée par le philosophe du langage J.L. Austin ?",
    answers: [
...
Exemple : Lorsqu'un maire dit « Je déclre la séance ouverte », il ne décrit pas une ouverture, il l'accomplit. De même, le « Oui » des époux lors d'un mariage civil est un acte performatif qui les unit légalement.`
  },
  // Question n°4
  {
    question: "Dans le Gorgias de Platon, quelle métaphore Socrate utilise-t-il pour disqualifier la rhétorique des sophistes ?",
    answers: [
...
Exemple : Un discours populiste promettant des solutions simples et gratifiantes à des problèmes complexes flatte l'auditoire (comme la cuisine grasse), tandis qu'un discours politique responsable expose les difficultés et les efforts nécessaires (comme un traitement médical).`
  ...
  // Question n°5
  {
    question: "Quelle est la différence entre « persuader » et « convaincre », selon une distinction classique héritée de la pensée pascalienne ?",
    answers: [
...
Exemple : Un avocat peut chercher à convaincre le jury par des preuves matérielles (conviction), mais aussi à le persuader par un plaidoyer émouvant sur la détresse de son client (persuasion).`
  ...
  // Question n°6
  {
    question: "Quels sont les trois « preuves » ou « moyens de persuasion » (πίστεις) qu'Aristote identifie comme fondements de l'art rhétorique ?",
    answers: [
...
Exemple : Dans un discours sur l'écologie, un scientifique utilisera des données (logos), manifestera sa compétence et son intégrité (ethos), et pourra évoquer l'amour pour les générations futures pour émouvoir (pathos).`
  ...
  // Question n°7
  {
    question: "Pourquoi Platon, dans le Phèdre, critique-t-il l'écriture, lui préférant la parole vivante du dialogue ?",
    answers: [
...
Exemple : Un texte philosophique peut être interprété de mille façons, parfois contraires, sans que l'auteur puisse intervenir. Une discussion en classe permet, elle, de préciser, nuancer et approfondir la compréhension en direct.`
  ...
  // Question n°8
  {
    question: "Qu'est-ce que la « doxa » (δόξα) dans le vocabulaire platonicien, et pourquoi est-elle le terrain de prédilection du sophiste ?",
    answers: [
...
Exemple : En politique, un démagogue base son discours sur les préjugés populaires du moment (la doxa) plutôt que sur une analyse factuelle et raisonnée de la situation.`
  ...
  // Question n°9
  {
    question: "Selon Cicéron, quelles sont les cinq parties canoniques de l'art oratoire (les officia oratoris) ?",
    answers: [
...
Exemple : Pour préparer un discours, on trouve d'abord des idées et des preuves (inventio), on les organise en un plan (dispositio), on rédige en soignant les mots et les tournures (elocutio), on l'apprend par cœur (memoria), et enfin on travaille sa voix et ses gestes pour le jour J (actio).`
  ...
  // Question n°10
  {
    question: "Quelle est la fonction du « kairos » (καιρός) dans la pratique rhétorique des sophistes ?",
    answers: [
...
Exemple : Un leader politique qui adapte son discours (ton, arguments, exemples) en fonction qu'il s'adresse à des ouvriers en grève, à des chefs d'entreprise ou à un parlement international, fait preuve de sens du kairos.`
  ...
  // Question n°11
  {
    question: "Que signifie l'expression « psychagogie » (ψυχαγωγία), souvent associée à la rhétorique de Gorgias ?",
    answers: [
      "L'étude scientifique de l'esprit humain (psychologie).",
      "L'art de « conduire les âmes » par la parole, de les influencer et de les manipuler.",
...
Exemple : Un conteur qui captive son auditoire, le faisant rire, trembler ou rêver, pratique une forme de psychagogie. De même, un slogan publicitaire répétitif vise à « conduire » le consommateur vers l'acte d'achat.`
  },
  // Question n°12
  {
...
Exemple : Un spot publicitaire télévisé (parole anonyme de la marque) ne dialogue pas avec vous ; il vous assène un message calibré. À l'inverse, un débat entre deux citoyens (parole personnelle) implique écoute et réponse.`
  },
  // Question n°13
  {
    question: "Dans la tragédie Antigone de Sophocle, quel est l'enjeu du conflit entre la parole de Créon (édit royal) et celle d'Antigone (loi divine et familiale) ?",
    answers: [
...
Exemple : Les « humanités » classiques (littérature, histoire, philosophie) dans l'éducation républicaine française s'inscrivent dans cette tradition isocratique de formation du citoyen par la culture du langage et de la pensée.`
  },
  // Question n°16
  {
...
Exemple : Si un enfant dit à ses copains « Je vous déclare mari et femme », l'énoncé est « malheureux » car l'enfant n'a pas l'autorité légale (le statut) pour accomplir cet acte. La convention sociale n'est pas respectée.`
  },
  // Question n°17
  {
    question: "Que représente la figure mythologique de Protagoras, avec sa fameuse phrase « L'homme est la mesure de toute chose » ?",
    answers: [
...
Exemple : L'idée que « la beauté est dans l'œil de celui qui regarde » est un écho du relativisme protagoréen. En politique, cela peut justifier que chaque groupe défende sa propre « vérité » sans référence à un bien commun objectif.`
  },
  // Question n°18
  {
    question: "Dans l'analyse du discours de Marc Antoine dans Jules César de Shakespeare, quel procédé rhétorique utilise-t-il pour retourner la foule contre Brutus ?",
    answers: [
...
Exemple : Quand vous apprenez l'anglais, vous apprenez une « langue » (son vocabulaire, sa grammaire). Quand vous dites « Hello, how are you? », vous produisez un acte de « parole ». La capacité d'apprendre et d'utiliser une langue fait partie de votre « langage ».`
  },
  // Question n°20
  {
    question: "Que signifie l'idée de « violence symbolique » développée par le sociologue Pierre Bourdieu ?",
    answers: [
    ...
    correct: 3,
    explanation: `La violence symbolique est une imposition de significations (visions du monde, catégories de pensée) qui sont le produit des rapports de force dominants, mais qui sont perçues comme légitimes, naturelles, allant de soi. Elle s'exerce notamment par le langage (les titres, les façons de parler jugées « correctes », les stéréotypes). Les dominés adhèrent à ces représentations qui les dévalorisent, contribuant ainsi à leur propre domination sans besoin de coercition physique.
Exemple : Le fait de considérer certains accents régionaux ou de banlieue comme « vulgaires » ou « moins éduqués » est une violence symbolique qui dévalorise socialement les locuteurs de ces milieux et légitime la suprématie d'une norme linguistique dominante.`
  },
  // Question n°21
  {
    question: "Quelle est la fonction principale de l'« exorde » dans la structure classique d'un discours ?",
    answers: [
...
Exemple : Un avocat commençant son plaidoirie par « Mesdames, Messieurs les jurés, je suis honoré de plaider aujourd'hui devant vous une affice qui touche aux fondements même de notre justice... » cherche par cet exorde à capter leur bienveillance et leur attention.`
  },
  // Question n°22
  {
    question: "Comment peut-on définir un « sophisme » ?",
    answers: [
...
Exemple : L'appel à la tradition (« On a toujours fait comme ça ») est un sophisme : ce n'est pas parce qu'une pratique est ancienne qu'elle est bonne. De même, l'attaque personnelle (ad hominem) qui discrédite la personne plutôt que son argument est un sophisme courant.`
  ...
  // Question n°23
  {
    question: "Quel concept Hannah Arendt utilise-t-elle pour désigner la capacité humaine à commencer quelque chose de nouveau par la parole et l'action dans la sphère publique ?",
    answers: [
      "La « vita activa » (vie active).",
      "La « natalité ».",
      "Le « contrat social »."
    ],
    correct: 2,
...
Exemple : Le discours « I have a dream » de Martin Luther King fut un acte de parole qui initia un nouveau chapitre dans la lutte pour les droits civiques, révélant une possibilité d'avenir nouvelle pour la société américaine.`
  ...
  // Question n°24
  {
    question: "Dans le Banquet de Platon, quelle est la nature de l'ascension décrite par Diotime, qui mène de l'amour des beaux corps à l'amour du Beau en soi ?",
    answers: [
...
Exemple : Un étudiant peut d'abord être passionné par une discipline particulière (les mathématiques) pour la beauté de ses démonstrations, puis en venir à aimer la science et la recherche de la vérité en général, qui est l'objet de la philosophie.`
  ...
  // Question n°25
  {
    question: "Que signifie l'expression « langue de bois » en contexte politique ?",
    answers: [
      "Un langage volontairement compliqué et jargonnant pour impressionner l'auditoire.",
      "Un discours stéréotypé, vague et dénué de sens concret, destiné à ne rien dire de engageant tout en donnant l'illusion de communiquer.",
      "Le langage technique des rapports administratifs, incompréhensible pour le grand public."
    ],
    correct: 2,
    explanation: `La langue de bois est un discours creux, formulé avec des phrases toutes faites, des abstractions (« la croissance », « l'emploi », « le vivre-ensemble ») et des tournures passives qui évitent de nommer les responsabilités. Elle a pour fonction de masquer la réalité, d'éviter le débat de fond et de préserver le statu quo. C'est l'antithèse d'une parole authentique, précise et responsable. Elle illustre la dégénérescence de la parole politique en outil de camouflage.
Exemple : Une réponse politique du type « Des mesures seront prises en temps utile, dans le cadre d'une approche globale et concertée, pour répondre aux préoccupations légitimes exprimées » est un classique de la langue de bois, car elle ne dit rien de concret sur les mesures, leur calendrier ou leur responsabilité.`
  ...
  // Question n°26
  {
    question: "Quelle différence majeure oppose, selon le cours, la puissance (potentia) et le pouvoir (potestas) de la parole ?",
    answers: [
...
Exemple : Une conversation amicale où l'on se confie et se comprend fait jouer la potentia de la parole. Un ordre militaire ou un discours de propagande qui formate les pensées fait jouer la potestas.`
  ...
  // Question n°27
  {
    question: "Comment Aristote définit-il l'« enthymème » dans sa Rhétorique ?",
    answers: [
...
Exemple : Le silence d'une minute en mémoire des victimes d'une tragédie est une parole non-dite, collective et puissante. Dans un débat, le fait de se taire pour écouter vraiment l'autre est un silence actif et respectueux.`
  ...
  // Question n°29
  {
    question: "Que signifie « l'argument d'autorité » et pourquoi est-il souvent considéré comme un sophisme ?",
    answers: [
...
Exemple : « Il faut croire en Dieu car la Bible le dit » est un argument d'autorité qui ne vaut que pour ceux qui reconnaissent déjà l'autorité de la Bible. Il est irrecevable dans un débat philosophique sur l'existence de Dieu.`
  ...
  // Question n°30
  {
    question: "Quelle est la thèse centrale de Walter Benjamin dans son essai « Le Conteur », concernant la modernité ?",
    answers: [
    ...
    correct: 2,
    explanation: `Benjamin oppose l'information, qui est éphémère, décontextualisée et « expliquée », à l'expérience (Erfahrung) que transmet le conteur. Le conteur tire sa sagesse de l'expérience vécue et la transmet sous forme narrative, laissant à l'auditeur le soin d'en tirer sa propre leçon. La modernité (la Grande Guerre, les médias de masse) a, selon Benjamin, appauvri cette capacité à partager et à transmettre l'expérience, la remplaçant par un flot d'informations stériles.
Exemple : Les grands récits des anciens (sur la guerre, l'amour, le travail) avaient une valeur d'expérience. Aujourd'hui, nous sommes submergés par des « infos » brutes sur les catastrophes dans le monde, sans pouvoir les intégrer dans une expérience narrative et sensée.`
  },
  // Question n°31
  {
    question: "Comment Cicéron définit-il l'idéal de l'orateur parfait dans son traité « De l'Orateur » ?",
    answers: [
...
Exemple : Cicéron lui-même, en dénonçant la conjuration de Catilina, cherchait à incarner cet idéal : user de son immense talent oratoire (les Catilinaires) pour sauver la République romaine, au nom de la vertu et de la loi.`
  ...
  // Question n°32
  {
    question: "Que désigne le terme « topos » (τόπος) en rhétorique ?",
    answers: [
      "Le lieu géographique où se tient le discours.",
      "Le sujet principal abordé par l'orateur.",
      "Un « lieu commun », c'est-à-dire un schéma d'argumentation standard, un réservoir d'idées et d'arguments préétablis sur lequel l'orateur peut puiser."
    ],
    correct: 3,
    explanation: `Les topoi (lieux) sont des cadres argumentatifs généraux, des « sièges d'arguments ». Aristote les classe en lieux communs (applicables à tout sujet, comme les lieux du plus et du moins) et lieux spéciaux (propres à un domaine, comme la politique ou le droit). Ce sont des matrices à produire des arguments. L'orateur ne crée pas ex nihilo, il explore ces lieux pour trouver ce qu'il peut dire sur son sujet. C'est une forme de rationalisation de l'invention.
Exemple : Pour défendre une loi, on peut puiser dans le topos de l'utilité (elle est utile), de la justice (elle est juste), de la possibilité (elle est réalisable), ou du topos contraire pour l'attaquer. Le topos « à père avare, fils prodigue » est un lieu commun sur la génération.`
  ...
  // Question n°33
  {
    question: "En quoi le concept de « parole prophétique » se distingue-t-il de la parole rhétorique classique ?",
    answers: [
...
Exemple : Au cinéma, nous savons que les acteurs ne meurent pas vraiment, mais nous sommes émus aux larmes par une scène de mort bien mise en scène. Le réalisateur, « trompeur », est applaudi pour ce talent.`
  ...
  // Question n°35
  {
    question: "Quelle critique Rousseau adresse-t-il à l'éloquence des sociétés polies dans le « Discours sur l'origine de l'inégalité » ?",
    answers: [
...
Exemple : Le « Manifeste du Parti communiste » n'est pas un traité académique, mais un appel à l'action, une parole destinée à être un instrument de mobilisation et de transformation du monde social.`
  },
  // Question n°37
  {
    question: "Que signifie le principe de « charitable interpretation » (interprétation charitable) dans la philosophie du langage et le débat d'idées ?",
    answers: [
    ...
    correct: 2,
    correct: 2,
    explanation: `Également appelé « principe de charité », cette règle méthodologique exige de prêter à l'interlocuteur ou à l'auteur qu'on lit une rationalité minimale. On doit chercher à comprendre son argument dans sa meilleure formulation, en supposant qu'il vise la cohérence et la vérité, avant d'en montrer les limites. Ce principe est au fondement d'un débat intellectuel loyal et fécond, par opposition à la polémique qui déforme la pensée adverse pour mieux la ridiculiser.
Exemple : Avant de critiquer la position d'un philosophe, on doit s'efforcer de la reconstruire de manière aussi solide et sensée que possible, même si on n'est pas d'accord. Cela oblige à une critique bien plus profonde et respectueuse.`
  ...
  // Question n°38
  {
    question: "Quelle est la fonction de la « narration » (narratio) dans un discours judiciaire selon les traités classiques ?",
    answers: [
...
Exemple : Dans un procès, l'avocat de la défense et le procureur proposent deux narrations différentes des mêmes événements, chacune mettant en avant les éléments qui servent leur plaidoirie (l'intention, le contexte, les antécédents).`
  ...
  // Question n°39
  {
    question: "Comment Hannah Arendt analyse-t-elle le phénomène totalitaire en lien avec la destruction du langage ?",
    answers: [
...
Exemple : Dans 1984 d'Orwell, le novlangue vise à réduire le nombre de mots pour rendre les pensées dissidentes impossibles. C'est une illustration fictionnelle de cette destruction arendtienne du langage comme espace de liberté.`
  ...
  // Question n°40
  {
    question: "Que signifie l'expression « argument ad hominem » ?",
    answers: [
...
Exemple : « Ne croyez pas les conclusions de ce rapport sur le climat, il a été financé par une entreprise pétrolière ! » C'est peut-être un motif de prudence, mais cela n'invalide pas par lui-même les arguments scientifiques du rapport, qu'il faut examiner pour eux-mêmes.`
  ...
  // Question n°41
  {
    question: "Quelle est la différence entre « dénotation » et « connotation » dans l'analyse du langage ?",
    answers: [
    ...
    correct: 1,
    explanation: `Cette distinction est centrale en sémantique. La dénotation est le référent ou le concept objectif que le mot désigne (le « chien » comme animal). C'est le sens stable, partagé par tous les locuteurs d'une langue. La connotation est l'aura de sens secondaires, souvent affectifs, sociaux ou idéologiques (« chien » peut connoter la fidélité ou, péjorativement, la méchanceté). La rhétorique joue beaucoup sur les connotations pour produire des effets persuasifs ou poétiques.
Exemple : Le mot « révolution » dénote un changement politique brutal. Mais il peut connoter positivement le progrès et la liberté (la Révolution française) ou négativement le chaos et la violence (vue par un contre-révolutionnaire).`
  },
  // Question n°42
  {
    question: "Quel rôle joue la « réticence » (ou aposiopèse) comme figure de style dans un discours persuasif ?",
    answers: [
...
Exemple : « Si je vous disais tout ce que je sais sur ses agissements... mais non, je me tairai par respect pour les institutions. » L'orateur insinue ainsi qu'il y a des choses terribles à révéler, sans en apporter la moindre preuve.`
  ...
  // Question n°43
  {
    question: "Comment le philosophe Jürgen Habermas conçoit-il l'idéal de la « communication non-distorsionnée » ?",
    answers: [
...
Exemple : Un conseil municipal participatif où tous les habitants peuvent s'exprimer librement et où les décisions sont prises après un débat argumenté et transparent se rapproche (imparfaitement) de cet idéal habermassien.`
  ...
  // Question n°44
  {
    ...
    correct: 2,
    explanation: `Cette phrase du « Tractatus » exprime une thèse forte sur le rapport entre langage et réalité. Le langage n'est pas un simple outil pour décrire un monde préexistant ; il structure notre expérience du monde. Les concepts, les catégories grammaticales de notre langue dessinent le cadre à l'intérieur duquel nous pouvons former des pensées et donner sens à notre expérience. Ce qui ne peut pas être dit (mis en propositions ayant sens) ne peut pas être pensé clairement et appartient au domaine du « mystique ».
Exemple : Si une langue n'a pas de mot pour une émotion subtile (comme le « saudade » portugais), il sera plus difficile pour ses locuteurs de conceptualiser et de partager cette expérience affective de manière précise.`
  },
  // Question n°45
  {
    question: "Que désigne l'« argument du pente glissante » (pente savonneuse) ?",
    answers: [
...
Exemple : « Si on autorise le mariage pour tous, bientôt on autorisera le mariage avec des animaux ! » C'est un glissement fallacieux qui ne repose sur aucun lien logique ou juridique avéré entre les deux propositions.`
  ...
  // Question n°46
  {
    question: "En quoi consiste la stratégie rhétorique de la « concession » ?",
    answers: [
...
Exemple : « Je reconnais volontiers que cette réforme comporte des aspects positifs en matière de simplification. Cependant, son coût social exorbitant et son injustice fondamentale la rendent inacceptable. » L'orateur neutralise ainsi l'argument adverse mineur avant de porter son attaque principale.`
  ...
  // Question n°47
  {
    question: "Quelle est la fonction de la « question rhétorique » dans un discours ?",
    answers: [
...
Exemple : « Jusqu'à quand tolérerez-vous cette injustice ? » (sous-entendu : « Il faut cesser de la tolérer »). « Est-ce là le comportement d'un homme honnête ? » (sous-entendu : « Non, ce n'est pas le cas »).`
  ...
  // Question n°48
  {
    question: "Comment Nietzsche analyse-t-il la relation entre la vérité et le langage dans « Vérité et mensonge au sens extra-moral » ?",
    answers: [
      "Le langage est l'outil parfait pour exprimer la vérité des choses.",
      "Le langage, né de besoins utilitaires, est une armée de métaphores usées, de métonymies et d'anthropomorphismes ; la « vérité » n'est qu'un mensonge socialement utile et oublié comme tel.",
      "Le langage poétique seul peut approcher la vérité, car il dépasse les limites du langage conceptuel."
    ],
    correct: 2,
    explanation: `Nietzsche propose une généalogie matérialiste et sceptique du langage. Les mots ne sont pas nés d'une intuition de l'essence des choses, mais de désignations arbitraires et métaphoriques visant à survivre en société. Avec le temps, on oublie l'origine métaphorique des mots et on croit qu'ils désignent la vérité des choses. La « vérité » n'est donc qu'un « mobile d'erreurs » devenu nécessaire et régulateur pour la vie en commun. Cette analyse radicale sape tout fondement absolu du discours vrai.
Exemple : Le mot « esprit » était à l'origine une métaphore souffle/vent (du latin « spiritus »). Nous l'utilisons aujourd'hui comme un concept fixe désignant une réalité, oubliant son origine imagée et anthropomorphique.`
  },
  // Question n°49
  {
    question: "Qu'est-ce qu'un « stéréotype » linguistique et quel est son rôle dans la communication ?",
    answers: [
...
Exemple : Les stéréotypes de genre (« les femmes sont émotives, les hommes sont forts ») simplifient la réalité à l'extrême, ignorent la diversité des individus, et servent souvent à justifier des discriminations ou des rôles sociaux inégaux.`
  ...
  // Question n°50
  {
    question: "Quelle est la différence entre « oralité » et « oral » ?",
    answers: [
      "L'oralité désigne la communication parlée en général, l'oral est un examen où l'on doit parler.",
      "L'« oral » désigne le mode de communication (par opposition à l'écrit), tandis que « l'oralité » désigne une culture où le savoir, la mémoire et la transmission reposent principalement sur la parole et non sur l'écriture.",
...
Exemple : Dans une négociation tendue, le fait de se taire après avoir posé une question peut mettre la pression sur l'interlocuteur et l'amener à révéler plus qu'il ne le voulait. C'est un silence stratégique et « d'or ».`
  },
  // Question n°52
  {
    question: "Quelle est la thèse de Ferdinand de Saussure sur l'« arbitraire du signe » linguistique ?",
    answers: [
...
Exemple : Rien dans la suite de sons [ʃ(ə)val] ne rappelle l'animal « cheval ». C'est la convention sociale de la langue française qui lui associe ce concept.`
  ...
  // Question n°53
  {
    question: "Qu'est-ce que « l'argument par l'absurde » (reductio ad absurdum) ?",
    answers: [
...
Exemple : Pour prouver qu'« il n'existe pas de plus grand nombre entier », on suppose qu'il en existe un, N. Mais alors N+1 est plus grand que N, ce qui contredit l'hypothèse. Donc l'hypothèse est fausse.`
  },
  // Question n°54
  {
    question: "Comment peut-on définir la « propagande » moderne par rapport à la rhétorique classique ?",
    answers: [
...
Exemple : La propagande nazie, avec ses affiches, ses films et ses discours radiodiffusés, visait à créer une communauté unie par la haine des Juifs et la croyance en la supériorité aryenne, en étouffant toute voix dissidente et tout examen rationnel.`
  ...
  // Question n°55
  {
    question: "Quelle est la fonction de la « périphrase » comme figure de style ?",
    answers: [
...
Exemple : « La Ville Lumière » pour Paris, « le pays du Cèdre » pour le Liban, « l'astre du jour » pour le soleil. En politique, dire « l'hôte de l'Élysée » plutôt que « le Président » peut avoir une nuance de distance ou de déférence.`
  ...
  // Question n°56
  {
    question: "Quelle est la position de Platon sur la poésie, exprimée notamment dans « La République » ?",
    answers: [
...
Exemple : Homère montre Achille pleurant la mort de Patrocle. Pour Platon, cela encourage les jeunes à s'abandonner à la douleur au lieu de la dominer par la raison.`
  ...
  // Question n°57
  {
    ...
    correct: 2,
    explanation: `C'est une forme d'argument ad hominem et une manipulation courante dans la polémique. Au lieu de discuter du contenu objectif d'une proposition ou d'un acte, on prétend dévoiler les « vraies » intentions (néfastes, intéressées, hypocrites) de son auteur. Cela permet de disqualifier l'adversaire moralement sans avoir à argumenter sur le fond. C'est une accusation souvent infalsifiable car portant sur l'invisible (les pensées).
Exemple : « Il propose une baisse d'impôts, mais ne vous y trompez pas, son intention réelle est de favoriser ses amis riches et de priver l'État de ressources pour les services publics. » On attaque l'intention supposée plutôt que d'analyser les effets probables de la mesure.`
  ...
  // Question n°58
  {
    question: "Comment la notion de « cadre » (frame) est-elle utilisée en analyse du discours et en communication politique ?",
    answers: [
    ...
    correct: 2,
    explanation: `Cadrer un débat, c'est en définir les termes, les causes présumées et les solutions envisageables. Par exemple, présenter l'immigration comme un « problème de sécurité » (cadre sécuritaire) plutôt que comme une « chance économique et culturelle » (cadre ouvert) oriente radicalement la discussion et les politiques envisagées. Le framing est une activité rhétorique puissante car il agit en amont des arguments, en conditionnant la perception même de la réalité. Qui définit le cadre a déjà gagné une grande partie du débat.
Exemple : Parler de « charges sociales » plutôt que de « cotisations sociales » change le cadre : on passe d'une contribution collective à un fardeau pour l'entreprise.`
  },
  // Question n°59
  {
    question: "Quelle est la différence entre « langue morte » et « langue vivante » ?",
    answers: [
    ...
    correct: 2,
    explanation: `Le critère est l'usage comme première langue dans la vie quotidienne d'une communauté. Le latin, parlé dans l'Empire romain, était une langue vivante. Il est devenu « mort » quand il a cessé d'être transmis comme langue maternelle, se fossilisant dans sa forme classique. Il survit dans des usages spécialisés (Église, sciences, droit). Une langue vivante, elle, se transforme constamment (nouveaux mots, évolution de la prononciation, de la grammaire) par la pratique de ses locuteurs.
Exemple : L'hébreu est un cas unique de « résurrection » : langue liturgique morte pendant des siècles, elle a été revitalisée comme langue vivante et officielle d'Israël au XXe siècle.`
  },
  // Question n°60
  {
...
Exemple : Après une dispute, on repense à ce qu'aurait dû être notre réponse idéale. C'est « l'esprit de l'escalier » qui travaille, souvent pour notre plus grande irritation.`
  ...
  // Question n°62
  {
    question: "Quelle est la fonction de l'« apostrophe » dans un discours ?",
    answers: [
...
Exemple : Dans un discours politique : « Monsieur le Premier ministre, allez-vous enfin répondre à cette question simple ? » L'orateur utilise l'apostrophe pour mettre son adversaire directement sur la sellette.`
  ...
  // Question n°63
  {
    question: "Comment la philosophie analytique (par exemple, avec P.F. Strawson) aborde-t-elle la question des « actes de parole » ?",
    answers: [
...
Exemple : « La porte est ouverte » (locution). Peut être une simple constatation (illocution), ou un ordre implicite de la fermer (illocution). L'effet (perlocution) sera que l'auditeur s'en fiche, ou qu'il aille la fermer.`
  ...
  // Question n°64
  {
    question: "Qu'est-ce qu'un « lieu commun » (koinos topos) dans le sens péjoratif du terme ?",
    answers: [
...
Exemple : « Il faut vivre avec son temps » ou « L'argent ne fait pas le bonheur » sont des lieux communs. Ils peuvent contenir une part de vérité, mais leur répétition automatique dispense de penser aux nuances et aux situations concrètes.`
  ...
  // Question n°65
  {
    question: "Quel est le rôle des « exemples » (paradeigmata) dans l'argumentation selon Aristote ?",
    answers: [
...
Exemple : Pour défendre une politique de dépenses publiques en temps de crise, un homme politique peut citer l'exemple du New Deal de Roosevelt dans les années 1930, en arguant que cela a permis de relancer l'économie américaine.`
  ...
  // Question n°66
  {
    question: "Que signifie l'expression « parler à demi-mot » ?",
    answers: [
...
Exemple : Entre deux personnes qui connaissent une situation délicate, l'une peut dire à l'autre : « Tu as entendu pour... lui ? » L'autre comprend immédiatement de qui et de quoi il s'agit, sans qu'il soit besoin de préciser.`
  ...
  // Question n°67
  {
    question: "Comment le « paradoxe » est-il utilisé dans la parole philosophique, notamment chez les Stoïciens ou les Cyniques ?",
    answers: [
...
Exemple : L'assertion socratique « Je sais que je ne sais rien » est un paradoxe célèbre : comment peut-on savoir qu'on ne sait rien ? Elle invite à une redéfinition profonde de la connaissance et de la sagesse.`
  ...
  // Question n°68
  {
    question: "Quelle est la fonction de l'« hyperbole » comme figure de style ?",
    answers: [
      ...
      "Comparer deux éléments à l'aide de « comme » ou « tel »."
    ],
    correct: 2,
...
Exemple : « Je t'ai appelé mille fois ! » (pour dire « plusieurs fois »). Dans un discours politique : « Cette loi est une catastrophe absolue, un suicide national ! » L'hyperbole vise à mobiliser l'indignation.`
  ...
  // Question n°69
  {
    question: "Qu'est-ce qu'un « lapsus » linguistique, et comment la psychanalyse l'interprète-t-elle ?",
    answers: [
    ...
    correct: 2,
    explanation: `Freud, dans « Psychopathologie de la vie quotidienne », voit dans le lapsus (comme dans l'oubli de noms) l'expression de l'inconscient. Le moi conscient veut dire une chose, mais une pulsion ou une pensée refoulée perturbe l'énoncé et fait surgir un autre mot, souvent lié par l'association phonétique ou sémantique au mot voulu. Le lapsus est donc une « parole vraie » qui échappe au contrôle, révélant un conflit psychique. Il montre que la parole n'est pas toujours maîtrisée par la conscience.
Exemple : Un président de séance qui dit « Je déclare la séance levée » au lieu de « ouverte » peut (éventuellement) trahir un désir inconscient d'en finir rapidement avec cette réunion.`
  },
  // Question n°70
  {
    question: "Comment la notion de « politiquement correct » est-elle généralement interprétée dans les débats contemporains sur le langage ?",
    answers: [
...
Exemple : Le débat sur l'écriture inclusive (« iel », « agriculteur·rice·s ») relève des enjeux du politiquement correct : faut-il modifier la langue pour qu'elle soit plus égalitaire entre les genres ?`
  ...
  // Question n°71
  {
    question: "Quelle est la signification de l'expression « parole vide » ?",
    answers: [
...
Exemple : Les discours de campagne électorale qui multiplient les promesses génériques (« plus d'emplois », « plus de sécurité ») sans aucun plan concret sont souvent perçus comme des paroles vides.`
  ...
  // Question n°72
  {
    question: "Quel est le sens de la maxime de Térence : « Je suis homme, et rien de ce qui est humain ne m'est étranger » (Homo sum, humani nihil a me alienum puto) ?",
    answers: [
    ...
    correct: 2,
    explanation: `Cette citation, tirée de la comédie « L'Homme qui se punit lui-même », exprime une ouverture à autrui et un sens de la solidarité humaine. Elle fonde un impératif d'empathie et de curiosité. Rien de ce que font ou subissent les autres hommes ne doit nous laisser indifférents, car nous partageons la même nature. Cette maxime a été reprise par les humanistes de la Renaissance comme un credo contre l'indifférence et l'égoïsme. Elle invite à une parole qui reconnaît l'humanité de l'autre.
Exemple : Un journaliste qui va à la rencontre de populations marginalisées pour donner voix à leur expérience agit selon cet idéal : il ne considère pas leur sort comme « étranger » à son humanité et à sa responsabilité.`
  },
  // Question n°73
  {
    question: "Qu'est-ce qu'un « dialogue de sourds » ?",
    answers: [
...
Exemple : De nombreux débats télévisés entre politiques de bords opposés tournent au dialogue de sourds : chacun récite son credo, coupe la parole à l'autre, et aucun progrès dans la pensée n'émerge.`
  ...
  // Question n°74
  {
    question: "Comment la notion de « mythe » est-elle utilisée par le philosophe et sociologue Roland Barthes dans ses « Mythologies » ?",
    answers: [
...
Exemple : La publicité qui associe une voiture 4x4 à la liberté et à la nature est un mythe : elle transforme un objet industriel polluant en symbole de pureté et d'évasion, effaçant sa réalité matérielle et sociale.`
  ...
  // Question n°75
  {
    question: "Que signifie l'expression « le poids des mots » ?",
    answers: [
    ...
    correct: 2,
    explanation: `Cette expression métaphorique souligne la force performative et l'impact concret de la parole. Un mot peut déclencher une guerre (« casus belli »), sceller un amour (« je t'aime »), ruiner une réputation (calomnie), ou donner espoir (promesse). Prendre conscience du « poids des mots », c'est réaliser que parler n'est pas un acte anodin, que l'on est responsable de ce que l'on dit et de ses effets sur autrui. C'est le fondement de l'éthique de la parole.
Exemple : Les campagnes de sensibilisation contre le harcèlement scolaire insistent sur le « poids des mots » : une moquerie répétée peut avoir des conséquences dramatiques sur la santé mentale d'un enfant.`
  },
  // Question n°76
  {
    question: "Qu'est-ce que la « litote » comme figure de style ?",
    answers: [
...
Exemple : Dire « Bonjour » à quelqu'un n'est pas juste un code social ; dans la perspective lévinassienne, c'est déjà une reconnaissance de son existence et une ouverture à la relation. Le silence face à la détresse d'autrui serait une faute éthique.`
  ...
  // Question n°78
  {
    question: "Qu'est-ce qu'une « pétition de principe » (petitio principii) ?",
    answers: [
...
Exemple : « L'homéopathie est efficace car elle soigne les patients. Et comment sait-on qu'elle les soigne ? Parce qu'elle est efficace. » Le raisonnement tourne en rond sans apporter de preuve extérieure.`
  ...
  // Question n°79
  {
    question: "Quelle est la fonction de la « métaphore » dans le langage, au-delà de son usage poétique ?",
    answers: [
      "Elle est un simple ornement facultatif.",
      "Elle est constitutive de la pensée et du langage ordinaire (concepts « racine », « source », « flux » sont métaphoriques) ; elle permet de conceptualiser l'abstrait à partir du concret et structure notre vision du monde.",
      "Elle sert uniquement à créer des images frappantes dans la publicité."
    ],
    correct: 2,
    correct: 2,
    explanation: `Les travaux de Lakoff et Johnson ont montré que la métaphore n'est pas qu'une figure de style, mais un processus cognitif fondamental. Nous pensons et parlons constamment de manière métaphorique (« le temps, c'est de l'argent », « une discussion animée », « une idée lumineuse »). Ces métaphores structurantes organisent notre expérience. La rhétorique exploite cette propriété du langage pour orienter la perception (par exemple, métaphore de la « guerre » contre le terrorisme vs métaphore du « soin » pour une maladie sociale).
Exemple : Parler d'« inundation migratoire » est une métaphore qui fait percevoir les migrants comme une force naturelle destructrice et incontrôlable, influençant ainsi le débat politique.`
  },
  // Question n°80
  {
    question: "Que signifie l'expression « parler pour ne rien dire » ?",
    answers: [
...
Exemple : L'Agora athénienne, lieu de débat public où les citoyens discutaient des lois, est l'incarnation de cette idée : la cité naît et vit par la parole échangée.`
  ...
  // Question n°82
  {
    question: "Qu'est-ce que « l'ironie socratique » ?",
    answers: [
      "Une moquerie méchante et blessante.",
      "Une posture pédagogique où Socrate feint l'ignorance (il est le « taon » de la cité) pour amener son interlocuteur à exposer ses prétendus savoirs et à en révéler les contradictions, l'amenant ainsi à prendre conscience de son ignorance réelle.",
      "Le fait de dire le contraire de ce qu'on pense, comme dans l'ironie moderne."
    ],
    correct: 2,
    explanation: `L'ironie socratique (eirôneia, εἰρωνεία) n'est pas un simple procédé rhétorique, mais une méthode dialectique. Socrate commence par se déclarer ignorant et demande à l'« expert » (un sophiste, un politique) de l'instruire. Par des questions apparemment naïves, il pousse l'interlocuteur à préciser ses définitions, ce qui finit par mettre en lumière des incohérences dans ses croyances. Cette feinte modestie est une arme redoutable pour démasquer la fausse science et ouvrir la voie à une authentique recherche de la vérité.
Exemple : Dans le Ménon, Socrate demande à Ménon de définir la vertu. Chaque définition proposée par Ménon est déconstruite par des questions, le laissant perplexe (état d'aporie), condition préalable pour vraiment apprendre.`
  ...
  // Question n°83
  {
    question: "Comment le « storytelling » est-il utilisé dans la communication contemporaine (politique, management, marketing) ?",
    answers: [
...
Exemple : Un candidat à la présidentielle qui raconte son enfance modeste, ses combats, pour incarner le « rêve américain » ou l'« ascenseur social républicain » utilise le storytelling pour créer un lien émotionnel avec les électeurs.`
  },
  // Question n°84
  {
    question: "Que signifie l'expression « jeter des mots à la tête de quelqu'un » ?",
    answers: [
...
Exemple : Lors d'une dispute conjugale houleuse, les partenaires peuvent « se jeter des mots à la tête » : des reproches anciens, des insultes, des généralisations (« tu es toujours... ») qui visent à faire mal plutôt qu'à résoudre le problème.`
  },
  // Question n°85
  {
    question: "Quel est le rôle de la « règle d'or » de la réciprocité dans l'éthique de la discussion ?",
    answers: [
...
Exemple : Dans un débat en classe, si vous exigez que vos arguments soient écoutés jusqu'au bout, vous devez accorder la même écoute à ceux de vos camarades, même si vous n'êtes pas d'accord.`
  },
  // Question n°86
  {
    question: "Qu'est-ce qu'une « antithèse » comme figure de style ?",
    answers: [
...
Exemple : « Vous êtes riche, je suis pauvre ; vous êtes puissant, je suis faible. » (Antithèses sociales). « C'était le meilleur des temps, c'était le pire des temps... » (Début de « A Tale of Two Cities » de Dickens).`
  },
  // Question n°87
  {
    question: "Comment la notion de « parole donnée » (promesse) est-elle analysée philosophiquement ?",
    answers: [
    ...
    correct: 2,
    explanation: `La promesse est un acte de langage qui crée une obligation morale. En disant « Je promets », je me lie moi-même et je donne à l'autre un droit sur mon futur comportement. C'est un acte de liberté qui crée une contrainte. Des philosophes comme Hobbes ou Rousseau en font le fondement du contrat social. Pour d'autres comme Nietzsche, il faut une « mémoire de la volonté » pour tenir ses promesses, ce qui est le propre de l'homme « susceptible de promesse ». Rompre sa parole, c'est briser un lien social essentiel.
Exemple : Le serment d'Hippocrate (« Je promets... ») est une parole donnée par les médecins qui les engage moralement et professionnellement pour toute leur carrière.`
  ...
  // Question n°88
  {
    question: "Qu'est-ce que le « double bind » (double contrainte) dans la communication, selon l'école de Palo Alto ?",
    answers: [
...
Exemple : Un manager qui dit à son équipe « Soyez créatifs et sortez des sentiers battus, mais surtout ne faites pas d'erreurs et respectez strictement le protocole » crée une double contrainte paralysante.`
  ...
  // Question n°89
  {
    question: "Que signifie l'expression « appeler un chat un chat » ?",
    answers: [
...
Exemple : Au lieu de dire « il a des difficultés sociales », dire « il est pauvre ». Au lieu de « dommages collatéraux », dire « civils tués ». C'est « appeler un chat un chat ».`
  ...
  // Question n°90
  {
    question: "Quelle est la fonction de l'« anaphore » comme figure de style ?",
    answers: [
...
Exemple : Le discours « I have a dream » de Martin Luther King est construit sur de puissantes anaphores : « I have a dream that... », « Let freedom ring... ». Cela donne au discours son rythme et sa force prophétique.`
  ...
  // Question n°91
  {
    ...
    correct: 2,
    explanation: `Wittgenstein, dans les « Recherches philosophiques », rejette l'idée d'une essence unique du langage. Il propose l'image des « jeux de langage » : le langage est une collection d'activités humaines hétérogènes, chacune avec ses règles. Comprendre un mot, c'est savoir l'utiliser correctement dans le jeu auquel il appartient. Le sens n'est pas une représentation mentale, mais un usage. Cette approche pragmatique met l'accent sur la diversité des fonctions de la parole dans la vie sociale.
Exemple : Le mot « pain » n'a pas le même « jeu de langage » chez le boulanger (« Un pain, s'il vous plaît »), dans un laboratoire (« La composition moléculaire du pain »), ou dans une prière (« Donne-nous aujourd'hui notre pain quotidien »). Son sens est lié à la pratique.`
  ...
  // Question n°92
  {
    question: "Qu'est-ce qu'un « oxymore » comme figure de style ?",
    answers: [
...
Exemple : « Cette douce violence », « un merveilleux malheur », « le clair-obscur » en peinture. En politique, des expressions comme « guerre humanitaire » ou « austérité croissance » peuvent être analysées comme des oxymores (volontaires ou non).`
  ...
  // Question n°93
  {
    question: "Que signifie l'expression « tourner sa veste » en langage politique ?",
    answers: [
...
Exemple : Dans le duel, les adversaires donnaient leur parole d'honneur de respecter les règles. La trahir était la pire des ignominies. De même, un officier qui donne sa parole de ne pas s'évader s'engage sur son honneur.`
  ...
  // Question n°95
  {
    question: "Qu'est-ce que le « pléonasme » ?",
    answers: [
...
Exemple : « Une fausse perruque » (toute perruque est fausse), « prévoir à l'avance », « au jour d'aujourd'hui » sont des pléonasmes critiqués. Mais « Je l'ai entendu de mes propres oreilles » est un pléonasme expressif.`
  ...
  // Question n°96
  {
    question: "Quelle est la signification de la formule de Paul Valéry : « Ce qui se conçoit bien s'énonce clairement, Et les mots pour le dire arrivent aisément » ?",
    answers: [
...
Exemple : Un étudiant qui bute pour expliquer un concept compliqué est invité, par cette maxime, à revenir à sa compréhension fondamentale du concept avant de tenter de le reformuler.`
  ...
  // Question n°97
  {
    question: "Qu'est-ce que le « sous-entendu » dans la communication ?",
    answers: [
...
Exemple : Si quelqu'un dit « Il fait froid ici » en regardant la fenêtre ouverte, le sous-entendu est une demande (ou un reproche) implicite de fermer la fenêtre. « Tu as fini de faire du bruit ? » sous-entend « Arrête de faire du bruit ».`
  ...
  // Question n°98
  {
    question: "Comment la « parole de témoin » (dans un procès, sur un événement historique) est-elle épistémologiquement problématique ?",
    answers: [
...
Exemple : Les témoignages sur un accident de voiture varient souvent sur des détails cruciaux (couleur du feu, vitesse estimée). Cela ne signifie pas que les témoins mentent, mais que leur perception et leur mémoire sont faillibles.`
  ...
  // Question n°99
  {
    question: "Que signifie l'expression « prendre quelqu'un au mot » ?",
    answers: [
    ...
    correct: 2,
    explanation: `C'est une stratégie rhétorique et relationnelle. Lorsque quelqu'un fait une déclaration (une promesse, une menace, une généralisation), « le prendre au mot », c'est exiger qu'il assume les conséquences logiques ou pratiques de cette parole. Cela peut être une manière de le tester, de le coincer dans ses propres contradictions, ou simplement de le forcer à être cohérent. Cela montre que les paroles engagent celui qui les prononce.
Exemple : Un enfant dit à ses parents « Je déteste cette école, j'arrête d'y aller ». Les parents peuvent le « prendre au mot » en lui demandant sérieusement quel est son plan alternatif pour son éducation, pour lui faire mesurer la portée réelle de ses paroles.`
  },
  // Question n°100
  {
    question: "Quel est l'enjeu final de l'étude de « l'art de la parole » en philosophie et en littérature ?",
    answers: [
...
Exemple : Cette séquence de HLP vise à former votre esprit critique face aux discours médiatiques et politiques, et à vous donner les outils pour construire et défendre vos propres idées de manière argumentée, à l'écrit comme à l'oral, dans le respect d'autrui.`
  }
];