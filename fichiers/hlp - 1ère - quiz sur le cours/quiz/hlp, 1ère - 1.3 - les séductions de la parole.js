...
const questions = [
  ...
  // Question n°2
  {
    question: "Dans <em>L'Apologie de Socrate</em>, sur quel fondement principal Socrate base-t-il la légitimité de sa parole face au tribunal ?",
    answers: [
  ...
  // Question n°3
  {
    question: "Quel mécanisme narratif Shéhérazade utilise-t-elle pour différer indéfiniment son exécution et séduire le sultan ?",
    answers: [
  ...
  // Question n°4
  {
    question: "Selon Hannah Arendt, quel mécanisme spécifique utilise la propagande totalitaire pour imposer sa fiction politique ?",
    answers: [
  ...
  // Question n°5
  {
    question: "Dans le domaine publicitaire, quelle stratégie vise à associer un produit à une identité sociale ou à des aspirations personnelles ?",
    answers: [
  ...
  // Question n°6
  {
    question: "Quelle puissance la figure mythique d'Orphée incarne-t-elle à propos de la parole ?",
    answers: [
  ...
  // Question n°8
  {
    question: "Comment Gorgias de Léontinoi décrit-il l'effet du discours (<em>logos</em>) sur l'âme dans son <em>Éloge d'Hélène</em> ?",
    answers: [
  ...
  // Question n°11
  {
    question: "Que signifie le caractère <em>performatif</em> de certaines paroles dans le contexte amoureux ou juridique ?",
    answers: [
  ...
  // Question n°13
  {
    question: "Comment Max Weber définit-il l'autorité politique de type <em>charismatique</em> ?",
    answers: [
  ...
  // Question n°14
  {
    question: "Quel effet Ulysse cherche-t-il à produire sur les Phéaciens en leur racontant ses aventures ?",
    answers: [
  ...
  // Question n°16
  {
    question: "Quelle distinction fondamentale Hannah Arendt établit-elle entre la <em>force</em> (violence) et la <em>puissance</em> politique ?",
    answers: [
  ...
  // Question n°18
  {
    question: "Que signifie l'idée qu'un discours politique repose sur une « légitimité horizontale » plutôt que verticale ?",
    answers: [
  ...
  // Question n°22
  {
    question: "Selon le mythe rapporté par Diotime dans <em>Le Banquet</em> de Platon, qui sont les parents d'Éros (l'Amour) ?",
    answers: [
  ...
  // Question n°23
  {
    question: "Selon Rousseau dans l'<em>Essai sur l'origine des langues</em>, quelle est la fonction première du langage ?",
    answers: [
  ...
  // Question n°24
  {
    question: "Comment Jules César utilisait-il la séduction amoureuse comme instrument de sa stratégie politique ?",
    answers: [
  ...
  // Question n°25
  {
    question: "Sur quel sentiment humain universel Priam mise-t-il pour fléchir Achille et récupérer le corps d'Hector ?",
    answers: [
  ...
  // Question n°28
  {
    question: "Selon une idée reprise par Rousseau, quel personnage mythique est présenté comme l'inventeur du dessin ?",
    answers: [
  ...
  // Question n°29
  {
    question: "Comment le silence peut-il devenir un élément actif et puissant dans une stratégie de séduction ?",
    answers: [
  ...
  // Question n°30
  {
    question: "Que représente le masque (<em>prosopon</em>, <em>persona</em>) dans le théâtre antique grec ?",
    answers: [
  ...
  // Question n°34
  {
    question: "Quel est le rôle principal du chœur dans la tragédie grecque antique ?",
    answers: [
  ...
  // Question n°36
  {
    question: "Que désigne le terme grec <em>doxa</em> (δόξα) dans le contexte de la rhétorique et de la séduction ?",
    answers: [
  ...
  // Question n°37
  {
    question: "En quoi la parole d'Héloïse à Abélard représente-t-elle une forme de séduction paradoxale et radicale ?",
    answers: [
  ...
  // Question n°38
  {
    question: "Comment Jean Baudrillard analyse-t-il la publicité dans <em>Simulacres et simulation</em> ?",
    answers: [
  ...
  // Question n°39
  {
    question: "Que symbolise le mythe de l'androgyne, raconté par Aristophane dans <em>Le Banquet</em> de Platon ?",
    answers: [
  ...
  // Question n°42
  {
    question: "Comment Martin Heidegger caractérise-t-il le « bavardage » (<em>Gerede</em>) dans <em>Être et Temps</em> ?",
    answers: [
  ...
  // Question n°59
  {
    question: "Un professeur doit-il user de séduction pour enseigner efficacement ?",
    answers: [
  ...
  // Question n°62
  {
    question: "Comment l'auteur d'une autobiographie séduit-il son lecteur par sa parole écrite ?",
    answers: [
  ...
  // Question n°68
  {
    question: "Quelle est la fonction séductrice du récit mythique (comme ceux de la Genèse) ?",
    answers: [
  ...
  // Question n°73
  {
    question: "Pourquoi le mensonge est-il une arme à double tranchant dans la parole séductrice ?",
    answers: [
  ...
  // Question n°74
  {
    question: "Quel est le pouvoir des images associées à la parole dans la séduction contemporaine (publicité, politique) ?",
    answers: [
  ...
  // Question n°75
  {
    question: "Comment un expert (scientifique, médecin) use-t-il de la parole pour séduire et faire autorité ?",
    answers: [
  ...
  // Question n°77
  {
    question: "Pourquoi le silence de l'écoute est-il une condition essentielle à l'émergence d'une parole authentique ?",
    answers: [
  ...
  // Question n°81
  {
    question: "Quelle distinction peut-on faire entre deux pôles de la séduction ?",
    answers: [
  ...
  // Question n°82
  {
    question: "Comment la parole peut-elle avoir un pouvoir « guérisseur » (dans une thérapie) ?",
    answers: [
  ...
  // Question n°83
  {
    question: "Quel type de séduction opère la parole du « peuple » (proverbes, dictons) ?",
    answers: [
  ...
  // Question n°85
  {
    question: "En quoi une parole qui engage (serment, promesse) est-elle au cœur de la séduction amoureuse ou politique ?",
    answers: [
  ...
  // Question n°86
  {
    question: "Que révèlent les manuels d'éducation pour jeunes filles (comme celui du Chevalier de La Tour Landry) sur la parole féminine ?",
    answers: [
  ...
  // Question n°87
  {
    question: "Quelle est la différence fondamentale, selon Platon, entre la parole du philosophe et celle du rhéteur ?",
    answers: [
  ...
  // Question n°90
  {
    question: "Quels procédés typiques de la séduction peut-on identifier dans un discours politique contemporain ?",
    answers: [
  ...
  // Question n°93
  {
    question: "Comment un artiste (écrivain, cinéaste) séduit-il son public par son œuvre ?",
    answers: [
  ...
  // Question n°98
  {
    question: "Comment les hymnes nationaux ou les chants de supporters créent-ils une séduction collective ?",
    answers: [
