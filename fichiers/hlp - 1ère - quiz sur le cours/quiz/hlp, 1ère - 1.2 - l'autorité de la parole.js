...
const questions = [
  // Question n°1
  {
    ...
    answers: [
      ...
      "Auctoritas (autorité traditionnelle) et Potestas (puissance de contrainte)",
      "Autorité personnelle et autorité institutionnelle"
    ],
    correct: 2,
    explanation: `La distinction centrale est entre l'auctoritas (autorité fondée sur la tradition, l'origine, le prestige) et la potestas (puissance de contrainte, pouvoir de commandement). L'auctoritas renvoie à une légitimité héritée du passé, à un poids symbolique. La potestas désigne l'exercice effectif du pouvoir, la capacité à imposer sa volonté. Cette distinction, héritée de la pensée politique romaine, permet de comprendre qu'une parole peut "faire autorité" sans pour autant détenir le pouvoir coercitif.\nExemple : Un grand professeur émérite a de l'auctoritas dans son domaine, même s'il n'a plus de potestas administrative.`
  },
  // Question n°2
  {
  ...
  // Question n°3
  {
    ...
    correct: 2,
    explanation: `Cicéron énonce : "Tandis que le pouvoir réside dans le peuple, l'autorité appartient au sénat". Cette formule résume la conception républicaine romaine de la répartition des pouvoirs. Le peuple (populus) détient la souveraineté et le pouvoir de voter les lois (potestas). Le Sénat, assemblée des anciens et des hommes prestigieux, détient l'auctoritas : son avis, son prestige, son poids moral orientent et légitiment les décisions sans les commander directement.\nExemple : Une loi votée par les comices populaires acquérait une légitimité renforcée si elle recevait l'approbation (l'auctoritas) du Sénat.`
  },
  // Question n°4
  {
    question: "Quelle est la distinction établie par Max Weber entre 'puissance' (Macht) et 'domination' (Herrschaft) ?",
    answers: [
    ...
    correct: 2,
    explanation: `Max Weber définit la puissance (Macht) comme "toute chance de faire triompher au sein d'une relation sociale sa propre volonté, même contre des résistances". C'est un rapport de force contingente. La domination (Herrschaft) est "la chance de trouver des personnes déterminables prêtes à obéir à un ordre de contenu déterminé". Elle implique une légitimité reconnue, une institutionnalisation qui rend l'obéissance quasi-automatique. La domination se rapproche ainsi de la notion d'autorité légitime.\nExemple : Un chef de bande a de la puissance sur ses hommes ; un juge exerce une domination légale-rationnelle.`
  },
  // Question n°5
  {
    question: "Dans l''Odyssée', comment Télémaque justifie-t-il son ordre à Pénélope de se retirer dans ses appartements ?",
    answers: [
  ...
  // Question n°9
  {
    question: "Selon Hannah Arendt, quel est le fondement de l'autorité (auctoritas) dans la Rome antique ?",
    answers: [
      "La force militaire",
    ...
    correct: 3,
    explanation: `Hannah Arendt, dans « Qu'est-ce que l'autorité ? », explique que l'auctoritas romaine dérive de la fondation sacrée de Rome. Les actes présents tirent leur légitimité en étant « ajoutés », pour ainsi dire, au poids entier du passé fondateur. L'autorité n'est pas la force (potestas) mais ce qui « augmente » (de augere) et confirme les actions humaines en les reliant à un commencement sacré. Les dieux et le Sénat avaient de l'auctoritas : ils augmentaient et validaient, mais ne commandaient pas directement.\nExemple : L'approbation du Sénat (son auctoritas) « augmentait » la valeur et la légitimité d'une décision prise par les magistrats.`
  },
  // Question n°10
  {
  ...
  // Question n°11
  {
    question: "Quel est l'enjeu principal du mythe de Gygès, rapporté par Platon dans 'La République' ?",
    answers: [
  ...
  // Question n°19
  {
    question: "Que signifie étymologiquement le mot 'poésie', issu du grec ποιεῖν (poiein) ?",
    answers: [
      "Chanter",
      "Faire, créer",
      "Rêver"
  ...
  // Question n°21
  {
    question: "Quelle est la critique majeure que Socrate (Platon) adresse à l'écriture dans le 'Phèdre' ?",
    answers: [
  ...
  // Question n°27
  {
    ...
    correct: 2,
    explanation: `L'"oint" (du latin "unctus", "oint") traduit les termes hébreu "messie" et grec "christos". Il désigne celui qui a reçu l'onction d'huile sacrée, signe de son élection et de sa consécration par Dieu. Dans la monarchie de droit divin (notamment en France avec le sacre à Reims), le roi est "l'oint du Seigneur". Cette onction lui confère une autorité (auctoritas) sacrée, qui dépasse sa personne physique. Il incarne ainsi une double nature, à l'image du Christ : un corps mortel et un corps politique immortel (théorie des "deux corps du roi" étudiée par Kantorowicz).\nExemple : Le roi de France était réputé guérir les écrouelles (scrofules) par son toucher, pouvoir thaumaturgique lié à son onction sacrée.`
  },
  // Question n°28
  {
  ...
  // Question n°34
  {
    ...
    correct: 2,
    explanation: `Utopique vient du grec "ou-topos", qui signifie "sans lieu". Une parole utopique est donc, au sens premier, une parole qui n'a pas de lieu institutionnel assigné, qui échappe aux cadres établis du discours (tribunal, assemblée, chaire, média). Elle est par essence marginale, subversive, déplacée. La parole authentique du philosophe, du poète ou du prophète est souvent utopique en ce sens : elle surgit hors des lieux prévus, dérange l'ordre discursif établi. Ce n'est que secondairement qu'"utopique" a pris le sens de "chimérique".\nExemple : Socrate parlait sur l'agora, dans la rue, hors des institutions scolaires ou politiques officielles ; sa parole était utopique.`
  },
  // Question n°35
  {
  ...
  // Question n°37
  {
    ...
    correct: 2,
    explanation: `Pour Arendt, l'autorité (au sens romain d'auctoritas) est inextricablement liée à la tradition et à la fondation. L'autorité du Sénat romain venait de ce qu'il était le gardien et le continuateur de l'acte fondateur de Rome. L'autorité "augmente" le présent en le reliant constamment au passé fondateur. Dans le monde moderne, la crise de l'autorité est, selon Arendt, une crise de la tradition : le fil qui reliait le présent à l'origine s'est rompu. Sans tradition vivante, l'autorité dégénère en violence pure (potestas) ou en persuasion.\nExemple : L'autorité d'un professeur peut venir en partie de sa position dans une longue tradition de transmission du savoir, qu'il incarne et perpétue.`
  },
  // Question n°38
  {
  ...
  // Question n°40
  {
    question: "Comment Démosthène, dans la 'Première Philippique', cherche-t-il à exhorter les Athéniens à l'action ?",
    answers: [
  ...
  // Question n°54
  {
    question: "Comment le 'silence de Dieu' (deus absconditus) est-il interprété dans la théologie et la littérature ?",
    answers: [
  ...
  // Question n°55
  {
    question: "Quelle est la fonction de la 'parole de conciliation' ou de médiation ?",
    answers: [
  ...
  // Question n°84
  {
    question: "Comment la 'parole de dénonciation' (whistleblowing, lanceur d'alerte) exerce-t-elle son autorité ?",
    answers: [
  ...
  // Question n°98
  {
    question: "Que signifie l'expression 'parole de dévoilement' au sens philosophique (alètheia) ?",
    answers: [
